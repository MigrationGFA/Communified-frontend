              ...
              <div class="header-button">
                ...
                >
                  <span>
                    ...
                    <span class="btn-double-text" data-text="Send a message"
                      >Send a message</span
                    >
                  </span>
                </a>
              ...
              >
                ...
                <div class="pricing-features">
                  <ul>
                    ...
                    <li>
                      <i class="fas fa-check"></i> Access to the Communified
                      Marketplace
                    </li>
                    <li>
              ...
              >
                ...
                <div class="pricing-features">
                  <ul>
                    ...
                    <li><i class="fas fa-check"></i> Save $100</li>
                    <li>
