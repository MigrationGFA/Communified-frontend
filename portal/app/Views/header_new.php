...
<head>
    ...
    <link rel="apple-touch-icon" href="<?php echo base_url('favicon-nora.png') ?>">
...
<!-- BEGIN: Vendor CSS-->
    ...
    <link rel="stylesheet" type="text/css" href="<?php echo base_url("assets/app-assets/css/pages/pagination.css"); ?>">
    ...
    <link rel="stylesheet" type="text/css" href="<?php echo base_url("assets/app-assets/css/portal-onb.css"); ?>">
    <script src="<?php echo base_url("assets/app-assets/js/scripts/pagination.js"); ?>"></script>
    <script src="<?php echo base_url("assets/app-assets/js/core/api.js"); ?>"></script>
    <link rel="stylesheet" type="text/css" href="<?php echo base_url("assets/css/communified_dashboard.css"); ?>?v=<?php echo time(); ?>_2">
    <style>
