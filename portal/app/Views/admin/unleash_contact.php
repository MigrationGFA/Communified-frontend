        ...
        <div class="col-xs-12">
          ...
          <div class="box">
            ...
            <div class="box-header">
              <h3 class="box-title">Unleashified Contact List</h3>
            </div>
            <!-- /.box-header -->
            ...
            <div class="box-body">
              ...
              <table id="example1" class="table table-bordered table-striped">
				...
				<?php 
				$n = 1;
				$row = $admin_model->getAllUnleashifiedContact();  foreach($row as $rowArray){  
				...
				?>
                  <tr class="myTable<?php //echo $rowArray['id'] ?>">
                    ...
                    <td><strong>Topic: </strong><?php echo $rowArray['topic']; ?><br><?php echo $rowArray['message']; ?></td>
