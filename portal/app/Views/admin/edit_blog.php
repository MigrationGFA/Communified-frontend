...
<div class="content-wrapper">
 ...
 <!-- Content Header (Page header) -->
     ...
     <div class="row displayForm">
        <div class="col-md-12">
          ...
          <div class="box box-info">
            ...
            <?php $getBlogData = $this->admin_model->get_blog_post($id); ?>
            <div class="box-body">
              <!-- Color Picker -->
            ...
            <div class="col-12 col-sm-6 mb-1">
              ...
              <option value="<?php echo $getBlogData[0]['category'] ?>"><?php echo $getBlogData[0]['category'] ?></option>
             ...
             <div class="col-12 col-sm-6 mb-1">
                ...
                required
                placeholder=""
                value="<?php echo $getBlogData[0]['title'] ?>"
            ...
            <div class="col-12 col-sm-6 mb-1">
              ...
              <input
                ...
                name="source"
                placeholder=""
                value="<?php echo $getBlogData[0]['source'] ?>"
                data-msg="Please enter first name"
              />
            </div>
             ...
             <div class="col-12 col-sm-6 mb-1">
              ...
              <select id="country" name="blog_url" class="select2 form-control form-select">
                <option value="<?php echo $getBlogData[0]['blog_url'] ?>"><?php echo $getBlogData[0]['blog_url'] ?></option>
            ...
            <div class="col-12 col-sm-6 mb-1">
             ...
             <input type="hidden" name="getFile" value="<?php echo $getBlogData[0]['blog_photo'] ?>" />
            <div class="col-12 col-sm-6 mb-1">
              ...
              <select id="country" name="status" class="select2 form-control form-select">
                    <option value="<?php echo $getBlogData[0]['status'] ?>"><?php echo $getBlogData[0]['status'] ?></option>
            ...
            <div class="col-12 col-sm-6 mb-1">
              ...
              <div
                  ...
                  style="height: 100px"
				  name="content"
                ><?php echo $getBlogData[0]['content'] ?></div>
            </div>
    ...
    $.ajax({
     data:formData,
     type: "POST",
     url: "<?php echo base_url(); ?>admin/updateblogpro",
