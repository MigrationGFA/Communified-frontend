        ...
        <div class="col-xs-12">
          ...
          <div class="box">
            ...
            <div class="box-header">
              <h3 class="box-title">Unleashified Customer Quote</h3>
            </div>
            <!-- /.box-header -->
            ...
            <div class="box-body">
              ...
              <table id="example1" class="table table-bordered table-striped">
				...
				<?php 
				$n = 1;
				$row = $admin_model->getAllUnleashifiedQuote();  foreach($row as $rowArray){  
				...
				?>
                  <tr class="myTable<?php //echo $rowArray['id'] ?>">
                    ...
                    <td><strong>Budget: </strong><?php echo $rowArray['budget']; ?><br><?php echo $rowArray['details']; ?></td>
