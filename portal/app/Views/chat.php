<!DOCTYPE html>
<html lang="en" class="light-style layout-navbar-fixed layout-menu-fixed layout-compact " dir="ltr" data-theme="theme-default" data-assets-path="<?= base_url('assets-new')?>/" data-template="vertical-menu-template">
<head>
    <meta charset="utf-8" />
    ...
    <!-- Icons -->
    <link rel="stylesheet" href="<?= base_url('assets-new')?>/vendor/fonts/fontawesome.css" />
    <link rel="stylesheet" href="<?= base_url('assets-new')?>/vendor/fonts/tabler-icons.css"/>
    <link rel="stylesheet" href="<?= base_url('assets-new')?>/vendor/fonts/flag-icons.css" />

    <!-- Core CSS -->
    <link rel="stylesheet" href="<?= base_url('assets-new')?>/vendor/css/rtl/core.css" class="template-customizer-core-css" />
    <link rel="stylesheet" href="<?= base_url('assets-new')?>/vendor/css/rtl/theme-default.css" class="template-customizer-theme-css" />
    <link rel="stylesheet" href="<?= base_url('assets-new')?>/css/demo.css" />
    
    <!-- Vendors CSS -->
    <link rel="stylesheet" href="<?= base_url('assets-new')?>/vendor/libs/node-waves/node-waves.css" />
    <link rel="stylesheet" href="<?= base_url('assets-new')?>/vendor/libs/perfect-scrollbar/perfect-scrollbar.css" />
    <link rel="stylesheet" href="<?= base_url('assets-new')?>/vendor/libs/typeahead-js/typeahead.css" /> 
    <link rel="stylesheet" href="<?= base_url('assets-new')?>/vendor/libs/bootstrap-maxlength/bootstrap-maxlength.css" />

    <!-- Page CSS -->	
	<link rel="stylesheet" href="<?= base_url('assets-new')?>/vendor/css/pages/app-chat.css">
	
        <!-- Helpers -->
        <script src="<?= base_url('assets-new')?>/vendor/js/helpers.js"></script>
    <!--! Template customizer & Theme config files MUST be included after core stylesheets and helpers.js in the <head> section -->
    <!--? Template customizer: To hide customizer set displayCustomizer value false in config.js.  -->
    <!--<script src="<?= base_url('assets-new')?>/vendor/js/template-customizer.js"></script>-->
    <!--? Config:  Mandatory theme config file contain global vars & default theme options, Set your preferred theme option in this file.  -->
    <script src="<?= base_url('assets-new')?>/js/config.js"></script>
...
<body>
                ...
                <div class="row g-0">
                    ...
                    <div class="sidebar-header">
                        ...
                        <div class="flex-shrink-0 avatar me-3" data-bs-toggle="sidebar" data-overlay="app-overlay-ex" data-target="#app-chat-sidebar-left">
                            <img class="user-avatar rounded-circle cursor-pointer" src="<?= base_url('assets-new')?>/img/avatars/default-img.jpg" alt="Avatar">
                        </div>
                        ...
                        <div class="chat-history-wrapper">
                            ...
                            <div class="d-flex justify-content-between align-items-center">
                                ...
                                <div class="flex-shrink-0 avatar">
                                    <img src="<?= base_url('assets-new')?>/img/avatars/default-img.jpg" alt="Avatar" class="rounded-circle" data-bs-toggle="sidebar" data-overlay data-target="#app-chat-sidebar-right">
                                </div>
    ...
    <script src="<?= base_url('assets-new')?>/vendor/libs/jquery/jquery.js"></script>
    <script src="<?= base_url('assets-new')?>/vendor/libs/popper/popper.js"></script>
    <script src="<?= base_url('assets-new')?>/vendor/js/bootstrap.js"></script>
    <script src="<?= base_url('assets-new')?>/vendor/libs/node-waves/node-waves.js"></script>
    <script src="<?= base_url('assets-new')?>/vendor/libs/perfect-scrollbar/perfect-scrollbar.js"></script>
    <script src="<?= base_url('assets-new')?>/vendor/libs/hammer/hammer.js"></script>
    <script src="<?= base_url('assets-new')?>/vendor/libs/i18n/i18n.js"></script>
    <script src="<?= base_url('assets-new')?>/vendor/libs/typeahead-js/typeahead.js"></script>
    <script src="<?= base_url('assets-new')?>/vendor/js/menu.js"></script>
    
    <!-- endbuild -->
    
    <!-- Vendors JS -->
    <script src="<?= base_url('assets-new')?>/vendor/libs/bootstrap-maxlength/bootstrap-maxlength.js"></script>
    <!-- Main JS -->
    <script src="<?= base_url('assets-new')?>/js/main.js"></script>
    <!-- Page JS -->
    <script src="<?= base_url('assets-new')?>/js/app-chat.js" defer></script>
