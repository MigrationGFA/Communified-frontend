   ...
   ?>
    ...
    <div class="main-menu menu-fixed menu-light menu-accordion menu-shadow" data-scroll-to-active="true">
      <div class="navbar-header">
       ...
       <center><a href="<?php echo base_url('gfa/dashboard'); ?>"><img src="<?php echo base_url('assets/images/communified-logo.png'); ?>" width="120px" height="120px" align="center" style="border-radius: 20%;"></a></center>
      </div><br> <br> <br>
