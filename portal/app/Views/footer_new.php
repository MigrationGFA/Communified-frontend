  <!-- BEGIN: Footer-->
    ...
    <!-- BEGIN: Page Vendor JS-->
    <script src="<?php echo base_url('assets/app-assets/vendors/js/calendar/fullcalendar.min.js'); ?>"></script>
    <script src="<?php echo base_url('assets/app-assets/vendors/js/extensions/moment.min.js'); ?>"></script>
    <script src="<?php echo base_url('assets/app-assets/vendors/js/forms/select/select2.full.min.js'); ?>"></script>
    ...
    <!-- BEGIN: Page JS-->
    <script src="<?php echo base_url('assets/app-assets/js/scripts/forms/pickers/form-pickers.min.js'); ?>"></script>
