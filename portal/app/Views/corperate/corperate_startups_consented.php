...
<!--   The investor name & title -->
            ...
            <h4 class="card-title">Consented To Account Opening <?php echo ucwords($state) ?> State </h4>
 ...
 <?php 
    ...
    <div class="col-lg-12 col-12">
        <div class="col-lg-12 text-center mb-2">
           <a href="<?php echo base_url(); ?>gfa/export_all_reg_consented/<?php echo $batch ?>" class="btn btn-secondary btn-next" style="margin:5px;"> Export Data </a> 
          ...
          <div class="table-responsive">
            <table class="table" id="table">
              ...
              <tbody>
                ...
                $userDetails = $this->gfa_model->userCourseDetails($rowArray['Email']);
                $id = $userDetails[0]['STUP_ID'];
                ?> 
                <tr class="data">
                    ...
                    <td>
                        ...
                        <a class="btn btn-secondary" href="<?php echo base_url("gfa/corperate_startups_details/{$id}"); ?>">Details</a>
                  ...
                  <td>
                    <div class="d-flex align-items-center">
                      ...
                      <div>
                        <div class="fw-bolder">
                            <?php 
                            if ($userDetails[0]['Primary_Contact_Name']!=''){
                       
                            echo $userDetails[0]['Primary_Contact_Name'];
                        }  
                        
                        ?> 
                      
                      </div>
                        <div class="font-small-2 text-muted"><?php echo $userDetails['Contact_Email'] ; ?></div>
                  ...
                  <td>
                   <div class="d-flex align-items-center">
                      ...
                      if($rowArray["Category"]=="Business Owner"){
           echo "<strong>Business Owner</strong>"; 
        }
        if($rowArray["Category"]=="Aspiring Business Owner"){
           echo "<strong>Aspiring Business Owner</strong>"; 
        }
        if($rowArray["Category"]=="Professional" || $rowArray["Category"]=="professional"){
           echo "<strong>Working Professional</strong>"; 
        }
        if($rowArray["Category"]=="jobseeker"){
           echo "<strong>Job Seeker</strong>"; 
                    ...
                    <td>
                   <?php echo str_replace("?","",$userDetails[0]['profile_extra']);  ?>
                   </td>
