...
<aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
  ...
  <div class="app-brand demo ">
     ...
     <img src="https://gfa-tech.com/projects/gateway/images/gfa+ogun-removebg-preview.png" width="100%">
    </a>
  </div>
  ...
  <ul class="menu-inner py-1">
    ...
    <li class="menu-item">
      ...
      <li class="menu-item <?php echo ($this->gfa_model->getCohortDetails($email)) ? 'd-none' : ''; ?>">
  ...
  <?php }  ?>
     ...
     <!-- <li class="menu-item">
      <a href="<?php echo base_url('chat'); ?>" class="menu-link">
        <i class="menu-icon tf-icons ti ti-book"></i>
