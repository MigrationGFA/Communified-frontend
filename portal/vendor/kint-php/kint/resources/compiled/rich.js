  ...
  (window.kintRich = (function () {
    ...
    var l = {
      ...
      toggle: function (e, t) {
        ...
        a &&
          (e.classList.toggle('kint-show', t), 1 === a.childNodes.length) &&
      ...
      switchTab: function (e) {
        ...
        for (var o = e.parentNode.nextSibling.childNodes, s = 0; s < o.length; s++)
          s === a
        ...
        t &&
          ...
          t.document.write(
            l.mktag('html') +
              ...
              l.mktag('script class="kint-rich-script" nonce="' + l.script.nonce + '"') +
              l.script.innerHTML +
              l.mktag('/script') +
              l.mktag('style class="kint-rich-style" nonce="' + l.style.nonce + '"') +
              l.style.innerHTML +
              l.mktag('/style') +
              l.mktag('/head') +
              l.mktag('body') +
      ...
      showSearchBox: function (e) {
        ...
        t &&
          ...
          t.classList.contains('kint-show')
            ? (e.classList.add('kint-show'), t.focus(), t.select(), l.search(e.parentNode, t.value))
          ...
          if (a)
            if (
                ...
                'DL' == e.tagName
                  ...
                  : 'UL' == e.tagName &&
                    (e.classList.contains('kint-tabs')
                      ? (o = e.childNodes)
                      : e.classList.contains('kint-tab-contents') && (s = e.childNodes));
              }),
              ...
              for (var r = 0; r < o.length; r++) {
                var i = !1;
                (i =
                  -1 != o[r].textContent.toUpperCase().indexOf(t.toUpperCase()) ||
                  ((n = s[r].cloneNode(!0)).querySelectorAll('.access-path').forEach(function (e) {
                    e.remove();
                  }),
                  -1 != n.textContent.toUpperCase().indexOf(t.toUpperCase()))
                    ? !0
      ...
      getChildren: function (e) {
        for (; (e = e.nextElementSibling) && 'dd' !== e.nodeName.toLowerCase(); );
        return e;
      },
      ...
      initLoad: function () {
        ((l.style = window.kintShared.dedupe('style.kint-rich-style', l.style)),
          (l.script = window.kintShared.dedupe('script.kint-rich-script', l.script)),
          (l.folder = window.kintShared.dedupe('.kint-rich.kint-folder', l.folder)));
        var t,
      ...
      keyboardNav: {
        ...
        sync: function (e) {
          ...
          (t && t.classList.remove('kint-focused'),
            l.keyboardNav.active &&
              ((t = l.keyboardNav.targets[l.keyboardNav.target]).classList.add('kint-focused'),
        ...
        scroll: function (e) {
          ...
          (l.folder && e === l.folder.querySelector('dt > nav')) ||
            ...
            l.isFolderOpen()
              ? (a = l.folder.querySelector('dd.kint-foldout')).scrollTo(0, e - a.clientHeight / 2)
      ...
      window.addEventListener(
        ...
        function (e) {
          ...
          if (l.mouseNav.lastClickTarget && l.mouseNav.lastClickTimer && l.mouseNav.lastClickCount)
            if (((t = l.mouseNav.lastClickTarget), 1 === l.mouseNav.lastClickCount))
            ...
            if (('dfn' === n && l.selectText(t), 'th' === n))
              ...
              ((t = l.getParentHeader(t)) &&
                (l.keyboardNav.setCursor(t.querySelector('nav')), l.keyboardNav.sync(!0)),
              (t = e.target),
              ...
              else for (; r && !r.classList.contains('kint-parent'); ) r = r.parentNode;
              l.openInNewWindow(r);
            } else
        ...
        function (e) {
          if (e.target === document.body && !e.altKey && !e.ctrlKey)
            if (68 === e.keyCode) {
              ...
              if (9 === e.keyCode)
                (l.keyboardNav.moveCursor(e.shiftKey ? -1 : 1), e.preventDefault());
                ...
                ((o = o.parentNode),
                  65 === e.keyCode
                    ...
                    : 'footer' === o.nodeName.toLowerCase() &&
                      ...
                      : 32 === e.keyCode || 13 === e.keyCode
                        ? (l.toggle(o), l.keyboardNav.fetchTargets(), e.preventDefault())
                        : (39 !== e.keyCode &&
                            76 !== e.keyCode &&
                            37 !== e.keyCode &&
                            72 !== e.keyCode) ||
                          ...
                          o.classList.contains('kint-show')
                            ...
                            : t ||
                              ((a = l.getParentHeader(o.parentNode.parentNode, !0)) &&
                                (l.keyboardNav.setCursor((o = a).querySelector('nav')),
                                l.keyboardNav.sync())),
                          l.toggle(o, t),
                          l.keyboardNav.fetchTargets(),
                          e.preventDefault()));
