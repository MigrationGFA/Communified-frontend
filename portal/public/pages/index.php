...
<link rel="stylesheet" href="../frontend_assets/css/communified.css" />
  ...
  growth representative
                ...
                ?>
                <div class="pricing-action">
                  <button class="btn btn-primary w-100 select-plan-btn" onclick="window.location.href='/portal/gfa/pricingsub/<?php echo $subscription; ?>/<?php echo $subType ?>/<?php detectCurrencyAmountGFA(750000); ?>/<?php echo $gateway ?>'">
                    Choose Plan
                  </button>
                </div>
              </div>
