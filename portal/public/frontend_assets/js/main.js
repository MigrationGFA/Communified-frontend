(function ($) {
  ...
  if (
    ...
    if (typeof $.fn.mCustomScrollbar === 'function') {
      if ($('.navbar-collapse-clone').length) {
        var scrollOptions =
          $('.navbar-collapse-clone').attr('data-scroll-options') || '{ "theme": "light" }';
      ...
      initEvents() {
        ...
        this.DOM.menuLinks.forEach((item, i) => {
          ...
          item.addEventListener('mouseenter', (e) => {
            item
              .closest('.menu')
              .childNodes.forEach((item) => item.classList && item.classList.remove('active'));
    ...
    if (typeof $.fn.easyPieChart === 'function') {
      ...
      $(document.body).on('appear', '.pie-chart-style-01', function (e) {
        $('.pie-chart-style-01').easyPieChart({
          ...
          barColor: function () {
            color1 =
              $(this.el).attr('data-start-color') || $(this.el).attr('data-bar-color') || '#000';
            color2 =
              $(this.el).attr('data-end-color') || $(this.el).attr('data-bar-color') || '#000';
  ...
  function slideboxstyle() {
    $('.sliding-box').each(function (index, value) {
      ...
      valueObj
        .find('.sliding-box-item, .sliding-box-img, .sliding-box-item .sliding-box-content')
    ...
    if (!isIE()) {
      ...
      $('[data-parallax-liquid]').each(function () {
        ...
        var reverse = $(this).attr('data-parallax-reverse')
          ...
          : false;
        var parallaxTransition = parseFloat($(this).attr('data-parallax-transition'))
  ...
  function setOverLayerPosition() {
    if (
      ...
      $('.overlap-section, .overlap-section-one-fourth, .overlap-section-three-fourth').each(
        function () {
          let _this = $(this),
          ...
          if (getWindowWidth() > overlayBreakpoint) {
            ...
            setTimeout(function () {
              ...
              $('.overlap-section, .overlap-section-one-fourth, .overlap-section-three-fourth').css(
                'margin-top',
                'inherit'
              );
            }, 500);
