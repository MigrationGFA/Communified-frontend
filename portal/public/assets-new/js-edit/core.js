(function ($, window) {
    ...
    init: {
      ...
      set: function (fName) {
        if (
          ...
          (this.plugin[fName] && typeof this.plugin[fName] == 'function')
        ) {
          this._init.push(fName);
        } else if (
          (Array.isArray(fName) && fName.length > 1 && typeof fName[0] == 'function') ||
          (Array.isArray(fName) &&
            fName.length > 1 &&
            this.plugin[fName[0]] &&
            typeof this.plugin[fName[0]] == 'function')
        ) {
  ...
  $.fn.tableEdit = function (options) {
    if (
      ...
      var options = options || {},
        that = $.extend(true, localPlugin, $.TableEdit.plugin, options);
