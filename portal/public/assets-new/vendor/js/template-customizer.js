  ...
  return (function () {
    ...
    var t = {
        7621: function (t, e, s) {
          ...
          (u.push([
            t.id,
            '#template-customizer{font-family:-apple-system,BlinkMacSystemFont,"Segoe UI",Roboto,"Helvetica Neue",Arial,sans-serif,"Apple Color Emoji","Segoe UI Emoji","Segoe UI Symbol" !important;font-size:inherit !important;position:fixed;top:0;right:0;height:100%;z-index:99999999;display:-webkit-box;display:-ms-flexbox;display:flex;-webkit-box-orient:vertical;-webkit-box-direction:normal;-ms-flex-direction:column;flex-direction:column;width:360px; box-shadow:0 0 20px 0 rgba(0,0,0,.2);-webkit-transition:all .2s ease-in;-o-transition:all .2s ease-in;transition:all .2s ease-in;-webkit-transform:translateX(380px);-ms-transform:translateX(380px);transform:translateX(380px)}#template-customizer h5{position:relative;font-size:11px;font-weight:600}#template-customizer>h5{flex:0 0 auto}#template-customizer .disabled{color:#d1d2d3 !important}#template-customizer.template-customizer-open{-webkit-transition-delay:.1s;-o-transition-delay:.1s;transition-delay:.1s;-webkit-transform:none !important;-ms-transform:none !important;transform:none !important}#template-customizer .template-customizer-open-btn{position:absolute;top:180px;left:0;z-index:-1;display:block;width:42px;height:42px;border-top-left-radius:15%;border-bottom-left-radius:15%; color:#fff !important;text-align:center;font-size:18px !important;line-height:42px;opacity:1;-webkit-transition:all .1s linear .2s;-o-transition:all .1s linear .2s;transition:all .1s linear .2s;-webkit-transform:translateX(-62px);-ms-transform:translateX(-62px);transform:translateX(-62px)}@media(max-width: 991.98px){#template-customizer .template-customizer-open-btn{top:145px}}.dark-style #template-customizer .template-customizer-open-btn{ }#template-customizer .template-customizer-open-btn::before{content:"";width:22px;height:22px;display:block;background-size:100% 100%;position:absolute;background-image:url(' +
              d +
              ...
              (e.i = function (t, s, i, o, a) {
                ...
                for (var c = 0; c < t.length; c++) {
                  ...
                  (i && n[u[0]]) ||
                    ...
                    s &&
                      (u[2]
                        ? ((u[1] = '@media '.concat(u[2], ' {').concat(u[1], '}')), (u[2] = s))
                        : (u[2] = s)),
                    o &&
                      (u[4]
    ...
    ((s.m = t),
      ...
      (s.d = function (t, e) {
        for (var i in e)
          s.o(e, i) && !s.o(t, i) && Object.defineProperty(t, i, { enumerable: !0, get: e[i] });
      }),
      (s.o = function (t, e) {
                ...
                },
                {
                  ...
                  value: function (t) {
                    this._hasControls('style') &&
                      (this._setSetting('Style', -1 === ['dark'].indexOf(t) ? 'light' : t),
                    ...
                    if (this._hasControls('themes')) {
                      ...
                      if (i) {
                        ...
                        (this._loadStylesheets(
                          v({}, o, document.querySelector('.template-customizer-theme-css')),
                          s || function () {}
                        ),
                ...
                },
                {
                  ...
                  value: function () {
                    ...
                    ((t =
                      ...
                      this._hasControls('style') ||
                        (this.settings.style = S.contains('dark-style') ? 'dark' : 'light'),
                    ...
                    var a = this.container.querySelector('.template-customizer-close-btn'),
                      n = function () {
                        (t.container.classList.remove('template-customizer-open'),
                          t._updateInterval &&
                            (clearInterval(t._updateInterval), (t._updateInterval = null)));
                      };
