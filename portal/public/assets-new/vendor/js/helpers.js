    ...
    var f = {
          ...
          if (i) {
            ...
            if (!0 === e) {
              var l = function e() {
                var n = +new Date() - u,
                  i = o(n, s, a, t);
                ((r.scrollTop = i), n < t ? requestAnimationFrame(e) : (r.scrollTop = a));
              };
              l();
            } else r.scrollTop = a;
          }
      ...
      scrollPageTo: function (e) {
        ...
        var o = i.scrollTop,
          ...
          a = function a() {
            var u = +new Date() - s,
              l = n(u, o, r, t);
            ((i.scrollTop = l), u < t ? requestAnimationFrame(a) : (i.scrollTop = e));
          };
        a();
      },
      ...
      on: function () {
        var e = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : d('event'),
          ...
          u = n(a),
          l = u.slice(1);
        ((l = l.join('.') || null), this._listeners.push({ event: s, namespace: l, callback: t }));
      },
      off: function () {
        var e = this,
            ...
            e.addEventListener('click', function (t) {
              ...
              'text' === o.getAttribute('type')
                ...
                : 'password' === o.getAttribute('type') &&
                  (o.setAttribute('type', 'text'), i.classList.replace('ti-eye-off', 'ti-eye'));
            });
          });
      },
            ...
            e.addEventListener('click', function () {
              (e.closest('.input-group').querySelector('.form-control').focus(),
                ...
                (n.onresult = function (t) {
                  e.closest('.input-group').querySelector('.form-control').value =
      ...
      'undefined' != typeof window &&
        ...
        'complete' === document.readyState
          ...
          : document.addEventListener('DOMContentLoaded', function e() {
              (f.update(), document.removeEventListener('DOMContentLoaded', e));
            })),
      t
    );
  })();
