          ...
          t.exports = (function () {
                ...
                if (
                  ...
                  do {
                    if (
                      ...
                      ('none' !== _(i, 'transform') || (n && 'static' !== _(i, 'position')))
                    ) {
            ...
            function N(t, e) {
              for (
                ...
                n && (n === Ft.ghost || 'none' === _(n, 'display') || (e && !b(n, e)));
                  ...
                  e(
                    {
                      ...
                      dispatchSortableEvent: function (t) {
                        V({ sortable: n, name: t, originalEvent: i });
                      },
                    },
                    a
                  )
              ...
              Rt = function (t) {
                function e(t, n) {
                  return function (o, i, r, a) {
                    ...
                    return (
                      !0 === t || ('string' == typeof t && t === s) || (t.join && t.indexOf(s) > -1)
                    );
                  };
                }
                var o = {},
            ...
            function Ft(t, e) {
              ...
              var n = {
                ...
                supportPointer: !1 !== Ft.supportPointer && 'PointerEvent' in window && !h,
                emptyInsertThreshold: 5,
              };
              for (var o in (z.initializePlugins(this, t, n), n)) !(o in e) && (e[o] = n[o]);
              for (var r in (Rt(e), this))
                '_' === r.charAt(0) &&
            ...
            function Wt(t, e, n, o, i, r, a, l) {
              ...
              if (!a)
                if (l && yt < c * i) {
                  if (
                    (!_t && (1 === bt ? s > u + (c * r) / 2 : s < d - (c * r) / 2) && (_t = !0), _t)
                  )
                    h = !0;
              ...
              return (h = h || a) && (s < u + (c * r) / 2 || s > d - (c * r) / 2)
                ? s > u + c / 2
                  ? 1
                  : -1
                : 0;
            ...
            ((Ft.prototype = {
                ...
                if (t.cancelable) {
                  ...
                  if (
                    ...
                    !Z &&
                      ...
                      !s.isContentEditable &&
                      (this.nativeDraggable || !h || !l || 'SELECT' !== l.tagName.toUpperCase()) &&
                      !(((l = w(l, o.draggable, n, !1)) && l.animated) || et === l))
                  ) {
              ...
              _prepareDragStart: function (t, e, n) {
                ...
                if (n && !Z && n.parentNode === r) {
                  ...
                  if (
                    ...
                    (st = a.group),
                    (Ft.dragged = Z),
                    (ut = { target: Z, clientX: (e || t).clientX, clientY: (e || t).clientY }),
                      ...
                      (q('delayEnded', i, { evt: t }),
                        Ft.eventCanceled
                          ...
                          : (i._disableDelayedDragEvents(),
                            !d && i.nativeDraggable && (Z.draggable = !0),
                ...
                ((e = e || ('touch' == t.pointerType && t)),
                  !this.nativeDraggable || e
                    ? this.options.supportPointer
                      ...
                      : v(document, e ? 'touchmove' : 'mousemove', this._onTouchMove)
                    : (v(Z, 'dragend', this), v(J, 'dragstart', this._onDragStart)));
                try {
                  document.selection
                    ? Gt(function () {
              ...
              _onTouchMove: function (t) {
                if (ut) {
                  var e = this.options,
                    ...
                    s = At && wt && P(wt),
                    c =
                      (i.clientX - ut.clientX + o.x) / (a || 1) + (s ? s[0] - Tt[0] : 0) / (a || 1),
                    u =
                      (i.clientY - ut.clientY + o.y) / (l || 1) + (s ? s[1] - Tt[1] : 0) / (l || 1);
                  if (!Ft.active && !Et) {
                    if (
                      n &&
                      Math.max(
              ...
              _appendGhost: function () {
                if (!Q) {
                  ...
                  (S((Q = Z.cloneNode(!0)), n.ghostClass, !1),
                    ...
                    _(Q, 'height', e.height),
                    _(Q, 'opacity', '0.8'),
                    _(Q, 'position', At ? 'absolute' : 'fixed'),
                    _(Q, 'zIndex', '100000'),
                  ...
                  if (
                    ...
                    if (i)
                      return (
                        ...
                        this._hideClone(),
                        j('revert'),
                        Ft.eventCanceled || (tt ? J.insertBefore(Z, tt) : J.appendChild(Z)),
                        L(!0)
                      );
                    ...
                    if (
                      ...
                      if (
                        (v && a === t.target && (l = v),
                        l && (o = O(l)),
                        !1 !== Ht(J, a, Z, n, l, o, t, !!l))
                      )
                        return (
                          F(),
                          v && v.nextSibling ? a.insertBefore(Z, v.nextSibling) : a.appendChild(Z),
                          ($ = a),
                          K(),
                          L(!0)
                        );
                      ...
                      (function (t, e, n) {
                        ...
                        return e
                          ? t.clientX < o.left - 10 || (t.clientY < o.top && t.clientX < o.right)
                          : t.clientY < o.top - 10 || (t.clientY < o.bottom && t.clientX < o.left);
                      })(t, r, this)
                    ) {
                      var m = A(a, 0, s, !0);
                      if (m === Z) return L(!1);
                      if (((o = O((l = m))), !1 !== Ht(J, a, Z, n, l, o, t, !1)))
                        return (F(), a.insertBefore(Z, m), ($ = a), K(), L(!0));
                      ...
                      var b,
                        ...
                        T = r ? 'top' : 'left',
                        x = M(l, 'top', 'top') || M(Z, 'top', 'top'),
                        P = x ? x.scrollTop : void 0;
                      if (
                        (mt !== l && ((b = o[T]), (_t = !1), (Ct = (!C && s.invertSwap) || D)),
                        0 !==
                          (E = Wt(
                            t,
                            l,
                      ...
                      if (0 === E || y === l) return L(!1);
                      ((mt = l), (bt = E));
                      var R = l.nextElementSibling,
                        X = !1,
                        B = Ht(J, a, Z, n, l, o, t, (X = 1 === E));
                      if (!1 !== B)
                        return (
                          (1 !== B && -1 !== B) || (X = 1 === B),
                          (xt = !0),
                          setTimeout(Kt, 30),
                          F(),
                          X && !R ? a.appendChild(Z) : l.parentNode.insertBefore(Z, X ? R : l),
                          x && Y(x, 0, P - x.scrollTop),
                          ($ = Z.parentNode),
                          void 0 === b || Ct || (yt = Math.abs(b - O(l)[T])),
                          K(),
                          L(!0)
                        );
                    }
                  ...
                  return (
                    ...
                    e &&
                      ...
                      p !== f &&
                        ...
                        S(Z, s.ghostClass, !0)),
                      ct !== p && p !== Ft.active ? (ct = p) : p === Ft.active && ct && (ct = null),
                    ...
                    ((l === Z && !Z.animated) || (l === a && !l.animated)) && (mt = null),
                    s.dragoverBubble ||
                      t.rootEl ||
                      l === document ||
                      (Z.parentNode[H]._isOutsideThisEl(t.target), !e && Bt(t)),
              ...
              _offMoveEvents: function () {
                (m(document, 'mousemove', this._onTouchMove),
                  ...
                  m(document, 'dragover', Bt),
                  m(document, 'mousemove', Bt),
                  m(document, 'touchmove', Bt));
              },
                ...
                ((rt = I(Z)),
                  ...
                  Ft.eventCanceled ||
                    ...
                    t &&
                      ...
                      Z &&
                        (this.nativeDraggable && m(Z, 'dragend', this),
                        Lt(Z),
                        (Z.style['will-change'] = ''),
                        vt && !Et && S(Z, ct ? ct.options.ghostClass : this.options.ghostClass, !1),
              ...
              (Ft.mount = function () {
                ...
                (n[0].constructor === Array && (n = n[0]),
                  n.forEach(function (t) {
                    ...
                    (t.utils && (Ft.utils = e(e({}, Ft.utils), t.utils)), z.mount(t));
                  }));
              }),
                      ...
                      ? ((E =
                        ...
                        (D =
                          ...
                          ('auto' === T.overflowY ||
                            'scroll' === T.overflowY ||
                            'visible' === T.overflowY)))
                      : ((E = y < S && ('auto' === T.overflowX || 'scroll' === T.overflowX)),
                        (D = w < C && ('auto' === T.overflowY || 'scroll' === T.overflowY)));
                    var N =
                        E && (Math.abs(b - r) <= l && M + y < S) - (Math.abs(m - r) <= l && !!M),
                      I = D && (Math.abs(v - a) <= l && A + w < C) - (Math.abs(g - a) <= l && !!A);
                    if (!te[d]) for (var P = 0; P <= d; P++) te[P] || (te[P] = {});
                    ((te[d].vx == N && te[d].vy == I && te[d].el === f) ||
                      ((te[d].el = f),
                      (te[d].vx = N),
                      (te[d].vy = I),
                      clearInterval(te[d].pid),
                      (0 == N && 0 == I) ||
                        ((u = !0),
                        (te[d].pid = setInterval(
                          function () {
                            o && 0 === this.layer && Ft.active._onTouchMove(Qt);
                            var e = te[this.layer].vy ? te[this.layer].vy * s : 0,
                              n = te[this.layer].vx ? te[this.layer].vx * s : 0;
                            ('function' == typeof i &&
                              'continue' !==
                                i.call(Ft.dragged.parentNode[H], n, e, t, Qt, te[this.layer].el)) ||
                              Y(te[this.layer].el, n, e);
                          }.bind({ layer: d }),
                          24
                        )))),
                      d++);
                ...
                new (function () {
                  ...
                  return (
                    (t.prototype = {
                      ...
                      nulling: function () {
                        ((Qt = Vt = qt = ee = Jt = Zt = $t = null), (te.length = 0));
                      },
                      ...
                      _handleAutoScroll: function (t, e) {
                        ...
                        if (((Qt = t), e || this.options.forceAutoScrollFallback || u || c || h)) {
                          ...
                          if (!this.options.bubbleScroll || k(r, !0) === x()) return void ne();
                    ...
                    (t.prototype = {
                      ...
                      dragOverValid: function (t) {
                        ...
                        if (i.options.swap) {
                          ...
                          if (n && n !== l) {
                            var c = ie;
                            (!1 !== o(n) ? (S(n, s.swapClass, !0), (ie = n)) : (ie = null),
                              c && c !== ie && S(c, s.swapClass, !1));
                          }
                          (r(), e(!0), a());
                        }
                      },
                  ...
                  return (
                    (t.prototype = {
                      ...
                      setupClone: function (t) {
                        ...
                        if (this.isMultiDrag) {
                          for (var o = 0; o < pe.length; o++)
                            (ge.push(B(pe[o])),
                              (ge[o].sortableIndex = pe[o].sortableIndex),
                              (ge[o].draggable = !1),
                              (ge[o].style['will-change'] = ''),
                              S(ge[o], this.options.selectedClass, !1),
                              pe[o] === de && S(ge[o], this.options.chosenClass, !1));
                          (e._hideClone(), n());
                        }
                      },
                      clone: function (t) {
                        ...
                        this.isMultiDrag &&
                          (this.options.removeCloneOnHide ||
                            (pe.length && ue === e && (ye(!0, n), o('clone'), i())));
                      },
                      ...
                      revert: function (t) {
                        ...
                        pe.length > 1 &&
                          (pe.forEach(function (t) {
                            (o.addAnimationState({ target: t, rect: me ? O(t) : i }),
                              F(t),
                              (t.fromRect = i),
                      ...
                      dragOverCompleted: function (t) {
                        ...
                        if (o) {
                          if (
                            (n && i._hideClone(),
                            (ve = !1),
                            l.animation && pe.length > 1 && (me || (!n && !i.options.sort && !a)))
                          ) {
                            var s = O(de, !1, !0, !0);
                            (pe.forEach(function (t) {
                              t !== de && (j(t, s), r.appendChild(t));
                            }),
                              (me = !0));
                          }
                          if (!n)
                            if ((me || we(), pe.length > 1)) {
                              var c = fe;
                              (i._showClone(e),
                                i.options.animation &&
                                  !fe &&
                      ...
                      drop: function (t) {
                        ...
                        if (e) {
                          ...
                          if (be && this.isMultiDrag) {
                            if (((me = !1), (o[H].options.sort || o !== n) && pe.length > 1)) {
                              var g = O(de),
                                v = I(de, ':not(.' + this.options.selectedClass + ')');
                              if (
                                (!ve && c.animation && (de.thisAnimationDuration = null),
                      ...
                      _deselectMultiDrag: function (t) {
                        if (
                          !(
                            (void 0 !== be && be) ||
                            ue !== this.sortable ||
                            (t && w(t.target, this.options.draggable, this.sortable.el, !1)) ||
                            (t && 0 !== t.button)
                          )
                        )
                          for (; pe.length; ) {
                    ...
                    i(t, {
                      ...
                      utils: {
                        select: function (t) {
                          ...
                          e &&
                            e.options.multiDrag &&
                            !~pe.indexOf(t) &&
                            (ue && ue !== e && (ue.multiDrag._deselectMultiDrag(), (ue = e)),
                      ...
                      eventProperties: function () {
                        ...
                        return (
                          ...
                          { items: a(pe), clones: [].concat(ge), oldIndicies: e, newIndicies: n }
                        );
                      },
                      optionListeners: {
