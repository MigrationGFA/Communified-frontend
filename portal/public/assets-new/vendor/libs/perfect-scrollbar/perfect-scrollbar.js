            ...
            function m(t, e, r, i, n) {
              ...
              !(function (t, e, r, i, n) {
                ...
                ((t.reach[a] = null),
                  ...
                  t.reach[a] && (e || n) && u.dispatchEvent(v('ps-' + a + '-reach-' + t.reach[a])));
              })(t, r, l, i, n);
            }
            function Y(t) {
            ...
            var L = {
                ...
                wheel: function (e) {
                      ...
                      !(function (e, i, n) {
                        ...
                        for (var l = e; l && l !== r; ) {
                          ...
                          if (n && o.overflowY.match(/(scroll|auto)/)) {
                            ...
                            if (s > 0 && ((l.scrollTop > 0 && n < 0) || (l.scrollTop < s && n > 0)))
                              return !0;
                          }
                          if (i && o.overflowX.match(/(scroll|auto)/)) {
                            ...
                            if (
                              a > 0 &&
                              ((l.scrollLeft > 0 && i < 0) || (l.scrollLeft < a && i > 0))
                            )
                              return !0;
                          }
                          l = l.parentNode;
                  ...
                  void 0 !== window.onwheel
                    ...
                    : void 0 !== window.onmousewheel && e.event.bind(r, 'mousewheel', i);
                },
                touch: function (e) {
                        ...
                        (function (e, i, n) {
                          ...
                          for (var l = e; l && l !== r; ) {
                            ...
                            if (n && o.overflowY.match(/(scroll|auto)/)) {
                              ...
                              if (
                                s > 0 &&
                                ((l.scrollTop > 0 && n < 0) || (l.scrollTop < s && n > 0))
                              )
                                return !0;
                            }
                            if (i && o.overflowX.match(/(scroll|auto)/)) {
                        ...
                        (function (t, i) {
                          ...
                          if (s > o) {
                            if (
                              ...
                              return 0 === window.scrollY && i > 0 && y.isChrome;
                          } else if (
                            o > s &&
              ...
              R = function (i, n) {
                ...
                ((this.scrollbarXBottom = parseInt(b.bottom, 10)),
                  isNaN(this.scrollbarXBottom)
                    ? ((this.isScrollbarXUsingBottom = !1), (this.scrollbarXTop = Y(b.top)))
                    : (this.isScrollbarXUsingBottom = !0),
                  (this.railBorderXWidth = Y(b.borderLeftWidth) + Y(b.borderRightWidth)),
                ...
                ((this.scrollbarYRight = parseInt(v.right, 10)),
                  isNaN(this.scrollbarYRight)
                    ? ((this.isScrollbarYUsingRight = !1), (this.scrollbarYLeft = Y(v.left)))
                  ...
                  (this.scrollbarYOuterWidth = this.isRtl
                    ...
                    : null),
                  (this.railBorderYWidth = Y(v.borderTopWidth) + Y(v.borderBottomWidth)),
              ...
              (R.prototype.update = function () {
                this.isAlive &&
                  ...
                  (this.railXMarginWidth =
                    Y(t(this.scrollbarXRail).marginLeft) + Y(t(this.scrollbarXRail).marginRight)),
                  (this.railYMarginHeight =
                    Y(t(this.scrollbarYRail).marginTop) + Y(t(this.scrollbarYRail).marginBottom)),
