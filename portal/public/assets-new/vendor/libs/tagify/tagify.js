          ...
          t.exports = (function () {
            ...
            function p() {
              ...
              for (let i of arguments)
                for (let s of i)
                  h(s) ? e[s.value] || (t.push(s), (e[s.value] = 1)) : t.includes(s) || t.push(s);
              return t;
            }
            function c(t) {
            ...
            var w = {
                  ...
                  (this.dropdown.fill(a),
                    n.dropdown.highlightFirst &&
                      this.dropdown.highlightOption(
                        this.DOM.dropdown.content.querySelector(n.classNames.dropdownItemSelector)
                      ),
                ...
                return 'number' == typeof s.dropdown.enabled && s.dropdown.enabled >= 0
                  ? (this.DOM.scope.setAttribute('aria-expanded', !0),
                    document.body.contains(this.DOM.dropdown) ||
                      ...
                      setTimeout(() =>
                        this.DOM.dropdown.classList.remove(s.classNames.dropdownInital)
                      )),
                    this)
                  : this;
              },
                      ...
                      switch (t.key) {
                        ...
                        case 'Up':
                          ...
                          (e && (e = this.dropdown.getNextOrPrevOption(e, !a)),
                            (e && e.matches(this.settings.classNames.dropdownItemSelector)) ||
                              (e = s[a ? s.length - 1 : 0]),
                            (i = this.dropdown.getSuggestionDataByNode(e)),
              ...
              selectOption(t, e) {
                var i = this.settings.dropdown,
                  ...
                  a = i.closeOnSelect;
                if (!t)
                  return (this.addTags(this.state.inputText, !0), void (a && this.dropdown.hide()));
                e = e || {};
                ...
                (this.trigger('dropdown:select', { data: r, elm: t, event: e }),
                  n && (r || o)
                    ? (this.state.editing
                        ? this.onEditTagDone(null, g({ __isValid: !0 }, this.normalizeTags([r])[0]))
              ...
              D = {
                ...
                binding() {
                  ...
                  if (!this.state.mainEvents || !t) {
                    ...
                    (n && n.disconnect(),
                      'mix' == this.settings.mode && n.observe(this.DOM.input, { childList: !0 }));
                  }
                },
                bindGlobal(t) {
                  var e,
                ...
                callbacks: {
                  ...
                  onEditTagBlur(t) {
                    if (
                      (this.state.hasFocus || this.toggleFocusClass(), this.DOM.scope.contains(t))
                    ) {
                      var e,
                        i,
                        s = this.settings,
                  ...
                  t
                    ? (localStorage.setItem(b + t + '/v', 1),
                      (e, i) => {
                        ...
                        e &&
                          i &&
                          (localStorage.setItem(b + t + s, a), dispatchEvent(new Event('storage')));
                      })
                    : () => {})(e.id)),
            ...
            return (
              (M.prototype = {
                ...
                tagLoading(t, e) {
                  return (
                    t && t.classList[e ? 'add' : 'remove'](this.settings.classNames.tagLoading),
                    this
                  );
                },
                toggleClass(t, e) {
                ...
                placeCaretAfterNode(t) {
                  if (t && t.parentNode) {
                    var e = t,
                      ...
                      s = i.getRangeAt(0);
                    i.rangeCount &&
                      (s.setStartAfter(e || t), s.collapse(!0), i.removeAllRanges(), i.addRange(s));
                  }
                },
                insertAfterTag(t, e) {
                  ...
                  (this.trigger('edit:beforeUpdate', i, { cloneData: !1 }),
                    ...
                    t && e[this.settings.tagTextProp]
                      ? ((t = this.replaceTag(t, e)),
                        ...
                        this.settings.a11y.focusableTags ? t.focus() : this.placeCaretAfterNode(t))
                      : t && this.removeTags(t),
                ...
                input: {
                  ...
                  validate() {
                    ...
                    return (
                      this.DOM.input.classList.toggle(this.settings.classNames.inputInvalid, !t),
                      t
                    );
                  },
                  normalize(t) {
                ...
                getTagIndexByValue(t) {
                  ...
                  return (
                    this.getTagElms().forEach((i, a) => {
                      s(this.trim(i.textContent), t, this.settings.dropdown.caseSensitive) &&
                        e.push(a);
                    }),
                    e
                  );
                  ...
                  if (this.state.tag || e) {
                    ...
                    return (
                      ...
                      -1 == (i = n.nodeValue.lastIndexOf(e)) ||
                        ((s = n.splitText(i)), t && n.parentNode.replaceChild(t, s)),
                      !0
                    );
                  }
                },
                  ...
                  return (
                    ...
                    t.forEach((t) => {
                      ...
                      if (
                        ...
                        if (i) return;
                        if (
                          (g(r, this.getInvalidTagAttrs(t, t.__isValid), { __preInvalidData: l }),
                    ...
                    t.length &&
                      e &&
                      (this.input.set.call(this, a.createInvalidTags ? '' : n.join(a._delimiters)),
