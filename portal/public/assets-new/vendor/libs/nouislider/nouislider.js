        ...
        4211: function (t, e) {
          !(function (t) {
            ...
            function J(e, o, u) {
              ...
              function j(t, e) {
                var r = T(t, o.cssClasses.origin),
                  n = T(r, o.cssClasses.handle);
                if (
                      ...
                      return (function (t, e) {
                        ...
                        if ((t.preventDefault(), f || p)) {
                          var m = p ? 0 : 1,
                            g = vt(e)[m];
                          if (null === g) return !1;
                          (!1 === g && (g = C.getDefaultStep(V[e], p, o.keyboardDefaultStep)),
              ...
              function H(t, e) {
                return !(!o.tooltips || !o.tooltips[e]) && T(t.firstChild, o.cssClasses.tooltip);
              }
              function F() {
                      ...
                      if ((s = r ? r(i, s) : s) !== t.PipsType.None) {
                        ...
                        ((l.className = d(s, o.cssClasses.marker)),
                          ...
                          s > t.PipsType.NoValue &&
                            (((l = T(a, !1)).className = d(s, o.cssClasses.value)),
                    ...
                    return (
                      ...
                      !(
                        (s.classList
                          ...
                          : new RegExp('\\b' + a + '\\b').test(s.className)) && !n.doNotReject
                      )) &&
                      !(t === x.start && void 0 !== l.buttons && l.buttons > 1) &&
                      (!n.hover || !l.buttons) &&
                      (y || l.preventDefault(), (l.calcPoint = l.points[o.ort]), void r(l, n))
                    );
                  },
                  s = [];
                return (
                  t.split(' ').forEach(function (t) {
                    (e.addEventListener(t, i, !!y && { passive: !0 }), s.push([t, i]));
                  }),
                  s
                );
              }
                  ...
                  u =
                    (100 *
                      (t -
                        ...
                        r ? n.top + l.y - s.clientTop : n.left + l.x - s.clientLeft))) /
                    $();
                return ((u = a(u)), o.dir ? 100 - u : u);
              }
              function Q(t, e) {
                'mouseout' === t.type &&
              ...
              function tt(t, e) {
                (e.handle && (p(e.handle, o.cssClasses.active), (M -= 1)),
                  e.listeners.forEach(function (t) {
                    D.removeEventListener(t[0], t[1]);
                  }),
                  0 === M &&
                    (p(w, o.cssClasses.drag),
                    pt(),
                    t.cursor && ((O.style.cursor = ''), O.removeEventListener('selectstart', i))),
              ...
              function et(t, e) {
                if (!e.handleNumbers.some(R)) {
                  ...
                  (1 === e.handleNumbers.length &&
                    ((r = h[e.handleNumbers[0]].children[0]), (M += 1), c(r, o.cssClasses.active)),
                    t.stopPropagation());
                  var n = [],
                    s = J(x.move, D, Z, {
                      target: t.target,
              ...
              function rt(t) {
                ...
                !1 !== r &&
                  (o.events.snap || s(w, o.cssClasses.tap, o.animationDuration),
                  ft(r, e, !0, !0),
                  pt(),
                  st('slide', r, !0),
                  st('update', r, !0),
                ...
                Object.keys(A).forEach(function (n) {
                  ...
                  t === i &&
                    A[n].forEach(function (t) {
                      t.call(bt, N.map(o.format.to), e, N.slice(), r || !1, V.slice(), bt);
                    });
                });
              }
              function at(t, e, r, n, i, s, l) {
                var u;
                return (
                  h.length > 1 &&
                    ...
                    (n &&
                      e > 0 &&
                      ((u = C.getAbsoluteDistance(t[e - 1], o.margin, !1)), (r = Math.max(r, u))),
                    i &&
                      e < h.length - 1 &&
                      ((u = C.getAbsoluteDistance(t[e + 1], o.margin, !0)), (r = Math.min(r, u)))),
                  h.length > 1 &&
                    o.limit &&
                    (n &&
                      e > 0 &&
                      ((u = C.getAbsoluteDistance(t[e - 1], o.limit, !1)), (r = Math.min(r, u))),
                    i &&
                      e < h.length - 1 &&
                      ((u = C.getAbsoluteDistance(t[e + 1], o.limit, !0)), (r = Math.max(r, u)))),
                  o.padding &&
                    (0 === e &&
                      ((u = C.getAbsoluteDistance(0, o.padding[0], !1)), (r = Math.max(r, u))),
                    e === h.length - 1 &&
                      ((u = C.getAbsoluteDistance(100, o.padding[1], !0)), (r = Math.min(r, u)))),
                  l || (r = C.getStep(r)),
                  !((r = a(r)) === t[e] && !s) && r
                );
              }
                ...
                ((n = n.slice()),
                  ...
                  n.length > 1
                    ? n.forEach(function (t, r) {
                        var n = at(s, t, s[t] + e, u[r], c[r], !1, l);
              ...
              function ft(t, e, r, n, i, s) {
                return (
                  i || (e = at(V, t, e, r, n, !1, s)),
                  !1 !== e &&
                    ((function (t, e) {
                      ((V[t] = e), (N[t] = C.fromStepping(e)));
                      var r = 'translate(' + lt(ct(e, 0) - L + '%', '0') + ')';
                      ((h[t].style[o.transformRule] = r), dt(t), dt(t + 1));
                    })(t, e),
                    !0)
                );
              }
              function dt(t) {
                if (m[t]) {
                  var e = 0,
                    r = 100;
                  (0 !== t && (e = V[t - 1]), t !== m.length - 1 && (r = V[t]));
                  var n = r - e,
              ...
              function ht(t, e) {
                return null === t || !1 === t || void 0 === t
                  ...
                  : ('number' == typeof t && (t = String(t)),
                    !1 !== (t = o.format.from(t)) && (t = C.toStepping(t)),
                    !1 === t || isNaN(t) ? V[e] : t);
              }
              function mt(t, e, r) {
                var n = l(t),
                ...
                if (i && C.hasNoSize() && ((r = !0), (V[0] = 0), k.length > 1)) {
                ...
                (pt(),
                  k.forEach(function (t) {
                    (st('update', t), null !== n[t] && e && st('set', t));
                  }));
              }
              function gt(t) {
                if ((void 0 === t && (t = !1), t)) return 1 === N.length ? N[0] : N.slice(0);
                var e = N.map(o.format.to);
              ...
              (c((S = w), o.cssClasses.target),
                ...
                b.tap && J(x.start, d, rt, {}),
                b.hover && J(x.move, d, nt, { hover: !0 }),
                b.drag &&
                    ...
                    if (!1 !== t && 0 !== e && e !== m.length - 1) {
                      ...
                      (c(t, o.cssClasses.draggable),
                        ...
                        i.forEach(function (e) {
                          J(x.start, e, et, { handles: s, handleNumbers: a, connect: t });
                        }));
                    }
                  }),
                mt(o.start),
                ...
                o.tooltips && B(),
                ot('update' + P),
                it('update' + P, function (t, e, r, n, i) {
                  k.forEach(function (t) {
                    var e = h[t],
                      n = at(V, t, 0, !0, !0, !0),
                      s = at(V, t, 100, !0, !0, !0),
              ...
              var bt = {
                ...
                setHandle: function (t, e, r, n) {
                  ...
                  (ft(t, ht(e, t), !0, !0, n), st('update', t), r && st('set', t));
                },
                reset: function (t) {
                  mt(o.start, t);
                },
