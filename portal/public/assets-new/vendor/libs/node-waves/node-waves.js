        ...
        8291: function (t, e, n) {
          ...
          !(function (n, r) {
            ...
            var u = {
                ...
                show: function (t, e, n) {
                  ...
                  ('touches' in t && t.touches.length
                    ? ((i = t.touches[0].pageY - r.top), (c = t.touches[0].pageX - r.left))
                    : ((i = t.pageY - r.top), (c = t.pageX - r.left)),
                    (c = c >= 0 ? c : 0),
                    (i = i >= 0 ? i : 0));
            ...
            return (
              ...
              (t.attach = function (t, e) {
                ...
                for (var a = 0, s = t.length; a < s; a++)
                  ((r = (o = t[a]).tagName.toLowerCase()),
                    -1 !== ['input', 'img'].indexOf(r) && (c[r](o), (o = o.parentElement)),
              ...
              (t.calm = function (t) {
                for (
                  var e = { type: 'mouseup', button: 1 }, n = 0, o = (t = i(t)).length;
                  n < o;
                  n++
                )
                  u.hide(e, t[n]);
