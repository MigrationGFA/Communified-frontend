          ...
          ((i = [r(1145)]),
            (n = function (t) {
              var e = Array.prototype.slice,
                ...
                p = function () {
                  for (
                    ...
                    if ((d.stickyWrapper.css('height', d.stickyElement.outerHeight()), e <= l))
                      null !== d.currentTop &&
                        (d.stickyElement.css({ width: '', position: '', top: '', 'z-index': '' }),
                ...
                u = {
                  init: function (e) {
                    ...
                    return this.each(function () {
                      ...
                      var p = e.parent();
                      (r.center &&
                        p.css({ width: e.outerWidth(), marginLeft: 'auto', marginRight: 'auto' }),
                        'right' === e.css('float') &&
                  ...
                  unstick: function (e) {
                    return this.each(function () {
                      for (var e = t(this), n = -1, i = s.length; i-- > 0; )
                        s[i].stickyElement.get(0) === this && (r.call(s, i, 1), (n = i));
                      -1 !== n &&
                        (e.unwrap(),
                        e.css({ width: '', position: '', top: '', float: '', 'z-index': '' }));
                    });
                  },
                };
              (window.addEventListener
                ...
                (t.fn.sticky = function (r) {
                  return u[r]
                    ? u[r].apply(this, e.call(arguments, 1))
                    : 'object' != typeof r && r
                      ? void t.error('Method ' + r + ' does not exist on jQuery.sticky')
