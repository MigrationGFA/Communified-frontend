                  ...
                  function l(n) {
                    ...
                    if (
                      ...
                      return (
                        ...
                        i.closeButton &&
                          (v.addClass(i.closeClass).attr('role', 'button'), p.prepend(v)),
                        i.progressBar && (g.addClass(i.progressClass), p.prepend(g)),
                            ...
                            function () {
                              (clearTimeout(l),
                                ...
                                p
                                  ...
                                  [
                                    i.showMethod
                                  ]({ duration: i.showDuration, easing: i.showEasing }));
                            },
                            function () {
                  ...
                  function d(e) {
                    (t || (t = r()),
                      e.is(':visible') ||
                        (e.remove(),
                        (e = null),
                        0 === t.children().length && (t.remove(), (o = void 0))));
                  }
                })();
