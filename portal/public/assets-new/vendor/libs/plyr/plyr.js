          ...
          'object' == typeof navigator &&
            (e.exports = (function () {
                    ...
                    [
                      {
                        ...
                        value: function (t) {
                          ...
                          if (
                            (y(t) || p(t)
                              ? (s = Array.from(
                                  document.querySelectorAll(p(t) ? t : 'input[type="range"]')
                                ))
                              : f(t)
                                ? (s = [t])
                                : g(t)
              ...
              const w = (e) => (null != e ? e.constructor : null),
                ...
                P = (e) => T(e, NodeList),
                M = (e) =>
                  k(e) || ((A(e) || E(e) || P(e)) && !e.length) || (C(e) && !Object.keys(e).length);
              var x = k,
                N = C,
              ...
              function re(e = null, t = !1) {
                D(e) &&
                  (e.focus({ preventScroll: !0 }), t && se(e, this.config.classNames.tabFocus));
              }
              const ce = {
                  'audio/ogg': 'vorbis',
                  'audio/wav': '1',
                ...
                he = {
                  ...
                  pip: !(
                    ...
                    (!_(X('video').webkitSetPresentationMode) &&
                      (!document.pictureInPictureEnabled || X('video').disablePictureInPicture))
                  ),
              ...
              function ye() {
                return new Promise((e) =>
                  this.ready ? setTimeout(e, 0) : pe.call(this, this.elements.container, 'ready', e)
                ).then(() => {});
              }
              function ve(e) {
              ...
              const Ie = (e = '', t = '', i = '') =>
                ...
                Le = (e = '') =>
                  e
                    .toString()
                    .replace(/\w\S*/g, (e) => e.charAt(0).toUpperCase() + e.slice(1).toLowerCase());
              function $e(e) {
              ...
              const Fe = {
                ...
                findElements() {
                  try {
                    return (
                      ...
                      (this.elements.progress = oe.call(this, this.config.selectors.progress)),
                ...
                createBadge(e) {
                  ...
                  return (
                    t.appendChild(X('span', { class: this.config.classNames.menu.badge }, e)),
                    t
                  );
                },
                createButton(e, t) {
                  ...
                  switch (
                    ...
                    Object.keys(i).includes('class')
                      ? i.class.split(' ').some((e) => e === this.config.classNames.control) ||
                        K(i, { class: `${i.class} ${this.config.classNames.control}` })
                  ...
                  return (
                    n.toggle
                      ? (a.appendChild(
                          Fe.createIcon.call(this, n.iconPressed, { class: 'icon--pressed' })
                        ),
                        a.appendChild(
                          Fe.createIcon.call(this, n.icon, { class: 'icon--not-pressed' })
                        ),
                        a.appendChild(
                          Fe.createLabel.call(this, n.labelPressed, { class: 'label--pressed' })
                        ),
                        a.appendChild(
                          Fe.createLabel.call(this, n.label, { class: 'label--not-pressed' })
                        ))
                ...
                setQualityMenu(e) {
                  ...
                  if ((Fe.toggleMenuButton.call(this, t, s), Z(i), Fe.checkMenu.call(this), !s))
                    return;
                  const n = (e) => {
                ...
                setCaptionsMenu() {
                  ...
                  const e = 'captions',
                    ...
                    s = Boolean(i.length);
                  if ((Fe.toggleMenuButton.call(this, e, s), Z(t), Fe.checkMenu.call(this), !s))
                    return;
                  const n = i.map((e, i) => ({
                    value: i,
                    checked: this.captions.toggled && this.currentTrack === i,
                    title: Ue.getLabel.call(this, e),
                    badge: e.language && Fe.createBadge.call(this, e.language.toUpperCase()),
                    list: t,
                    type: 'language',
                  }));
                  (n.unshift({
                    ...
                    const e = Fe.getMenuSize.call(this, i),
                      t = (e) => {
                        e.target === s &&
                          ...
                          ((s.style.width = ''), (s.style.height = ''), me.call(this, s, B, t));
                      };
                    (pe.call(this, s, B, t),
                  ...
                  return (
                    we(O(this.config.controls) ? this.config.controls : []).forEach((l) => {
                      ...
                      if (
                        ...
                        if (
                          ((D(t) && c.contains(t)) ||
                            ((t = X('div', K({}, h, { class: `${h.class} plyr__volume`.trim() }))),
                          ...
                          t.appendChild(
                            n.call(this, 'volume', K(i, { id: `plyr-volume-${e.id}` }))
                          );
                        }
                      }
                      if (
                        ...
                        const s = X(
                          'div',
                          K({}, h, { class: `${h.class} plyr__menu`.trim(), hidden: '' })
                        );
                        s.appendChild(
                        ...
                        (l.appendChild(o),
                          ...
                          this.config.settings.forEach((i) => {
                            ...
                            (h.appendChild(
                              X('span', { 'aria-hidden': !0 }, Oe.get(i, this.config))
                            ),
                              h.appendChild(
                                X(
                                  'span',
                      ...
                      if (
                        ('pip' === l && he.pip && c.appendChild(i.call(this, 'pip', h)),
                        'airplay' === l && he.airplay && c.appendChild(i.call(this, 'airplay', h)),
                        'download' === l)
                      ) {
                        ...
                        (!F(t) &&
                          this.isEmbed &&
                          K(e, { icon: `logo-${this.provider}`, label: this.provider }),
                ...
                setMarkers() {
                  ...
                  (i.forEach((e) => {
                    ...
                    s.appendChild(n),
                    this.config.tooltips.seek ||
                      ((a = X('span', { class: this.config.classNames.tooltip }, '')),
                      s.appendChild(a)),
                  ...
                  setup() {
                    ...
                    if (
                      (D(this.elements.captions) ||
                        ((this.elements.captions = X('div', te(this.config.selectors.captions))),
                      ...
                      e
                        ...
                        .forEach((e) => {
                          (this.debug.log('Track added', e),
                            ...
                            pe.call(this, e, 'cuechange', () => Ue.updateCues.call(this)));
                        }),
                      ((a && this.language !== i) || !e.includes(n)) &&
                        (Ue.setLanguage.call(this, i), Ue.toggle.call(this, t && a)),
                      this.elements &&
                        se(this.elements.container, this.config.classNames.captions.enabled, !V(e)),
                      O(this.config.controls) &&
                        this.config.controls.includes('settings') &&
                        this.config.settings.includes('captions') &&
                        Fe.setCaptionsMenu.call(this));
                  ...
                  toggle(e, t = !0) {
                    ...
                    if (n !== i) {
                      ...
                      (this.elements.buttons.captions &&
                        ...
                        fe.call(this, this.media, n ? 'captionsenabled' : 'captionsdisabled'));
                    }
                    setTimeout(() => {
                      n &&
                      ...
                      if (I(e))
                        if (e in i) {
                          ...
                          (Ue.toggle.call(this, !0, t),
                            this.isHTML5 && this.isVideo && Ue.updateCues.call(this));
              ...
              class Je {
                constructor(t) {
                  (e(this, 'onChange', () => {
                    ...
                    e(this, 'exit', () => {
                      if (this.enabled)
                        if (W.isIos && this.player.config.fullscreen.iosNative)
                          (this.target.webkitExitFullscreen(), ve(this.player.play()));
                    ...
                    pe.call(this, this.player.elements.container, 'keydown', (e) =>
                      this.trapFocus(e)
                    ),
                    this.update());
                }
                ...
                get active() {
                  ...
                  if (!Je.native || this.forceFallback)
                    return ne(this.target, this.player.config.classNames.fullscreen.fallback);
                  const e = this.prefix
                ...
                constructor(t) {
                  (e(this, 'firstTouch', () => {
                        ...
                        'focusout' !== n &&
                          (this.focusTimer = setTimeout(() => {
                            ...
                            i.container.contains(e) &&
                              se(document.activeElement, t.config.classNames.tabFocus, !0);
                          }, 10)));
                    }),
                    e(this, 'global', (e = !0) => {
                      const { player: t } = this;
                    ...
                    e(this, 'container', () => {
                      ...
                      (!t.keyboard.global &&
                        t.keyboard.focused &&
                        pe.call(e, i.container, 'keydown keyup', this.handleKey, !1),
                        pe.call(
                          e,
                          i.container,
                          ...
                          (t) => {
                            ...
                            (['touchstart', 'touchmove', 'mousemove'].includes(t.type) &&
                              (Ze.toggleControls.call(e, !0), (a = e.touch ? 3e3 : 2e3)),
                              clearTimeout(s.controls),
                              (s.controls = setTimeout(() => Ze.toggleControls.call(e, !1), a)));
                          }
                        ));
                      const n = () => {
                      ...
                      pe.call(e, i.container, 'enterfullscreen exitfullscreen', (t) => {
                        ...
                        s === i.container &&
                          ((!e.isEmbed && V(e.config.ratio)) ||
                            (n(),
                            ('enterfullscreen' === t.type ? pe : me).call(e, window, 'resize', a)));
                      });
                    }),
                    e(this, 'media', () => {
                      const { player: e } = this,
                      ...
                      if (
                        ...
                        pe.call(e, e.media, 'durationchange loadeddata loadedmetadata', (t) =>
                          Fe.durationUpdate.call(e, t)
                        ),
                        pe.call(e, e.media, 'ended', () => {
                          e.isHTML5 && e.isVideo && e.config.resetOnEnd && (e.restart(), e.pause());
                        }),
                        pe.call(e, e.media, 'progress playing seeking seeked', (t) =>
                          Fe.updateProgress.call(e, t)
                        ),
                        pe.call(e, e.media, 'volumechange', (t) => Fe.updateVolume.call(e, t)),
                        pe.call(e, e.media, 'playing play pause ended emptied timeupdate', (t) =>
                          Ze.checkPlaying.call(e, t)
                        ),
                        pe.call(e, e.media, 'waiting canplay seeked playing', (t) =>
                          Ze.checkLoading.call(e, t)
                        ),
                      ...
                      (this.bind(
                        ...
                        e.config.toggleInvert &&
                          ...
                          this.bind(t.display.currentTime, 'click', () => {
                            0 !== e.currentTime &&
                              ((e.config.invertTime = !e.config.invertTime), Fe.timeUpdate.call(e));
                          }),
                        this.bind(
                          t.inputs.volume,
                          i,
                        ...
                        this.bind(t.controls, 'focusin', () => {
                          ...
                          (clearTimeout(s.controls),
                            (s.controls = setTimeout(() => Ze.toggleControls.call(e, !1), n)));
                        }),
                        this.bind(
                          t.inputs.volume,
                          'wheel',
              ...
              function st(e) {
                (e && !this.embed.hasPlayed && (this.embed.hasPlayed = !0),
                  this.media.paused === e &&
                    ((this.media.paused = !e), fe.call(this, this.media, e ? 'play' : 'pause')));
              }
              const nt = {
                setup() {
                  const e = this;
                ...
                ready() {
                  ...
                  if (
                    ...
                    (u.setAttribute('data-poster', e.poster), (e.media = ee(u, e.media)));
                  else {
                    const t = X('div', {
              ...
              const ot = {
                  setup() {
                    if (
                      (se(this.elements.wrapper, this.config.classNames.embed, !0),
              ...
              class ct {
                        ...
                        this.player.on('seeked', () => {
                          ...
                          V(this.cuePoints) ||
                            this.cuePoints.forEach((i, s) => {
                              t < i &&
                                i < e &&
                                (this.manager.discardAdBreak(), this.cuePoints.splice(s, 1));
                            });
                        }),
                ...
                get tagUrl() {
                  ...
                  return F(e.tagUrl)
                    ? e.tagUrl
                    : `https://go.aniview.com/api/adserver6/vast/?${Be({ AV_PUBLISHERID: '58c25bb0073ef448b1087ad6', AV_CHANNELID: '5a0458dc28a06145e4519d21', AV_URL: window.location.hostname, cb: Date.now(), AV_WIDTH: 640, AV_HEIGHT: 480, AV_CDIM2: e.publisherId })}`;
                }
              }
                      ...
                      this.destroy.call(
                        ...
                        () => {
                          ...
                          (Object.assign(this, {
                            ...
                            $(e.autoplay) && (this.config.autoplay = e.autoplay),
                            this.isHTML5 &&
                            ...
                            this.isHTML5 && mt.insertElements.call(this, 'source', t),
                ...
                constructor(t, i) {
                        ...
                        this.isHTML5
                          ...
                          : this.isYouTube
                            ? (clearInterval(this.timers.buffering),
                              ...
                              null !== this.embed && _(this.embed.destroy) && this.embed.destroy(),
                              i())
                            : this.isVimeo &&
                  ...
                  switch (n) {
                    case 'div':
                      ...
                      if (V(this.provider) || !Object.values(Ke).includes(this.provider))
