                  ...
                  (!c &&
                    ...
                    (e.jstree.core.prototype = {
                      ...
                      is_parent: function (e) {
                        return (
                          (e = this.get_node(e)) && (!1 === e.state.loaded || e.children.length > 0)
                        );
                      },
                              ...
                              if (n.length && n[0].id !== t && n[0].parent !== t) {
                                ...
                                for (r = 0, s = n.length; r < s; r++)
                                  (i = j(n[r], d, p.parents.concat())) &&
                                    ...
                                    f[i].children_d.length && (l = l.concat(f[i].children_d)));
                                for (
                                  p.children = c, p.children_d = l, r = 0, s = p.parents.length;
                                  r < s;
                                  r++
                                )
                                  f[p.parents[r]].children_d = f[p.parents[r]].children_d.concat(l);
                      ...
                      _parse_model_from_flat_json: function (e, i, r) {
                        ...
                        for (
                          ...
                          ((o =
                            c[(n = this._parse_model_from_flat_json(c[h.children[s]], h.id, r))]),
                            h.children_d.push(n),
                            o.children_d.length &&
                      ...
                      redraw_node: function (t, i, r, s) {
                        ...
                        a.state.loaded && !k
                          ? (u += ' jstree-leaf')
                          : ((u +=
                              a.state.opened && a.state.loaded ? ' jstree-open' : ' jstree-closed'),
                            t.childNodes[1].setAttribute(
                              'aria-expanded',
                      ...
                      open_all: function (t, i, r) {
                        ...
                        var s,
                          ...
                          n,
                          o =
                            t.id === e.jstree.root ? this.get_container_ul() : this.get_node(t, !0);
                        if (!o.length) {
                      ...
                      is_selected: function (t) {
                        return (
                          !(!(t = this.get_node(t)) || t.id === e.jstree.root) && t.state.selected
                        );
                      },
                      ...
                      set_id: function (t, i) {
                        ...
                        for (
                          ...
                          a[t.parents[r]].children_d[e.inArray(t.id, a[t.parents[r]].children_d)] =
                            i;
                        for (r = 0, s = t.children.length; r < s; r++) a[t.children[r]].parent = i;
                        for (r = 0, s = t.children_d.length; r < s; r++)
                          a[t.children_d[r]].parents[e.inArray(t.id, a[t.children_d[r]].parents)] =
                            i;
                        return (
                      ...
                      get_json: function (t, i, r) {
                        ...
                        if (
                          (i && i.flat ? (n.parent = t.parent) : (n.children = []), i && i.no_state)
                        )
                          delete n.state;
                        else
                      ...
                      create_node: function (i, r, s, a, n) {
                        ...
                        switch (
                          ...
                          (r = 'string' == typeof r ? { text: r } : e.extend(!0, {}, r)).text ===
                            t && (r.text = this.get_string('New node')),
                          i.id === e.jstree.root &&
                          ...
                          n && n.functions && (!1 === n.functions[t] || !0 === n.functions[t])
                            ...
                            : !(
                              ...
                              ((this._data.core.last_error = {
                                ...
                                id: 'core_03',
                                reason:
                                  'User config for core.check_callback prevents function: ' + t,
                                data: JSON.stringify({
                                  chk: t,
                                  pos: s,
                                  obj: !(!i || !i.id) && i.id,
                      ...
                      move_node: function (i, r, s, a, n, o, d) {
                        ...
                        if (
                          ...
                          (f =
                            !(g =
                              d || (this._model.data[i.id] ? this : e.jstree.reference(i.id))) ||
                            !g._id ||
                            this._id !== g._id),
                          (_ =
                        ...
                        if (i.parent === u.id) {
                          ...
                          for (
                            (m = i.children_d.concat()).push(i.id), v = 0, j = i.parents.length;
                            v < j;
                            v++
                          ) {
                            for (
                      ...
                      copy_node: function (i, r, s, a, n, o, d) {
                        ...
                        if (!(f = v ? v.get_json(i, { no_id: !0, no_data: !0, no_state: !0 }) : i))
                          return !1;
                        if (
                          (!0 === f.id && delete f.id,
                      ...
                      cut: function (t) {
                        ...
                        for (n = 0, o = t.length; n < o; n++)
                          (i = this.get_node(t[n])) && i.id && i.id !== e.jstree.root && d.push(i);
                      ...
                      paste: function (e, t) {
                        if (
                          !((e = this.get_node(e)) && s && s.match(/^(copy_node|move_node)$/) && r)
                        )
                          return !1;
                      ...
                      show_icon: function (t) {
                        ...
                        return !(
                          ...
                          (t.icon =
                            !s.length ||
                            s.children('.jstree-anchor').children('.jstree-themeicon').attr('rel')),
                          t.icon || (t.icon = !0),
                          s
                            .children('.jstree-anchor')
                            .children('.jstree-themeicon')
                        ...
                        (this.check_all = function () {
                          ...
                          for (
                            ...
                            this._model.data[this._data.checkbox.selected[t]] &&
                              (this._model.data[this._data.checkbox.selected[t]].state.checked =
                                !0);
                          (this.redraw(!0),
                        ...
                        (this.uncheck_all = function () {
                          ...
                          for (e = 0, t = this._data.checkbox.selected.length; e < t; e++)
                            this._model.data[this._data.checkbox.selected[e]] &&
                              (this._model.data[this._data.checkbox.selected[e]].state.checked =
                                !1);
                          ((this._data.checkbox.selected = []),
                    ...
                    e(function () {
                      ...
                      e(d)
                        ...
                        .on('dnd_move.vakata.jstree', function (o, d) {
                          ...
                          if (
                            (a &&
                              ((d.event && 'dragover' === d.event.type && !c) || clearTimeout(a)),
                            d &&
                              d.data &&
                              d.data.jstree &&
                          ...
                          if (
                            ...
                            if (!i.is_drag) {
                              if (
                                ...
                                return;
                              (i.helper &&
                                (i.helper.appendTo(d.body), (i.helper_w = i.helper.outerWidth())),
                                (i.is_drag = !0),
                    ...
                    (e.jstree.plugins.massload = function (t, i) {
                      ((this.init = function (e, t) {
                        ...
                        (this._load_node = function (t, r) {
                          ...
                          return a
                            ? ((n = this[
                                'string' == typeof a ? '_append_html_data' : '_append_json_data'
                              ](
                                t,
                                'string' == typeof a
                      ...
                      ((this.init = function (i, s) {
                        ...
                        (this.get_json = function (t, i, s) {
                          ...
                          if (e.vakata.is_array(c))
                            ...
                            ((c.type = c.id && o[c.id] && o[c.id].type ? o[c.id].type : 'default'),
                        ...
                        (this.set_type = function (i, r) {
                          ...
                          if (((s = this.settings.types), (i = this.get_node(i)), !s[r] || !i))
                            return !1;
                          if (
                            ((l = this.get_node(i, !0)) &&
                              l.length &&
                            ...
                            return (
                              ...
                              (o = -1 === e.inArray(l, h) || (i.text && c === l)) ||
                                (this._data.core.last_error = {
                                  ...
                                  id: 'unique_01',
                                  reason:
                                    'Child with name ' + l + ' already exists. Preventing: ' + t,
                                  data: JSON.stringify({
                                    chk: t,
                                    pos: a,
                                    obj: !(!i || !i.id) && i.id,
