        ...
        1936: function () {
          !(function (e) {
            ...
            function l(t, o) {
              ...
              if (-1 !== e.inArray(l, o))
                return (
                  -1 === e.inArray(l, i) || Boolean(t.nodeValue.match(s) || t.nodeValue.match(n))
                );
              for (
            ...
            var U = new RegExp('38|40'),
              ...
              _ = {
                ...
                a: function (e, t, i) {
                  ...
                  return (
                    e &&
                      (11 === e.nodeType ? s.appendChild(e) : s.insertAdjacentHTML('beforeend', e)),
                ...
                text: function (e, t) {
                  ...
                  if (e.content) n.innerHTML = e.content;
                    ...
                    if (((n.textContent = e.text), e.icon)) {
                      ...
                      (((s = (!0 === t ? j.i : j.span).cloneNode(!1)).className =
                        this.options.iconBase + ' ' + e.icon),
                        j.fragment.appendChild(s),
                        j.fragment.appendChild(o));
                    }
                    e.subtext &&
                      (((i = j.subtext.cloneNode(!1)).textContent = e.subtext), n.appendChild(i));
                  }
                  if (!0 === t)
                ...
                label: function (e) {
                  ...
                  return (
                    e.subtext &&
                      (((t = j.subtext.cloneNode(!1)).textContent = e.subtext), s.appendChild(t)),
                    j.fragment.appendChild(s),
                    j.fragment
                  );
                },
            ...
            function Q(i) {
              ...
              if (M.major >= '4') {
                ...
                for (var r = 0; r < l.length; r++)
                  ((i = l[r]), (K.DEFAULTS[i.name] = B[i.className]));
              }
              ...
              (K.prototype = {
                ...
                init: function () {
                  ...
                  (P++,
                    ...
                    n &&
                      null === s.form &&
                      (n.id || (n.id = 'form-' + this.selectId), s.setAttribute('form', n.id)),
                  ...
                  function h(e, i) {
                    ...
                    if (
                      ...
                      if (
                        ...
                        var H =
                          Math.floor((c * n.options.chunkSize) / n.options.source.pageSize) + 2;
                        n.fetchData(
                          function () {
                ...
                buildData: function (t, i) {
                  ...
                  function p(i, o) {
                    if ((((o = o || {}).divider = n(i, 'divider')), !0 === o.divider))
                      h({ optID: o.optID });
                    else {
                      var a = l.length + r,
                        c = n(i, 'style'),
                ...
                buildList: function (e, t) {
                  ...
                  function l(e, t) {
                    ...
                    switch (t.type) {
                      ...
                      case 'option':
                        (s = _.li(
                          _.a(_.text.call(i, t), t.optionClass, t.inlineStyle),
                          '',
                          t.optID
                ...
                render: function (e) {
                  ...
                  if (
                    ...
                    ((t =
                      ...
                      a > 0) &&
                      (t =
                        ((i = this.options.selectedTextFormat.split('>')).length > 1 && a > i[1]) ||
                        (1 === i.length && a >= 2)),
                    !1 === t)
                  ) {
                    if (!o) {
                    ...
                    var I = this.$element[0].querySelectorAll(
                      ...
                      y =
                        'function' == typeof this.options.countSelectedText
                          ? this.options.countSelectedText(a, I)
                ...
                liHeight: function (t) {
                  if (t || (!1 !== this.options.size && !Object.keys(this.sizeInfo).length)) {
                    var i,
                      ...
                      h =
                        this.options.header && this.$menu.find('.' + B.POPOVERHEADER).length > 0
                ...
                selectPosition: function () {
                  ...
                  var t,
                    ...
                    l = function (l) {
                      ...
                      (n.$bsContainer
                        ...
                        .toggleClass(B.DROPUP, l.hasClass(B.DROPUP)),
                        (t = l.offset()),
                        o.is('body')
                          ? (i = { top: 0, left: 0 })
                          : (((i = o.offset()).top +=
                  ...
                  (this.$button.on('click.bs.dropdown.data-api', function () {
                    ...
                    e(window)
                      ...
                      .on(
                        'resize' + W + '.' + this.selectId + ' scroll' + W + '.' + this.selectId,
                        function () {
                ...
                setDisabled: function (e) {
                  ...
                  s &&
                    ...
                    t &&
                      (M.major >= '4' && t.classList.toggle(B.DISABLED, i),
                      i
                ...
                checkDisabled: function () {
                  this.isDisabled()
                    ? (this.$newElement[0].classList.add(B.DISABLED),
                      this.$button.addClass(B.DISABLED).attr('aria-disabled', !0))
                    ...
                    this.$menuInner.on('click', 'li a', function (i, s) {
                      ...
                      if (
                        ...
                        if (
                          ...
                          s ||
                            ((t.prevActiveElement = t.activeElement), (t.activeElement = void 0)),
                          t.multiple && 1 !== E)
                        ) {
                          if (
                            (t.setSelected(r, !w), t.focusedParent.focus(), !1 !== E || !1 !== $)
                          ) {
                ...
                liveSearchListener: function () {
                  ...
                  (this.$button.on('click.bs.dropdown.data-api', function () {
                    e.$searchbox.val() &&
                      (e.$searchbox.val(''), (e.selectpicker.search.previousValue = void 0));
                  }),
                    this.$searchbox.on(
                  ...
                  if (void 0 !== e) {
                    ...
                    if (
                      ...
                      if (this.multiple) this.setOptionStatus(!0);
                        ...
                        'number' == typeof l &&
                          this.setSelected(this.selectpicker.current.data[l], !0);
                      }
                ...
                toggle: function (e, t) {
                  ...
                  ((e = e || window.event) && e.stopPropagation(),
                    !1 === s &&
                      ((i = this.$newElement[0].classList.contains(B.SHOW)),
                      (s = (!0 === t && !1 === i) || (!1 === t && !0 === i))),
                      ...
                      if (
                            ...
                            : (40 === t.which || p) &&
                              ...
                              c.selectpicker.view.canHighlight[i + m] ||
                                (i =
                                  i +
                                  1 +
                                  c.selectpicker.view.canHighlight.slice(i + m + 1).indexOf(!0))),
                          t.preventDefault());
                        var v = m + i;
                        (38 === t.which
                          ? 0 === m && i === d.length - 1
                        ...
                        if (w.length) {
                          ...
                          (d.removeClass('active').find('a').removeClass('active'),
                            1 === b.length &&
                              (-1 === (x = w.indexOf(c.activeElement)) || x === w.length - 1
                                ? (x = 0)
                                : x++),
                            (g = w[x]),
            ...
            ((e.fn.selectpicker = Q),
              ...
              e(document)
                ...
                .on(
                  ...
                  ':not(.bootstrap-select) > [' + R.DATA_TOGGLE + ']',
                  Z
                )
