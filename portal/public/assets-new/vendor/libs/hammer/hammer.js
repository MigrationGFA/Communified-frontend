          ...
          !(function (r, s, o, a) {
                  ...
                  ((e.overallVelocityX = d.x),
                    ...
                    (function (t, e) {
                      ...
                      if (8 != e.eventType && (u > 25 || o.velocity === a)) {
                        ...
                        ((n = o.velocity), (i = o.velocityX), (r = o.velocityY), (s = o.direction));
            ...
            function H(t) {
              for (var e = [], n = 0; n < t.pointers.length; )
                ((e[n] = { clientX: l(t.pointers[n].clientX), clientY: l(t.pointers[n].clientY) }),
                  n++);
              return {
                timeStamp: f(),
                pointers: e,
            ...
            function vt(t, e) {
              1 & t
                ? ((this.primaryTouch = e.changedPointers[0].identifier), mt.call(this, e))
                : 12 & t && mt.call(this, e);
            }
            function mt(t) {
            ...
            function qt(t, e) {
              return (
                ((e = e || {}).recognizers = A(e.recognizers, qt.defaults.preset)),
                new jt(t, e)
              );
            }
            function jt(t, e) {
              ((this.options = u({}, qt.defaults, e || {})),
                ...
                (this.oldCssProps = {}),
                (this.element = t),
                (this.input = new (this.options.inputClass || (X ? rt : Y ? pt : N ? dt : Q))(
                  this,
                  L
                )),
            ...
            ((Dt.prototype = {
              ...
              requireFailure: function (t) {
                ...
                return (
                  -1 === D(e, (t = Mt(t, this))) && (e.push(t), t.requireFailure(this)),
                  this
                );
              },
              ...
              recognize: function (t) {
                ...
                if (!I(this.options.enable, [this, e]))
                  return (this.reset(), void (this.state = Ct));
