...
!(function (t, e) {
  ...
  return (function () {
    ...
    function H(t, e) {
      ...
      return (o < -0.5 * P && (o += D), { angle: o, distance: n });
    }
    function $(t, e) {
    ...
    function at(t, e, i) {
      ...
      if (t._sorted) {
        ...
        (d &&
          (n = q(
            Math.min(Z(r, a.axis, h).lo, i ? s : Z(e, l, a.getPixelForValue(h)).lo),
            0,
            s - 1
          )),
          (o = u
            ? q(
                Math.max(
                  Z(r, a.axis, c, !0).hi + 1,
                  i ? 0 : Z(e, l, a.getPixelForValue(c), !0).hi + 1
                ),
                n,
                s
              ) - n
    ...
    const lt = (t) => 0 === t || 1 === t,
      ...
      dt = {
        ...
        easeInElastic: (t) => (lt(t) ? t : ht(t, 0.075, 0.3)),
        easeOutElastic: (t) => (lt(t) ? t : ct(t, 0.075, 0.3)),
        easeInOutElastic(t) {
          const e = 0.1125;
          return lt(t)
            ? t
        ...
        easeInOutBounce: (t) =>
          t < 0.5 ? 0.5 * dt.easeInBounce(2 * t) : 0.5 * dt.easeOutBounce(2 * t - 1) + 0.5,
      };
    function ut(t) {
      return (t + 0.5) | 0;
    }
    ...
    const Rt =
      ...
      zt = (t) => (t <= 0.04045 ? t / 12.92 : Math.pow((t + 0.055) / 1.055, 2.4));
    function Ft(t, e, i) {
      if (t) {
        let s = Dt(t);
    ...
    function Bt(t) {
      ...
      return (
        Array.isArray(t)
          ? t.length >= 3 &&
            ((e = { r: t[0], g: t[1], b: t[2], a: 255 }), t.length > 3 && (e.a = pt(t[3])))
          : ((e = Vt(t, { r: 0, g: 0, b: 0, a: 1 })).a = pt(e.a)),
        e
      );
    }
    function Wt(t) {
    ...
    class Nt {
      ...
      hexString() {
        return this._valid
          ? ((t = this._rgb),
            (e = ((t) => Mt(t.r) && Mt(t.g) && Mt(t.b) && Mt(t.a))(t) ? yt : vt),
    ...
    function Yt(t) {
      return Ht(t) ? t : jt(t).saturate(0.5).darken(0.1).hexString();
    }
    ...
    function Jt(t, e, i, s) {
      ...
      (s.font !== e && ((n = s.data = {}), (a = s.garbageCollect = []), (s.font = e)),
        t.save(),
        (t.font = e));
      let r = 0;
      const l = i.length;
      ...
      for (h = 0; h < l; h++)
        if (((u = i[h]), null != u && !0 !== o(u))) r = Zt(t, n, a, r, u);
          ...
          for (c = 0, d = u.length; c < d; c++)
            ((f = u[c]), null == f || o(f) || (r = Zt(t, n, a, r, f)));
      t.restore();
      const g = a.length / 2;
      if (g > i.length) {
      ...
      for (n = 0, a = t.length; n < a; ++n)
        if (
          ...
          void 0 !== r &&
            ...
            void 0 !== i && o(r) && ((r = r[i % r.length]), (l = !1)),
            void 0 !== r))
        )
    ...
    const ke = (t, e) => (t ? t + M(e) : e),
      Se = (t, e) =>
        a(e) && 'adapters' !== t && (null === Object.getPrototypeOf(e) || e.constructor === Object);
    function Pe(t, e, i) {
    ...
    function We(t, e, i, s, n) {
      ...
      if ((e.spanGaps && (t = t.filter((t) => !t.skip)), 'monotone' === e.cubicInterpolationMode))
            ...
            (function (t, e, i = 'x') {
              ...
              for (let h = 0; h < n; ++h) {
                ...
                (a && ((o = (n - a[i]) / 3), (r[`cp1${i}`] = n - o), (r[`cp1${s}`] = c - o * e[h])),
                  l &&
                    ((o = (l[i] - n) / 3), (r[`cp2${i}`] = n + o), (r[`cp2${s}`] = c + o * e[h])));
              }
            })(t, o, e));
        })(t, n);
      else {
        ...
        for (o = 0, a = t.length; o < a; ++o)
          ((r = t[o]),
            (l = Ve(i, r, t[Math.min(o + 1, a - (s ? 0 : 1)) % a], e.tension)),
            (r.cp1x = l.previous.x),
            (r.cp1y = l.previous.y),
            (r.cp2x = l.next.x),
            (r.cp2y = l.next.y),
          ...
          for (i = 0, s = t.length; i < s; ++i)
            ((a = o),
              ...
              o &&
                ((n = t[i]),
                a &&
                  ((n.cp1x = Be(n.cp1x, e.left, e.right)), (n.cp1y = Be(n.cp1y, e.top, e.bottom))),
                r &&
                  ((n.cp2x = Be(n.cp2x, e.left, e.right)),
                  (n.cp2y = Be(n.cp2y, e.top, e.bottom)))));
        })(t, i);
    }
    function Ne() {
    ...
    function ri({ start: t, end: e, count: i, loop: s, style: n }) {
        ...
        ((m = e[t % a]),
          m.skip ||
            ...
            p !== b &&
              ...
              null !== _ &&
                (!x || 0 === r(o, p) || l(o, b, p)) &&
                (g.push(ri({ start: _, end: t, loop: u, count: a, style: f })), (_ = null)),
              (i = t),
              (b = p))));
      return (null !== _ && g.push(ri({ start: _, end: d, loop: u, count: a, style: f })), g);
    }
    function hi(t, e) {
      const i = [],
        s = t.segments;
    ...
    class pi {
      constructor(t, e, i, s) {
        ...
        ((this._active = !0),
          (this._fn = t.fn || gi[t.type || typeof o]),
      ...
      update(t, e, i) {
        if (this._active) {
          ...
          ((this._start = i),
            ...
            (this._total += n),
            (this._loop = !!t.loop),
            (this._to = _e([t.to, e, s, t.from])),
            (this._from = _e([t.from, s, e])));
        }
      }
      cancel() {
    ...
    function ki(t, e) {
      ...
      for (let t = 0; t < d; ++t) {
        const i = e[t],
          { [l]: o, [h]: d } = i;
        ((u = (i._stacks || (i._stacks = {}))[h] = Mi(n, c, o)),
          (u[r] = d),
    ...
    class Ci {
      ...
      buildOrUpdateElements(t) {
        ...
        ((e._stacked = vi(e.vScale, e)),
          e.stack !== i.stack && ((s = !0), Pi(e), (e.stack = i.stack)),
      ...
      parseObjectData(t, e, i, s) {
        ...
        let h, c, d, u;
        for (h = 0, c = s; h < c; ++h)
          ((d = h + i), (u = e[d]), (l[h] = { x: n.parse(v(u, a), d), y: o.parse(v(u, r), d) }));
        return l;
      }
      getParsed(t) {
      ...
      applyStack(t, e, i) {
        const s = this.chart,
          n = this._cachedMeta,
          o = e[t.axis];
        return yi({ keys: _i(s, !0), values: e._stacks[t.axis] }, o, n.index, { mode: i });
      }
      updateRangeFromParsed(t, e, i, s) {
        const n = i[e.axis];
        let o = null === n ? NaN : n;
        const a = s && i._stacks[e.axis];
        (s && a && ((s.values = a), (o = yi(s, n, this._cachedMeta.index))),
      ...
      getMinMax(t, e) {
        const i = this._cachedMeta,
          ...
          l = ((t, e, i) => t && !e.hidden && e._stacked && { keys: _i(i, !0), values: null })(
            e,
            i,
            this.chart
          ),
    ...
    function Li(t, e, i, s) {
      ...
      let h, c, d, u;
      for (h = i, c = i + s; h < c; ++h)
        ((u = e[h]), (d = {}), (d[n.axis] = r || n.parse(a[h], h)), l.push(Ti(u, d, o, h)));
      return l;
    }
    function Ei(t) {
    ...
    function Ii(t, e, i, s) {
      ...
      return (
        s
          ? ((a = i), (t = zi((t = (n = t) === (o = e) ? a : n === a ? o : n), i, e)))
          : (t = zi(t, e, i)),
        t
      );
    }
    ...
    function Fi(t, { inflateAmount: e }, i) {
    ...
    class Vi extends Ci {
      ...
      parseObjectData(t, e, i, s) {
        ...
        let d, u, f, g;
        for (d = i, u = i + s; d < u; ++d)
          ((g = e[d]), (f = {}), (f[n.axis] = n.parse(v(g, l), d)), c.push(Ti(v(g, h), f, o, d)));
        return c;
      }
      updateRangeFromParsed(t, e, i, s) {
      ...
      updateElements(t, e, i, s) {
        ...
        for (let f = e; f < e + i; f++) {
          const e = this.getParsed(f),
            i = o || n(e[r.axis]) ? { base: l, head: l } : this._calculateBarValuePixels(f),
    ...
    class Wi extends Ci {
      ...
      _circumference(t, e) {
        ...
        return (e && i.animation.animateRotate) ||
          ...
          s.data[t].hidden
          ? 0
          : this.calculateCircumference((s._parsed[t] * n) / D);
      }
      updateElements(t, e, i, s) {
        const n = 'reset' === s,
          o = this.chart,
        ...
        for (let g = e; g < e + i; ++g) {
          const e = t[g],
            ...
            M = (_[f] =
              o || y
                ? r.getBasePixel()
                : r.getPixelForValue(l ? this.applyStack(r, i, l) : i[f], g));
          ((_.skip = isNaN(v) || isNaN(M) || y),
            (_.stop = g > 0 && Math.abs(i[u] - x[u]) > m),
            p && ((_.parsed = i), (_.raw = h.data[g])),
    ...
    class Hi extends Wi {}
    ((Hi.id = 'pie'),
      (Hi.defaults = { cutout: 0, rotation: 0, circumference: 360, radius: '100%' }));
    class $i extends Ci {
      getLabelAndValue(t) {
    ...
    (($i.id = 'radar'),
      ...
      ($i.overrides = { aspectRatio: 1, scales: { r: { type: 'radialLinear' } } }));
    class Yi {
      constructor() {
        ((this.x = void 0),
          (this.y = void 0),
    ...
    function qi(t, e, i, s, n) {
      ...
      for (l = Math.max(o, 0); l < a; l++)
        l === c && (e.push(t[l]), d++, (c = Math.round(o + d * i)));
    }
    (Gt.set('scale', {
      display: !0,
      offset: !1,
      ...
      Gt.route('scale.grid', 'borderColor', '', 'borderColor'),
    ...
    class es extends Yi {
      ...
      update(t, e, i) {
        ...
        (this._convertTicksToLabels(l ? Gi(this.ticks, r) : this.ticks),
          this.configure(),
          ...
          a.display &&
            ...
            ((this.ticks = (function (t, e) {
              ...
              if (a > 0) {
                ...
                for (qi(e, h, c, n(s) ? 0 : r - s, r), t = 0, i = a - 1; t < i; t++)
                  qi(e, h, c, o[t], o[t + 1]);
      ...
      calculateLabelRotation() {
        ...
        ((o = t.offset ? this.maxWidth / i : u / (i - 1)),
          c + 6 > o &&
            ...
            (a = this.maxHeight - Ji(t.grid) - e.padding - Qi(t.title, this.chart.options.font)),
            (r = Math.sqrt(c * c + d * d)),
            (l = N(
              Math.min(
                Math.asin(q((h.highest.height + 6) / o, -1, 1)),
                Math.asin(q(a / r, -1, 1)) - Math.asin(q(d / r, -1, 1))
              )
            )),
      ...
      fit() {
        ...
        if (o) {
          ...
          if (
            (a
              ? ((t.width = this.maxWidth), (t.height = Ji(n) + o))
              : ((t.height = this.maxHeight), (t.width = Ji(n) + o)),
          ...
          if (
            ...
            if (o(d))
              for (h = 0, c = d.length; h < c; ++h)
                ((_ = d[h]), n(_) || o(_) || ((b = Zt(i, p.data, p.gc, b, _)), (x += m)));
      ...
      _computeGridLineItems(t) {
        ...
        if ('top' === o)
          ...
          ((b = m(this.top)), (P = t.top), (O = m(t.bottom) - p), (M = b + p), (k = this.top + d));
        else if ('left' === o)
          ((b = m(this.right)),
            (v = this.right - d),
            (w = b - p),
      ...
      drawTitle() {
        ...
        'bottom' === e || 'center' === e || a(e)
          ? ((h += r.bottom), o(i.text) && (h += n.lineHeight * (i.text.length - 1)))
          : (h += r.top);
        const {
          titleX: c,
          titleY: d,
    ...
    class is {
      ...
      unregister(t) {
        const e = this.items,
          ...
          s = this.scope;
        (i in e && delete e[i],
          s && i in Gt[s] && (delete Gt[s][i], this.override && delete Ut[i]));
      }
    }
    var ss = new (class {
      constructor() {
        ((this.controllers = new is(Ci, 'datasets', !0)),
          (this.elements = new is(Yi, 'elements')),
    ...
    class ns extends Ci {
      ...
      addElements() {
        ...
        (!this.datasetElementType && t && (this.datasetElementType = ss.getElement('line')),
          super.addElements());
      }
      updateElements(t, e, i, s) {
        const o = 'reset' === s,
    ...
    ((ns.id = 'scatter'),
      (ns.defaults = { datasetElementType: !1, dataElementType: 'point', showLine: !1, fill: !1 }),
      (ns.overrides = {
    ...
    Gt.set('layout', { autoPadding: !0, padding: { top: 0, right: 0, bottom: 0, left: 0 } });
    var Ps = {
      addBox(t, e) {
        (t.boxes || (t.boxes = []),
    ...
    class Hs extends Ds {
      ...
      addEventListener(t, e, i) {
        ...
        const s = t.$proxies || (t.$proxies = {}),
          n = { attach: Is, detach: zs, resize: Ws }[e] || js;
        s[e] = n(t, e, i);
      }
      removeEventListener(t, e) {
        const i = t.$proxies || (t.$proxies = {}),
          s = i[e];
        s && (({ attach: Ns, detach: Ns, resize: Ns }[e] || Es)(t, e, s), (i[e] = void 0));
      }
      getDevicePixelRatio() {
      ...
      getMaximumSize(t, e, i, s) {
        return (function (t, e, i, s) {
              ...
              if (void 0 === e || void 0 === i) {
                ...
                if (o) {
                  ...
                  ((e = t.width - l.width - r.width),
                    ...
                    (s = He(a.maxWidth, o, 'clientWidth')),
                    (n = He(a.maxHeight, o, 'clientHeight')));
          ...
          return (
            ...
            (h = qe(Math.min(h, a, l.maxWidth))),
            (c = qe(Math.min(c, r, l.maxHeight))),
            h && !c && (c = qe(h / 2)),
            { width: h, height: c }
          );
        })(t, e, i, s);
          ...
          ? (function (t, { plugins: e, localIds: i }, s, n) {
              ...
              for (const r of e) {
                const e = r.id,
                  l = Ys(s[e], n);
                null !== l &&
                  o.push({ plugin: r, options: Us(t.config, { plugin: r, local: i[e] }, l, a) });
              }
              return o;
            })(t, n, s, e)
          : [];
          ...
          return (
            Object.keys(s).forEach((t) => {
              ...
              const l = qs(t, e),
                ...
                c = i.scales || {};
              ((o[l] = o[l] || t), (r[t] = x(Object.create(null), [{ axis: l }, e, c[l], c[h]])));
            }),
            t.data.datasets.forEach((i) => {
              ...
              Object.keys(l).forEach((t) => {
                const e = (function (t, e) {
                  ...
                  n = i[e + 'AxisID'] || o[e] || e;
                ((r[n] = r[n] || Object.create(null)), x(r[n], [{ axis: e }, s[n], l[t]]));
              });
            }),
    ...
    class en {
      ...
      getOptionScopes(t, e, i) {
        ...
        e.forEach((e) => {
          (t && (r.add(t), e.forEach((e) => tn(r, t, e))),
            ...
            e.forEach((t) => tn(r, Ut[n] || {}, t)),
            e.forEach((t) => tn(r, Gt, t)),
            e.forEach((t) => tn(r, Xt, t)));
        });
      ...
      chartOptionScopes() {
        ...
        return [t, Ut[e] || {}, Gt.datasets[e] || {}, { type: e }, Gt, Xt];
      }
      resolveNamedOptions(t, e, i, s = ['']) {
        const n = { $shared: !0 },
          { resolver: a, subPrefixes: r } = sn(this._resolverCache, t, s);
        let l = a;
        (function (t, e) {
          const { isScriptable: i, isIndexable: s } = we(t);
          for (const n of e) {
            const e = i(n),
              a = s(n),
              r = (a || e) && t[n];
          ...
          ((n.$shared = !1), (l = Me(a, (i = k(i) ? i() : i), this.createResolver(t, i, r))));
    ...
    class gn {
      constructor(t, e) {
        ...
        ((this.platform = new (i.platform ||
          (function (t) {
            return !Ne() || ('undefined' != typeof OffscreenCanvas && t instanceof OffscreenCanvas)
              ? Os
              : Hs;
          })(n))()),
        ...
        ((this.id = s()),
          ...
          (dn[this.id] = this),
          r && l
            ? (ui.listen(this, 'complete', ln),
              ui.listen(this, 'progress', hn),
              this._initialize(),
      ...
      buildOrUpdateScales() {
        ...
        (e &&
          ...
          u(n, (e) => {
            ...
            (o in i && i[o].type === r
              ? (l = i[o])
              : ((l = new (ss.getScale(r))({ id: o, type: r, ctx: this.ctx, chart: this })),
                (i[l.id] = l)),
              l.init(n, t));
          }),
          u(s, (t, e) => {
        ...
        for (this._removeUnreferencedMetasets(), i = 0, s = e.length; i < s; i++) {
          ...
          if (
            ...
            const e = ss.getController(o),
              { datasetElementType: s, dataElementType: a } = Gt.datasets[o];
    ...
    function bn(t, e, i) {
      ...
      (t.beginPath(),
        t.arc(o, a, r, s - h, i + h),
        l > n ? ((h = n / l), t.arc(o, a, l, i + h, s - h, !0)) : t.arc(o, a, n, i + T, s - T),
        t.closePath(),
        t.clip());
    }
    function xn(t, e, i, s) {
    ...
    function _n(t, e, i, s, n, o) {
      ...
      const p = (g - Math.max(0.001, g * d - i / P) / d) / 2,
        m = l + p + f,
        b = n - p - f,
        {
          outerStart: x,
          ...
          const n = ge(t.options.borderRadius, [
              'outerStart',
              'outerEnd',
              'innerStart',
              'innerEnd',
    ...
    Object.defineProperties(gn, {
      defaults: { enumerable: mn, value: Gt },
      instances: { enumerable: mn, value: dn },
      overrides: { enumerable: mn, value: Ut },
      registry: { enumerable: mn, value: ss },
          ...
          r &&
            ...
            e.fullCircles &&
              (function (t, e, i) {
                ...
                let c;
                for (
                  i && bn(t, e, o + D), t.beginPath(), t.arc(s, n, h, o + D, o, !0), c = 0;
                  c < r;
                  ++c
                )
                  t.stroke();
    ...
    class On extends Yi {
      ...
      interpolate(t, e) {
        const i = this.options,
          s = t[e],
          n = this.points,
          o = hi(this, { property: e, start: s, end: s });
        if (!o.length) return;
        const a = [],
          r = (function (t) {
    ...
    ((On.id = 'line'),
      ...
      (On.defaultRoutes = { backgroundColor: 'backgroundColor', borderColor: 'borderColor' }),
      (On.descriptors = {
        _scriptable: !0,
    ...
    class zn extends Yi {
      ...
      draw(t) {
        const {
          ...
          r = (l = o.radius).topLeft || l.topRight || l.bottomLeft || l.bottomRight ? ce : Rn;
        var l;
        (t.save(),
          (o.w === n.w && o.h === n.h) ||
            (t.beginPath(),
    ...
    function Nn(t, e, i, s) {
      ...
      let n = e[t],
        o = i[t];
      return ('angle' === t && ((n = U(n)), (o = U(o))), { property: t, start: n, end: o });
    }
    function jn(t, e, i) {
      for (; e > t; e--) {
        const t = i[e];
    ...
    function $n(t, e) {
      ...
      return (
        ...
        i.length ? new On({ points: i, options: { tension: 0 }, _loop: s, _fullLoop: s }) : null
      );
    }
    function Yn(t) {
      return t && !1 !== t.fill;
    ...
    function qn(t, e, i) {
      ...
      for (let n = 0; n < i.length; n++) {
        const o = i[n],
          { first: a, last: r, point: l } = Kn(o, e, 'x');
        if (!(!l || (a && r)))
          if (a) s.unshift(l);
    ...
    class Gn {
      ...
      pathSegment(t, e, i) {
        ...
        return ((e = e || { start: 0, end: D }), t.arc(s, n, o, e.end, e.start, !0), !i.bounds);
      }
      interpolate(t) {
        ...
        (function (t, e) {
          ...
          (t.save(),
            'x' === l &&
              o !== n &&
              (Jn(t, s, a.top),
              Qn(t, { line: i, target: s, color: n, scale: r, property: l }),
              t.restore(),
              t.save(),
              Jn(t, s, a.bottom)),
            Qn(t, { line: i, target: s, color: o, scale: r, property: l }),
            t.restore());
        })(t, { line: n, target: s, above: u, below: f, area: i, scale: o, axis: l }),
        oe(t));
    }
    function Jn(t, e, i) {
            ...
            for (const e of h) {
              ...
              for (const t of r)
                a.push({
                  source: t,
                  target: e,
                  start: { [i]: Hn(l, s, 'start', Math.max) },
                  end: { [i]: Hn(l, s, 'end', Math.min) },
                });
            }
          }
          return a;
      ...
      afterDatasetsUpdate(t, e, i) {
        ...
        for (a = 0; a < s; ++a)
          ((o = t.getDatasetMeta(a)),
            ...
            n.push(l));
        for (a = 0; a < s; ++a)
          ((l = n[a]), l && !1 !== l.fill && (l.fill = Un(n, a, i.propagate)));
      },
      beforeDraw(t, e, i) {
    ...
    class no extends Yi {
      ...
      adjustHitBoxes() {
        ...
        if (this.isHorizontal()) {
          ...
          for (const r of e)
            (n !== r.row &&
              ((n = r.row), (a = ot(i, this.left + s, this.right - this.lineWidths[n]))),
              (r.top += this.top + t + s),
      ...
      _draw() {
        const { options: t, columnSizes: e, lineWidths: i, ctx: s } = this,
          { align: n, labels: o } = t,
          a = Gt.color,
          r = si(t.rtl, this.left, this.width),
          l = xe(o.font),
          { color: c, padding: d } = o,
          u = l.size,
          f = u / 2;
        ...
        (this.drawTitle(),
          ...
          (s.lineWidth = 0.5),
          (s.font = l.string));
        const { boxWidth: p, boxHeight: m, itemHeight: b } = so(o, u),
          x = this.isHorizontal(),
          _ = this._computeTitleHeight();
        ((g = x
          ? { x: ot(n, this.left + d, this.right - i[0]), y: this.top + d + _, line: 0 }
          : { x: this.left + d, y: ot(n, this.top + _ + d, this.bottom - e[0].height), line: 0 }),
        ...
        (this.legendItems.forEach((v, M) => {
          ...
          (r.setWidth(this.width),
            x
              ? M > 0 &&
                P + S + d > this.right &&
                ((D = g.y += y), g.line++, (P = g.x = ot(n, this.left + d, this.right - i[g.line])))
              : M > 0 &&
                D + y > this.bottom &&
      ...
      drawTitle() {
        ...
        if (this.isHorizontal())
          ...
          h =
            l +
            ot(t.align, this.top, this.bottom - e - t.labels.padding - this._computeTitleHeight());
        }
        const u = ot(a, c, c + d);
      ...
      _getLegendItemAt(t, e) {
        ...
        if (K(t, this.left, this.right) && K(e, this.top, this.bottom))
          for (n = this.legendHitBoxes, i = 0; i < n.length; ++i)
            if (((s = n[i]), K(t, s.left, s.left + s.width) && K(e, s.top, s.top + s.height)))
      ...
      _drawArgs(t) {
        ...
        return (
          this.isHorizontal()
            ...
            : ('left' === o.position
                ? ((l = i + t), (h = ot(a, s, e)), (c = -0.5 * P))
                : ((l = n - t), (h = ot(a, e, s)), (c = 0.5 * P)),
              (r = s - e)),
    ...
    function xo(t, e, i, s) {
      const { caretSize: n, caretPadding: o, cornerRadius: a } = t,
        { xAlign: r, yAlign: l } = i,
        h = n + o,
        { topLeft: c, topRight: d, bottomLeft: u, bottomRight: f } = me(a);
      let g = (function (t, e) {
        let { x: i, width: s } = t;
      ...
      return (
        ...
        { x: q(g, 0, s.width - e.width), y: q(p, 0, s.height - e.height) }
      );
    }
    function _o(t, e, i) {
    ...
    class Mo extends Yi {
        ...
        return (
          u(t, (t) => {
            const e = { before: [], lines: [], after: [] },
              n = vo(i, t);
            (uo(e.before, fo(n.beforeLabel.call(this, t))),
              uo(e.lines, n.label.call(this, t)),
              uo(e.after, fo(n.afterLabel.call(this, t))),
              s.push(e));
          }),
          s
        );
      ...
      getCaretPosition(t, e, i) {
        const { xAlign: s, yAlign: n } = this,
          ...
          { topLeft: r, topRight: l, bottomLeft: h, bottomRight: c } = me(a),
          { x: d, y: u } = t,
          { width: f, height: g } = e;
        let p, m, b, x, _, y;
        return (
      ...
      drawBackground(t, e, i, s) {
        const { xAlign: n, yAlign: o } = this,
          { x: a, y: r } = t,
          { width: l, height: h } = i,
          { topLeft: c, topRight: d, bottomLeft: u, bottomRight: f } = me(s.cornerRadius);
    ...
    ((So.id = 'category'), (So.defaults = { ticks: { callback: So.prototype.getLabelForValue } }));
    class Do extends es {
      constructor(t) {
        (super(t),
          (this.start = void 0),
      ...
      buildTicks() {
        ...
        const s = (function (t, e) {
          ...
          ((k = Math.ceil(m / S) - Math.floor(p / S)),
            k > g && (S = z((k * S) / g / f) * f),
            n(l) || ((v = Math.pow(10, l)), (S = Math.ceil(S * v) / v)),
            'ticks' === s
    ...
    ((Oo.id = 'linear'), (Oo.defaults = { ticks: { callback: Xi.formatters.numeric } }));
    class Ao extends es {
      constructor(t) {
        (super(t),
          (this.start = void 0),
      ...
      buildTicks() {
        const t = this.options,
          e = (function (t, e) {
            ...
            do {
              (n.push({ value: o, major: Co(o) }),
                ++r,
                10 === r && ((r = 1), ++a, (h = a >= 0 ? 1 : h)),
                (o = Math.round(r * Math.pow(10, a) * h) / h));
            } while (a < i || (a === i && r < s));
            const c = l(t.max, o);
            return (n.push({ value: c, major: Co(o) }), n);
          })({ min: this._userMin, max: this._userMax }, this);
        return (
          'ticks' === t.bounds && B(e, this, 'value'),
          t.reverse
    ...
    ((Ao.id = 'logarithmic'),
      (Ao.defaults = { ticks: { callback: Xi.formatters.logarithmic, major: { enabled: !0 } } }));
    class Fo extends Do {
      constructor(t) {
        (super(t),
          (this.xCenter = void 0),
      ...
      generateTickLabels(t) {
        (Do.prototype.generateTickLabels.call(this, t),
              ...
              for (let u = 0; u < a; u++) {
                ...
                const f = t.getPointPosition(u, t.drawingArea + n[u], l),
                  ...
                  p =
                    ...
                    { w: Jt(h, c.string, d), h: d.length * c.lineHeight });
                s[u] = p;
              ...
              for (let o = e - 1; o >= 0; o--) {
                ...
                if (!n(g)) {
                  ...
                  Object.values(t).some((t) => 0 !== t)
                    ? (i.beginPath(), ce(i, { x: n, y: o, w: a, h: r, radius: t }), i.fill())
                    : i.fillRect(n, o, a, r);
                }
      ...
      drawLabels() {
        ...
        (t.save(),
          ...
          this.ticks.forEach((s, a) => {
            ...
            le(t, s.label, 0, -n, l, { color: r.color });
          }),
          t.restore());
      }
      drawTitle() {}
    ...
    ((Fo.id = 'radialLinear'),
      ...
      (Fo.descriptors = { angleLines: { _fallback: 'grid' } }));
    const Vo = {
    ...
    function No(t, e) {
      ...
      let l = e;
      return (
        'function' == typeof s && (l = s(l)),
        r(l) || (l = 'string' == typeof s ? i.parse(l, s) : i.parse(l)),
        null === l
          ? null
          : (o &&
              (l =
                'week' !== o || (!F(a) && !0 !== a) ? i.startOf(l, o) : i.startOf(l, 'isoWeek', a)),
            +l)
      );
    }
    function jo(t, e, i, s) {
    ...
    class Yo extends es {
      ...
      _generate() {
        ...
        return (
          (d !== i && 'ticks' !== s.bounds && 1 !== u) || Ho(c, d, g),
          Object.keys(c)
            .sort((t, e) => t - e)
            .map((t) => +t)
        );
    ...
    function Uo(t, e, i) {
      let s,
        ...
        l = t.length - 1;
      i
        ? (e >= t[r].pos && e <= t[l].pos && ({ lo: r, hi: l } = Z(t, 'pos', e)),
          ({ pos: s, time: o } = t[r]),
          ({ pos: n, time: a } = t[l]))
        : (e >= t[r].time && e <= t[l].time && ({ lo: r, hi: l } = Z(t, 'time', e)),
          ({ time: s, pos: o } = t[r]),
          ({ time: n, pos: a } = t[l]));
      const h = n - s;
    ...
    class Xo extends Yo {
      ...
      initOffsets() {
        ...
        ((this._minPos = Uo(e, this.min)),
          (this._tableRange = Uo(e, this.max) - this._minPos),
          super.initOffsets(t));
      }
      buildLookupTable(t) {
