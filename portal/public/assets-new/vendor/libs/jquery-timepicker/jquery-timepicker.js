            ...
            (function () {
                  ...
                  return (
                    ...
                    (n = [
                      ...
                      },
                      {
                        ...
                        value: function () {
                          var e,
                            t = p(document.getElementsByClassName('ui-timepicker-input'));
                          try {
                            for (t.s(); !(e = t.n()).done; ) {
                    ...
                    (i = [
                      ...
                      },
                      {
                        ...
                        value: function (e, t) {
                          ...
                          return (
                            -1 == ['error', 'initial'].indexOf(t) && this.targetEl.dispatchEvent(n),
                            !1
                          );
                        },
                      },
                      ...
                      },
                      {
                        ...
                        value: function (e) {
                          ...
                          ('a' != (e = e.toLowerCase().replace(/[\s\.]/g, '')).slice(-1) &&
                            'p' != e.slice(-1)) ||
                            (e += 'm');
                          var t =
                          ...
                          if (n <= 12 && r) {
                            var l =
                              (r = r.trim()) == this.settings.lang.pm || r == this.settings.lang.PM;
                        ...
                        value: function (e) {
                          ...
                          for (var s, a, o = '', l = 0; l < this.settings.timeFormat.length; l++)
                            switch ((a = this.settings.timeFormat.charAt(l))) {
                              case 'a':
                                o +=
                                  r.getHours() > 11 ? this.settings.lang.pm : this.settings.lang.am;
                                break;
                              case 'A':
                                o +=
                                  r.getHours() > 11 ? this.settings.lang.PM : this.settings.lang.AM;
                              ...
                              case 'G':
                                ((s = r.getHours()),
                                  e === m && (s = this.settings.show2400 ? 24 : 0),
                                  (o += s));
                                break;
                              case 'h':
              ...
              (!(function () {
                  ...
                  var t = {
                      ...
                      return this.each(function () {
                        ...
                        if (
                          ...
                          (s.on('change.timepicker', a._handleFormatValue),
                            ...
                            o.disableTextInput &&
                              s.on('keydown.timepicker', a._disableTextInputHandler),
                    ...
                    show: function (t) {
                      ...
                      if ((t && t.preventDefault(), a.useSelect)) s.list.trigger('focus');
                        ...
                        var o = s.list;
                        if (!r.prop('readonly') && (i(r), (o = s.list), !k.isVisible(o))) {
                          ...
                          return (
                            ...
                            a.closeOnWindowScroll && e(document).on('scroll.ui-timepicker', n),
                          ...
                          i = [].concat(
                            ...
                            (function (e) {
                              var t,
                                ...
                                s = null !== (i = n.maxTime()) && void 0 !== i ? i : r + m - 1;
                              (s < r && (s += m),
                                86399 === s &&
                              ...
                              for (var a = [], o = r, l = 0; o <= s; l++, o += 60 * n.step(l)) {
                                var u = o,
                                  c = e._int2time(u),
                                  f = u % m < 43200 ? 'ui-timepicker-am' : 'ui-timepicker-pm',
                ...
                'object' === a(t) && t && 'object' === a(e) && e && e.exports === t
                  ? g(i(1145))
                  : ((r = [i(1145)]),
                    void 0 === (s = 'function' == typeof (n = g) ? n.apply(t, r) : n) ||
                      (e.exports = s)));
            })());
        },
        1145: function (t) {
