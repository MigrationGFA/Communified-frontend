  ...
  return (function () {
            ...
            !(function (t) {
                          ...
                          : r && Blob.prototype.isPrototypeOf(e)
                            ...
                            : i && FormData.prototype.isPrototypeOf(e)
                              ...
                              : n && URLSearchParams.prototype.isPrototypeOf(e)
                                ...
                                : a && r && (t = e) && DataView.prototype.isPrototypeOf(t)
              ...
              function b(e, t) {
                ...
                if (
                  ...
                  (this.method =
                    ((o = (n = t.method || this.method || 'GET').toUpperCase()),
                    m.indexOf(o) > -1 ? o : n)),
              ...
              ((x.polyfill = !0),
                e.fetch || ((e.fetch = x), (e.Headers = p), (e.Request = b), (e.Response = O)),
                (t.Headers = p),
                (t.Request = b),
                (t.Response = O),
                (t.fetch = x),
    ...
    return (
      (function () {
              ...
              a(e, [
                ...
                },
                {
                  ...
                  value: function (t) {
                    return new e(
                      this.logger,
                      g(g({}, { prefix: ''.concat(this.prefix, ':').concat(t, ':') }), this.options)
                    );
                  },
                },
                {
                ...
                },
                {
                  ...
                  value: function (e, t, n) {
                    ...
                    return s || !i || 'string' != typeof n
                      ? s
                      : I(this.data && this.data[e] && this.data[e][t], n, r);
                  },
                },
                {
                  key: 'addResource',
                  ...
                  value: function (e, t, n, o, r) {
                    var i =
                        arguments.length > 5 && void 0 !== arguments[5]
                          ...
                          : { silent: !1 },
                      a = [e, t];
                    (e.indexOf('.') > -1 && ((o = n), (n = t), (t = (a = e.split('.'))[1])),
                      this.addNamespaces(t));
                    var s = j(this.data, a) || {};
                    (o ? L(s, n, r) : (s = A(A({}, s), n)),
                      S(this.data, a, s),
                ...
                [
                  ...
                  },
                  {
                    ...
                    value: function (e, t) {
                      ...
                      if (i && !a) {
                        ...
                        var u = e.split(n);
                        ((n !== o || (n === o && this.options.ns.indexOf(u[0]) > -1)) &&
                          (r = u.shift()),
                          (e = u.join(o)));
                      }
                  ...
                  },
                  {
                    ...
                    value: function (t, n, o) {
                      ...
                      var i =
                          void 0 !== n.returnDetails ? n.returnDetails : this.options.returnDetails,
                      ...
                      if (p && 'cimode' === p.toLowerCase()) {
                        if (h) {
                          ...
                          return i
                            ? ((g.res = ''.concat(f).concat(d).concat(c)), g)
                      ...
                      if (
                        ...
                        if (!n.returnObjects && !this.options.returnObjects) {
                          ...
                          var S = this.options.returnedObjectHandler
                            ? this.options.returnedObjectHandler(v, y, B(B({}, n), {}, { ns: l }))
                            : "key '"
                                .concat(c, ' (')
                        ...
                        if (a) {
                          ...
                          for (var R in y)
                            if (Object.prototype.hasOwnProperty.call(y, R)) {
                              ...
                              ((P[R] = this.translate(E, B(B({}, n), { joinArrays: !1, ns: l }))),
                                P[R] === E && (P[R] = y[R]));
                            }
                          y = P;
                        }
                        ...
                        (!this.isValidLookup(y) && D && ((C = !0), (y = I)),
                          this.isValidLookup(y) || ((N = !0), (y = c)));
                        var F =
                        ...
                        if (N || C || _) {
                          if (
                            (this.logger.log(_ ? 'updateKey' : 'missingKey', p, f, c, _ ? I : y), a)
                          ) {
                          ...
                          if ('fallback' === this.options.saveMissingTo && q && q[0])
                            ...
                            'all' === this.options.saveMissingTo
                              ? (H = this.languageUtils.toResolveHierarchy(n.lng || this.language))
                              : H.push(n.lng || this.language);
                          var K = function (e, t, o) {
                            var i = D && o !== y ? o : U;
                            (r.options.missingKeyHandler
                              ? r.options.missingKeyHandler(e, f, t, i, _, n)
                              : r.backendConnector &&
                                r.backendConnector.saveMissing &&
                                r.backendConnector.saveMissing(e, f, t, i, _, n),
                    ...
                    value: function (e, t, n, o, r) {
                      ...
                      if (this.i18nFormat && this.i18nFormat.parse)
                        e = this.i18nFormat.parse(
                          e,
                          B(B({}, this.options.interpolation.defaultVariables), n),
                          o.usedLng,
                          o.usedNS,
                          o.usedKey,
                          { resolved: o }
                        ...
                        if (
                          (this.options.interpolation.defaultVariables &&
                            (c = B(B({}, this.options.interpolation.defaultVariables), c)),
                            ...
                            function () {
                              ...
                              return r && r[0] === o[0] && !n.context
                                ? (i.logger.warn(
                                  ...
                                  null)
                                : i.translate.apply(i, o.concat([t]));
                            },
                            n
                          )),
                        ...
                        e.forEach(function (e) {
                          if (!a.isValidLookup(t)) {
                            ...
                            l.forEach(function (e) {
                              a.isValidLookup(t) ||
                                ((i = e),
                                !M[''.concat(d[0], '-').concat(e)] &&
                                  a.utils &&
                                  a.utils.hasLoadedNamespace &&
                                  !a.utils.hasLoadedNamespace(i) &&
                                  ((M[''.concat(d[0], '-').concat(e)] = !0),
                                  a.logger.warn(
                                    'key "'
              ...
              },
              {
                ...
                value: function (e, t, n, o) {
                  ...
                  var l = function (e) {
                    if (e.indexOf(s.formatSeparator) < 0) {
                      ...
                      return s.alwaysFormat
                        ? s.format(r, void 0, n, Y(Y(Y({}, o), t), {}, { interpolationkey: e }))
                        : r;
                    }
                  ...
                  var f =
                    ...
                    p =
                      o && o.interpolation && void 0 !== o.interpolation.skipOnVariables
                    ...
                    [
                      ...
                      for (a = 0; (r = t.regex.exec(e)); ) {
                        ...
                        if (
                          ((e = e.replace(r[0], c)),
                          p
                            ? ((t.regex.lastIndex += i.length), (t.regex.lastIndex -= r[0].length))
                            : (t.regex.lastIndex = 0),
                          ++a >= s.maxReplaces)
                        )
                          break;
                      ...
                      c &&
                        (o = u.reduce(function (e, t) {
                          return r.format(
                            ...
                            t,
                            i.lng,
                            Y(Y({}, i), {}, { interpolationkey: n[1].trim() })
                          );
                        }, o.trim())),
                      (e = e.replace(n[0], o)),
            ...
            (t(this, e),
              ...
              (this.formats = {
                ...
                currency: function (e, t, n) {
                  return new Intl.NumberFormat(t, ee(ee({}, n), {}, { style: 'currency' })).format(
                    e
                  );
                },
                  ...
                  this.read(r, i, 'read', void 0, void 0, function (o, a) {
                    (o &&
                      ...
                      !o &&
                        a &&
                        t.logger.log(
                          ''.concat(n, 'loaded namespace ').concat(i, ' for language ').concat(r),
                          a
                        ),
                      t.loaded(e, o, a));
                  });
                ...
                value: function (e, t, n, o, r) {
                  ...
                  !this.services.utils.hasLoadedNamespace(t)
                    ...
                    : null != n &&
                      ...
                      (this.backend &&
                        this.backend.create &&
                        this.backend.create(e, t, n, o, null, oe(oe({}, i), {}, { isUpdate: r })),
            ...
            a(u, [
              {
                ...
                value: function () {
                  ...
                  if (
                    ((this.options = ue(ue(ue({}, o), this.options), ae(t))),
                    'v1' !== this.options.compatibilityAPI &&
                  ...
                  return (
                    this.options.resources || !this.options.initImmediate ? p() : setTimeout(p, 0),
                    f
                  );
                },
              },
                ...
                value: function (t, n, o) {
                  var r = this,
                    i = function t(n, i) {
                      ...
                      if ('object' !== e(i)) {
                        for (
                          var s = arguments.length, u = new Array(s > 2 ? s - 2 : 0), c = 2;
                          c < s;
                          c++
                        )
                          u[c - 2] = arguments[c];
        ...
        function me(e) {
          return (
            ye.call(ve.call(arguments, 1), function (t) {
        ...
        function be() {
          return (
            ...
            'object' === ('undefined' == typeof XMLHttpRequest ? 'undefined' : de(XMLHttpRequest))
          );
        }
        var we,
          Oe,
            ...
            return (
              ...
              we
                ? (function (e, t, n, o) {
                    ...
                    var r = me(
                      {},
                      'function' == typeof e.customHeaders ? e.customHeaders() : e.customHeaders
                    );
                ...
                : be() || 'function' == typeof ActiveXObject
                  ? (function (e, t, n, o) {
                      (n && 'object' === je(n) && (n = Pe('', n).slice(1)),
                        e.queryStringParams && (t = Pe(t, e.queryStringParams)));
                      try {
                        var r;
                        ((r = Oe ? new Oe() : new ke('MSXML2.XMLHTTP.3.0')).open(
                          n ? 'POST' : 'GET',
                          t,
                          1
                        ),
                        ...
                        ((r.onreadystatechange = function () {
                          r.readyState > 3 &&
                            o(r.status >= 400 ? r.statusText : null, {
                              status: r.status,
                              data: r.responseText,
                            });
                        }),
                            ...
                            n.read(t, e, 'read', null, null, function (o, i) {
                              (o &&
                                ...
                                !o &&
                                  i &&
                                  r.log(
                                    'loaded namespace '.concat(e, ' for language ').concat(t),
                                    i
                                  ),
        ...
        function _e(e) {
          return (
            Fe.call(Ue.call(arguments, 1), function (t) {
              if (t) for (var n in t) void 0 === e[n] && (e[n] = t[n]);
            }),
            e
          );
            ...
            lookup: function (e) {
              ...
              if ('undefined' != typeof window) {
                ...
                !window.location.search &&
                  ...
                  (n = window.location.hash.substring(window.location.hash.indexOf('?')));
