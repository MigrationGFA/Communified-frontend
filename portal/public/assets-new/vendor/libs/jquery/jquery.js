          ...
          !(function (t, n) {
                    ...
                    if (null != (e = arguments[s]))
                      for (t in e)
                        ((r = e[t]),
                          '__proto__' !== t &&
                            a !== r &&
                            (l && r && (S.isPlainObject(r) || (o = Array.isArray(r)))
                              ? ((n = a[t]),
                                (i =
                                  o && !Array.isArray(n) ? [] : o || S.isPlainObject(n) ? n : {}),
                                (o = !1),
                                (a[t] = S.extend(l, i, r)))
                              : void 0 !== r && (a[t] = r)));
                  return a;
              ...
              return (
                ...
                (u = se.select =
                  function (e, t, n, o) {
                    ...
                    return (
                      (p || s(e, d))(o, t, !g, n, !t || (ee.test(e) && ye(t.parentNode)) || t),
                      n
                    );
                  }),
                ...
                function (e, t) {
                  S.fn[e] = function (n, r) {
                    ...
                    return (
                      ...
                      this.length > 1 && (R[e] || S.uniqueSort(o), P.test(e) && o.reverse()),
                      this.pushStack(o)
                    );
                  };
                }
              ...
              var t,
                ...
                l = {
                  ...
                  fireWith: function (e, n) {
                    return (
                      o || ((n = [e, (n = n || []).slice ? n.slice() : n]), a.push(n), t || u()),
                      this
                    );
                  },
                  fire: function () {
              ...
              S.extend({
                ...
                ready: function (e) {
                  (!0 === e ? --S.readyWait : S.isReady) ||
                    ((S.isReady = !0), (!0 !== e && --S.readyWait > 0) || _.resolveWith(x, [S]));
                },
              }),
              (S.ready.then = _.then),
            ...
            var U = function (e, t, n, r, o, i, a) {
                var s = 0,
                  u = e.length,
                  l = null == n;
                if ('object' === T(n)) for (s in ((o = !0), n)) U(e, t, s, n[s], !0, i, a);
                else if (
                  void 0 !== r &&
                  ((o = !0),
                  y(r) || (a = !0),
                  ...
                  return 'object' == typeof e
                    ...
                    : U(
                        ...
                        function (t) {
                          var n;
                          if (i && void 0 === t)
                            return void 0 !== (n = Z.get(i, e)) || void 0 !== (n = ne(i, e))
                              ? n
                              : void 0;
                          this.each(function () {
                            Z.set(this, e, t);
                ...
                queue: function (e, t, n) {
                  ...
                  if (e)
                    return (
                      ...
                      (r = K.get(e, t)),
                      n &&
                        (!r || Array.isArray(n) ? (r = K.access(e, t, S.makeArray(n))) : r.push(n)),
                      r || []
                    );
                },
            ...
            function de(e, t) {
              for (var n, r, o = [], i = 0, a = e.length; i < a; i++)
                (r = e[i]).style &&
                  ...
                  t
                    ? ('none' === n &&
                        ((o[i] = K.get(r, 'display') || null), o[i] || (r.style.display = '')),
            ...
            function Ce(e, t, n, r, o) {
              for (
                var i, a, s, u, l, c, f = t.createDocumentFragment(), p = [], d = 0, h = e.length;
                d < h;
                d++
              )
                if ((i = e[d]) || 0 === i)
                  ...
                  for (
                    ...
                    for (
                      ...
                      (u.rnamespace && !1 !== i.namespace && !u.rnamespace.test(i.namespace)) ||
                        ...
                        (u.data = i.data),
                        void 0 !==
                          (r = ((S.event.special[i.origType] || {}).handle || i.handler).apply(
                            o.elem,
                            s
                          )) &&
                          !1 === (u.result = r) &&
            ...
            (S.extend({
              ...
              clone: function (e, t, n) {
                ...
                if (t)
                  if (n)
                    for (i = i || be(e), a = a || be(s), r = 0, o = i.length; r < o; r++)
                      Re(i[r], a[r]);
                  else Re(e, s);
                ...
                function (e, t) {
                  S.fn[e] = function (e) {
                    for (var n, r = [], o = S(e), i = o.length - 1, a = 0; a <= i; a++)
                      ((n = a === i ? this : this.clone(!0)), S(o[a])[t](n), l.apply(r, n.get()));
            ...
            function rt(e, t, n, r, o, i) {
              ...
              for (; a < 4; a += 2)
                ('margin' === n && (u += S.css(e, n + ie[a], !0, o)),
                  r
                    ? ('content' === n && (u -= S.css(e, 'padding' + ie[a], !0, o)),
                      'margin' !== n && (u -= S.css(e, 'border' + ie[a] + 'Width', !0, o)))
              ...
              style: function (e, t, n, r) {
                if (e && 3 !== e.nodeType && 8 !== e.nodeType && e.style) {
                  var o,
                    ...
                    u = $e.test(t),
                    l = e.style;
                  if ((u || (t = Ke(s)), (a = S.cssHooks[t] || S.cssHooks[s]), void 0 === n))
                  ...
                  ('string' == (i = typeof n) &&
                    ...
                    null != n &&
                      n == n &&
                      ('number' !== i || u || (n += (o && o[3]) || (S.cssNumber[s] ? '' : 'px')),
                      v.clearCloneStyle ||
                        '' !== n ||
            ...
            function dt(e, t, n) {
              for (
                var r, o = (ht.tweeners[t] || []).concat(ht.tweeners['*']), i = 0, a = o.length;
                i < a;
                i++
              )
            ...
            function ht(e, t, n) {
              ...
              for (
                ...
                if ((r = ht.prefilters[i].call(l, e, c, l.opts)))
                  return (
                    y(r.stop) && (S._queueHooks(l.elem, l.opts.queue).stop = r.stop.bind(r)),
                    r
                  );
              return (
                S.map(c, dt, l),
            ...
            (S.fn.extend({
              ...
              S.each(S.expr.match.bool.source.match(/\w+/g), function (e, t) {
                ...
                vt[t] = function (e, t, r) {
                  ...
                  return (
                    r ||
                      ((i = vt[a]), (vt[a] = o), (o = null != n(e, t, r) ? a : null), (vt[a] = i)),
                    o
                  );
                };
              }));
                  ...
                  select: {
                    ...
                    set: function (e, t) {
                      for (var n, r, o = e.options, i = S.makeArray(t), a = o.length; a--; )
                        ((r = o[a]).selected = S.inArray(S.valHooks.option.get(r), i) > -1) &&
                          (n = !0);
              ...
              trigger: function (e, t, n, o) {
                ...
                if (
                  ...
                  3 !== n.nodeType &&
                    ...
                    (l = g.indexOf(':') < 0 && 'on' + g),
                    ((e = e[S.expando] ? e : new S.Event(g, 'object' == typeof e && e)).isTrigger =
                      o ? 2 : 3),
                    (e.namespace = v.join('.')),
