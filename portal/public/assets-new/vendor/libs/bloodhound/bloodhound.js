                      ...
                      return (
                        ...
                        function () {
                          ...
                          return (
                            ...
                            (n = arguments),
                            c <= 0
                              ? (clearTimeout(i), (i = null), (s = a), (o = t.apply(r, n)))
                              : i || (i = setTimeout(u, c)),
                            o
                          );
                        }
                        ...
                        ((o = this._fingerprint(e)),
                          this.cancelled ||
                            ...
                            ((s = n[o])
                              ? s.done(a).fail(c)
                              : t < i
                                ? (t++, (n[o] = this._send(e).done(a).fail(c).always(h)))
                          ...
                          ((e = r.isArray(e) ? e : [e]),
                            r.each(e, function (e) {
                              ...
                              ((n.datums[(s = n.identify(e))] = e),
                                ...
                                r.each(u, function (e) {
                                  var r, i, u;
                                  for (r = n.trie, i = e.split(''); (u = i.shift()); )
                      ...
                      fromCache: function () {
                        ...
                        return this.cache
                          ? ((r.data = this.storage.get(t.data)),
                            ...
                            (e =
                              r.thumbprint !== this.thumbprint || r.protocol !== location.protocol),
                      ...
                      (i.prefetch = (function (i) {
                        ...
                        return i
                          ? ((o = {
                            ...
                            !(i = r.mixin(o, i)).url && e.error('prefetch requires url to be set'),
                      ...
                      (i.remote = (function (n) {
                        ...
                        if (n)
                          return (
                            ...
                            !(n = r.mixin(i, n)).url && e.error('remote requires url to be set'),
                            ...
                            (n.transport = n.transport ? t(n.transport) : e.ajax),
                            delete n.replace,
                            delete n.wildcard,
