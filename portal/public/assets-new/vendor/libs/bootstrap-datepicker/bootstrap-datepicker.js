...
!(function (t, e) {
  ...
  return (function () {
              ...
              h.prototype = {
                    ...
                    s.endDate !== 1 / 0 &&
                      (s.endDate
                        ? s.endDate instanceof Date
                          ...
                          : (s.endDate = m.parseDate(s.endDate, o, s.language, s.assumeNearbyYear))
                        : (s.endDate = 1 / 0)),
                ...
                _fill_yearsView: function (i, a, s, n, o, r, h) {
                  for (
                    ...
                    ((l = [a]),
                      (d = null),
                      v === g - p ? l.push('old') : v === D + p && l.push('new'),
                    ...
                    s.hasClass('disabled') ||
                      ((s.hasClass('month') ||
                        ...
                        1 === this.viewMode
                          ...
                          : ((o = 0), (n = Number(s.text())), this.viewDate.setUTCFullYear(n)),
                    ...
                    this.each(function () {
                      ...
                      if (!n) {
                        ...
                        (e.hasClass('input-daterange') || p.inputs
                          ? (t.extend(p, { inputs: p.inputs || e.find('input').toArray() }),
                            (n = new l(this, p)))
                          : (n = new h(this, p)),
                          e.data('datepicker', n));
                      }
              ...
              var D = (t.fn.datepicker.dates = {
                ...
                m = {
                  ...
                  parseDate: function (i, s, n, o) {
                    ...
                    if (('string' == typeof s && (s = m.parseFormat(s)), s.toValue))
                    ...
                    if (
                      (i in f && (i = f[i]), /^[\-+]\d+[dmwy]([\s,]+[\-+]\d+[dmwy])*$/i.test(i))
                    ) {
                      for (
                        r = i.match(/([\-+]\d+)([dmwy])/gi), i = new Date(), c = 0;
                        c < r.length;
                        c++
                      )
                    ...
                    if (
                      ...
                      for (c = 0, C = b.length; c < C; c++) {
                        if (((g = parseInt(r[c], 10)), (l = b[c]), isNaN(g)))
                          switch (l) {
                            case 'MM':
                      ...
                      for (c = 0; c < w.length; c++)
                        (M = w[c]) in v &&
                          !isNaN(v[M]) &&
                          ((T = new Date(i)), k[M](T, v[M]), isNaN(T) || (i = T));
                    }
                    return i;
                  },
                  formatDate: function (e, i, a) {
                    if (!e) return '';
                    if (('string' == typeof i && (i = m.parseFormat(i)), i.toDisplay))
    ...
    ((a.n = function (t) {
      ...
      (a.d = function (t, e) {
        for (var i in e)
          a.o(e, i) && !a.o(t, i) && Object.defineProperty(t, i, { enumerable: !0, get: e[i] });
      }),
      (a.o = function (t, e) {
