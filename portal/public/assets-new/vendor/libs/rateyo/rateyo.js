          ...
          !(function (t) {
            ...
            var o = /^#([0-9a-f]{2})([0-9a-f]{2})([0-9a-f]{2})$/i,
              i = function (t) {
                ...
                var e = o.exec(t);
                return { r: parseInt(e[1], 16), g: parseInt(e[2], 16), b: parseInt(e[3], 16) };
              };
            function l(t, e, r) {
              var n = (r / 100) * (e - t);
            ...
            function s(r, o) {
              ...
              var u,
                ...
                g,
                m,
                h = t('<div/>').addClass('jq-ry-group-wrapper').appendTo(r),
                v = t('<div/>').addClass('jq-ry-normal-group').addClass('jq-ry-group').appendTo(h),
                y = t('<div/>').addClass('jq-ry-rated-group').addClass('jq-ry-group').appendTo(h),
                b = o.rating,
                w = !1;
              function x(t) {
                (a(t) || (t = o.rating), (b = t));
              ...
              function S(t) {
                var e = (o.starWidth = t);
                return (
                  (f = window.parseFloat(o.starWidth.replace('px', ''))),
                  v.find('svg').attr({ width: o.starWidth, height: e }),
                  y.find('svg').attr({ width: o.starWidth, height: e }),
                  k(),
                  r
                );
              }
              ...
              function j(t) {
                return (
                  (o.normalFill = t),
                  (o.rtl ? y : v).find('svg').attr({ fill: o.normalFill }),
                  r
                );
              }
              var C = o.ratedFill;
              function q(t) {
                ...
                return (
                  (o.ratedFill = t),
                  (o.rtl ? v : y).find('svg').attr({ fill: o.ratedFill }),
                  r
                );
              }
              function z(t) {
                ((t = !!t), (o.rtl = t), j(o.normalFill), x());
              }
              function I(t) {
                ((o.multiColor = t), q(t || C));
              }
              function O(n) {
                ((o.numStars = n), (u = o.maxValue / o.numStars), v.empty(), y.empty());
                for (var a = 0; a < o.numStars; a++)
                  (v.append(t(o.starSvg || e)), y.append(t(o.starSvg || e)));
                return (S(o.starWidth), j(o.normalFill), F(o.spacing), x(), r);
              }
              function V(t) {
                return (
                  (o.maxValue = t),
              ...
              function M(t) {
                return ((o.precision = t), _(o.rating), r);
              }
              function E(t) {
                return ((o.halfStar = t), r);
              }
              function W(t) {
                return ((o.fullStar = t), r);
              }
              function A(t) {
                var e,
                  r,
                ...
                if (f < l) m = 0;
                  ...
                  ((r = (e = m) % u),
                    ...
                    (m =
                      (i = o.fullStar) || a
                        ? (i || (a && r > n) ? (e += u - r) : ((e -= r), r > 0 && (e += n)), e)
                        : e));
                }
                return (o.rtl && (m = c - m), parseFloat(m));
              }
              function T(t) {
                return (
                  (o.readOnly = t),
              ...
              function _(t) {
                ...
                return (
                  'string' == typeof e &&
                    ('%' === e[e.length - 1] && ((e = e.substr(0, e.length - 1)), V((a = 100))),
                    (e = parseFloat(e))),
                  (function (t, e, r) {
                    if (!(t >= 0 && t <= r))
                  ...
                  (o.rating = e),
                  x(),
                  w && r.trigger('rateyo.set', { rating: e }),
                  r
                );
              }
              function P(t) {
              ...
              function R(t) {
                return ((o.onChange = t), r);
              }
              function B(t) {
                var e = A(t).toFixed(o.precision),
                  a = o.maxValue;
                (x((e = n(parseFloat(e), 0, a))), r.trigger('rateyo.change', { rating: e }));
              }
              function L() {
                var t, e;
                ((e = !1),
                  ...
                  (/(android|bb\d+|meego).+mobile|avantgo|bada\/|blackberry|blazer|compal|elaine|fennec|hiptop|iemobile|ip(hone|od)|iris|kindle|lge |maemo|midp|mmp|mobile.+firefox|netfront|opera m(ob|in)i|palm( os)?|phone|p(ixi|re)\/|plucker|pocket|psp|series(4|6)0|symbian|treo|up\.(browser|link)|vodafone|wap|windows ce|xda|xiino|android|ipad|playbook|silk/i.test(
                    ...
                    (e = !0),
                  e || (x(), r.trigger('rateyo.change', { rating: o.rating })));
              }
              function N(t) {
                var e = A(t).toFixed(o.precision);
                ((e = parseFloat(e)), c.rating(e));
              }
              function Q(t, e) {
              ...
              function X(t, e) {
                o.onChange &&
                  ...
                  o.onChange.apply(this, [e.rating, c]);
              }
              function $(t, e) {
              ...
              ((this.rating = function (t) {
                ...
                (this.method = function (t) {
                  ...
                  if (!a(this[t])) throw Error('Method ' + t + " doesn't exist!");
