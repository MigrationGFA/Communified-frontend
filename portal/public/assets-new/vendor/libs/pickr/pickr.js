          ...
          (self,
            (t.exports = (() => {
              ...
              function v(t, e, o) {
                ...
                return (
                  0 !== n &&
                    (e = 1 === n ? 0 : n < 0.5 ? (e * o) / (2 * n) : (e * o) / (2 - 2 * n)),
                  [t, 100 * e, 100 * n]
                );
              }
              function b(t, e, o) {
                ...
                const i =
                  ...
                  r = {
                    ...
                    toHSVA() {
                      ...
                      return (
                        (t.toString = i(t, (t) => `hsva(${t[0]}, ${t[1]}%, ${t[2]}%, ${r.a})`)),
                        t
                      );
                    },
                    toHSLA() {
                      ...
                      return (
                        (t.toString = i(t, (t) => `hsla(${t[0]}, ${t[1]}%, ${t[2]}%, ${r.a})`)),
                        t
                      );
                    },
                    toRGBA() {
                      const t = [...m(r.h, r.s, r.v), r.a];
                      return (
                        (t.toString = i(t, (t) => `rgba(${t[0]}, ${t[1]}, ${t[2]}, ${r.a})`)),
                        t
                      );
                    },
                    toCMYK() {
                      ...
                      return (
                        (t.toString = i(t, (t) => `cmyk(${t[0]}%, ${t[1]}%, ${t[2]}%, ${t[3]}%)`)),
                        t
                      );
                    },
                    toHEXA() {
                      const t = (function (t, e, o) {
                          return m(t, e, o).map((t) => f(t).toString(16).padStart(2, '0'));
                        })(r.h, r.s, r.v),
                        e =
                          r.a >= 1
                            ? ''
                ...
                const e = {
                      ...
                      if (document.activeElement === o.wrapper) {
                        ...
                        if ('keydown' === n && (r || s || a || l)) {
                          ...
                          ('v' === o
                            ...
                            e.update(A(e.cache.x + 0.01 * n), A(e.cache.y + 0.01 * i)),
                            t.preventDefault());
                    ...
                    destroy() {
                      ...
                      (r(document, ['keydown', 'keyup'], n),
                        r([t.wrapper, t.element], 'mousedown', o),
                        r([t.wrapper, t.element], 'touchstart', o, { passive: !1 }));
                    },
                  },
                  { options: o, _tapstart: n, _keyboard: s } = e;
                return (
              ...
              class O {
                        ...
                        onchange(o, n) {
                          ...
                          ((this.element.style.background = p),
                            ...
                            a.comparison
                              ...
                              : (s.button.style.setProperty('--pcr-color', p),
                      ...
                      t: for (const i in e) {
                        ...
                        switch (i) {
                          ...
                          case 'rgba': {
                            ...
                            return { values: [...b(t, e, s), a], a: a, type: i };
                          }
                          case 'hexa': {
                            let [, t] = n;
                ...
                destroy() {
                  (cancelAnimationFrame(this._setupAnimationFrame),
                    this._eventBindings.forEach((t) => r(...t)),
