                      ...
                      fromCache: function () {
                        ...
                        return this.cache
                          ? ((n.data = this.storage.get(t.data)),
                            ...
                            (e =
                              n.thumbprint !== this.thumbprint || n.protocol !== location.protocol),
            ...
            (r = function (t) {
              return (
                    ...
                    n.mixin(r.prototype, s, {
                      ...
                      _getSuggestionsFragment: function (i, r) {
                        ...
                        return (
                          ...
                          this.highlight &&
                            o({ className: this.classes.highlight, node: s, pattern: i }),
                          e(s)
                        );
                      },
                  ...
                  return (
                    n.mixin(t.prototype, {
                      ...
                      _minLengthMet: function (t) {
                        return (
                          (t = n.isString(t) ? t : this.input.getQuery() || '').length >=
                          this.minLength
                        );
                      },
                ...
                void (function () {
                  ...
                  function p(t) {
                    var i;
                    return (i = n.isJQuery(t) || n.isElement(t) ? e(t).first() : []).length
                      ? i
                      : null;
                  }
                  ((t = e.fn.typeahead),
                      ...
                      initialize: function (t, o) {
                        ...
                        function g() {
                          ...
                          (n.each(o, function (e) {
                            ...
                            (x = new l(
                              { input: w, menu: S, eventBus: b, minLength: t.minLength },
                              a
                            )),
                            i.data(s.www, a),
