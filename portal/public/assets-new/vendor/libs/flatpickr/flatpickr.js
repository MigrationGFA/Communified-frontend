          ...
          e.exports = (function () {
                      ...
                      if ('today' === u) ((l = new Date()), (i = !0));
                        ...
                        for (var f = void 0, m = [], g = 0, p = 0, h = ''; g < d.length; g++) {
                          ...
                          if (D[b] && !y) {
                            ...
                            C &&
                              (f = !0) &&
                              m['Y' !== b ? 'push' : 'unshift']({ fn: v[b], val: C[++p] });
                          } else w || (h += '.');
                        }
                        ((l =
                          n && n.noCalendar
            ...
            function k(p, v) {
              ...
              function _(e) {
                ...
                (O(), Me(), b._input.value !== a && b._debouncedChange());
              }
              function O() {
              ...
              function j(e, t) {
                ...
                (t && b.currentYear !== a && (De('onYearChange'), q()),
                ...
                var n = k(),
                  ...
                  i =
                    void 0 !== e
                      ...
                      : a
                        ? n
                        : void 0 !== b.selectedDateElem && ne(b.selectedDateElem)
                          ? b.selectedDateElem
                          : void 0 !== b.todayDateElem && ne(b.todayDateElem)
                            ? b.todayDateElem
                            : B(t > 0 ? 1 : -1);
                void 0 === i
                  ? b._input.focus()
                ...
                b.config.showMonths > 1 || 'static' === b.config.monthSelectorType
                  ...
                  : ((b.monthsDropdownContainer = d('select', 'flatpickr-monthDropdown-months')),
                    ...
                    P(b.monthsDropdownContainer, 'change', function (e) {
                      ...
                      (b.changeMonth(n - b.currentMonth), De('onMonthChange'));
                    }),
                    q(),
                ...
                if (void 0 !== b.amPM && t === b.amPM)
                  switch (e.key) {
                    ...
                    case b.l10n.amPM[0].charAt(0).toLowerCase():
                      ((b.amPM.textContent = b.l10n.amPM[0]), O(), Me());
                      break;
                    case b.l10n.amPM[1].charAt(0):
                    case b.l10n.amPM[1].charAt(0).toLowerCase():
                      ((b.amPM.textContent = b.l10n.amPM[1]), O(), Me());
                  }
                    ...
                    (r && !u) ||
                      ...
                      void 0 !== e &&
                        ...
                        a < n && d === a
                          ...
                          : a > n && d === a && t.classList.add('endRange'),
                        d >= l &&
                          (0 === c || d <= c) &&
                          ((o = a), (s = n), (i = d) > Math.min(o, s) && i < Math.max(o, s)) &&
              ...
              function se() {
                ('object' != typeof b.config.locale &&
                  void 0 === S.l10ns[b.config.locale] &&
                  ...
                  void 0 === e(e({}, v), JSON.parse(JSON.stringify(p.dataset || {}))).time_24hr &&
                    void 0 === S.defaultConfig.time_24hr &&
              ...
              function ue() {
                b.config.noCalendar || b.isMobile || (q(), ye(), U());
              }
              function fe() {
                (b._input.focus(),
                ...
                clickOpens: [
                  function () {
                    !0 === b.config.clickOpens
                      ? (P(b._input, 'focus', b.open), P(b._input, 'click', b.open))
              ...
              function De(e, t) {
                if (void 0 !== b.config) {
                  ...
                  'onChange' === e &&
                    (b.input.dispatchEvent(be('change')), b.input.dispatchEvent(be('input')));
                }
              }
              function be(e) {
                  ...
                  ((b.element = b.input = p),
                    ...
                    (function () {
                      ...
                      for (
                        ...
                        for (var m in f)
                          n.indexOf(m) > -1
                            ? (b.config[m] = c(f[m]).map(T).concat(b.config[m]))
                            : void 0 === i[m] && (b.config[m] = f[m]);
                      }
                      (i.altInputClass ||
                        (b.config.altInputClass = ce().className + ' ' + b.config.altInputClass),
                        De('onParseConfig'));
                    })(),
                    se(),
                    (b.input = ce()),
                    ...
                    b.isMobile ||
                      (function () {
                        ...
                        var i =
                          void 0 !== b.config.appendTo && void 0 !== b.config.appendTo.nodeType;
                        if (
                    ...
                    (function () {
                      if (
                        ...
                        !(function () {
                          ...
                          try {
                            b.input.parentNode &&
                              b.input.parentNode.insertBefore(b.mobileInput, b.input.nextSibling);
                          } catch (e) {}
                        ...
                        if (
                          ...
                          (P(b.timeContainer, ['increment'], _),
                            P(b.timeContainer, 'blur', _, { capture: !0 }),
