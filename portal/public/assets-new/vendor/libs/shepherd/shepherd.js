        ...
        4992: function (t, e, n) {
                ...
                if (null != n) {
                  ...
                  try {
                    if (((i = (n = n.call(t)).next), 0 === e)) {
                      ...
                      for (
                        ;
                        !(c = (o = i.call(n)).done) && (a.push(o.value), a.length !== e);
                        c = !0
                      );
                  } catch (t) {
                    ((l = !0), (r = t));
          ...
          ((i = function () {
                ...
                g(t, [
                  {
                    ...
                    value: function (t, e, n, o) {
                      return (
                        void 0 === o && (o = !1),
                        w(this.bindings) && (this.bindings = {}),
                        w(this.bindings[t]) && (this.bindings[t] = []),
                  ...
                  },
                  {
                    ...
                    value: function (t) {
                      for (
                        var e = this, n = arguments.length, o = new Array(n > 1 ? n - 1 : 0), r = 1;
                        r < n;
                        r++
                      )
                        o[r - 1] = arguments[r];
            ...
            function U(t, e) {
              ...
              if (W(t) && e) {
                var i = t.offsetHeight,
                  s = t.offsetWidth;
                (s > 0 && (o = X(n.width) / s || 1), i > 0 && (r = X(n.height) / i || 1));
              }
              return {
                width: n.width / o,
                height: n.height / r,
            ...
            function Q(t) {
              return 'html' === D(t)
                ? t
                : t.assignedSlot || t.parentNode || (F(t) ? t.host : null) || J(t);
            }
            function tt(t) {
              return W(t) && 'fixed' !== K(t).position ? t.offsetParent : null;
            }
            function et(t) {
              for (var e = H(t), n = tt(t); n && G(n) && 'static' === K(n).position; ) n = tt(n);
              return n && ('html' === D(n) || ('body' === D(n) && 'static' === K(n).position))
                ? e
                : n ||
                    (function (t) {
                      ...
                      if (
                        ...
                        return null;
                      var n = Q(t);
                      for (F(n) && (n = n.host); W(n) && ['html', 'body'].indexOf(D(n)) < 0; ) {
                        var o = K(n);
                        if (
                          'none' !== o.transform ||
                          'none' !== o.perspective ||
              ...
              fn: function (t) {
                ...
                if (i && s) {
                  var u = (function (t, e) {
                    ...
                    O = ot(b, w, x),
                    $ = c;
                  n.modifiersData[o] = (((e = {})[$] = O), (e.centerOffset = O - w), e);
                }
              },
              effect: function (t) {
                var e = t.state,
              ...
              if (l) {
                ...
                (O === H(n) &&
                  ...
                  (r === E || ((r === j || r === k) && i === I)) &&
                    ((x = S),
                    (v -=
                      (f && O === w && w.visualViewport ? w.visualViewport.height : O[$]) -
                      o.height),
                    (v *= c ? 1 : -1)),
                  (r !== j && ((r !== E && r !== S) || i !== I)) ||
                    ((b = k),
                    (d -=
                      (f && O === w && w.visualViewport ? w.visualViewport.width : O[T]) - o.width),
                    (d *= c ? 1 : -1)));
              }
              var _,
            ...
            function Et(t, e) {
              ...
              var n = e,
                  ...
                  var o =
                      'clippingParents' === e
                        ? (function (t) {
                            var e = xt(Q(t)),
                              n =
                                ['absolute', 'fixed'].indexOf(K(t).position) >= 0 && W(t)
                                  ? et(t)
                                  : t;
                            return R(n)
                              ? e.filter(function (t) {
                ...
                x = U(t.elements.reference),
                w = $t({ reference: x, element: y, strategy: 'absolute', placement: r }),
                O = wt(Object.assign({}, y, w)),
                $ = u === M ? O : x,
                j = {
                  top: b.top - $.top + v.top,
            ...
            function St(t, e) {
              ...
              var d = p.reduce(function (e, n) {
                return (
                  (e[n] = Et(t, { placement: n, boundary: r, rootBoundary: i, padding: s })[V(n)]),
                  e
                );
              }, {});
            ...
            var kt = {
              ...
              fn: function (t) {
                ...
                if (!e.modifiersData[o]._skip) {
                  ...
                  e.placement !== _ &&
                    ((e.modifiersData[o]._skip = !0), (e.placement = _), (e.reset = !0));
                }
              },
                  ...
                  u = {
                    ...
                    setOptions: function (n) {
                      ...
                      (f(),
                        ...
                        (a.scrollParents = {
                          reference: R(t) ? xt(t) : t.contextElement ? xt(t.contextElement) : [],
                          popper: xt(e),
                        }));
                      var s,
                        l,
                    ...
                    forceUpdate: function () {
                      if (!l) {
                        ...
                        if (Pt(e, n)) {
                          ((a.rects = {
                            reference: _t(e, et(n), 'fixed' === a.options.strategy),
                            popper: z(n),
                          }),
                            (a.reset = !1),
                          ...
                          for (var o = 0; o < a.orderedModifiers.length; o++)
                            if (!0 !== a.reset) {
                              var r = a.orderedModifiers[o],
                                ...
                                f = r.name;
                              'function' == typeof i &&
                                (a = i({ state: a, options: c, name: f, instance: u }) || a);
                            } else ((a.reset = !1), (o = -1));
                        }
                      }
                    },
                          ...
                          return (
                            (t[n] = (function (t, e, n) {
                              ...
                              return (
                                (s = s || 0),
                                (a = (a || 0) * r),
                                [j, k].indexOf(o) >= 0 ? { x: a, y: s } : { x: s, y: a }
                              );
                            })(n, e.rects, i)),
                            t
                          );
                  ...
                  kt,
                  {
                    ...
                    fn: function (t) {
                      var e = t.state,
                        ...
                        h = n.tetherOffset,
                        v = void 0 === h ? 0 : h,
                        m = Et(e, { boundary: c, rootBoundary: l, padding: f, altBoundary: u }),
                        y = V(e.placement),
                        g = at(e.placement),
                        b = !g,
                        x = nt(y),
                      ...
                      if (O) {
                        if (i) {
                          var L,
                            ...
                            J = K[B],
                            Q = ot(0, $[D], Z[D]),
                            tt = b ? $[D] / 2 - F - Q - G - I.mainAxis : N - Q - G - I.mainAxis,
                            rt = b ? -$[D] / 2 + F + Q + J + I.mainAxis : X + Q + J + I.mainAxis,
                            it = e.elements.arrow && et(e.elements.arrow),
                            st = it ? ('y' === x ? it.clientTop || 0 : it.clientLeft || 0) : 0,
                            ct = null != (L = null == P ? void 0 : P[x]) ? L : 0,
                            lt = H + rt - ct,
                            ut = ot(d ? Y(R, H + tt - ct - st) : R, H, d ? q(W, lt) : W);
                          ((O[x] = ut), (M[x] = ut - H));
                        }
                        if (a) {
                          var ft,
                            ...
                            yt = ht - m[dt],
                            gt = -1 !== [E, j].indexOf(y),
                            bt = null != (ft = null == P ? void 0 : P[w]) ? ft : 0,
                            xt = gt ? mt : ht - $[vt] - T[vt] - bt + I.altAxis,
                            wt = gt ? ht + $[vt] + T[vt] - bt - I.altAxis : yt,
                            Ot =
                              d && gt
                                ? (function (t, e, n) {
                                    var o = ot(t, e, n);
                  ...
                  Rt(t)
                    ? (n = (function (t) {
                        var e = [
                          ...
                          n = { placement: 'top', strategy: 'fixed', modifiers: [Dt(t)] };
                        return Bt({}, n, {
                          modifiers: Array.from(new Set([].concat(d(n.modifiers), d(e)))),
                        });
                      })(e))
                    : (n.placement = t.on);
            ...
            function Nt(t, e) {
              if (t.popperOptions) {
                ...
                if (t.popperOptions.modifiers && t.popperOptions.modifiers.length > 0) {
                  ...
                  n.modifiers = Array.from(new Set([].concat(d(r), d(t.popperOptions.modifiers))));
                }
                return n;
              }
              return e;
            ...
            function Zt(t, e) {
              return t != t
                ? e == e
                : t !== e || (t && 'object' === x(t)) || 'function' == typeof t;
            }
            function Kt(t, e) {
              t.appendChild(e);
            }
            ...
            function Ie(t, e, n, o, r, i, s, a) {
              ...
              if (
                ((l.ctx = n
                  ? n(t, e.props || {}, function (e, n) {
                      ...
                      return (
                        l.ctx &&
                          r(l.ctx[e], (l.ctx[e] = o)) &&
                          (!l.skip_bound && l.bound[e] && l.bound[e](o), u && Ae(t, e)),
                        n
                      );
                    })
                  : []),
                ...
                (e.intro && Se(t.$$.fragment), Te(t, e.target, e.anchor, e.customElement), be());
              }
              ae(c);
            }
            var Pe = (function () {
              ...
              return {
                ...
                p: function (r, i) {
                  ...
                  ((t = r),
                    ...
                    8 & s && n !== (n = t[3] ? t[3] : null) && re(e, 'aria-label', n),
                    18 & s &&
                      o !==
                        (o = ''
                          .concat(t[1] || '', ' shepherd-button ')
            ...
            function Le(t, e, n) {
              ...
              return (
                (t.$$set = function (t) {
                  ('config' in t && n(6, (l = t.config)), 'step' in t && n(7, (u = t.step)));
                }),
                (t.$$.update = function () {
                  192 & t.$$.dirty &&
            ...
            var Ce = (function (t) {
              ...
              function n(t) {
                ...
                return (
                  m(this, n),
                  Ie(u((o = e.call(this))), t, Le, Me, Zt, { config: 6, step: 7 }),
                  o
                );
              }
              return g(n);
            ...
            function De(t) {
              for (var e, n, o = t[1], r = [], i = 0; i < o.length; i += 1) r[i] = He(Be(t, o, i));
              var s = function (t) {
                ...
                p: function (t, n) {
                  if (3 & n) {
                    ...
                    for (o = t[1], i = 0; i < o.length; i += 1) {
                      ...
                      r[i]
                        ? (r[i].p(a, n), Se(r[i], 1))
                        : ((r[i] = He(a)), r[i].c(), Se(r[i], 1), r[i].m(e.parentNode, e));
                    }
            ...
            function Re(t) {
              ...
              return {
                c: function () {
                  ((e = Qt('footer')), o && o.c(), re(e, 'class', 'shepherd-footer'));
                },
                m: function (t, r) {
            ...
            var Fe = (function (t) {
              ...
              function n(t) {
                var o;
                return (m(this, n), Ie(u((o = e.call(this))), t, We, Re, Zt, { step: 0 }), o);
              }
              return g(n);
            })(Pe);
            function Ne(t) {
              ...
              return {
                c: function () {
                  ((e = Qt('button')),
                    ...
                    re(e, 'aria-label', (o = t[0].label ? t[0].label : 'Close Tour')),
                    re(e, 'class', 'shepherd-cancel-icon'),
                    re(e, 'type', 'button'));
                },
                m: function (o, s) {
                  (Gt(o, e, s), Kt(e, n), r || ((i = oe(e, 'click', t[1])), (r = !0)));
                },
                p: function (t, n) {
                  1 & p(n, 1)[0] &&
            ...
            var qe = (function (t) {
              ...
              function n(t) {
                ...
                return (
                  m(this, n),
                  Ie(u((o = e.call(this))), t, Ve, Ne, Zt, { cancelIcon: 0, step: 2 }),
                  o
                );
              }
              return g(n);
            ...
            function Ye(t) {
              ...
              return {
                c: function () {
                  (re((e = Qt('h3')), 'id', t[1]), re(e, 'class', 'shepherd-title'));
                },
                m: function (n, o) {
                  (Gt(n, e, o), t[3](e));
                },
            ...
            var Ue = (function (t) {
              ...
              function n(t) {
                ...
                return (
                  m(this, n),
                  Ie(u((o = e.call(this))), t, Xe, Ye, Zt, { labelId: 1, element: 0, title: 2 }),
                  o
                );
              }
              return g(n);
            ...
            function Ke(t) {
              ...
              return {
                ...
                m: function (t, s) {
                  (Gt(t, e, s), r && r.m(e, null), Kt(e, n), i && i.m(e, null), (o = !0));
                },
                p: function (t, o) {
                  var s = p(o, 1)[0];
                  (t[2]
            ...
            var Je = (function (t) {
              ...
              function n(t) {
                ...
                return (
                  m(this, n),
                  Ie(u((o = e.call(this))), t, Ge, Ke, Zt, { labelId: 0, step: 1 }),
                  o
                );
              }
              return g(n);
            ...
            function Qe(t) {
              ...
              return {
                c: function () {
                  (re((e = Qt('div')), 'class', 'shepherd-text'), re(e, 'id', t[1]));
                },
                m: function (n, o) {
                  (Gt(n, e, o), t[3](e));
                },
            ...
            function tn(t, e, n) {
              ...
              return (
                le(function () {
                  ...
                  (v(t) && (t = t.call(i)), h(t) ? r.appendChild(t) : n(0, (r.innerHTML = t), r));
                }),
                (t.$$set = function (t) {
            ...
            function ln(t) {
              ...
              return {
                c: function () {
                  (re((e = Qt('div')), 'class', 'shepherd-arrow'), re(e, 'data-popper-arrow', ''));
                },
                m: function (t, n) {
                  Gt(t, e, n);
                },
            ...
            function un(t) {
              var e,
                ...
                l =
                  ...
                  ln();
              o = new cn({ props: { descriptionId: t[2], labelId: t[3], step: t[4] } });
              for (
                var u = [
                    { 'aria-describedby': (r = w(t[4].options.text) ? null : t[2]) },
                  ...
                  (4 & c && (d.descriptionId = t[2]),
                    ...
                    ie(
                      ...
                      (f = (function (t, e) {
                        ...
                        (!s || (20 & c && r !== (r = w(t[4].options.text) ? null : t[2]))) && {
                          'aria-describedby': r,
                        },
                        (!s || (24 & c && i !== (i = t[4].options.title ? t[3] : null))) && {
                          'aria-labelledby': i,
                        },
                        2 & c && t[1],
                        { role: 'dialog' },
            ...
            function pn(t, e, n) {
              ...
              return (
                ...
                (t.$$.update = function () {
                  16 & t.$$.dirty &&
                    (n(5, (o = v.options && v.options.cancelIcon && v.options.cancelIcon.enabled)),
                      ...
                      polyfill: function () {
                        ...
                        function c(t) {
                          if (
                            ...
                            return !0;
                          if ('object' === x(t) && 'smooth' === t.behavior) return !1;
                          throw new TypeError(
                        ...
                        function d(e) {
                          ...
                          ((s = a = a > 1 ? 1 : a),
                            ...
                            (o === e.x && r === e.y) || t.requestAnimationFrame(d.bind(t, e)));
                        }
                        function h(n, o, s) {
                          var c,
                            l,
                          ...
                          (n === e.body
                            ? ((c = t),
                              ...
                              (f = r.scroll))
                            : ((c = n), (l = n.scrollLeft), (u = n.scrollTop), (f = a)),
                            d({
                              scrollable: c,
                              method: f,
                              startTime: p,
            ...
            var vn = (function (t) {
              ...
              function n(t, o) {
                ...
                return (
                  ...
                  (r.classPrefix = r.tour.options ? Ht(r.tour.options.classPrefix) : ''),
                  (r.styles = t.styles),
                ...
                g(n, [
                      ...
                      return (
                        (this._resolvedAttachTo = (function (t) {
                          var e = t.options.attachTo || {},
                            n = Object.assign({}, e);
                          if ((v(n.element) && (n.element = n.element.call(t)), y(n.element))) {
                            try {
                  ...
                  },
                  {
                    ...
                    value: function (t) {
                      ...
                      var n =
                        this.tour && this.tour.options && this.tour.options.defaultStepOptions;
                      ((n = f({}, n || {})), (this.options = Object.assign({ arrow: !0 }, n, t)));
                              ...
                              i = (function (t, e) {
                                return function (n) {
                                  if (e.isOpen()) {
                                    ...
                                    ((!w(t) && n.currentTarget.matches(t)) || o) && e.tour.next();
                                  }
                                };
                              })(o, t);
                            try {
                  ...
                  },
                  {
                    ...
                    value: function () {
                      ...
                      (n.classList.add(''.concat(this.classPrefix, 'shepherd-enabled')),
                        n.classList.add(''.concat(this.classPrefix, 'shepherd-target')),
            ...
            function yn(t) {
              ...
              return 'hidden' !== e && 'visible' !== e && t.scrollHeight >= t.clientHeight
                ? t
                : yn(t.parentElement);
            }
            function gn(t, e, n) {
              ...
              function u(t, e, o, i) {
                if ((void 0 === t && (t = 0), void 0 === e && (e = 0), i)) {
                  ...
                  n(
                    4,
                    (r = { width: p + 2 * t, height: l + 2 * t, x: (f || d) - t, y: a - t, r: e })
                  );
                } else c();
              }
              function f() {
                      ...
                      t.tour.options.useModalOverlay
                        ? ((function (t) {
                            var e = t.options,
                              ...
                              r = yn(t.target);
                            ((function e() {
                              ((a = void 0), u(n, o, r, t.target), (a = requestAnimationFrame(e)));
                            })(),
              ...
              wn = (function (t) {
                ...
                function n(t) {
                  ...
                  return (
                    ...
                    void 0 === t && (t = {}),
                    $(u((o = e.call(this, t)))),
                    (o.options = Object.assign({}, { exitOnEsc: !0, keyboardNavigation: !0 }, t)),
                    (o.classPrefix = Ht(o.options.classPrefix)),
                    (o.steps = []),
                    o.addSteps(o.options.steps),
                    ['active', 'cancel', 'complete', 'inactive', 'show', 'start'].map(function (t) {
                      var e;
                      ((e = t),
                        o.on(e, function (t) {
                          (((t = t || {}).tour = u(o)), xn.trigger(e, t));
                        }));
                    }),
                    o._setTourID(),
                    l(o, u(o))
                  ...
                  g(n, [
                    {
                      ...
                      value: function (t, e) {
                        var n = t;
                        return (
                          n instanceof vn ? (n.tour = this) : (n = new vn(this, n)),
                          w(e) ? this.steps.push(n) : this.steps.splice(e, 0, n),
                          n
                        );
                      },
                    },
                    ...
                    },
                    {
                      ...
                      value: function (t) {
                        ...
                        (this.steps.some(function (n, o) {
                          if (n.id === t)
                            return (n.isOpen() && n.hide(), n.destroy(), e.steps.splice(o, 1), !0);
                        }),
                          n &&
                            n.id === t &&
                    ...
                    },
                    {
                      ...
                      value: function (t) {
                        ...
                        h(this.focusedElBeforeOpen) && this.focusedElBeforeOpen.focus();
                      },
                    },
                    {
                      key: '_setupActiveTour',
                      value: function () {
                        (this.trigger('active', { tour: this }), (xn.activeTour = this));
                      },
                    },
                    {
                      key: '_setupModal',
            ...
            return (Object.assign(xn, { Tour: wn, Step: vn }), xn);
          }),
            'object' === x(e)
              ? (t.exports = i())
              : void 0 === (r = 'function' == typeof (o = i) ? o.call(e, n, e, t) : o) ||
                (t.exports = r));
        },
      },
      e = {};
