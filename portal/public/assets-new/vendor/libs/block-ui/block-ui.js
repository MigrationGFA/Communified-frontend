                ...
                (s =
                  ...
                  typeof (n = function (e) {
                    ...
                    function a(a, d) {
                      ...
                      if (
                        !(d = e.extend({}, e.blockUI.defaults, d || {})).ignoreIfBlocked ||
                        ...
                        ((m =
                          ...
                          (I = e(w)),
                          y && (d.theme ? (I.css(b), I.addClass('ui-widget-content')) : I.css(u)),
                        ...
                        var C =
                          i && (!e.support.boxModel || e('object,embed', h ? null : a).length > 0);
                        if (n || C) {
                          if (
                            (h &&
                              d.allowBodyStretch &&
                          ...
                          e.each(U, function (e, t) {
                            ...
                            if (((o.position = 'absolute'), e < 2))
                              ...
                              var n =
                                ...
                                (d.css && d.css.top ? parseInt(d.css.top, 10) : 0) +
                                ') + "px"';
                        ...
                        if (
                          (y &&
                            (d.theme ? I.find('.ui-widget-content').append(y) : I.append(y),
                          ...
                          h
                            ...
                            : (function (e, t, o) {
                                var n = e.parentNode,
                                  ...
                                  l =
                                    (n.offsetHeight - e.offsetHeight) / 2 - p(n, 'borderTopWidth');
                                (t && (i.left = s > 0 ? s + 'px' : '0'),
                                  o && (i.top = l > 0 ? l + 'px' : '0'));
                    ...
                    function u(t) {
                      ...
                      var a = t.data,
                        r = e(t.target);
                      return (
                        r.hasClass('blockOverlay') && a.onOverlayClick && a.onOverlayClick(t),
