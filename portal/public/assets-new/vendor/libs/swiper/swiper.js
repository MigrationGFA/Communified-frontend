!(function (e, t) {
  ...
  return (function () {
    ...
    var e = {
        d: function (t, s) {
          for (var a in s)
            e.o(s, a) && !e.o(t, a) && Object.defineProperty(t, a, { enumerable: !0, get: s[a] });
        },
        o: function (e, t) {
    ...
    const m = {
      ...
      on: function (...e) {
        ...
        function r(e) {
          ...
          if ((i.indexOf(e) < 0 && i.unshift(e), p(t).is(s))) a.apply(t, i);
          else {
            const e = p(t).parents();
      ...
      is: function (e) {
        ...
        if ('string' == typeof e) {
          ...
          for (i = p(e), n = 0; n < i.length; n += 1) if (i[n] === a) return !0;
          return !1;
        }
        if (e === s) return a === s;
        if (e === t) return a === t;
        if (e.nodeType || e instanceof o) {
          for (i = e.nodeType ? [e] : e, n = 0; n < i.length; n += 1) if (i[n] === a) return !0;
          return !1;
        }
        return !1;
      },
            ...
            void 0 !== i &&
              ...
              (b(t[a]) && b(r[a])
                ? r[a].__swiper__
                  ...
                  : x(t[a], r[a])
                : !b(t[a]) && b(r[a])
                  ? ((t[a] = {}), r[a].__swiper__ ? (t[a] = r[a]) : x(t[a], r[a]))
                  : (t[a] = r[a]));
          }
        }
      }
        ...
        updateClickedSlide: function (e) {
          ...
          ((t.clickedSlide = a),
            t.virtual && t.params.virtual.enabled
              ? (t.clickedIndex = parseInt(f(a).attr('data-swiper-slide-index'), 10))
              : (t.clickedIndex = i),
        ...
        if (l.cssMode) {
          ...
          if (0 === t) {
            ...
            if (!r.support.smoothScroll)
              return (E({ swiper: r, targetPosition: s, side: e ? 'left' : 'top' }), !0);
    ...
    function O(e) {
      const t = this,
        ...
        a = l(),
        i = t.touchEventsData,
        { params: n, touches: o, enabled: d } = t;
      if (!d) return;
      ...
      if (
        ...
        let e = !0;
        (p.is(i.focusableElements) && ((e = !1), 'SELECT' === p[0].nodeName && (i.isTouched = !1)),
          s.activeElement &&
            f(s.activeElement).is(i.focusableElements) &&
            s.activeElement !== p[0] &&
            s.activeElement.blur());
        const a = e && t.allowTouchMove && n.touchStartPreventDefault;
        (!n.touchStartForcePreventDefault && !a) || p[0].isContentEditable || c.preventDefault();
      }
      (t.params.freeMode &&
    ...
    function L(e) {
      ...
      const c =
          'touchmove' === d.type && d.targetTouches && (d.targetTouches[0] || d.changedTouches[0]),
        p = 'touchmove' === d.type ? c.pageX : d.pageX,
        u = 'touchmove' === d.type ? c.pageY : d.pageY;
      if (d.preventedByNestedSwiper) return ((n.startX = p), void (n.startY = u));
      if (!s.allowTouchMove)
        return (
          f(d.target).is(a.focusableElements) || (s.allowClick = !1),
          void (
            a.isTouched &&
      ...
      if (
        ...
        f(d.target).is(a.focusableElements)
      )
      ...
      if (
        ...
        g > 0 && a.currentTranslate > s.minTranslate()
          ? ((w = !1),
            i.resistance &&
              (a.currentTranslate =
                s.minTranslate() - 1 + (-s.minTranslate() + a.startTranslate + g) ** b))
          : g < 0 &&
            a.currentTranslate < s.maxTranslate() &&
            ((w = !1),
            i.resistance &&
              (a.currentTranslate =
                s.maxTranslate() + 1 - (s.maxTranslate() - a.startTranslate - g) ** b)),
    ...
    function I(e) {
      ...
      if (c > a.longSwipesMs) {
        ...
        ('next' === t.swipeDirection &&
          (w >= a.longSwipesRatio ? t.slideTo(a.rewind && t.isEnd ? m : u + b) : t.slideTo(u)),
        ...
        !t.navigation || (o.target !== t.navigation.nextEl && o.target !== t.navigation.prevEl)
          ? ('next' === t.swipeDirection && t.slideTo(null !== m ? m : u + b),
    ...
    const H = (e, t) => {
      const s = r(),
        { params: a, touchEvents: i, el: n, wrapperEl: l, device: o, support: d } = e,
        c = !!a.nested,
      ...
      if (d.touch) {
        ...
        (n[p](i.start, e.onTouchStart, t),
          n[p](i.move, e.onTouchMove, d.passiveListener ? { passive: !1, capture: c } : c),
          n[p](i.end, e.onTouchEnd, t),
          i.cancel && n[p](i.cancel, e.onTouchEnd, t));
      } else
        (n[p](i.start, e.onTouchStart, !1),
          s[p](i.move, e.onTouchMove, c),
          s[p](i.end, e.onTouchEnd, !1));
      ((a.preventClicks || a.preventClicksPropagation) && n[p]('click', e.onClick, !0),
    ...
    var X = {
      attachEvents: function () {
        ...
        ((e.onTouchStart = O.bind(e)),
          ...
          (e.onClick = A.bind(e)),
          a.touch && !N && (t.addEventListener('touchstart', B), (N = !0)),
          H(e, 'on'));
      },
          ...
          translateTo: function (e = 0, t = this.params.speed, s = !0, a = !0, i) {
            ...
            if (((c = a && e > o ? o : a && e < d ? d : e), r.updateProgress(c), n.cssMode)) {
              ...
              if (0 === t) l[e ? 'scrollLeft' : 'scrollTop'] = -c;
                ...
                if (!r.support.smoothScroll)
                  return (E({ swiper: r, targetPosition: -c, side: e ? 'left' : 'top' }), !0);
        ...
        loop: {
          loopCreate: function () {
            const e = this,
              ...
              i = a.children().length > 0 ? f(a.children()[0].parentNode) : a;
            ...
            for (let e = 0; e < o.length; e += 1)
              i.append(f(o[e].cloneNode(!0)).addClass(s.slideDuplicateClass));
            for (let e = l.length - 1; e >= 0; e -= 1)
              i.prepend(f(l[e].cloneNode(!0)).addClass(s.slideDuplicateClass));
          },
          loopFix: function () {
            const e = this;
    ...
    function ie({ swiper: e, duration: t, transformEl: s, allSlides: a }) {
    ...
    function re(e, t, s) {
      ...
      return (
        r.length ||
          ((r = f(`<div class="swiper-slide-shadow${s ? `-${s}` : ''}"></div>`)), i.append(r)),
        r
      );
    }
    const ne = [
      function ({ swiper: e, extendParams: t, on: s, emit: a }) {
        ...
        function r(t, s) {
          ...
          const i = a.renderSlide
            ? f(a.renderSlide.call(e, t, s))
            : f(`<div class="${e.params.slideClass}" data-swiper-slide-index="${s}">${t}</div>`);
          return (
        ...
        function n(t) {
          ...
          ((f = e.rtlTranslate ? 'right' : e.isHorizontal() ? 'left' : 'top'),
            n
              ? ((g = Math.floor(s / 2) + i + o), (v = Math.floor(s / 2) + i + l))
              : ((g = s + (i - 1) + o), (v = i + l)));
          ...
          if (
            ...
            return (
              e.slidesGrid !== u && x !== h && e.slides.css(f, `${x}px`),
              e.updateProgress(),
          ...
          for (let e = 0; e < p.length; e += 1)
            e >= w &&
              e <= b &&
              (void 0 === c || t ? C.push(e) : (e > c && C.push(e), e < d && E.push(e)));
          (C.forEach((t) => {
        ...
        (t({
          ...
          s('init update resize', () => {
            e.params.virtual.enabled &&
              e.params.cssMode &&
              y(e.wrapperEl, '--swiper-virtual-size', `${e.virtualSize}px`);
          }),
      ...
      function ({ swiper: e, extendParams: t, on: s, emit: a }) {
        ...
        function d() {
          e.keyboard.enabled || (f(i).on('keydown', o), (e.keyboard.enabled = !0));
        }
        function c() {
          e.keyboard.enabled && (f(i).off('keydown', o), (e.keyboard.enabled = !1));
        }
      ...
      function ({ swiper: e, extendParams: t, on: s, emit: a }) {
        ...
        function u(t) {
          return !(
            ...
            (e.params.mousewheel.thresholdTime && v() - o < e.params.mousewheel.thresholdTime) ||
            (!(t.delta >= 6 && v() - o < 60) &&
              (t.direction < 0
        ...
        function h(t) {
          ...
          if (
            ('container' !== e.params.mousewheel.eventsTarget &&
              (o = f(e.params.mousewheel.eventsTarget)),
            ...
            if (!i) {
              ...
              if (
                ...
                const s = d.length ? d[d.length - 1] : void 0,
                  a = d[0];
                if ((d.push(t), s && (t.delta > s.delta || t.direction !== s.direction)))
                  d.splice(0);
                else if (
                  d.length >= 15 &&
                  t.time - a.time < 500 &&
                ...
                r ||
                  (r = g(() => {
                    ((n = t), d.splice(0), e.slideToClosest(e.params.speed, !0, void 0, 0.5));
                  }, 500));
              }
              if (
                (i || a('scroll', s),
        ...
        function m(t) {
          let s = e.$el;
          ('container' !== e.params.mousewheel.eventsTarget &&
            (s = f(e.params.mousewheel.eventsTarget)),
            s[t]('mouseenter', c),
            s[t]('mouseleave', p),
            s[t]('wheel', h));
        }
      ...
      function ({ swiper: e, extendParams: t, on: s, emit: a }) {
        ...
        function d() {
          ...
          if (
            ((e.params.navigation = U(e, e.originalParams.navigation, e.params.navigation, {
      ...
      function ({ swiper: e, extendParams: t, on: s, emit: a }) {
        ...
        function E(t) {
          ...
          l.touch
            ? (d[u](a.start, b, c), d[u](a.move, x, c), d[u](a.end, y, p))
            : (d[u](r.start, b, c), i[u](r.move, x, c), i[u](r.end, y, p));
        }
        function C() {
          const { scrollbar: t, $el: s } = e;
          e.params.scrollbar = U(e, e.originalParams.scrollbar, e.params.scrollbar, {
            el: 'swiper-scrollbar',
          });
          ...
          (0 === r.length &&
            ((r = f(`<div class="${e.params.scrollbar.dragClass}"></div>`)), i.append(r)),
        ...
        (t({
          ...
          s('init', () => {
            !1 === e.params.scrollbar.enabled ? $() : (C(), m(), h());
          }),
        ...
        Object.assign(e.scrollbar, {
          enable: () => {
            (e.$el.removeClass(e.params.scrollbar.scrollbarDisabledClass),
              e.scrollbar.$el &&
                e.scrollbar.$el.removeClass(e.params.scrollbar.scrollbarDisabledClass),
              C(),
              m(),
              h());
          },
      ...
      function ({ swiper: e, extendParams: t, on: s, emit: a }) {
        ...
        function v(t) {
          ...
          if (((n = !1), (o = !1), !s.gestures)) {
            if ('touchstart' !== t.type || ('touchstart' === t.type && t.targetTouches.length < 2))
              return;
            ((n = !0), (p.scaleStart = g(t)));
          }
          (p.$slideEl && p.$slideEl.length) ||
          ((p.$slideEl = f(t.target).closest(`.${e.params.slideClass}`)),
        ...
        function b(t) {
          ...
          p.$imageEl && 0 !== p.$imageEl.length
            ? (s.gestures ? (i.scale = t.scale * d) : (i.scale = (p.scaleMove / p.scaleStart) * d),
              i.scale > p.maxRatio &&
        ...
        function y(t) {
          ...
          u.isMoved ||
            ...
            (u.startX = w(p.$imageWrapEl[0], 'x') || 0),
            (u.startY = w(p.$imageWrapEl[0], 'y') || 0),
        ...
        function C(t) {
          ...
          if (
            (p.$slideEl ||
              (t && t.target && (p.$slideEl = f(t.target).closest(`.${e.params.slideClass}`)),
              p.$slideEl ||
            ...
            return;
          let r, n, l, o, c, h, m, g, v, w, b, x, y, E, C, T, $, S;
          (e.params.cssMode &&
        ...
        (Object.defineProperty(e.zoom, 'scale', {
          ...
          Object.assign(e.zoom, { enable: O, disable: L, in: C, out: T, toggle: $ }));
      },
      function ({ swiper: e, extendParams: t, on: s, emit: a }) {
        (t({
          lazy: {
        ...
        function d() {
          const t = l();
          if (!e || e.destroyed) return;
          const s = e.params.lazy.scrollingElement ? f(e.params.lazy.scrollingElement) : f(t),
            a = s[0] === t,
          ...
          u ? (o(), s.off('scroll', d, m)) : i || ((i = !0), s.on('scroll', d, m));
        }
        (s('beforeInit', () => {
          ...
          s('destroy', () => {
            e.$el &&
              e.$el.find(`.${e.params.lazy.loadingClass}`).removeClass(e.params.lazy.loadingClass);
          }),
      ...
      function ({ swiper: e, extendParams: t, on: s }) {
        ...
        function u(t) {
          ...
          (e.navigation &&
            ...
            e.pagination && a.is(K(e.params.pagination.bulletClass)) && a[0].click());
        }
        function h() {
        ...
        const g = (e, t, s) => {
          ...
          x = () => {
            ...
            (t.itemRoleDescriptionMessage && o(f(e.slides), t.itemRoleDescriptionMessage),
              t.slideRole && l(f(e.slides), t.slideRole));
            ...
            e.params.a11y.enabled &&
              (() => {
                ...
                ((l = r),
                  ...
                  p && p.length && g(p, r, t.prevSlideMessage),
                  m() && e.pagination.$el.on('keydown', K(e.params.pagination.bulletClass), u),
                  e.$el.on('focus', b, !0),
            ...
            e.params.a11y.enabled &&
              (function () {
                ...
                (a && a.length > 0 && a.remove(),
                  ...
                  t && t.off('keydown', u),
                  s && s.off('keydown', u),
                  m() && e.pagination.$el.off('keydown', K(e.params.pagination.bulletClass), u),
                  e.$el.off('focus', b, !0),
        ...
        (a('init', () => {
          e.params.hashNavigation.enabled &&
            (() => {
              ...
              e.params.hashNavigation.watchState && f(o).on('hashchange', d);
            })();
        }),
          a('destroy', () => {
            e.params.hashNavigation.enabled &&
              e.params.hashNavigation.watchState &&
              f(o).off('hashchange', d);
          }),
      ...
      function ({ swiper: e, extendParams: t, on: s, emit: a }) {
        ...
        function u() {
          (e.params.autoplay.disableOnInteraction ? o() : (a('autoplayPause'), d()),
            ['transitionend', 'webkitTransitionEnd'].forEach((t) => {
              e.$wrapperEl[0].removeEventListener(t, p);
            }));
        }
        function h() {
          e.params.autoplay.disableOnInteraction ||
            ((e.autoplay.paused = !1), a('autoplayResume'), n());
        }
          ...
          se({
            ...
            setTranslate: () => {
              ...
              for (let a = 0; a < t.length; a += 1) {
                ...
                ae(s, t).css({ opacity: n }).transform(`translate3d(${i}px, ${r}px, 0px)`);
              }
            },
            setTransition: (t) => {
              const { transformEl: s } = e.params.fadeEffect;
              ((s ? e.slides.find(s) : e.slides).transition(t),
                ie({ swiper: e, duration: t, transformEl: s, allSlides: !0 }));
            },
            overwriteParams: () => ({
              slidesPerView: 1,
              slidesPerGroup: 1,
      ...
      function ({ swiper: e, extendParams: t, on: s }) {
        ...
        const a = (e, t, s) => {
          ...
          (0 === a.length &&
            ((a = f(`<div class="swiper-slide-shadow-${s ? 'left' : 'top'}"></div>`)), e.append(a)),
            0 === i.length &&
              ((i = f(`<div class="swiper-slide-shadow-${s ? 'right' : 'bottom'}"></div>`)),
              e.append(i)),
        ...
        se({
          ...
          setTranslate: () => {
            ...
            c.shadow &&
              (p
                ? ((h = s.find('.swiper-cube-shadow')),
                  0 === h.length &&
                    ((h = f('<div class="swiper-cube-shadow"></div>')), s.append(h)),
                  h.css({ height: `${r}px` }))
                : ((h = t.find('.swiper-cube-shadow')),
                  0 === h.length &&
                    ((h = f('<div class="swiper-cube-shadow"></div>')), t.append(h))));
            for (let e = 0; e < i.length; e += 1) {
              ...
              (d <= 1 && d > -1 && ((m = 90 * s + 90 * d), l && (m = 90 * -s - 90 * d)),
                t.transform(v),
            ...
            const g = d.isSafari || d.isWebView ? -o / 2 : 0;
            (s.transform(
              `translate3d(0px,0,${g}px) rotateX(${e.isHorizontal() ? 0 : m}deg) rotateY(${e.isHorizontal() ? -m : 0}deg)`
            ),
      ...
      function ({ swiper: e, extendParams: t, on: s }) {
        ...
        const a = (t, s, a) => {
          ...
          (0 === i.length && (i = re(a, t, e.isHorizontal() ? 'left' : 'top')),
            0 === r.length && (r = re(a, t, e.isHorizontal() ? 'right' : 'bottom')),
        ...
        se({
          ...
          setTranslate: () => {
            ...
            for (let r = 0; r < t.length; r += 1) {
              ...
              let d = -180 * l,
                ...
                u = 0;
              (e.isHorizontal() ? s && (d = -d) : ((u = p), (p = 0), (c = -d), (d = 0)),
          ...
          setTransition: (t) => {
            ...
            ((s ? e.slides.find(s) : e.slides)
              ...
              .transition(t),
              ie({ swiper: e, duration: t, transformEl: s }));
          },
          recreateShadows: () => {
        ...
        se({
          ...
          setTranslate: () => {
            ...
            for (let s = 0; s < t.length; s += 1) {
              ...
              let c = d;
              l ||
                (c = Math.min(Math.max(i[0].originalProgress, -r.limitProgress), r.limitProgress));
              ...
              if ((m && f.shadow) || !m) {
                ...
                if ((0 === e.length && f.shadow && (e = re(r, i)), e.length)) {
            ...
            setTranslate: () => {
              ...
              for (let l = 0; l < t.length; l += 1) {
                ...
                const w = e.virtual && e.params.virtual.enabled ? e.virtual.from + l : l,
                  b =
                    (w === s || w === s - 1) && c > 0 && c < 1 && (r || e.params.cssMode) && n < i,
                  x =
                    (w === s || w === s + 1) && c < 0 && c > -1 && (r || e.params.cssMode) && n > i;
                if (b || x) {
                ...
                ((o[0].style.zIndex = -Math.abs(Math.round(d)) + t.length), ae(a, o).transform(E));
              }
            },
            setTransition: (t) => {
