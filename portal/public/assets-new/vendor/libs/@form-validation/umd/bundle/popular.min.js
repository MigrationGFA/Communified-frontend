    ...
    var e = function (t, n) {
      ...
      t = (function (t) {
        ...
        return (
          ...
          (n.prototype.install = function () {
            if (
              this.core.getFormElement().querySelectorAll('[type="submit"][name="submit"]').length
            )
        ...
        return (
          ...
          (i.prototype.onFieldRemoved = function (e) {
            ...
            if (e.elements.length && e.field) {
              ...
              ('radio' === n || 'checkbox' === n ? [e.elements[0]] : e.elements).forEach(
                function (e) {
                  if (t.messages.has(e)) {
                    var n = t.messages.get(e);
          ...
          (i.prototype.onElementIgnored = function (e) {
            ...
            if (this.messages.has(i)) {
              ...
              [].slice
                .call(
                  r.querySelectorAll('[data-field="'.concat(e.field.replace(/"/g, '\\"'), '"]'))
                )
                .forEach(function (e) {
                  r.removeChild(e);
                });
        ...
        return (
          ...
          (o.prototype.prepareElementContainer = function (e, t) {
            ...
            a !== t &&
              (i(
                a,
                (((n = {})[this.opts.rowClasses] = !0), (n['fv-plugins-icon-container'] = !0), n)
              ),
