/*! For license information please see numeral.js.LICENSE.txt */
!(function (e, r) {
  ...
  return (function () {
          ...
          ((i = function () {
            ...
            return (
                ...
                if (e.isNumeral(n)) i = n.value();
                  ...
                  if (s.zeroFormat && n === s.zeroFormat) i = 0;
                    ...
                    for (t in l)
                      if (
                        (a =
                          'function' == typeof l[t].regexps.unformat
                            ? l[t].regexps.unformat()
                            : l[t].regexps.unformat) &&
                        n.match(a)
                      ) {
                        o = l[t].unformat;
                  ...
                  numberToFormat: function (r, n, i) {
                    ...
                    if (
                      ...
                      e._.includes(n, 'a') &&
                        ...
                        (l >= p && !t) || 't' === t
                          ? ((y += b.abbreviations.trillion), (r /= p))
                          : (l < p && l >= v && !t) || 'b' === t
                            ? ((y += b.abbreviations.billion), (r /= v))
                            : (l < v && l >= g && !t) || 'm' === t
                              ? ((y += b.abbreviations.million), (r /= g))
                              : ((l < g && l >= 1e3 && !t) || 'k' === t) &&
                                ((y += b.abbreviations.thousand), (r /= 1e3))),
                      e._.includes(n, '[.]') && ((h = !0), (n = n.replace('[.]', '.'))),
                      (a = r.toString().split('.')[0]),
                      (s = n.split('.')[1]),
                      (c = n.indexOf(',')),
                      (d = (n.split('.')[0].split(',')[0].match(/0/g) || []).length),
                      s
                        ? (e._.includes(s, '[')
                            ? ((s = (s = s.replace(']', '')).split('[')),
                              (_ = e._.toFixed(r, s[0].length + s[1].length, i, s[1].length)))
                            : (_ = e._.toFixed(r, s.length, i)),
                          (a = _.split('.')[0]),
                          (_ = e._.includes(_, '.') ? b.delimiters.decimal + _.split('.')[1] : ''),
                          h && 0 === Number(_.slice(1)) && (_ = ''))
                        : (a = e._.toFixed(r, 0, i)),
                      y && !t && Number(a) >= 1e3 && y !== b.abbreviations.trillion)
                    )
                      switch (((a = String(Number(a) / 1e3)), y)) {
                    ...
                    return (
                      c > -1 &&
                        (a = a
                          .toString()
                          .replace(/(\d)(?=(\d{3})+(?!\d))/g, '$1' + b.delimiters.thousands)),
                      0 === n.indexOf('.') && (a = ''),
                      (m = a + _ + (y || '')),
                      f
                        ? (m = (f && x ? '(' : '') + m + (f && x ? ')' : ''))
                  ...
                  stringToNumber: function (e) {
                    ...
                    if (s.zeroFormat && e === s.zeroFormat) n = 0;
                      ...
                      '.' !== t.delimiters.decimal &&
                        (e = e.replace(/\./g, '').replace(t.delimiters.decimal, '.')),
                      a))
                        if (
                          ((i = new RegExp(
                            '[^a-zA-Z]' +
              ...
              (e.fn = u.prototype =
                {
                  ...
                  divide: function (e) {
                    return (
                      (this._value = r.reduce([this._value, e], function (e, n, i, t) {
                        var l = r.correctionFactor(e, n);
                        ...
                        t =
                          l === a.after.length - 1
                            ...
                            : e._.insert(
                                t,
                                ' ',
                                -(a.after.length - (1 + l) + o.currency.symbol.length - 1)
                              );
                    }
                  return t;
                },
              ...
              e.register('format', 'exponential', {
                ...
                format: function (r, n, i) {
                  var t = ('number' != typeof r || e._.isNaN(r) ? '0e+0' : r.toExponential()).split(
                    'e'
                  );
                  return (
                    (n = n.replace(/e[\+|\-]{1}0/, '')),
    ...
    ((n.n = function (e) {
      ...
      (n.d = function (e, r) {
        for (var i in r)
          n.o(r, i) && !n.o(e, i) && Object.defineProperty(e, i, { enumerable: !0, get: r[i] });
      }),
      (n.o = function (e, r) {
