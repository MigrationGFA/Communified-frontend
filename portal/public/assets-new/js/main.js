  ...
  (function () {
    ...
    (window.templateCustomizer
      ? (a &&
        ...
        window.Helpers.isLightStyle()
          ? (a &&
              (a.querySelector('i').classList.add('ti-moon-stars'),
              new bootstrap.Tooltip(a, { title: 'Dark mode', fallbackPlacements: ['bottom'] })),
            s('light'))
          : (a &&
              (a.querySelector('i').classList.add('ti-sun'),
              new bootstrap.Tooltip(a, { title: 'Light mode', fallbackPlacements: ['bottom'] })),
            s('dark')))
