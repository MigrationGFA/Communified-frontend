...
(!(function () {
  ...
  $(function () {
    var e = $('#bs-datepicker-basic'),
      ...
      e =
        (e.length &&
          e.datepicker({ todayHighlight: !0, orientation: isRtl ? 'auto right' : 'auto left' }),
        t.length &&
          t.datepicker({
            todayHighlight: !0,
            format: 'dd/mm/yyyy',
        ...
        a.length &&
          a.datepicker({ todayHighlight: !0, orientation: isRtl ? 'auto right' : 'auto left' }),
        i.length &&
          i.datepicker({
            todayHighlight: !0,
    ...
    for (var s = 0; s < c.length; s++)
      (c[s].classList.remove('btn-default'), c[s].classList.add('btn-secondary'));
    ((o = $('#timepicker-basic')),
    ...
    (o.length && o.timepicker({ orientation: isRtl ? 'r' : 'l' }),
      ...
      i.length &&
        i.timepicker({ show: '24:00', timeFormat: 'H:i:s', orientation: isRtl ? 'r' : 'l' }));
  }),
  (function () {
