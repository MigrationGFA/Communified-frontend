...
(!(function () {
  ...
  (e &&
    e.map(function (l) {
      l.addEventListener('click', (e) => {
        (e.preventDefault(),
          ...
          Helpers._toggleClass(l.firstElementChild, 'ti-chevron-down', 'ti-chevron-right'));
      });
    }),
    l &&
      l.map(function (l) {
        l.addEventListener('click', (e) => {
          (e.preventDefault(),
            Helpers._toggleClass(l.firstElementChild, 'ti-arrows-maximize', 'ti-arrows-minimize'),
    ...
    null !== t && Sortable.create(t, { animation: 500, handle: '.card' }));
})(),
  $(function () {
    var e = $('.card-reload');
    e.length &&
