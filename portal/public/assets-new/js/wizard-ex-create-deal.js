  ...
  if (null !== e) {
    ...
    const s = FormValidation.formValidation(a, {
      fields: {
        ...
        dealRegion: { validators: { notEmpty: { message: 'Please select region' } } },
      },
      plugins: {
    ...
    e.length &&
      ...
      e
        .select2({ placeholder: 'Select an region', dropdownParent: e.parent() })
        .on('change.select2', function () {
          s.revalidateField('dealRegion');
        }));
    const d = FormValidation.formValidation(i, {
      fields: {
        dealTitle: { validators: { notEmpty: { message: 'Please enter deal title' } } },
        dealCode: {
          validators: {
    ...
    a.length &&
      ...
      a
        .select2({ placeholder: 'Select an offered item', dropdownParent: a.parent() })
        .on('change.select2', function () {}));
