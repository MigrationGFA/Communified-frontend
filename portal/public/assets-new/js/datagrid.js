...
var DataGridXL = (function () {
  ...
  function o(t) {
    for (var e, i = 0; i < t.length; i++)
      ((e = 1 + i),
        this._rows.store.push({ id: e, title: void 0, _hide: !1, _pass: !0 }),
  ...
  var l = function (t, e, i) {
      ...
      for (var o = !1, s = i, n = 0; n < t.length; n++) {
        ...
        null != e &&
          ('source' in t[n]
            ? t[n].source in e && ((r = t[n].source), (l = t[n].source))
            : ((r = e[n] || void 0), (l = e[n] || void 0)));
        var h = t[n].field || r,
          a = t[n].title || l,
          c = t[n]._hide || !1;
  ...
  function v(t) {
    'data' in t && e(t.data)
      ? y.call(this, t.data, t.columns || null)
      : 'columns' in t && e(t.columns)
        ? y.call(this, m(t.columns), t.columns)
        : y.call(this, this.constructor.createEmptyData(3, 3));
  }
  var m = function (t) {
    for (var e = [], i = 0; i < 3; i++) {
      e.push([]);
  ...
  function x() {
    ...
    for (var a = 0; a < this._cols.indexList.length; a++) {
      (this._cols.store[this._cols.indexList[a] - 1]._hide
        ? (n
            ? i[o].push(this._cols.indexList[a])
            : ((i[++o] = [this._cols.indexList[a]]), e > 0 && (s[e - 1][1] = o)),
          (n = !0))
        : (t.push(this._cols.indexList[a]),
  ...
  function w() {
    ...
    for (var a = 0; a < this._rows.indexList.length; a++) {
      ...
      (c._hide
        ? (n
            ? i[o].push(this._rows.indexList[a])
            : ((i[++o] = [this._rows.indexList[a]]), e > 0 && (s[e - 1][1] = o)),
          (n = !0))
        : c._pass &&
          (t.push(this._rows.indexList[a]),
  ...
  function C(t) {
    for (var e = [], i = 0; i < t.length; i++)
      'string' == typeof t[i]
        ? !(t[i] in this._presetParts) ||
          ('include' in this._presetParts[t[i]] && !this._presetParts[t[i]].include.call(this)) ||
          e.push(this._presetParts[t[i]])
        : e.push(t[i]);
    return e;
  }
  function b(t) {
  ...
  function L(t, e) {
    ...
    var i = {};
    if (null != t && Object.keys(t).length) for (var o in t) i[o] = t[o];
    if (null != e && Object.keys(e).length) for (var o in e) i[o] = e[o];
    return i;
  }
  function P(t, e, i) {
  ...
  function k(t, i) {
    ...
    var o = '';
    for (var s in t) {
      if (e(t[s])) for (var n = 0; n < t[s].length; n++) o += s + ': ' + t[s][n] + ';';
      else (i && (o += '\t'), (o += s + ': ' + t[s] + ';'));
      i && (o += '\n');
    }
    return o;
      ...
      if ('name' != o && 'tag' != o && 'domNodes' != o && 'children' != o)
        if ('text' == o) i.textContent = e.text;
          ...
          'noCSS' == o
            ? P(i, e.noCSS, !1)
            : 'styleText' == o
              ? (i.style.cssText = k(e.styleText))
              : o.startsWith('_')
                ? (i[o] = e[o])
                : ('string' == typeof e[o] || d(e[o])) && i.setAttribute(o, e[o]);
    return i;
  }
  function z() {
  ...
  var F = function (t, e) {
    ...
    if ('name' in t) {
      ...
      for (var s = 0; s < o.length; s++)
        ((i += 'dgxl-' + o[s].replace('.', '-')), s < o.length - 1 && (i += ' '));
      t.class = i;
    }
    var n = H(t.tag || 'div', t);
    if (
      ('domNodes' in t && t.domNodes.length && A(n, t.domNodes),
  ...
  function B() {
    return {
      ...
      children: [{ name: 'scrollbarMeterSurface', style: { width: '200px', height: '200px' } }],
    };
  }
  function O() {
    return {
  ...
  function D() {
    return {
      ...
      children: [{ tag: 'canvas', name: 'textWidthMeterCanvas' }],
    };
  }
  function V() {
    return {
  ...
  var X = function () {
    ...
    Y = {
      '.dgxl-component': function () {
        return { 'background-color': this.getThemeSetting('component') };
      },
      '.dgxl-bar': function () {
        return { 'column-gap': '6px', padding: '6px' };
      },
      ...
      'reset|.dgxl-inputWrapper.dgxl-hasFocus': function () {
        return { 'box-shadow': '', 'border-color': this.getThemeSetting('input|border') };
      },
      ...
      '.dgxl-part button': function () {
        ...
        return (
          'button' in this.theme ||
            ((t['background-image'] = 'linear-gradient(#f7f8fa ,#e7e9ec)'),
            (t['border-color'] = '#adb1b8 #a2a6ac #8d9096')),
          t
        );
      },
      '.dgxl-part button svg': function () {
        return { fill: this.getThemeSetting('button-icon') };
      },
      ...
      '.dgxl-contextMenuItem-highlight': function () {
        return { 'background-color': this.getThemeSetting('contextmenu-item:highlight') };
      },
  ...
  function W(t) {
    for (var e = t.parentNode.children, i = 0; i < e.length; i++) if (e[i] == t) return i;
    return -1;
  }
  function K(t, e) {
  ...
  function j(t, e, i) {
    if ((void 0 === e && (e = '#fff'), void 0 === i && (i = '#000'), 'rgb' == t.substring(0, 3)))
    ...
    return 0.2126 * h[0] + 0.7152 * h[1] + 0.0722 * h[2] > 0.179 ? i : e;
  }
  var U = function (t, e) {
    (void 0 === t && (t = null),
      (this._domNodes = {}),
      ...
      (this._context = null),
      (this._isOpen = !1),
      (this.dimensions = { width: 240, verticalPadding: 6, itemHeight: 30 }),
  ...
  ((U.prototype.isOpen = function () {
    ...
    (U.prototype.open = function (t, e, i, o, s, n) {
      ...
      var r =
        '--dgxl-contextmenu-shadowcolor: ' +
        j(this._context.getThemeSetting('sheet'), 'rgba(255,255,255,.35)', 'rgba(0,0,0,.35)') +
        ';--dgxl-contextmenu-verticalpadding: ' +
        this.dimensions.verticalPadding +
        'px;';
      ...
      for (
        var h = k(Y['.dgxl-contextMenuItemShortcutLabel'].call(this._context)),
          a = '<ul class="dgxl-contextMenuItemList" style="' + r + '">',
          c = 0;
        c < this.items.length;
        c++
      ) {
        var d = 'dgxl-contextMenuItem',
          u = '',
          p = !1;
        ('disabled' in this.items[c] && this.items[c].disabled.call(this._context)
          ? ((d += ' ' + d + '-disabled'), (u += 'opacity:0.25;'), (p = !0))
          : (u += 'cursor:pointer;'),
          (a += '<li class="' + d + '" style="' + (l + u) + '"'),
          (a += p ? ' data-disabled="true"' : ' data-disabled="false"'),
          (a += '>'));
        var f = R(this.items[c].label)
          ? this.items[c].label.call(this._context)
          : this.items[c].label;
        ((a +=
          '<div class="dgxl-contextMenuItemLabel">' + this._context.getLocaleSetting(f) + '</div>'),
          'shortcut' in this.items[c] &&
            (a +=
              '<div class="dgxl-contextMenuItemShortcutLabel" style="' +
              h +
              '">' +
              this.items[c].shortcut +
              '</div>'),
          (a += '</li>'));
      }
      ((a += '</ul>'),
        ...
        this.setCursor(-1),
        '_mouseDownListener' in this._domNodes.containerNode ||
          (this._domNodes.containerNode._mouseDownListener = function (t) {
        ...
        '_contextMenuListener' in this._domNodes.containerNode ||
          (this._domNodes.containerNode._contextMenuListener = function (t) {
            t.preventDefault();
          }),
        ...
        '_mouseMoveListener' in this._domNodes.containerNode ||
          (this._domNodes.containerNode._mouseMoveListener = function (t) {
            var e = K(t.target, 'dgxl-contextMenuItem');
            if (null == e || 1 == e.dataset.disabled) var i = -1;
            else i = W(e);
            this.setCursor(i);
          }.bind(this)),
        '_mouseLeaveListener' in this._domNodes.containerNode ||
          (this._domNodes.containerNode._mouseLeaveListener = function (t) {
            this.setCursor(-1);
          }.bind(this)),
        this._domNodes.containerNode.addEventListener(
          'mousemove',
          this._domNodes.containerNode._mouseMoveListener
        ),
        this._domNodes.containerNode.addEventListener(
          'mouseleave',
          this._domNodes.containerNode._mouseLeaveListener
        ));
    }),
    ...
    (U.prototype.execClose = function () {
      ((this._isOpen = !1),
        ...
        this._domNodes.containerNode.removeEventListener(
          'mousemove',
          this._domNodes.containerNode._mouseMoveListener
        ),
        this._domNodes.containerNode.removeEventListener(
    ...
    (U.prototype.setCursor = function (t) {
      if (t !== this._prevCursorIndex) {
        ...
        e.children.length &&
          (null !== this._prevCursorIndex &&
            this._prevCursorIndex > -1 &&
            (P(
              e.children[0].children[this._prevCursorIndex],
              Y['reset|.dgxl-contextMenuItem-highlight'].call(this._context)
            ),
            e.children[0].children[this._prevCursorIndex].classList.remove(
              'dgxl-contextMenuItem-highlight'
            )),
          (this._cursorIndex = t),
          null !== this._cursorIndex &&
            this._cursorIndex > -1 &&
            (P(
              e.children[0].children[this._cursorIndex],
              Y['.dgxl-contextMenuItem-highlight'].call(this._context)
            ),
            e.children[0].children[this._cursorIndex].classList.add(
              'dgxl-contextMenuItem-highlight'
            )),
    ...
    (U.prototype.moveCursorDown = function () {
      -1 == this._cursorIndex || null === this._cursorIndex || this._cursorIndex == Z.call(this)
        ? this.setCursor(q.call(this))
        : this.setCursor(G.call(this, this._cursorIndex));
    }),
    (U.prototype.moveCursorUp = function () {
      -1 == this._cursorIndex || null === this._cursorIndex || 0 == this._cursorIndex
        ? this.setCursor(Z.call(this))
        : this.setCursor($.call(this, this._cursorIndex));
    }),
    ...
    (U.prototype.redrawLabels = function () {
      if (this.isOpen())
        for (
          var t = this._domNodes.containerNode.getElementsByClassName(
              'dgxl-contextMenuItemList'
            )[0],
            e = 0;
          e < this.items.length;
          e++
        )
          R(this.items[e].label) &&
            (t.children[e].firstChild.innerHTML = this._context.getLocaleSetting(
              this.items[e].label.call(this._context)
            ));
    }),
    ...
    (U.prototype.hit = function (t) {
      -1 != t &&
        this.items[t] &&
        (('disabled' in this.items[t] && this.items[t].disabled.call(this._context)) ||
          ('method' in this.items[t] &&
            this._selectItemCallback.call(this._context, {
              contextMenu: this,
              index: t,
              item: this.items[t],
            })));
  ...
  var q = function () {
    ...
    G = function (t) {
      ...
      return 'disabled' in this.items[e] && this.items[e].disabled.call(this._context)
        ? G.call(this, e)
        : e;
    },
    Z = function () {
    ...
    Q = function (t, e, i) {
      ...
      if (((o.style.width = n + 'px'), t == window))
      ...
      (i + this._offsetY + s > r
        ? (o._top = i - (s + this._offsetY))
        : (o._top = i + this._offsetY),
        e + this._offsetX + n > l
          ? (o._left = e - (n + this._offsetX))
          : (o._left = e + this._offsetX),
  ...
  var tt = function () {
      (null === this._container
        ? (this._domNodes.container = null)
        : this._container instanceof HTMLElement
          ? (this._domNodes.container = this._container)
          : (this._domNodes.container = document.getElementById(this._container)),
        null === this._container
          ? T.call(this, O.call(this))
          : (this._domNodes.container.innerHTML = ''));
    },
    et = function () {
      Object.keys(this.constructor._domNodes).length ||
        (A(document.body, [
          T.call(this, E.call(this), this.constructor._domNodes),
          T.call(this, M.call(this), this.constructor._domNodes),
          T.call(this, B.call(this), this.constructor._domNodes),
        ]),
  ...
  function rt() {
    ...
    ((this._cd.containerWidth =
      this._domNodes.container.clientWidth -
      (parseFloat(e.paddingLeft) + parseFloat(e.paddingRight))),
      (this._cd.containerHeight =
        this._domNodes.container.clientHeight -
        (parseFloat(e.paddingTop) + parseFloat(e.paddingBottom))),
      0 == this._containerHeight && ((this._domNodes.container.style.height = '300px'), (t = !0)),
      ...
      'inline' == e.display &&
        ((this._domNodes.container.style.display = 'inline-block'), (t = !0)),
  ...
  function mt() {
    ...
    return { left: t, center: this._cd.viewportWidth - t };
  }
  function xt(t) {
  ...
  function wt() {
    ...
    return { top: t, center: this._cd.viewportHeight - t };
  }
  function Ct() {
    for (var t = this._cd.rowHeaderSpace, e = 0; e < this._sectionsPerPaneX.left.length; e++)
      t += bt.call(this, this._sectionsPerPaneX.left[e]);
    var i = t;
    (t > this._cd.rowHeaderSpace ||
      (this._freezeLineColAfterId &&
        this._sectionsPerPaneX.left.length &&
        !this._panesXids.left.length)) &&
      (i += 6);
    var o = { space: t, outer: i },
      s = this._cd.viewportWidth - o.outer,
      n = { space: s, outer: s };
    return ((o.offset = 0), (n.offset = o.outer), { left: o, center: n });
  }
  var bt = function (t) {
  ...
  function St() {
    ...
    var i = t;
    (t > this._cd.colHeaderSpace ||
      (this._freezeLineRowAfterId &&
        this._sectionsPerPaneY.top.length &&
        !this._panesYids.top.length)) &&
      (i += 6);
    var o = { space: t, outer: i },
      s = this._cd.viewportHeight - o.outer,
      n = { space: s, outer: s, inner: s, innerOffset: 0 };
    return ((o.offset = 0), (n.offset = o.outer), { top: o, center: n });
  }
  var It = function (t) {
  ...
  function Rt() {
    return { top: Lt.call(this, 'top'), center: Lt.call(this, 'center') };
  }
  var Lt = function (t) {
  ...
  function Pt() {
    return { left: Nt.call(this, 'left'), center: Nt.call(this, 'center') };
  }
  var Nt = function (t) {
  ...
  function zt() {
    for (
      var t, e, i = this._cd.innerDocumentWidth - this._cd.panesX.center.space, o = 0, s = 0;
      s < this._panesXids.center.length && ((t = s), (e = o), !(o >= i));
      s++
    )
      o += this.getColWidthById(this._panesXids.center[s]);
    var n = e + this._cd.panesX.center.space - this._cd.innerDocumentWidth;
    return { startIndex: this._panesXids.left.length + t, blankSpace: n };
  }
  function At() {
    for (
      var t, e, i = this._cd.innerDocumentHeight - this._cd.panesY.center.space, o = 0, s = 0;
      s < this._panesYids.center.length && ((t = s), (e = o), !(o >= i));
      s++
    )
      o += this.getRowHeightById(this._panesYids.center[s]);
    var n = e + this._cd.panesY.center.space - this._cd.innerDocumentHeight;
    return { startIndex: this._panesYids.top.length + t, blankSpace: n };
  }
  function Tt() {
  ...
  function Et() {
    return Math.max(
      this._cd.viewportWidth,
      this._cd.innerDocumentWidth + this._lastColView.blankSpace
    );
  }
  function Mt() {
  ...
  function Bt() {
    ...
    ((this._cd.topBarSpace = lt.call(this)),
      ...
      this._cd.virtualPanesX.center >= 200
        ? (this._sectionsPerPaneX = { left: [0], center: [1] })
        : (this._sectionsPerPaneX = { left: [], center: [0, 1] }),
      this._cd.virtualPanesY.center >= 120
        ? (this._sectionsPerPaneY = { top: [0], center: [1] })
        : (this._sectionsPerPaneY = { top: [], center: [0, 1] }),
  ...
  function Ot() {
    for (
      var t = this._viewportPosition.x - this._panesXids.left.length,
        e = [],
        i = 0,
        o = this._cd.panesX.center.space;
      i < o && !(t > this._panesXids.center.length - 1);
  ...
  function Dt() {
    for (
      var t = this._viewportPosition.y - this._panesYids.top.length,
        e = [],
        i = 0,
        o = this._cd.panesY.center.space;
      i < o && !(t > this._panesYids.center.length - 1);
  ...
  ((Yt.prototype.on = function (t, e) {
    return (
      'function' == typeof e &&
      'string' == typeof t &&
      (void 0 === this.events[t] && (this.events[t] = { listeners: [] }),
    ...
    (Yt.prototype.dispatch = function (t, e, i) {
      ...
      for (var n = 0; n < s.length; n++) if (!1 === s[n]) return !1;
      return !0;
    }));
  var Kt = function (t, e) {
      ((this._sharedSensorStyles = {
        ...
        (this._resizeSensorStyles = { overflow: 'hidden' }),
        (this._expandTriggerStyles = { width: '100000px', height: '100000px' }),
        (this._shrinkTriggerStyles = { width: '200%', height: '200%' }),
        (this._context = e),
        (this._domNodes = {}),
    ...
    jt = function () {
      ...
      var t = z(),
        e = H('div', { class: 'dgxl-expandSensor', style: this._sharedSensorStyles });
      e.appendChild(H('div', { class: 'dgxl-expandTrigger', style: this._expandTriggerStyles }));
      var i = H('div', { class: 'dgxl-shrinkSensor', style: this._sharedSensorStyles });
      (i.appendChild(H('div', { class: 'dgxl-shrinkTrigger', style: this._shrinkTriggerStyles })),
        t.appendChild(e),
        t.appendChild(i),
  ...
  var Gt = function () {
    for (var t, e = [], i = 0; i < this._validatedTopBar.length; i++)
      (((t = { type: this._validatedTopBar[i].name, wrapper: void 0, nodes: {} }).wrapper = T.call(
        this,
        {
  ...
  function te(t) {
    var e = t.cloneNode(!0);
    return (
      '_opacity' in t && (e._opacity = t._opacity),
  ...
  var re = function () {
      return [
        {
          name: 'rowLines',
          style: { position: 'absolute', top: 0, left: 0, width: this._cd.viewportWidth + 'px' },
          domNodes: le.call(this),
        },
        {
          name: 'colLines',
          style: { position: 'absolute', top: 0, left: 0, height: this._cd.viewportHeight + 'px' },
    ...
    he = function (t) {
      ...
      for (var s = 0; s < this._panesYids[t].length; s++) {
        ...
        (e.push(o), this._rowLines.push({ node: o, offset: i }));
      }
      return e;
    },
    ae = function () {
    ...
    ce = function (t) {
      ...
      for (var s = 0; s < this._panesXids[t].length; s++) {
        ...
        (e.push(o), this._colLines.push({ node: o, offset: i }));
      }
      return e;
    };
  function de() {
  ...
  function pe() {
    return { name: 'blankSheetContainer', children: [fe.call(this), ge.call(this)] };
  }
  var fe = function () {
      var t = 1;
  ...
  function _e() {
    return { name: 'cellRangeContainer', domNodes: [te(this._templates.cellRange)] };
  }
  function ye() {
    return {
      name: 'panes',
  ...
  var ve = function (t) {
    var e = [],
      i = 0;
    if (
      ('left' == t && (e.push(this._domNodes.rowHeaderColumn), (i += this._cd.rowHeaderSpace)),
      'center' == t)
    )
      var o = this._colView;
  ...
  var we = function () {
      ...
      return (
        this.allowFreezeCols || null != this._freezeLineColAfterId || (e = 'transparent'),
        {
          name: 'freezeLine-col',
          style: {
            position: 'absolute',
            ...
            left:
              (this._freezeLineColAfterId
                ? this._cd.panesX.left.space
                : this._cd.panesX.center.offset - 6) + 'px',
            bottom: 0,
            width: '6px',
            'background-color': this._freezeLineColAfterId
              ? this.getThemeSetting('freezeline')
              : 'transparent',
            opacity: this._cd.panesX.left.space ? t : 0.25,
          },
          children: [
            {
              style: {
    ...
    Ce = function () {
      ...
      var e = this.getThemeSetting('freezeline-tip');
      return (
        this.allowFreezeRows || null != this._freezeLineRowAfterId || (e = 'transparent'),
        {
          name: 'freezeLine-row',
          style: {
            position: 'absolute',
            top:
              (this._freezeLineRowAfterId
                ? this._cd.panesY.top.space
                : this._cd.panesY.center.offset - 6) + 'px',
            left: 0,
            right: 0,
            height: '6px',
            'background-color': this._freezeLineRowAfterId
              ? this.getThemeSetting('freezeline')
              : 'transparent',
            opacity: this._cd.panesY.top.space ? t : 0.25,
          },
          children: [
            {
              style: {
  ...
  var ke = function () {
    var t =
        '\n  <svg height="8" width="8" style="position:absolute;top:3px;right:4px;fill:' +
        this.getThemeSetting('header-icon') +
        ';">\n    <polygon points="2,4 8,0 8,8" class="triangle">\n  </svg>\n  ',
      e =
        '\n  <svg height="8" width="8" style="position:absolute;top:3px;left:4px;fill:' +
        this.getThemeSetting('header-icon') +
        ';">\n    <polygon points="6,4 0,0 0,8" class="triangle">\n  </svg>\n  ',
      i =
        '\n  <svg height="8" width="8" style="position:absolute;bottom:4px;left:3px;fill:' +
        this.getThemeSetting('header-icon') +
        ';">\n    <polygon points="4,2 0,8 8,8" class="triangle">\n  </svg>\n  ',
      o =
        '\n  <svg height="8" width="8" style="position:absolute;top:4px;left:3px;fill:' +
        this.getThemeSetting('header-icon') +
  ...
  function Me() {
    var t = {
      ...
      scrollSurface: { width: this._cd.scrollWidth + 'px', height: this._cd.scrollHeight + 'px' },
    };
    return {
      name: 'eventArea',
      style: t.eventArea,
      children: [
        {
          name: 'scrollArea',
          style: t.scrollArea,
          children: [{ name: 'scrollSurface', style: t.scrollSurface }],
        },
      ],
    };
  }
  ...
  function Oe() {
    ...
    return (
      this.constructor._isTouchDevice && (e.readonly = !0),
      {
        name: 'cellEditor',
        style: {
          position: 'absolute',
  ...
  var Xe = function () {
    for (var t, e = [], i = 0; i < this._validatedBottomBar.length; i++)
      (((t = { type: this._validatedBottomBar[i].name, wrapper: void 0, nodes: {} }).wrapper =
        T.call(
          this,
          {
  ...
  function qe(t) {
    for (
      var e, i, o = '', s = We(this._selection, { type: 'row' }), n = !1, r = 0;
      r < t.length;
      r++
    ) {
    ...
    si = function (t, e) {
      ...
      return (
            ...
            (s['text-align'] = 'right')),
        {
          ...
          children: [
            { name: 'column-top', style: o, text: ti.call(this, e) },
            { name: 'column-center', style: s, text: ei.call(this, e) },
          ],
        }
      );
    };
  ...
  function mi(t, e) {
    if (t in this._listeners && e in this._listeners[t]) {
      ...
      var o = e.split('_');
      1 == o.length
        ? i.addEventListener(e, this._listeners[t][e])
        : 'debounced' == o[1]
          ? i.addEventListener(o[0], this._listeners[t][e])
          : 'passive' == o[1] && i.addEventListener(o[0], this._listeners[t][e], { passive: !0 });
    }
  }
  function xi(t, e) {
    if (t in this._listeners && e in this._listeners[t]) {
  ...
  function wi(t) {
    var e = this;
    (void 0 === t && (t = !1),
      this.constructor._isIOS ||
        (this.activeSheetDisplay &&
          ((this._domNodes.cellEditor.style.top =
            this.getRowPositionInViewport(this._cellCursorPosition.y) + 'px'),
          (this._domNodes.cellEditor.style.left =
            this.getColPositionInViewport(this._cellCursorPosition.x) + 'px')),
        t
          ? Ci.call(this, this._domNodes.cellEditorInputField)
          : setTimeout(function () {
  ...
  function bi() {
    ('webkitCurrentFullScreenElement' in document
      ? Si.call(this, 'webkitCurrentFullScreenElement')
      : Si.call(this, 'fullscreenElement'),
  ...
  var Si = function (t) {
      ...
      (this.activate(),
        ...
        setTimeout(function () {
          (mi.call(t, 'window', 'resize'),
            t._domNodes.container._resizeSensor.events.off(
              'resize',
              t._listeners.container.resize
            ));
        }, 100),
        Li.call(this),
    ...
    Ri = function () {
      var t = this;
      ((this.constructor._isMacOS || this.constructor._isIOS) &&
        ((this._domNodes.component.style.height = this._cd.containerHeight + 'px'),
        ...
        this._isActive && (Pi.call(this), this.events.dispatch('fullscreenleave')));
    },
    Li = function () {
    ...
    Pi = function () {
      (this.constructor.contextMenu.isOpen() && this.constructor.contextMenu.close(),
        A(document.body, [
          this.constructor._domNodes.contextMenu,
  ...
  var zi = function (t) {
    var e = We(this._topBarNodes, { type: 'searchBar' }),
      i = We(this._bottomBarNodes, { type: 'searchBar' }),
      o = e.concat(i);
    o.length &&
      (t.preventDefault(),
      this.search(''),
  ...
  function Ti(t) {
    if (
      !(
        this._domNodes.container.contains(t.target) ||
        this.constructor._domNodes.contextMenu.contains(t.target) ||
        this.constructor._domNodes.contextMenuTouch.contains(t.target)
      )
    ) {
      for (var e = document.getElementsByClassName('dgxl-app'), i = 0; i < e.length; i++)
        if (e[i].contains(t.target)) return;
      Ai.call(this, { originalEvent: t });
    }
  }
  function Fi(t) {
    vi.call(this, 'window');
  ...
  function Vi(t) {
    return null == t ? null : { x: Xi.call(this, t), y: Yi.call(this, t) };
  }
  var Xi = function (t) {
      var e,
        i,
      ...
      for (e = 0; e < this._panesXids.left.length; e++)
        ((i = e),
          ...
          i >= t[0].x &&
            i <= t[1].x &&
            (a.push({ colIndex: i, visibleColIndex: r, visibleColOffset: l }), (h += o)),
          (l += o),
          r++);
      for (
        (this._panesXids.left.length ||
      ...
      var d = t[0].x < this._panesXids.left.length,
        u =
          t[0].x >= this._viewportPosition.x &&
          t[0].x <= this._viewportPosition.x + this._colView.length - 1;
      (d || u) && (s = !0);
      var p = t[1].x < this._panesXids.left.length,
        f =
          (t[1].x >= this._viewportPosition.x &&
            t[1].x < this._viewportPosition.x + this._colView.length - 1) ||
          (t[1].x == this._viewportPosition.x + this._colView.length - 1 &&
            this._colViewOverflow <= 0),
        g = t[1].x >= this._viewportPosition.x;
      return (
        (p || f) && (n = !0),
        d && g && (h += 6),
        h && (h += 1),
        { offset: c, size: h, lineLeft: s, lineRight: n }
      );
    },
    Yi = function (t) {
      var e,
      ...
      for (e = 0; e < this._panesYids.top.length; e++)
        ((i = e),
          ...
          i >= t[0].y &&
            i <= t[1].y &&
            (a.push({ rowIndex: i, visibleRowIndex: r, visibleRowOffset: l }), (h += o)),
          (l += o),
          r++);
      for (
        (this._panesYids.top.length ||
      ...
      var d = t[0].y < this._panesYids.top.length,
        u =
          t[0].y >= this._viewportPosition.y &&
          t[0].y <= this._viewportPosition.y + this._rowView.length - 1;
      (d || u) && (s = !0);
      var p = t[1].y < this._panesYids.top.length,
        f =
          (t[1].y >= this._viewportPosition.y &&
            t[1].y < this._viewportPosition.y + this._rowView.length - 1) ||
          (t[1].y == this._viewportPosition.y + this._rowView.length - 1 &&
            this._rowViewOverflow <= 0),
        g = t[1].y >= this._viewportPosition.y;
      return (
        (p || f) && (n = !0),
        d && g && (h += 6),
        h && (h += 1),
        { offset: c, size: h, lineTop: s, lineBottom: n }
      );
    };
  function Wi(t, e) {
    ...
    if (null != e) {
      ...
      ((o.y.lineTop && 0 != o.x.size) || (s = 'none'),
        ...
        '_actionProperties' in e &&
          'dragDirection' in e._actionProperties &&
          ('up' == e._actionProperties.dragDirection
            ? (n = 'none')
            : 'right' == e._actionProperties.dragDirection
              ? (r = 'none')
              : 'down' == e._actionProperties.dragDirection
                ? (s = 'none')
                : 'left' == e._actionProperties.dragDirection && (l = 'none')),
  ...
  function Ki(t, e, i) {
    ...
    (void 0 === i && (i = {}),
      'cut' == t
        ? ((this._cutRange = e), (this._copyRange = null))
        : 'copy' == t
          ? ((this._copyRange = e), (this._cutRange = null))
          : 'fill' == t &&
            ((this._fillRange = e),
  ...
  function ji(t, e) {
    ...
    if (
      ((t = { text: this.getCellRangeText(i), cellRange: i }),
      this.events.dispatch('beforecopy', t))
    ) {
      if (
        (null != this.constructor._clipboardObject &&
          Ki.call(this, this.constructor._clipboardObject.type, null),
  ...
  function Ui(t, e) {
    ...
    var i = this._selection[this._activeRangeIndex].range;
    if (
      ((t = { text: this.getCellRangeText(i), cellRange: i }), this.events.dispatch('beforecut', t))
    ) {
      if (
        (null != this.constructor._clipboardObject &&
          Ki.call(this, this.constructor._clipboardObject.type, null),
  ...
  function qi(t) {
    this._isActive &&
      (t.preventDefault(),
      'cut' == this._domNodes.cellEditor._actualCommand
        ? Ui.call(this, {}, t)
        : ('copy' == this._domNodes.cellEditor._actualCommand ||
            (null == this._domNodes.cellEditor._actualCommand && this.allowCopy)) &&
          ji.call(this, {}, t),
  ...
  function Gi(t) {
    return (
      void 0 === t && (t = ''),
      '' == t ? [[null]] : this.textParser.parse(t, { delimiter: '\t' }).data
    );
  }
  function Zi(t, e) {
    if ((void 0 === t && (t = {}), this.events.dispatch('beforepaste', t))) {
      ...
      (null != this.constructor._clipboardObject &&
        '\n' == t.text &&
        this.constructor._clipboardObject.isSingleEmptyCell &&
        (i = ''),
        (i.endsWith('\n') || i.endsWith('\r')) && (i = i.replace(/(\r\n|\n|\r)+$/g, '')));
      var o = Gi.call(this, i);
      if (
        null != this.constructor._clipboardObject &&
        this.constructor._clipboardObject.instance == this &&
        'cut' == this.constructor._clipboardObject.type &&
        i == this.constructor._clipboardObject.text
      )
        var s = !0;
      else s = !1;
  ...
  function $i(t) {
    this._isActive && (t.preventDefault(), this.allowPaste && Qi.call(this, t));
  }
  var Qi = function (t) {
    if (this.constructor._isIE) var e = window.clipboardData.getData('text');
    else e = t.clipboardData.getData('text');
    Zi.call(this, { text: e }, t);
  };
  function Ji(t) {
    this._isActive && (t.preventDefault(), this.allowCut && Ui.call(this, {}, t));
  }
  function to(t) {
    if (t in this.keyActionSets && t != this._activeKeyActionSet) {
      if (this._activeKeyActionSet)
        for (var e = 0; e < this.keyActionSets[this._activeKeyActionSet].length; e++) {
          ...
          this.keyActionSets[t].indexOf(i) > -1 ||
            this.keys.off(o.keys, o.action, o.repeat, o.target);
        }
      for (e = 0; e < this.keyActionSets[t].length; e++) {
        ((i = this.keyActionSets[t][e]), (o = this._presetKeyActions[i]));
        (null != this._activeKeyActionSet &&
          this.keyActionSets[this._activeKeyActionSet].indexOf(i) > -1) ||
          ('active' in o && !o.active.call(this)) ||
          this.keys.on(o.keys, o.action, o.repeat);
      }
      this._activeKeyActionSet = t;
    }
  }
  function eo(t) {
    'edit' != this._domNodes.cellEditor._mode &&
      ((this._domNodes.cellEditor._mode = 'edit'), to.call(this, 'inputModeEdit'));
  }
  function io() {
    var t = this.getColWidthById(this._cols.coordList[this._domNodes.cellEditor._coords.x]),
      e =
        Math.ceil(
          this._textWidthMeterCanvasContext.measureText(this._domNodes.cellEditorInputField.value)
            .width
        ) + 12;
  ...
  function oo(t) {
    if (
      this._isActive &&
      'contextMenuOpen' != this._activeKeyActionSet &&
      this.allowEditCells &&
      (t.target.selectionEnd != t.target.selectionStart + 1 || t.target != document.activeElement)
    ) {
      ...
      (this._domNodes.cellEditor._isOpen || this.openCellEditor('enter'),
        io.call(this),
        this.events.dispatch('celleditorinput', { value: t.target.value }));
    }
  }
  function so() {
  ...
  function no(t, e) {
    return (
      ...
      (null != t &&
        null != e &&
        (s(t) && s(e) ? t.x == e.x && t.y == e.y : !(!d(t) || !d(e)) && t == e))
    );
  }
  function ro() {
  ...
  function ho(t, e) {
    (void 0 === e && (e = { x: 0, y: 0 }), (t = co.call(this, t)), ao.call(this, t, e));
  }
  var ao = function (t, e) {
      no(this._viewportPosition, t) ||
        ((this._viewportPosition = t),
        (this._viewportOverflowPx = e),
        Ot.call(this),
        Dt.call(this),
        (this._isViewportConnectedTo = { top: ro.call(this), left: lo.call(this) }));
    },
    co = function (t) {
      return (
        t.x < this._panesXids.left.length && (t.x = this._panesXids.left.length),
  ...
  function uo(t) {
    (this._domNodes.display._hasScrolled || so.call(this),
      ...
      this._domNodes.display._setViewportPositionOnScroll &&
        (ho.call(this, {
          x: this._panesXids.left.length + Math.floor(this._scrollLeft / 40),
          y: this._panesYids.top.length + Math.floor(this._scrollTop / 40),
        }),
        this.redraw()),
      this._currentDragAction &&
        this._domNodes.display[this._currentDragAction + 'MoveFunc'].call(this),
  ...
  function _o(t, e) {
    ...
    return { x: Math.round(t - i.left), y: Math.round(e - i.top) };
  }
  function yo(t) {
    return t.y <= this._cd.scrollAreaHeight - this._cd.scrollbarSpace
      ? null
      : { name: 'horizontalScrollbar' };
  }
  function vo(t) {
    return t.x <= this._cd.scrollAreaWidth - this._cd.scrollbarSpace
      ? null
  ...
  function mo(t, e) {
    ...
    t <= this._cd.panesX.left.space
      ? ((i = this._cd.rowHeaderSpace), (o = 'left'), (s = this._panesXids.left))
      : ((i = this._cd.panesX.center.offset), (o = 'center'), (s = this._colView));
    for (var r = i, l = 0; r < t && !(l > s.length - 1); ) ((r += this.getColWidthById(s[l])), l++);
    ((n = l - 1), 'center' == o && (n += this._viewportPosition.x), e) &&
      (n < 0 && (n = 0),
      t - this.getColPositionInViewport(n) > this.getColWidthById(this.getColIdByCoord(n)) / 2 &&
        n++);
    return n;
  }
  function xo(t, e) {
    ...
    t <= this._cd.panesY.top.space
      ? ((i = this._cd.colHeaderSpace), (o = 'top'), (s = this._panesYids.top))
      : ((i = this._cd.panesY.center.offset), (o = 'center'), (s = this._rowView));
    for (var r = i, l = 0; r < t && !(l > s.length - 1); )
      ((r += this.getRowHeightById(s[l])), l++);
    ((n = l - 1), 'center' == o && (n += this._viewportPosition.y), e) &&
      (n < 0 && (n = 0),
      t - this.getRowPositionInViewport(n) > this.getRowHeightById(this.getRowIdByCoord(n)) / 2 &&
        n++);
    return n;
  }
  function wo(t) {
    return { x: mo.call(this, t.x), y: xo.call(this, t.y) };
  }
  function Co(t) {
    return t.x <= this._cd.rowHeaderSpace && t.y <= this._cd.colHeaderSpace
      ? { name: 'jointHeader', coords: wo.call(this, t) }
      : null;
  }
  function bo(t) {
  ...
  function Io(t, i) {
    return (
      ...
      null != i &&
      (s(t) && n(i)
        ? t.x >= i[0].x && t.x <= i[1].x && t.y >= i[0].y && t.y <= i[1].y
        : d(t) && e(i)
          ? t >= i[0] && t <= i[1]
          : void 0)
    );
  ...
  function Ro(t) {
    if (
      t.y > this._cd.colHeaderSpace ||
      (this._colViewOverflow < 0 && t.x > this._cd.viewportWidth - Math.abs(this._colViewOverflow))
    )
      return null;
    var e = wo.call(this, t),
      i = this.getColRangesFromCoord(e.x);
    return e.x >= this._cols.coordList.length
      ? null
      : i.length
        ? { name: 'selectedColHeader', coords: e, ranges: i }
        : null;
  }
  function Lo(t) {
    return t.y > this._cd.colHeaderSpace ? null : { name: 'colHeader', coords: wo.call(this, t) };
  }
  function Po(t) {
    if (t.y < 0 || t.y > this._cd.colHeaderSpace) return null;
    for (
      var e = wo.call(this, t), i = null, o = this._cd.rowHeaderSpace, s = 0;
      s < this._panesXids.left.length;
      s++
    )
      if (((o += this.getColWidthById(this._panesXids.left[s])), t.x <= o)) {
        t.x >= o - 4 &&
          ((e.x = s),
          (i = { name: 'colHeaderEdge', coords: e, objectPosition: { x: o - 4, y: 0 } }));
        break;
      }
    ...
    for (s = 0; s < this._colView.length; s++)
      if (((o += this.getColWidthById(this._colView[s])), t.x <= o)) {
        t.x >= o - 4 &&
          ((e.x = this._viewportPosition.x + s),
          (i = { name: 'colHeaderEdge', coords: e, objectPosition: { x: o - 4, y: 0 } }));
        break;
      }
    return i;
  ...
  function Ho(t) {
    if (
      !ko.call(this, 'freezeCols') ||
      (this._freezeLineColAfterId && !this._sectionsPerPaneX.left.length)
    )
      return null;
    ...
    return (
      (i.x = this._viewportPosition.x),
      { name: 'freezeLineCol', objectPosition: { x: e, y: 0 }, coords: i }
    );
  }
  function zo(t) {
    ...
    if (null !== this._cols.iconList[o.x][0] && t.x >= s && t.x <= s + 14) {
      var r = o.x - 1,
        ...
        h =
          r < 0
            ? null
            : { x: this.getColPositionInViewport(r) + this.getColWidthById(l) - 14 + 1, y: 0 };
      i = {
        ...
        objectPositionPrev: { x: s, y: 0 },
      };
    } else if (
      null !== this._cols.iconList[o.x][1] &&
      t.x >= s + this.getColWidthById(n) - 14 + 1 &&
      t.x <= s + this.getColWidthById(n)
    ) {
      var a = o.x + 1,
        c =
          (this.getColIdByCoord(a),
          a > this._cols.coordList.length - 1
            ? null
            : { x: this.getColPositionInViewport(a), y: 0 });
      i = {
        name: 'hiddenColGroupIcon',
        coords: o,
        type: 'next',
        groupIndex: this._cols.iconList[o.x][1],
        objectPositionNext: { x: s + this.getColWidthById(n) - 14 + 1, y: 0 },
    ...
    if (null !== this._rows.iconList[i.y][0] && t.y >= o && t.y <= o + 16) {
      var n = i.y - 1,
        ...
        l =
          n < 0
            ? null
            : { x: 0, y: this.getRowPositionInViewport(n) + this.getRowHeightById(r) - 16 + 1 };
      e = {
        ...
        objectPositionPrev: { x: 0, y: o },
      };
    } else if (
      null != this._rows.iconList[i.y][1] &&
      t.y >= o + this.getRowHeightById(s) - 16 + 1 &&
      t.y <= o + this.getRowHeightById(s)
    ) {
      var h = i.y + 1,
        a =
          (this.getRowIdByCoord(h),
          h > this._rows.coordList.length - 1
            ? null
            : { x: 0, y: this.getRowPositionInViewport(h) });
      e = {
        name: 'hiddenRowGroupIcon',
        coords: i,
        type: 'next',
        groupIndex: this._rows.iconList[i.y][1],
        objectPositionNext: { x: 0, y: o + this.getRowHeightById(s) - 16 + 1 },
  ...
  function To(t) {
    if (
      t.x > this._cd.rowHeaderSpace ||
      (this._rowViewOverflow < 0 && t.y > this._cd.viewportHeight - Math.abs(this._rowViewOverflow))
    )
      return null;
    var e = wo.call(this, t),
      i = this.getRowRangesFromCoord(e.y);
    return i.length ? { name: 'selectedRowHeader', coords: e, ranges: i } : null;
  }
  function Fo(t) {
    return t.x > this._cd.rowHeaderSpace ? null : { name: 'rowHeader', coords: wo.call(this, t) };
  }
  function Eo(t) {
    if (
      !ko.call(this, 'freezeRows') ||
      (this._freezeLineRowAfterId && !this._sectionsPerPaneY.top.length)
    )
      return null;
    ...
    var i = wo.call(this, t);
    return (
      (i.y = this._viewportPosition.y),
      { name: 'freezeLineRow', objectPosition: { x: 0, y: e }, coords: i }
    );
  }
  function Mo(t) {
    return t.x < this._cd.rowHeaderSpace || t.y < this._cd.colHeaderSpace
      ? null
      : { name: 'cell', coords: wo.call(this, t) };
  }
  function Bo(t) {
    ...
    return (
      t.x >= a &&
        ...
        t.y >= l &&
        t.y <= h &&
        (e = { name: 'fillHandle', coords: { x: i[1].x, y: i[1].y } }),
      e
    );
  }
  function Oo(t, e) {
    ...
    return (
      (i = yo.call(this, t))
        ...
        : (o = vo.call(this, t))
          ? (v = o)
          : this.allowFillCells && (_ = Bo.call(this, t))
            ? (v = _)
            : this.allowFreezeCols && (l = Ho.call(this, t))
              ? (v = l)
              : this.allowFreezeRows && (u = Eo.call(this, t))
                ? (v = u)
                : this.allowFreezeCols && (n = bo.call(this, t))
                  ? (v = n)
                  : this.allowFreezeRows && (r = So.call(this, t))
                    ? (v = r)
                    : (s = Co.call(this, t))
                      ? (v = s)
                      : (a = zo.call(this, t))
                        ? (v = a)
                        : 'touch' != e && this.allowResizeCols && (h = Po.call(this, t))
                          ? (v = h)
                          : this.allowMoveCols && (c = Ro.call(this, t))
                            ? (v = c)
                            : (d = Lo.call(this, t))
                              ? (v = d)
                              : (p = Ao.call(this, t))
                                ? (v = p)
                                : this.allowMoveRows && (f = To.call(this, t))
                                  ? (v = f)
                                  : (g = Fo.call(this, t))
                                    ? (v = g)
                                    : (y = Mo.call(this, t)) && (v = y),
      null != v &&
        ('coords' in v &&
          ((v.colSection = this.getColSectionFromCellCoords(v.coords)),
  ...
  var Zo = {
    start: function (t) {
      t.pointerOffset =
        t.pointerPositionPx.y -
        this.getRowPositionInViewport(t.ranges[t.ranges.length - 1].range[0].y);
    },
    move: function (t) {
      var e,
        i = this,
      ...
      (o < this._cd.colHeaderSpace && (o = this._cd.colHeaderSpace),
        ...
        (e = Io(t.pointerPosition.y, t.range)
          ? t.range[0]
          : t.pointerPosition.y < t.range[0]
            ? t.pointerPosition.y
            : t.pointerPosition.y + 1) < 0 && (e = 0),
        (t.endCoord = e || 0),
        requestAnimationFrame(function () {
  ...
  function Jo(t) {
    (P(this._domNodes.ghostForFreezeRows, { opacity: this._domNodes.ghostForFreezeRows._opacity }),
      Qo.call(this, t));
  }
  function ts() {
    ...
    ns =
      ((ss = function (t) {
        ((t.ghostPositionPx = t.pointerPositionPx.y - t.pointerOffset - 1),
          (t.endCoord = $o(
            xo.call(this, t.pointerPositionPx.y, !0),
            0,
            this._rows.coordList.length - 1
          )));
      }),
      {
        start: function (t) {
  ...
  function ls(t) {
    (P(this._domNodes.ghostForFreezeCols, { opacity: this._domNodes.ghostForFreezeCols._opacity }),
      rs.call(this, t));
  }
  function hs() {
  ...
  var us = (function () {
    var t = function (t) {
      ((t.ghostPositionPx = t.pointerPositionPx.x - t.pointerOffset - 1),
        (t.endCoord = $o(
          mo.call(this, t.pointerPositionPx.x, !0),
          0,
          this._cols.coordList.length - 1
        )));
    };
    return {
      start: function (t) {
  ...
  var vs = (function () {
    ...
    return {
      ...
      move: function (e) {
        ...
        ys(t.coords.x, this.getColSelection())
          ? this.resizeCols(this.getColSelection(), t.size)
          : this.resizeCols(t.coords.x, t.size);
      },
      prepare: function (e) {
        var i = this,
          o = e.pointerPositionPx.x;
  ...
  var Rs = function () {
    ...
    Ls = function (t) {
      return { top: t[0].y, right: t[1].x, bottom: t[1].y, left: t[0].x };
    };
  function Ps(t) {
    if (null == t) return null;
    if (e(t)) {
      ...
      var n = { x: null, y: null },
        r = { x: null, y: null };
      return (
        t[0].x < t[1].x ? ((n.x = t[0].x), (r.x = t[1].x)) : ((n.x = t[1].x), (r.x = t[0].x)),
        t[0].y < t[1].y ? ((n.y = t[0].y), (r.y = t[1].y)) : ((n.y = t[1].y), (r.y = t[0].y)),
        [n, r]
      );
    }
    return d(t) ? [t, t] : null;
  ...
  var Ns = {
    ...
    ks = function (t) {
      ...
      if ('xy' == this.fillCellsDirection) {
        if (0 == o && 0 == i)
          return { dragDirection: void 0, dragAmount: void 0, targetCellRange: null };
        if (i >= o) {
          var h = { x: e[0].x, y: r },
            a = { x: e[1].x, y: t.y };
          ((c = n), (d = i));
        } else {
          ((h = { x: l, y: e[0].y }), (a = { x: t.x, y: e[1].y }));
          ((c = s), (d = o));
        }
      } else if ('y' == this.fillCellsDirection) {
        if (0 == i) return { dragDirection: void 0, dragAmount: void 0 };
        ((h = { x: e[0].x, y: r }), (a = { x: e[1].x, y: t.y }));
        var c = n,
          d = i;
      } else if ('x' == this.fillCellsDirection) {
        if (0 == o) return { dragDirection: void 0, dragAmount: void 0 };
        ((h = { x: l, y: e[0].y }), (a = { x: t.x, y: e[1].y }), (c = s), (d = o));
      }
      return { dragDirection: c, dragAmount: d, targetCellRange: Ps([h, (a = Is.call(this, a))]) };
    },
    Hs = {
      resizeCols: { handler: vs, edgeDetection: !1 },
      freezeCols: { handler: us, edgeDetection: !1 },
      moveCols: {
        handler: {
          start: function (t) {
            t.pointerOffset =
              t.pointerPositionPx.x -
              this.getColPositionInViewport(t.ranges[t.ranges.length - 1].range[0].x);
          },
          move: function (t) {
            var e,
              i = this,
            ...
            (o < this._cd.rowHeaderSpace && (o = this._cd.rowHeaderSpace),
              ...
              (e = Io(t.pointerPosition.x, t.range)
                ? t.range[0]
                : t.pointerPosition.x < t.range[0]
                  ? t.pointerPosition.x
                  : t.pointerPosition.x + 1) < 0 && (e = 0),
              (t.endCoord = e || 0),
              requestAnimationFrame(function () {
      ...
      moveRows: { handler: Zo, edgeDetection: 'y' },
      freezeRows: { handler: ns, edgeDetection: !1 },
      fillCells: { handler: Ns, edgeDetection: 'xy' },
      selectCells: {
        handler: {
          start: function (t) {},
          move: function (t) {
  ...
  function Ms() {
    for (var t = ['next', 'prev'], e = 0; e < t.length; e++)
      P(this._domNodes['hintForShowCols' + No(t[e])], { opacity: 0 });
  }
  function Bs() {
    for (var t = ['next', 'prev'], e = 0; e < t.length; e++)
      P(this._domNodes['hintForShowRows' + No(t[e])], { opacity: 0 });
  }
  function Os() {
    var t = this;
    (requestAnimationFrame(function () {
  ...
  function Ds(t) {
    if ((void 0 === t && (t = null), null == t))
      return (
        (this._domNodes.eventArea.style.cursor = ''),
  ...
  function Ys(t) {
    ...
    (this._edgeOffsetX < -40 ? (e = -40) : this._edgeOffsetX > 40 && (e = 40),
      ...
      (this._domNodes.display._edgeDetectTimeout = setTimeout(
        this._domNodes.display._edgeDetectFunction,
        50
      )));
  }
  function Ws(t) {
    (void 0 === t && (t = 'xy'),
      ...
      (this._edgeOffsetY = 0),
      t &&
        ((this._domNodes.display._edgeDetectFunction = Ys.bind(this, t)),
        (this._domNodes.display._edgeDetectTimeout = setTimeout(
          this._domNodes.display._edgeDetectFunction,
          50
        ))));
  ...
  function Gs(t) {
    for (var e, i = ['next', 'prev'], o = 0; o < i.length; o++) {
      ...
      P(
        e,
        null == s ? { opacity: 0 } : { transform: 'translateX(' + s.x + 'px)', opacity: e._opacity }
      );
    }
  }
  function Zs(t) {
    for (var e, i = ['next', 'prev'], o = 0; o < i.length; o++) {
      ...
      P(
        e,
        null == s ? { opacity: 0 } : { transform: 'translateY(' + s.y + 'px)', opacity: e._opacity }
      );
    }
  }
  function $s(t) {
    ...
    (Ts.call(this),
      ...
      Bs.call(this),
      null == e
        ? Ks.call(this, 'default')
        : ('hiddenRowGroupIcon' == e.name
            ? Zs.call(this, e)
            : 'hiddenColGroupIcon' == e.name && Gs.call(this, e),
          'colHeaderEdge' == e.name
            ? js.call(this, e.objectPosition.x)
            : e.name.startsWith('freezeLineCol')
              ? Us.call(this, e.objectPosition.x)
              : e.name.startsWith('freezeLineRow') && qs.call(this, e.objectPosition.y),
          Ks.call(this, e.name)));
  }
  function Qs() {
    (null != this._domNodes.display._edgeDetectTimeout &&
      (clearTimeout(this._domNodes.display._edgeDetectTimeout),
  ...
  function nn(t, e, i) {
    t in Hs &&
      (('allow' + No(t) in this && !this['allow' + No(t)]) ||
        ((i.panesY = [i.paneY]),
        (i.panesX = [i.paneX]),
        zs.call(this),
        As.call(this),
        (this._domNodes.display[t + 'Properties'] = go(i)),
        (this._domNodes.display[t + 'Flags'] = { hasMoved: !1 }),
  ...
  var rn = function (t, e, i) {
      this._domNodes.display[t + 'MoveFunc'] = function (e) {
        ...
        if (
          (null != e && (i.e = e),
          o.hasMoved ||
            (Ws.call(this, Hs[t].edgeDetection),
        ...
        ('top' == i.paneY &&
          'center' == a &&
          !this._isViewportConnectedTo.top &&
          Hs[t].edgeDetection.includes('y') &&
          1 == i.panesY.length &&
          (u = this._panesYids.top.length),
          'left' == i.paneX &&
            'center' == h &&
            !this._isViewportConnectedTo.left &&
            Hs[t].edgeDetection.includes('x') &&
            1 == i.panesX.length &&
            (p = this._panesXids.left.length),
          i.panesY.indexOf('center') > -1 &&
            'top' == a &&
            !this._isViewportConnectedTo.top &&
            (l.y = this._viewportPosition.y),
          i.panesX.indexOf('center') > -1 &&
            'left' == h &&
            !this._isViewportConnectedTo.left &&
            (l.x = this._viewportPosition.x),
          (null === p && null === u) ||
            tn.call(this, {
          ...
          (i.newPaneX = h),
          (i.newPaneY = a),
          this._isViewportConnectedTo.top && 'top' == a
            ? (i.panesY = ['top'])
            : a != i.panesY[i.panesY.length - 1] && i.panesY.push(a),
          this._isViewportConnectedTo.left && 'left' == h
            ? (i.panesX = ['left'])
            : h != i.panesX[i.panesX.length - 1] && i.panesX.push(h),
          (i.newColSection = c),
          (i.newRowSection = d),
    ...
    ln = function (t, e, i) {
      this._domNodes.display[t + 'EndFunc'] = function (e) {
        (Js.call(this, t),
          ...
          this._domNodes.display[t + 'Flags'].hasMoved &&
            Hs[t].handler.end.call(this, this._domNodes.display[t + 'Properties']),
  ...
  function cn(t, e) {
    (3 == t.which && this.getRowRangesFromCoord(e.coords.y).length) ||
      ('mouse' == e.pointer
        ? (t.shiftKey
            ? this.setRowRangeExtreme(e.coords.y, !0)
            : t[this._commandKey]
              ? this.addRowRangeToSelection([e.coords.y, e.coords.y])
              : this.setRowSelection(e.coords.y, !0, !1),
          nn.call(this, 'selectRows', t, e))
        : 'touch' == e.pointer && this.setRowSelection(e.coords.y, !0, !1));
  }
  function dn(t, e) {
  ...
  function fn(t, e) {
    (3 == t.which && this.getColRangesFromCoord(e.coords.x).length) ||
      ('mouse' == e.pointer
        ? (t.shiftKey
            ? this.setColRangeExtreme(e.coords.x, !0)
            : t[this._commandKey]
              ? this.addColRangeToSelection([e.coords.x, e.coords.x])
              : this.setColSelection(e.coords.x, !0, !1),
          nn.call(this, 'selectCols', t, e))
        : 'touch' == e.pointer && this.setColSelection(e.coords.x, !0, !1));
  }
  function gn(t, e) {
    3 != t.which && nn.call(this, 'freezeCols', t, e);
  }
  ...
  function yn(t, e) {
    (3 == t.which && this.getAnyRangesFromCellCoords(e.coords).length) ||
      ('mouse' == e.pointer
        ? (t.shiftKey
            ? this.setCellRangeExtreme(e.coords, !0)
            : t[this._commandKey]
              ? this.addCellRangeToSelection([e.coords, e.coords])
              : this.setCellSelection(e.coords),
          nn.call(this, 'selectCells', t, e))
        : this.setCellSelection(e.coords));
  }
  function vn(t, e) {
    (3 == t.which && this.getAnyRangesFromCellCoords(e.coords).length) ||
      nn.call(this, 'fillCells', t, e);
  }
  function mn(t) {
    ...
    ((this._domNodes.display._initialMouseHitArea = go(i)),
      null != i &&
        ...
        'jointHeader' == i.name
          ...
          : 'fillHandle' == i.name
            ? vn.call(this, t, i)
            : 'freezeLinePlaceholderCol' == i.name
              ? gn.call(this, t, i)
              : 'freezeLinePlaceholderRow' == i.name
                ? _n.call(this, t, i)
                : 'freezeLineRow' == i.name
                  ? hn.call(this, t, i)
                  : 'hiddenRowGroupIcon' == i.name
                    ? Vo.call(this, t, i)
                    : 'selectedRowHeader' == i.name
                      ? an.call(this, t, i)
                      : 'rowHeader' == i.name
                        ? cn.call(this, t, i)
                        : 'freezeLineCol' == i.name
                          ? dn.call(this, t, i)
                          : 'hiddenColGroupIcon' == i.name
                            ? Do.call(this, t, i)
                            : 'colHeaderEdge' == i.name
                              ? un.call(this, t, i)
                              : 'selectedColHeader' == i.name
                                ? pn.call(this, t, i)
                                : 'colHeader' == i.name
                                  ? fn.call(this, t, i)
                                  : 'cell' == i.name && yn.call(this, t, i)));
  }
  function xn(t) {
    this._domNodes.display._touchStartFired
      ? (this._domNodes.display._touchStartFired = !1)
      : mn.call(this, t);
  }
  function wn(t) {
  ...
  function bn(t) {
    if (!(t.ctrlKey || t.metaKey || t.shiftKey)) {
      ...
      if (e) {
        ...
        null != i &&
          (this.allowResizeCols &&
          'colHeaderEdge' == i.name &&
          'colHeaderEdge' == e.name &&
          no(i.coords.x, e.coords.x)
            ? ys(i.coords.x, this.getColSelection())
              ? this.resizeColsToFit(this.getColSelection())
              : this.resizeColsToFit(i.coords.x)
            : this.allowEditCells &&
              'cell' == i.name &&
              'cell' == e.name &&
              no(i.coords, e.coords) &&
  ...
  function Sn(t) {
    for (var e = [], i = 0; i < t.length; i++)
      'string' == typeof t[i]
        ? !(t[i] in this._presetContextMenuItems) ||
          ('include' in this._presetContextMenuItems[t[i]] &&
            !this._presetContextMenuItems[t[i]].include.call(this)) ||
          e.push(this._presetContextMenuItems[t[i]])
        : e.push(t[i]);
    return e;
  }
  function In(t, e) {
    ...
    t.items.length) &&
      this.events.dispatch('beforeopencontextmenu', t) &&
      (this.constructor.contextMenu.open(
        this,
        t.items,
        t.snapPointX,
        t.snapPointY,
        this._handlers.contextMenu.selectItem,
        this._handlers.contextMenu.close
      ),
  ...
  function Rn(t) {
    3 == t.which &&
      ((this._pointerPositionPx = _o.call(this, t.clientX, t.clientY)),
      null == yo.call(this, this._pointerPositionPx) &&
  ...
  function kn() {
    ...
    1 == this._selection.length && Di.call(this, t)
      ? to.call(this, 'traverseSingleCell')
      : to.call(this, 'traverseMultiCell');
  }
  function Hn(t, e) {
    (void 0 === t && (t = {}),
  ...
  function An() {
    ((this._handlers = {
      contextMenu: { open: In.bind(this), selectItem: zn.bind(this), close: Hn.bind(this) },
    }),
      (this._listeners = {
        document: {
        ...
        window: { resize: Fi.bind(this) },
        container: { resize: Mi.bind(this) },
        lineHeightMeter: { resize: Ei.bind(this) },
        component: { contextmenu: Bi.bind(this) },
  ...
  function Tn() {
    ...
    for (var e in t) for (var i = 0; i < t[e].length; i++) mi.call(this, e, t[e][i]);
    (this._domNodes.container._resizeSensor.events.on('resize', this._listeners.container.resize),
      this._domNodes.lineHeightMeter._resizeSensor.events.on(
        'resize',
        this._listeners.lineHeightMeter.resize
      ));
  }
  function Fn() {
  ...
  var En = function (t) {
    ...
    for (
      ...
      (o.call(this, l), n.call(this, l), r.call(this, l));
  };
  function Mn() {
  ...
  var Bn = function (t, e) {
      ...
      ((i._context = i.getContext('2d', { alpha: !1 })),
  ...
  function Vn(t) {
    if ('' !== t) {
      ...
      if ('#' === t[0])
        return (
          t.length < 7 &&
            (t = '#' + t[1] + t[1] + t[2] + t[2] + t[3] + t[3] + (t.length > 4 ? t[4] + t[4] : '')),
          [
  ...
  function Xn() {
    var t = { top: this._panesYids.top, center: this._rowView };
    for (var e in this._domNodes.canvas) {
      ...
      for (var o = 0; o < i._drawHeight && !(o > t[i._panePositionY].length - 1); o++)
        (Yn.call(this, i, o, t[i._panePositionY][o], i._panePositionX),
          o == t[i._panePositionY].length - 1 &&
            Yn.call(this, i, o + 1, t[i._panePositionY][o], i._panePositionX));
    }
  }
  var Yn = function (t, e, i, o) {
    this.getRowCoordById(i);
    for (
      var s = { left: this._panesXids.left, center: this._colView }, n = 0, r = 0;
      r < s[o].length;
      r++
    ) {
  ...
  var Kn = function () {
    ...
    jn = function () {
      ...
      for (i = 0; i < this._domNodes['pane-left'].children.length; i++) {
        ...
        this._domNodes['pane-left'].children[i] == this._domNodes.rowHeaderColumn ||
          this._panesXids.left.indexOf(r) > -1 ||
          (this._domNodes['pane-left'].children[i].style.opacity = 0);
      }
    },
    Un = function () {
      ...
      for (i = 0; i < this._domNodes['pane-center'].children.length; i++) {
        ...
        this._colView.indexOf(r) > -1 ||
          (this._domNodes['pane-center'].children[i].style.opacity = 0);
      }
    };
  function qn() {
    ...
    for (; this._domNodes.cellRangeContainer.children.length > this._selection.length; )
      (this._domNodes.cellRangeContainer.removeChild(this._domNodes.cellRangeContainer.lastChild),
        this._domNodes.cellRangeForegroundContainer.removeChild(
          this._domNodes.cellRangeForegroundContainer.lastChild
        ));
  }
  var Gn = function (t, e, i, o, s) {
      e > this._domNodes.cellRangeContainer.children.length - 1 &&
        (this._domNodes.cellRangeContainer.appendChild(te(this._templates.cellRange)),
        this._domNodes.cellRangeForegroundContainer.appendChild(
          te(this._templates.cellRangeForeground)
        ));
    ...
    $n = function (t, e, i, o, s) {
      ...
      null == e || (i && o) || (s && String(this._currentDragAction).startsWith('select'))
        ? (n.style.opacity = 0)
        : (n.style.opacity = n._opacity);
  ...
  function Jn(t) {
    var e = !1,
      i = !1;
    return (
      ((t.y >= 0 && t.y < this._panesYids.top.length) ||
        (t.y >= this._viewportPosition.y &&
          t.y < this._viewportPosition.y + this._rowView.length)) &&
        (e = !0),
      ((t.x >= 0 && t.x < this._panesXids.left.length) ||
        (t.x >= this._viewportPosition.x &&
          t.x < this._viewportPosition.x + this._colView.length)) &&
        (i = !0),
      !(!e || !i)
    );
  }
  function tr() {
    ...
    if (this._selection.length && !this._domNodes.cellEditor._isOpen) {
      ...
      if (null != e) {
        ((t.style.opacity = t._opacity || ''),
          i.y.lineTop && 0 != i.x.size
            ? (t.style['border-top-style'] = o)
            : (t.style['border-top-style'] = 'none'),
          i.y.lineBottom && 0 != i.x.size
            ? (t.style['border-bottom-style'] = o)
            : (t.style['border-bottom-style'] = 'none'),
          i.x.lineLeft && 0 != i.y.size
            ? (t.style['border-left-style'] = o)
            : (t.style['border-left-style'] = 'none'),
          i.x.lineRight && 0 != i.y.size
            ? (t.style['border-right-style'] = o)
            : (t.style['border-right-style'] = 'none'));
        var s = 'translate(' + i.x.offset + 'px,' + i.y.offset + 'px)';
        ((t.style.transform = s),
          (t.style.width = i.x.size + 'px'),
          (t.style.height = i.y.size + 'px'),
          Jn.call(this, this._cellCursorPosition)
            ? (this._domNodes.cellCursor.style.opacity = this._domNodes.cellCursor._opacity)
            : (this._domNodes.cellCursor.style.opacity = 0));
      } else t.style.opacity = 0;
    } else t.style.opacity = 0;
  }
  function er() {
    ...
    if (this._searchCellsFound.length) {
      var e = this._searchCellsFound[this._searchCellIndex],
        i = Qn({ x: this.getColCoordById(e[1]), y: this.getRowCoordById(e[0]) }),
        o = Vi.call(this, i),
        s = t._borderStyle || 'solid';
      if (null != i) {
        ((t.style.opacity = t._opacity || ''),
          o.y.lineTop && 0 != o.x.size
            ? (t.style['border-top-style'] = s)
            : (t.style['border-top-style'] = 'none'),
          o.y.lineBottom && 0 != o.x.size
            ? (t.style['border-bottom-style'] = s)
            : (t.style['border-bottom-style'] = 'none'),
          o.x.lineLeft && 0 != o.y.size
            ? (t.style['border-left-style'] = s)
            : (t.style['border-left-style'] = 'none'),
          o.x.lineRight && 0 != o.y.size
            ? (t.style['border-right-style'] = s)
            : (t.style['border-right-style'] = 'none'));
        ...
        ((t.style.transform = n),
          ...
          Jn.call(this, i[0])
            ? (this._domNodes.searchCursor.style.opacity = this._domNodes.searchCursor._opacity)
            : (this._domNodes.searchCursor.style.opacity = 0));
      } else t.style.opacity = 0;
    } else t.style.opacity = 0;
  }
  function ir(t) {
    return [
      { x: t[0], y: 0 },
      { x: t[1], y: this._rows.coordList.length - 1 },
    ];
  }
  function or(t) {
    return [
      { x: 0, y: t[0] },
      { x: this._cols.coordList.length - 1, y: t[1] },
    ];
  }
  function sr() {
    for (
      var t = We(this._selection, { type: 'col' }),
        e = We(this._selection, { type: 'row' }),
        i = t.length,
        o = this._selection.length - t.length,
        s = e.length,
        n = this._selection.length - e.length,
        r = 0;
      r < t.length;
      r++
    )
    ...
    for (r = 0; r < this._selection.length; r++)
      'col' != this._selection[r].type && (lr.call(this, this._selection[r].range, l), l++);
    for (r = 0; r < e.length; r++) rr.call(this, e[r].range, r);
    for (l = 0, r = 0; r < this._selection.length; r++)
      'row' != this._selection[r].type && (nr.call(this, this._selection[r].range, l), l++);
    for (; this._domNodes.colHeaderRangeHighlightContainer.children.length > o; )
      this._domNodes.colHeaderRangeHighlightContainer.removeChild(
        this._domNodes.colHeaderRangeHighlightContainer.lastChild
      );
    for (; this._domNodes.colHeaderRangeSelectedContainer.children.length > i; )
      this._domNodes.colHeaderRangeSelectedContainer.removeChild(
        this._domNodes.colHeaderRangeSelectedContainer.lastChild
      );
    for (; this._domNodes.rowHeaderRangeHighlightContainer.children.length > n; )
      this._domNodes.rowHeaderRangeHighlightContainer.removeChild(
        this._domNodes.rowHeaderRangeHighlightContainer.lastChild
      );
    for (; this._domNodes.rowHeaderRangeSelectedContainer.children.length > s; )
      this._domNodes.rowHeaderRangeSelectedContainer.removeChild(
        this._domNodes.rowHeaderRangeSelectedContainer.lastChild
      );
  }
  var nr = function (t, e) {
      var i = Vi.call(this, t);
      e > this._domNodes.rowHeaderRangeHighlightContainer.children.length - 1 &&
        this._domNodes.rowHeaderRangeHighlightContainer.appendChild(
          te(this._templates.rowHeaderRangeHighlight)
        );
    ...
    rr = function (t, e) {
      var i = Vi.call(this, t);
      e > this._domNodes.rowHeaderRangeSelectedContainer.children.length - 1 &&
        this._domNodes.rowHeaderRangeSelectedContainer.appendChild(
          te(this._templates.rowHeaderRangeSelected)
        );
    ...
    lr = function (t, e) {
      var i = Vi.call(this, t);
      e > this._domNodes.colHeaderRangeHighlightContainer.children.length - 1 &&
        this._domNodes.colHeaderRangeHighlightContainer.appendChild(
          te(this._templates.colHeaderRangeHighlight)
        );
    ...
    hr = function (t, e) {
      var i = Vi.call(this, t);
      e > this._domNodes.colHeaderRangeSelectedContainer.children.length - 1 &&
        this._domNodes.colHeaderRangeSelectedContainer.appendChild(
          te(this._templates.colHeaderRangeSelected)
        );
  ...
  function ar(t, e, i) {
    for (var o = 0; o < t.length; o++) if (t[o][e] == i) return o;
    return -1;
  }
  function cr() {
  ...
  var dr = function () {
      for (var t = [], e = 0; e < this._panesYids.top.length; e++)
        null !== this._rows.iconList[e][1] &&
          t.push({
            groupIndex: this._rows.iconList[e][1],
            position:
              this.getRowPositionInViewport(e) +
              this.getRowHeightById(this._panesYids.top[e]) -
              16 +
              1,
          });
      for (e = 0; e < this._rowView.length; e++) {
        var i = this._viewportPosition.y + e;
        null !== this._rows.iconList[i][1] &&
          t.push({
            groupIndex: this._rows.iconList[i][1],
            position:
              this.getRowPositionInViewport(i) + this.getRowHeightById(this._rowView[e]) - 16 + 1,
          });
      }
      return t;
    },
    ...
    pr = function (t, e) {
      ...
      for (
        var i = this._rows[t + 'Nodes'],
          o = this._domNodes['hiddenRowGroupIcon' + No(t) + 'Container'],
          s = this._templates['hiddenRowGroupIcon' + No(t)],
          n = z(),
          r = [],
          l = 0;
        l < i.length;
  ...
  var gr = function () {
    ...
    _r = function () {
      for (var t = [], e = 0; e < this._panesXids.left.length; e++)
        null !== this._cols.iconList[e][1] &&
          t.push({
            groupIndex: this._cols.iconList[e][1],
            position:
              this.getColPositionInViewport(e) +
              this.getColWidthById(this._panesXids.left[e]) -
              14 +
              1,
          });
      for (e = 0; e < this._colView.length; e++) {
        var i = this._viewportPosition.x + e;
        null !== this._cols.iconList[i][1] &&
          t.push({
            groupIndex: this._cols.iconList[i][1],
            position:
              this.getColPositionInViewport(i) + this.getColWidthById(this._colView[e]) - 14 + 1,
          });
      }
      return t;
    },
    yr = function (t, e) {
      (void 0 === t && (t = 'next'), void 0 === e && (e = []));
      for (
        var i = this._cols[t + 'Nodes'],
          o = this._domNodes['hiddenColGroupIcon' + No(t) + 'Container'],
          s = this._templates['hiddenColGroupIcon' + No(t)],
          n = z(),
          r = [],
          l = 0;
        l < i.length;
  ...
  function vr() {
    ...
    if (this._selection.length && !this._domNodes.cellEditor._isOpen) {
      ...
      ((t.style.transform = 'translate(' + s + 'px, ' + n + 'px)'),
        !Jn.call(this, e) || String(this._currentDragAction).startsWith('select')
          ? (t.style.opacity = 0)
          : (t.style.opacity = this._domNodes.fillHandle._opacity));
    } else t.style.opacity = 0;
  }
  function mr() {
        ...
        for (var t, e = 0; e < this._prevSelection.selection.length; e++)
          for (var i = 0; i < this._prevSelection.selection[e].colIds.length; i++)
            ((t = this._prevSelection.selection[e].colIds[i]),
              (this._columnNodes[t - 1].columnHeaderLabel.style.color =
                this.getThemeSetting('header|text')));
    },
    br = function () {
      for (var t, e = We(this._selection, { type: 'col' }), i = 0; i < e.length; i++)
        for (var o = e[i].range[0].x; o <= e[i].range[1].x; o++)
          ((t = this.getColIdByCoord(o)),
            (this._columnNodes[t - 1].columnHeaderLabel.style.color =
              this.getThemeSetting('header:selected|text')));
    };
  function Sr() {
    ...
    for (e = 0; e < this._panesXids.left.length; e++)
      ((i += this.getColWidthById(this._panesXids.left[e])),
        (s = ar(this._colLines, 'position', i)) > -1
          ? (t.splice(t.indexOf(s), 1), (this._colLines[s].node.style.opacity = 1))
          : o.push(i));
    i = this._cd.panesX.center.offset;
    for (
      e = 0;
      e < this._colView.length &&
      !((i += this.getColWidthById(this._colView[e])) > this._cd.viewportWidth);
      e++
    ) {
      var s;
      (s = ar(this._colLines, 'position', i)) > -1
    ...
    for (e = 0; e < o.length; e++)
      if (t.length) {
        ...
        ((l.style.transform = 'translateX(' + o[e] + 'px)'),
          n.appendChild(l),
          this._colLines.push({ node: l, offset: o[e] }));
      }
  ...
  function Ir() {
    ...
    for (e = 0; e < this._panesYids.top.length; e++)
      ((i += this.getRowHeightById(this._panesYids.top[e])),
        (s = ar(this._rowLines, 'position', i)) > -1
          ? (t.splice(t.indexOf(s), 1), (this._rowLines[s].node.style.opacity = 1))
          : o.push(i));
    i = this._cd.panesY.center.offset;
    for (
      e = 0;
      e < this._rowView.length &&
      !((i += this.getRowHeightById(this._rowView[e])) > this._cd.viewportHeight);
      e++
    ) {
      var s;
      (s = ar(this._rowLines, 'position', i)) > -1
    ...
    for (e = 0; e < o.length; e++)
      if (t.length) {
        ...
        ((l.style.transform = 'translateY(' + o[e] + 'px)'),
          n.appendChild(l),
          this._rowLines.push({ node: l, offset: o[e] }));
      }
  ...
  function Pr() {
    ...
    (Nr.call(this),
      ...
      to.call(this, 'traverseSingleCell'),
      this.instantActivate ? (wi.call(this), this.activate()) : this.deactivate(),
      setTimeout(function () {
  ...
  var Nr = function () {
      ((this._domNodes.container._resizeSensor = new Kt(this._domNodes.container, this)),
        (this._domNodes.lineHeightMeter._resizeSensor = new Kt(
          this._domNodes.lineHeightMeter,
          this
        )));
    },
    kr = function () {
  ...
  var zr = function (t, e) {
    (void 0 === e && (e = document),
      ...
      (this._nonInputKeyCodes = [
        8, 9, 13, 16, 17, 18, 19, 20, 27, 33, 34, 35, 36, 37, 38, 39, 40, 44, 45, 46, 91, 92, 93,
  ...
  ((zr.prototype.on = function (t, e, i, o) {
    ...
    for (
      var s = !1, n = '', r = [], l = [], h = [], a = ((t = t.split('+')), []), c = 0;
      c < t.length;
      c++
    ) {
      var d = t[c].trim();
      (d in this._modifierKeys
        ? r.push(d)
        : d in this._actionKeys
          ? l.push(d)
          : d in this._characterKeys && h.push(d),
        a.push(d));
    }
    if (
      (Br({ modifierKeys: r, actionKeys: l, characterKeys: h }) && ((s = !0), (n = a.join('+'))), s)
    ) {
      if (void 0 === this.keys[n]) {
        ((this.keys[n] = { actions: [] }),
          this.keyActions.push({ actionKeys: l, characterKeys: h, modifierKeys: r, keyString: n }));
        for (c = 0; c < l.length; c++)
          (this._actionKeys[l[c]] in this.keysToPrevent ||
            (this.keysToPrevent[this._actionKeys[l[c]]] = []),
            this.keysToPrevent[this._actionKeys[l[c]]].push(n));
        for (c = 0; c < h.length; c++)
          (this._characterKeys[h[c]] in this.keysToPrevent ||
            (this.keysToPrevent[this._characterKeys[h[c]]] = []),
            this.keysToPrevent[this._characterKeys[h[c]]].push(n));
      }
      for (c = 0; c < this.keys[n].actions.length; c++)
        if (
          this.keys[n].actions[c].callback == e &&
          this.keys[n].actions[c].repeatable == i &&
          this.keys[n].actions[c].target == o
        )
          return;
      this.keys[n].actions.push({ callback: e, repeatable: i, target: o });
      var u = null;
      for (c = 0; c < a.length; c++)
        a[c] in this._modifierKeys
          ? -1 == this.trackedModifierKeys.indexOf(this._modifierKeys[a[c]]) &&
            this.trackedModifierKeys.push(this._modifierKeys[a[c]])
          : a[c] in this._actionKeys
            ? ((u = this._actionKeys[a[c]]),
              -1 == this.trackedActionKeys.indexOf(u) && this.trackedActionKeys.push(u))
            : a[c] in this._characterKeys &&
              ((u = this._characterKeys[a[c]]),
    ...
    (zr.prototype.off = function (t, e, i, o) {
      for (var s = [], n = [], r = [], l = ((t = t.split('+')), []), h = 0; h < t.length; h++) {
        var a = t[h].trim();
        (a in this._modifierKeys
          ? r.push(a)
          : a in this._actionKeys
            ? s.push(a)
            : a in this._characterKeys && n.push(a),
          l.push(a));
      }
      if (Br({ modifierKeys: r, actionKeys: s, characterKeys: n })) {
        var c = l.join('+');
        if (void 0 !== this.keys[c]) {
          var d = [];
          for (h = 0; h < this.keys[c].actions.length; h++)
            (this.keys[c].actions[h].callback == e &&
              this.keys[c].actions[h].repeatable == i &&
              this.keys[c].actions[h].target == o) ||
              d.push(this.keys[c].actions[h]);
              ...
              if (this.keyActions[h].keyString == c) {
                for (var u = 0; u < this.keyActions[h].actionKeys.length; u++) {
                  if (this._actionKeys[this.keyActions[h].actionKeys[u]] in this.keysToPrevent)
                    ((p =
                      this.keysToPrevent[
                        this._actionKeys[this.keyActions[h].actionKeys[u]]
                      ].indexOf(c)) > -1 &&
                      this.keysToPrevent[this._actionKeys[this.keyActions[h].actionKeys[u]]].splice(
                        p,
                        1
                      ),
                      this.keysToPrevent[this._actionKeys[this.keyActions[h].actionKeys[u]]]
                        .length ||
                        delete this.keysToPrevent[
                          this._actionKeys[this.keyActions[h].actionKeys[u]]
                        ]);
                }
                for (u = 0; u < this.keyActions[h].characterKeys.length; u++) {
                  var p;
                  if (
                    this._characterKeys[this.keyActions[h].characterKeys[u]] in this.keysToPrevent
                  )
                    ((p =
                      this.keysToPrevent[
                        this._characterKeys[this.keyActions[h].characterKeys[u]]
                      ].indexOf(c)) > -1 &&
                      this.keysToPrevent[
                        this._characterKeys[this.keyActions[h].characterKeys[u]]
                      ].splice(p, 1),
                      this.keysToPrevent[this._characterKeys[this.keyActions[h].characterKeys[u]]]
                        .length ||
                        delete this.keysToPrevent[
                          this._characterKeys[this.keyActions[h].characterKeys[u]]
                        ]);
  ...
  var Ar = function () {
      for (
        var t = {},
          e = [
            { startIndex: 65, series: 'abcdefghijklmnopqrstuvwxyz' },
            { startIndex: 48, series: '0123456789' },
          ],
          i = 0;
        i < e.length;
        i++
    ...
    Tr = function (t) {
      ...
      if (!(this._modifierKeyCodes.indexOf(e) > -1 && null === this.identifyKeyActionTimeout)) {
        this._scope != document ||
          Dr.call(this) ||
          !(e in this.keysToPrevent) ||
          e in this._lookupCharacterKeys ||
          t.preventDefault();
        for (var i = 0; i < this.trackedModifierKeys.length; i++) {
          var o = this.trackedModifierKeys[i];
          o in t && 1 == t[o]
            ? (this.pressedModifierKeys[o] = !0)
            : o in this.pressedModifierKeys && delete this.pressedModifierKeys[o];
        }
        (this.trackedActionKeys.indexOf(e) > -1 &&
          !this.pressedActionKeys[e] &&
          (this.pressedActionKeys[e] = !0),
          this.trackedCharacterKeys.indexOf(e) > -1 &&
            !this.pressedCharacterKeys[e] &&
            (this.pressedCharacterKeys[e] = !0),
    ...
    Fr = function (t) {
      ...
      (this.pressedActionKeys[e] && delete this.pressedActionKeys[e],
        ...
        this._metaKeyCodes.indexOf(e) > -1 &&
          ((this.pressedCharacterKeys = {}), (this.pressedActionKeys = {})),
        0 == Object.keys(this.pressedActionKeys).length &&
          0 == Object.keys(this.pressedCharacterKeys).length &&
          Er.call(this));
    },
    Er = function () {
      ...
      if ((void 0 === t && (t = null), document.hasFocus())) {
        for (var i = [], o = 0; o < this.keyActions.length; o++) {
          ...
          for (n = 0; n < this.keyActions[o].characterKeys.length; n++)
            this.pressedCharacterKeys[this._characterKeys[this.keyActions[o].characterKeys[n]]] &&
              s++;
          s > 0 &&
            s ==
              this.keyActions[o].actionKeys.length +
                this.keyActions[o].characterKeys.length +
                this.keyActions[o].modifierKeys.length &&
            i.push(this.keyActions[o]);
        }
        if (
          (i.length > 1 &&
            i.sort(function (t, e) {
              return (
                e.actionKeys.length +
                e.modifierKeys.length -
                (t.actionKeys.length + t.modifierKeys.length)
              );
            }),
          i.length
            ? (i[0] == this.prevKeyAction
                ? this.keyActionRepeatCounter++
                : (this.keyActionRepeatCounter = 0),
              this.keys[i[0].keyString].actions.forEach(function (i) {
                null != i.target || Dr.call(e)
                  ? i.target == t.target &&
                    document.activeElement == i.target &&
                    (0 == i.repeatable && (e.keyActionRepeatCounter = 0),
                    (1 != i.repeatable && 0 != e.keyActionRepeatCounter) ||
                      (i.callback.call(e._context, t), t.preventDefault()))
                  : (0 == i.repeatable && (e.keyActionRepeatCounter = 0),
                    (1 != i.repeatable && 0 != e.keyActionRepeatCounter) ||
                      i.callback.call(e._context, t));
              }),
              this._context.constructor._isMacOS &&
                i[0].modifierKeys.indexOf('ctrl') > -1 &&
                ((this.pressedCharacterKeys = {}), (this.pressedActionKeys = {})),
              (this.prevKeyAction = i[0]))
            : ((this.keyActionRepeatCounter = 0), (this.prevKeyAction = null)),
    ...
    Br = function (t) {
      var e = !0;
      return (
        ((t.modifierKeys.length && !t.actionKeys.length && !t.characterKeys.length) ||
          (!t.modifierKeys.length && !t.actionKeys.length && t.characterKeys.length) ||
          (t.actionKeys.length && t.characterKeys.length)) &&
          (e = !1),
        e
      );
    },
  ...
  ((Vr.prototype.add = function (t) {
    ...
    (Vr.prototype.undo = function () {
      ...
      return t && this._context.events.dispatch('beforeundo', { command: t })
        ? (Xr.call(this, t, 'undo'),
          (this.index -= 1),
          this._context.events.dispatch('undo', { command: t }),
          this.callback && this.callback(),
          this)
        : this;
    }),
    (Vr.prototype.redo = function () {
      ...
      return t && this._context.events.dispatch('beforeredo', { command: t })
        ? (Xr.call(this, t, 'redo'),
          (this.index += 1),
          this._context.events.dispatch('redo', { command: t }),
          this.callback && this.callback(),
          this)
        : this;
    }),
  ...
  var Xr = function (t, e) {
      return t && 'function' == typeof t[e]
        ? ((this.isExecuting = !0), t[e].call(this._context), (this.isExecuting = !1), this)
        : this;
    },
    Yr = function (t, e, i) {
      return (
        t.splice(e, !i || 1 + i - e + (!((i < 0) ^ (e >= 0)) && (i < 0 || -1) * t.length)),
        t.length
      );
    },
    Wr = (function () {
          ...
          parse: function (e, i) {
            ...
            if (
              ...
              return (
                ...
                (i.error = w(i.error)),
                delete i.worker,
                void l.postMessage({ input: e, config: i, workerId: l.id })
              );
            }
            var p = null;
            ...
            'string' == typeof e
              ? (p = i.download ? new h(i) : new c(i))
              : !0 === e.readable && w(e.read) && w(e.on)
                ? (p = new d(i))
                : ((t.File && e instanceof File) || e instanceof Object) && (p = new a(i));
            return p.stream(e);
          },
          unparse: function (t, e) {
            ...
            !(function () {
              ...
              'string' != typeof e.delimiter ||
                n.BAD_DELIMITERS.filter(function (t) {
              ...
              ('boolean' == typeof e.quotes ||
                ...
                (i = e.quotes);
              ('boolean' != typeof e.skipEmptyLines && 'string' != typeof e.skipEmptyLines) ||
                (a = e.skipEmptyLines);
              ...
              ('boolean' == typeof e.escapeFormulae || e.escapeFormulae instanceof RegExp) &&
                (d = e.escapeFormulae instanceof RegExp ? e.escapeFormulae : /^[=+\-@\t\r].*$/);
            })();
          ...
          return (
            this.each(function (e) {
              ...
              for (var s = 0; s < this.files.length; s++)
                o.push({ file: this.files[s], inputElem: this, instanceConfig: r.extend({}, i) });
            }),
            s(),
            this
          );
                ...
                if ('object' == typeof c) {
                  if ('abort' === c.action)
                    return (
                      ...
                      (s = a.inputElem),
                      (h = c.reason),
                      void (w(e.error) && e.error({ name: t }, i, s, h))
                    );
                  if ('skip' === c.action) return void l();
                  'object' == typeof c.config &&
                    (a.instanceConfig = r.extend(a.instanceConfig, c.config));
        ...
        ((this._handle = null),
          ...
          (this.parseChunk = function (e, o) {
            ...
            if (!this._handle.paused() && !this._handle.aborted()) {
              var h = l.meta.cursor;
              (this._finished ||
                ((this._partialLine = r.substring(h - this._baseIndex)), (this._baseIndex = h)),
                l && l.data && (this._rowCount += l.data.length));
              var a =
                this._finished || (this._config.preview && this._rowCount >= this._config.preview);
              if (i) t.postMessage({ results: l, workerId: n.WORKER_ID, finished: a });
          ...
          (this._sendError = function (e) {
            w(this._config.error)
              ...
              : i &&
                this._config.error &&
                t.postMessage({ workerId: n.WORKER_ID, error: e, finished: !1 });
          }));
      }
      function h(t) {
        var i;
          ...
          (this._readChunk = function () {
            if (this._finished) this._chunkLoaded();
              ...
              if (
                ...
                e ||
                  ((i.onload = x(this._chunkLoaded, this)),
      ...
      function a(t) {
        ...
        ((this.stream = function (t) {
          ((this._input = t),
            ...
            o
              ? (((e = new FileReader()).onload = x(this._chunkLoaded, this)),
                (e.onerror = x(this._chunkError, this)))
          ...
          (this._readChunk = function () {
            ...
            o || this._chunkLoaded({ target: { result: n } });
          }),
        ...
        ((t = t || {}),
          ...
          (this._nextChunk = function () {
            if (!this._finished) {
              ...
              return (
                i ? ((t = e.substring(0, i)), (e = e.substring(i))) : ((t = e), (e = '')),
                (this._finished = !e),
                this.parseChunk(t)
              );
            }
      ...
      function u(t) {
        ...
        ((this._onCsvData = function (t) {
          ...
          (this._addToParseQueue = function (t, e) {
            (n.push(
              x(function () {
                if ((this.parseChunk('string' == typeof t ? t : t.toString(i.encoding)), w(e)))
                  return e();
              }, this)
            ),
              o && ((o = !1), this._nextChunk()));
          }),
      ...
      function p(t) {
        ...
        if (w(t.step)) {
          ...
          t.step = function (e) {
            if (((y = e), b())) C();
              ...
              ((c += e.data.length),
                t.preview && c > t.preview ? i.abort() : ((y.data = y.data[0]), v(y, a)));
            }
          };
        }
        function x(e) {
          ...
          return (
            ...
            (function () {
              ...
              function e(e, i) {
                ...
                for (o = 0; o < e.length; o++) {
                  ...
                  (t.header && (n = o >= _.length ? '__parsed_extra' : _[o]),
                    ...
                    (r = S(n, r)),
                    '__parsed_extra' === n ? ((s[n] = s[n] || []), s[n].push(r)) : (s[n] = r));
                }
                return (
                  t.header &&
                    (o > _.length
                      ? I(
                          'FieldMismatch',
                          'TooManyFields',
                          'Too many fields: expected ' + _.length + ' fields but parsed ' + o,
                          d + i
                        )
                      : o < _.length &&
                        I(
                          'FieldMismatch',
                          'TooFewFields',
                          'Too few fields: expected ' + _.length + ' fields but parsed ' + o,
                          d + i
                        )),
                  s
                );
              ...
              !y.data.length || Array.isArray(y.data[0])
                ? ((y.data = y.data.map(e)), (i = y.data.length))
                : (y.data = e(y.data, 0));
        ...
        ((this.parse = function (s, r, l) {
          ...
          if (
            ...
            w(t.delimiter) && ((t.delimiter = t.delimiter(s)), (y.meta.delimiter = t.delimiter));
          else {
            var a = (function (e, i, o, s, r) {
              ...
              for (var d = 0; d < r.length; d++) {
                ...
                a = void 0;
                for (
                  var y = new g({ comments: s, delimiter: u, newline: i, preview: 10 }).parse(e),
                    v = 0;
                  v < y.data.length;
                  v++
                )
              ...
              return ((t.delimiter = l), { successful: !!l, bestDelimiter: l });
            })(s, t.newline, t.skipEmptyLines, t.comments, t.delimitersToGuess);
            (a.successful
              ? (t.delimiter = a.bestDelimiter)
              : ((o = !0), (t.delimiter = n.DefaultDelimiter)),
              (y.meta.delimiter = t.delimiter));
          }
          var c = m(t);
          return (
            t.preview && t.header && c.preview++,
            (e = s),
            (i = new g(c)),
            (y = i.parse(e, r, l)),
            C(),
            u ? { meta: { paused: !0 } } : y || { meta: { paused: !1 } }
          );
        }),
      ...
      function g(t) {
        ...
        if (
          (void 0 !== t.escapeChar && (a = t.escapeChar),
        ...
        (!0 === s
          ? (s = '#')
          : ('string' != typeof s || n.BAD_DELIMITERS.indexOf(s) > -1) && (s = !1),
          '\n' !== o && '\r' !== o && '\r\n' !== o && (o = '\n'));
        var c = 0,
          d = !1;
        ((this.parse = function (t, n, u) {
          ...
          for (
            ...
            if (t[c] !== e)
              if (s && 0 === C.length && t.substring(c, c + y) === s) {
                ...
                (C.push(t.substring(c, R)), (c = R + g), (R = t.indexOf(i, c)));
              else {
                if (-1 === L) break;
          ...
          function T(e) {
            return (
              u || (void 0 === e && (e = t.substring(c)), C.push(e), (c = p), z(C), v && M()),
              E()
            );
          }
          function F(e) {
      ...
      function _(t) {
        ...
        if (e.error) i.userError(e.error, e.file);
          ...
          var n = {
            abort: function () {
              ((s = !0), y(e.workerId, { data: [], errors: [], meta: { aborted: !0 } }));
            },
            pause: v,
            resume: v,
          };
          if (w(i.userStep)) {
            for (
              var r = 0;
              r < e.results.data.length &&
              (i.userStep(
                { data: e.results.data[r], errors: e.results.errors, meta: e.results.meta },
                n
              ),
              !s);
              r++
        ...
        i &&
          (t.onmessage = function (e) {
            ...
            if ('string' == typeof i.input)
              ...
              o && t.postMessage({ workerId: n.WORKER_ID, results: o, finished: !0 });
            }
          }),
    ...
    Kr = {
      inputBar: {
        ...
        node: function () {
          ...
          return (
            this.allowEditCells || (t.disabled = 'disabled'),
            {
              name: 'inputWrapper',
              style: Y['.dgxl-inputWrapper'].call(this),
              children: [
                { name: 'inputInfo', style: Y['.dgxl-inputInfo'].call(this), text: '' },
                t,
              ],
            }
          );
      ...
      searchBar: {
        ...
        node: function () {
          var t =
              '<svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 0 24 24" width="24px" style="' +
              k(Y['.dgxl-part button svg'].call(this)) +
          ...
          return {
            style: { display: 'flex', 'flex-grow': 1, 'grid-gap': '2px' },
            children: [
              {
                name: 'inputWrapper',
                style: Y['.dgxl-inputWrapper'].call(this),
        ...
        update: function (t) {
          ...
          var e =
            '$n=' + (this._searchCellIndex + 1) + ' from $total=' + this._searchCellsFound.length;
          this._searchCellsFound.length
            ? ((t.inputInfo.textContent = this.getLocaleSetting(e)),
              t.searchCellButtonNext.removeAttribute('disabled'),
              t.searchCellButtonPrev.removeAttribute('disabled'))
            : (this._searchStr
                ? (t.inputInfo.textContent = this.getLocaleSetting(e))
                : (t.inputInfo.textContent = ''),
      ...
      fullscreenButton: {
        ...
        node: function () {
          var t =
              '<svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 0 24 24" width="24px" style="' +
              k(Y['.dgxl-part button svg'].call(this)) +
              '"><path d="M0 0h24v24H0V0z" fill="none"/><path d="M7 14H5v5h5v-2H7v-3zm-2-4h2V7h3V5H5v5zm12 7h-3v2h5v-5h-2v3zM14 5v2h3v3h2V5h-5z"/></svg>',
            e =
              '<svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 0 24 24" width="24px" style="' +
              k(Y['.dgxl-part button svg'].call(this)) +
              '"><path d="M0 0h24v24H0V0z" fill="none"/><path d="M5 16h3v3h2v-5H5v2zm3-8H5v2h5V5H8v3zm6 11h2v-3h3v-2h-5v5zm2-11V5h-2v5h5V8h-3z"/></svg>';
          return {
            tag: 'button',
            name: 'fullscreenButton',
            style: Y['.dgxl-part button'].call(this),
    ...
    jr = {
      tab_navigateNext: {
        keys: 'tab',
        action: function () {
          this.moveCellCursorInsideSelection({ x: 1, y: 0 });
        },
        repeat: !0,
      },
      shiftTab_navigatePrev: {
      ...
      enter_navigateNext: {
        keys: 'enter',
        action: function () {
          this.moveCellCursorInsideSelection({ x: 0, y: 1 });
        },
        repeat: !0,
      },
      shiftEnter_navigatePrev: {
  ...
  function Ur() {
    if (null == this._cellCursorPosition) var t = null;
      ...
      t = [
        this.getRowIdByCoord(this._cellCursorPosition.y),
        this.getColIdByCoord(this._cellCursorPosition.x),
      ];
    for (
      var e = {
          selection: [],
        ...
        i = 0;
      i < this._selection.length;
      i++
    ) {
      var o = [
        { x: this._selection[i].range[0].x, y: this._selection[i].range[0].y },
  ...
  function tl(t, e, i, o) {
    return i.title
      ? i.title || ''
      : this.colHeaderLabelType in o
        ? (this.colHeaderLabelPrefix || '') +
          o[this.colHeaderLabelType] +
          (this.colHeaderLabelSuffix || '')
        : (this.colHeaderLabelPrefix || '') + (this.colHeaderLabelSuffix || '');
  }
  function el(t, e, i, o) {
    return i.title
      ? i.title || ''
      : this.rowHeaderLabelType in o
        ? (this.rowHeaderLabelPrefix || '') +
          o[this.rowHeaderLabelType] +
          (this.rowHeaderLabelSuffix || '')
        : (this.rowHeaderLabelPrefix || '') + (this.rowHeaderLabelSuffix || '');
  }
  var il = {
      traverseSingleCell: [
        'rightArrow_moveCellCursorRight',
    ...
    nl = {
      ...
      'Cannot move columns in or out of the frozen section. Try turning off frozen columns first.':
        null,
  ...
  function hl(t) {
    return null == t
      ? null
      : [Is.call(this, { x: t[0].x, y: t[0].y }), Is.call(this, { x: t[1].x, y: t[1].y })];
  }
  function al(t) {
    for (var e = [], i = 0; i < t.length; i++)
      e.push({ range: hl.call(this, Ps(t[i].range)), type: t[i].type });
    return e;
  }
  function cl(t) {
    ...
    for (var r = [], l = 0; l < o.length; l++) r.push({ range: o[l], type: 'cell' });
    return r;
  }
  function dl(t) {
    if ((void 0 === t && (t = null), null != t)) {
  ...
  function ul(t, e, i, o) {
    ...
    for (var c = 0; c < a.length; c++) {
      for (var d = n.length, u = 0; u < a[c].rowIds.length; u++)
        n.indexOf(a[c].rowIds[u]) > -1
          ? 'rowStartIndex' in a[c] || (a[c].rowStartIndex = n.indexOf(a[c].rowIds[u]))
          : n.push(a[c].rowIds[u]);
    ...
    for (c = 0; c < a.length; c++) {
      ...
      for (u = 0; u < a[c].colIds.length; u++)
        s.indexOf(a[c].colIds[u]) > -1
          ? 'colStartIndex' in a[c] || (a[c].colStartIndex = s.indexOf(a[c].colIds[u]))
          : s.push(a[c].colIds[u]);
    ...
    for (c = 0; c < a.length; c++)
      for (
        var f = a[c].rowStartIndex, g = a[c].colStartIndex, _ = 0, y = 0, v = a[c].range[0].y;
        v <= a[c].range[1].y;
        v++
      ) {
        y = 0;
        for (var m = a[c].range[0].x; m <= a[c].range[1].x; m++)
          ((r[f + _][g + y] = a[c].values[_][y]), y++);
        _++;
      }
    var x = [];
    for (c = 0; c < a.length; c++)
      ('action' in a[c] && 'cut' == a[c].action) || x.push({ range: a[c].range, type: 'cell' });
    return { rowIds: n, colIds: s, values: r, selection: x };
  }
  var pl = function (t) {
      for (var e, i = this._cols.store._lastId, o = [], s = t[0].x; s <= t[1].x; s++)
        (null == (e = this.getColIdByCoord(s)) && i++, o.push(e || i));
      return o;
    },
    fl = function (t) {
      for (var e, i = this._rows.store._lastId, o = [], s = t[0].y; s <= t[1].y; s++)
        (null == (e = this.getRowIdByCoord(s)) && i++, o.push(e || i));
      return o;
    },
    gl = function (t, i, o) {
      for (var s, n, r, l = [], h = 0; h < t.length; h++) {
        var a = [
          { x: t[h].range[0].x, y: t[h].range[0].y },
          { x: t[h].range[1].x, y: t[h].range[1].y },
        ];
        if (o && e(i)) {
        ...
        (this.expandSheetOnPaste ||
          ((a[1].y = Math.min(a[1].y, this._rows.coordList.length - 1)),
          (a[1].x = Math.min(a[1].x, this._cols.coordList.length - 1))),
          (n = fl.call(this, a)),
          (r = pl.call(this, a)),
          (s = e(i) ? (i.length != n.length || i[0].length != r.length ? yl(a, i) : i) : _l(a, i)),
          l.push({ range: a, rowIds: n, colIds: r, values: s }));
      }
      return l;
    },
    _l = function (t, e) {
  ...
  function vl(t, e) {
    ...
    for (var n = 0; n < this._rows.store.length; n++)
      for (s = 0; s < i.length; s++)
        this._cellStore[this._rows.store[n].id - 1][i[s] - 1] = { value: null };
  ...
  function ml(t, e) {
    for (var i = [], o = this._rows.store._lastId, s = 0; s < t; s++)
      (o++, this._rows.store.push({ id: o, title: void 0, _pass: !0 }), i.push(o));
    this._rows.store._lastId = o;
    for (var n = 0; n < this._cols.store.length; n++)
      for (s = 0; s < i.length; s++)
        (null == this._cellStore[i[s] - 1] && (this._cellStore[i[s] - 1] = []),
          (this._cellStore[i[s] - 1][this._cols.store[n].id - 1] = { value: null }));
  ...
  function xl(t) {
    for (var e = [], i = 0; i < t.length; i++) {
      ...
      (this._cols.indexList.splice(o, 1), e.push({ id: t[i], index: o }));
    }
    return e.reverse();
  }
  function wl(t) {
    for (var e = [], i = 0; i < t.length; i++) {
      ...
      (this._rows.indexList.splice(o, 1), e.push({ id: t[i], index: o }));
    }
    return e.reverse();
  }
  function Cl(t) {
    ...
    if ((void 0 === i && (i = 0), null != t)) {
      ...
      ((this._activeRangeIndex = Math.min(i, t.length - 1)),
        (this._cellCursorPosition =
          null == e ? t[this._activeRangeIndex].range[0] : Is.call(this, e)),
        (this._selection = t),
        (this.constructor.contextMenu.isOpen() && this.constructor.contextMenu._context == this) ||
          kn.call(this),
        this.constructor._isTouchDevice || wi.call(this),
        this.activate(),
  ...
  function Rl(t, e) {
    if ((void 0 === t && (t = null), void 0 === e && (e = 'xy'), null == t)) return { x: 0, y: 0 };
    var i = this._viewportPosition.x + (this._colView.length - 1);
    this._colViewOverflow > 0 && (i -= 1);
    var o = this._viewportPosition.y + (this._rowView.length - 1);
    if ((this._rowViewOverflow > 0 && (o -= 1), t.x < this._viewportPosition.x))
    ...
    return { x: (('xy' == e || 'x' == e) && s) || 0, y: (('xy' == e || 'y' == e) && n) || 0 };
  }
  function Ll(t) {
    var e = { x: this._viewportPosition.x, y: this._viewportPosition.y },
      i = Rl.call(this, t);
  ...
  function Pl(t) {
    if (null != t && t.selection.length) {
      for (var e = [], i = 0; i < t.selection.length; i++) {
        var o = { type: t.selection[i].type, range: t.selection[i].range };
        e.push(o);
      }
  ...
  function Nl() {
    null != this.constructor._clipboardObject &&
      Ki.call(
        this.constructor._clipboardObject.instance,
        this.constructor._clipboardObject.type,
        null
      );
  }
  function kl() {
  ...
  var Hl = function () {
    ...
    Ml = function () {
      ((this._domNodes.rowHeaderColumn.style.height = this._cd.viewportHeight + 'px'),
        (this._domNodes['column-center'].style.top =
          this._cd.panesY.center.offset - this._cd.colHeaderSpace + 'px'),
      ...
      for (var t = 0; t < this._columnNodes.length; t++)
        ((this._columnNodes[t].column.style.height = this._cd.viewportHeight + 'px'),
          (this._columnNodes[t]['column-top'].style.height =
            this._cd.panesY.top.outer - this._cd.colHeaderSpace + 'px'),
          (this._columnNodes[t]['column-center'].style.height =
    ...
    Bl = function () {
      ((this._domNodes.freezeLines.style.height = this._cd.viewportHeight + 'px'),
        ...
        null == this._freezeLineRowAfterId
        ...
        null == this._freezeLineColAfterId
    ...
    if ((t = t.toLowerCase())) {
      for (var o = 0; o < this._rows.coordList.length; o++)
        for (var s = 0; s < this._cols.coordList.length; s++) {
          ...
          null != n.value &&
            String(n.value).toLowerCase().indexOf(t) > -1 &&
            ((n._found = t), e.push([this._rows.coordList[o], this._cols.coordList[s]]));
        }
      e.length && (i = 0);
    }
  ...
  function Dl(t) {
    ...
    var s = !1,
      n = !1;
    ((('hideCols' == t && this._viewportPosition.x == this._panesXids.left.length) ||
      'freezeCols' == t) &&
      (s = !0),
      (('hideRows' == t && this._viewportPosition.y == this._panesYids.top.length) ||
        'freezeRows' == t) &&
        (n = !0),
      Bt.call(this),
      Vt.call(this, s, n),
    ...
    for (i = 0; i < this._validatedTopBar.length; i++)
      'update' in this._validatedTopBar[i] &&
        this._validatedTopBar[i].update.call(this, this._topBarNodes[i].nodes);
    for (i = 0; i < this._validatedBottomBar.length; i++)
      'update' in this._validatedBottomBar[i] &&
        this._validatedBottomBar[i].update.call(this, this._bottomBarNodes[i].nodes);
    setTimeout(function () {
      $s.call(e);
    }, 0);
  }
        ...
        if (
          ...
          (Nl.call(this),
            'do' == t
              ...
              : 'undo' == t
                ? (r.length && (h = xl.call(this, r)), l.length && (a = wl.call(this, l)))
                : 'redo' == t &&
                  (h.length && Cl.call(this, h),
          ...
          var c = 0,
            d = function () {
              ...
              (Sl.call(this, { rowIds: i, colIds: o, values: r }),
                Dl.call(this, 'setCellValues'),
                this.redraw(),
                c < e.rowIds.length - 1
                  ? setTimeout(d, 75)
                  : (this.events.dispatch('setcellvalues', e),
  ...
  function Kl(t, e, i) {
    ...
    var o = this.getCellRangeData(t),
      n = [];
    if ('right' == e) for (var r = 0; r < o.length; r++) n.push({ series: o[r] });
    else if ('left' == e) for (r = 0; r < o.length; r++) n.push({ series: o[r].reverse() });
    else if ('down' == e)
      ...
      for (l = 0; l < o[0].length; l++) {
        ...
        n.push({ series: h.reverse() });
      }
    if ((jl(n), 'right' == e))
      var c = [
        { x: t[1].x + 1, y: t[0].y },
        { x: Math.min(this._cols.coordList.length - 1, t[1].x + i), y: t[1].y },
      ];
    else if ('left' == e)
      c = [
        { x: Math.max(0, t[0].x - i), y: t[0].y },
        { x: t[0].x - 1, y: t[1].y },
      ];
    else if ('down' == e)
      c = [
        { x: t[0].x, y: t[1].y + 1 },
        { x: t[1].x, y: Math.min(this._rows.coordList.length - 1, t[1].y + i) },
      ];
    else if ('up' == e)
      c = [
        { x: t[0].x, y: Math.max(0, t[0].y - i) },
        { x: t[1].x, y: t[0].y - 1 },
      ];
    var d = c[1].y - c[0].y + 1,
      u = c[1].x - c[0].x + 1,
  ...
  var jl = function (t) {
    ...
    function i(t) {
      for (var e, i, s, n = [], r = null, l = 0; l < t.length; l++)
        ((e =
          '' !== (s = t[l]) && null !== s && !isNaN(s) && isFinite(s) && Math.floor(s) === Number(s)
            ? 'number'
            : 'string'),
          null == r
            ? (i = [t[l]])
            : e == r
              ? i.push(t[l])
              : ('number' == r && i.length && (i = o(i, l - i.length)),
                Array.prototype.push.apply(n, i),
                (i = [t[l]])),
          (r = e));
      return (
        i.length &&
          ('number' == r && i.length && (i = o(i, l - i.length)), Array.prototype.push.apply(n, i)),
        n
      );
    }
    function o(t, e) {
      ...
      if (null != i) {
        var n = { base: Number(t[0]), increment: i, startIndex: e, size: t.length },
          r = [];
  ...
  function Ul(t) {
    ...
    for (var s = [], n = 0; n < o.length; n++) s.push({ range: ir.call(this, o[n]), type: 'col' });
    return s;
  }
  function ql(t) {
    var e = this;
    ...
    for (var i = al.call(this, Ul.call(this, t)), o = new Set(), s = 0; s < i.length; s++)
      for (
        var n = this.getColIndexByCoord(i[s].range[0].x),
          r = this.getColIndexByCoord(i[s].range[1].x),
          l = n;
        l <= r;
        l++
      )
  ...
  function ih(t, e) {
    ...
    for (s = 0; s < o.length; s++)
      (o[s] == i + 1 || 0 == s ? r.push(o[s]) : (n.push(r), (r = [o[s]])), (i = o[s]));
    return (n.push(r), n);
  }
  function oh(t) {
  ...
  function sh(t) {
    for (var e = [], i = 0; i < t.length; i++) {
      ...
      if (
        (e.push({ id: t[i].id, afterId: this._cols.indexList[o - 1] || null }),
  ...
  function nh(t, e, i, o) {
    (void 0 === i && (i = !0), void 0 === o && (o = function () {}));
    var s = { colIds: t, targetId: e };
    if (this.events.dispatch('beforemovecols', s)) {
      var n,
        r = rh(s.colIds, s.targetId),
        l = Ur.call(this);
  ...
  var rh = function (t, e) {
    for (var i = [], o = 0; o < t.length; o++) i.push({ id: t[o], afterId: e });
    return i.reverse();
  };
  function lh(t, e) {
  ...
  function ch(t, e) {
    for (var i = 0; i < t.length; i++)
      void 0 !== e[i] &&
        (this._cols.store[t[i] - 1].width = 1 * Math.round(Math.max(e[i], 32) / 1));
    ah.call(this, t, e);
  }
  function dh(t, e, i, o) {
    (void 0 === i && (i = !0), void 0 === o && (o = function () {}));
    var s = { colIds: t, widths: e };
  ...
  function uh(t, e) {
    if ((void 0 === t && (t = null), void 0 === e && (e = null), null != t && null != e)) {
      for (
        var i = ql.call(this, t),
          o = [],
          s = 2 * Math.round(Math.max(Math.round(e), 32) / 2),
          n = 0;
        n < i.length;
        n++
      )
          ...
          for (var t = [], i = 0; i < e.length; i++)
            t.push({
              range: [
                { x: e[i][0], y: 0 },
                {
                  x: Math.min(e[i].at(-1), this._cols.coordList.length - 1),
  ...
  function mh(t, e, i) {
    ...
    if (this.events.dispatch('beforefreezecols', o)) {
      var s = this._freezeLineColAfterId,
        n = Ur.call(this);
      (vh.call(this, o.colId), Dl.call(this, 'freezeCols'), i.call(this), this.redraw());
      var r = Ur.call(this);
      (e &&
        this.undoManager.add({
          desc: 'freezeCols',
          undo: function () {
            (vh.call(this, s), Dl.call(this, 'freezeCols'), Pl.call(this, n), this.redraw());
          },
          redo: function () {
            (vh.call(this, o.colId), Dl.call(this, 'freezeCols'), Pl.call(this, r), this.redraw());
          },
        }),
  ...
  function xh(t) {
    (void 0 === t && (t = null), mh.call(this, t, !0));
  }
  function wh(t) {
  ...
  function bh(t, e, i) {
    ...
    if (this.events.dispatch('beforehidecols', o)) {
      var s = Ur.call(this);
      (wh.call(this, o.colIds), Dl.call(this, 'hideCols'), i.call(this), this.redraw());
      var n = Ur.call(this);
      (e &&
        this.undoManager.add({
          desc: 'hideCols',
          undo: function () {
            (Ch.call(this, o.colIds), Dl.call(this, 'showCols'), Pl.call(this, s), this.redraw());
          },
          redo: function () {
            (wh.call(this, o.colIds), Dl.call(this, 'hideCols'), Pl.call(this, n), this.redraw());
          },
        }),
  ...
  function Sh(t, e) {
    ...
    for (var i = ih.call(this, t, e), o = new Set(), s = 0; s < i.length; s++) {
      var n = i[s].at(-1);
      n + 1 > this['_' + t].coordList.length - 1
        ? o.add(this['_' + t].coordList[i[s][0] - 1])
        : o.add(this['_' + t].coordList[n + 1]);
    }
    return Array.from(o);
  }
  function Ih(t) {
    if (t.length != this._cols.coordList.length) {
      var e = Sh.call(this, 'cols', t);
      bh.call(this, t, !0, function () {
        for (var t = [], i = 0; i < e.length; i++)
          t.push({
            range: [
              { x: this.getColCoordById(e[i]), y: 0 },
              { x: this.getColCoordById(e[i]), y: this._rows.coordList.length - 1 },
            ],
            type: 'col',
          });
        Il.call(this, t);
  ...
  function Rh(t, e, i) {
    ...
    if (this.events.dispatch('beforeshowcols', o)) {
      var s = Ur.call(this);
      (Ch.call(this, o.colIds), Dl.call(this, 'showCols'), i.call(this), this.redraw());
      var n = Ur.call(this);
      (e &&
        this.undoManager.add({
          desc: 'showCols',
          undo: function () {
            (wh.call(this, o.colIds), Dl.call(this, 'hideCols'), Pl.call(this, s), this.redraw());
          },
          redo: function () {
            (Ch.call(this, o.colIds), Dl.call(this, 'showCols'), Pl.call(this, n), this.redraw());
          },
        }),
  ...
  function Ph(t) {
    var o;
    i(t) ? (o = t) : e(t) ? (o = [t]) : d(t) && (o = [[t, t]]);
    for (var s = [], n = 0; n < o.length; n++) s.push({ range: or.call(this, o[n]), type: 'row' });
    return s;
  }
  function Nh(t) {
    var e = this;
    ...
    for (var i = al.call(this, Ph.call(this, t)), o = new Set(), s = 0; s < i.length; s++)
      for (
        var n = this.getRowIndexByCoord(i[s].range[0].y),
          r = this.getRowIndexByCoord(i[s].range[1].y),
          l = n;
        l <= r;
        l++
      )
  ...
  function Eh(t) {
    for (var e = [], i = 0; i < t.length; i++) {
      ...
      if (
        (e.push({ id: t[i].id, afterId: this._rows.indexList[o - 1] || null }),
  ...
  function Mh(t, e, i, o) {
    (void 0 === i && (i = !0), void 0 === o && (o = function () {}));
    var s = { rowIds: t, targetId: e };
    if (this.events.dispatch('beforemoverows', s)) {
      var n,
        r = Bh(s.rowIds, s.targetId),
        l = Ur.call(this);
  ...
  function Oh(t, e) {
    if ((void 0 === t && (t = null), void 0 === e && (e = null), null != t && null != e)) {
      ...
      if (((e = $o(e, 0, this._rows.coordList.length)), Dh.call(this, i, e))) {
        ...
        i.indexOf(o) > -1 ||
          Mh.call(this, i, o, !0, function () {
            this.setRowSelection(oh(ih.call(this, 'rows', i)));
          });
      } else
        this.alertUser(
          'Cannot move rows in or out of the frozen section. Try turning off frozen rows first.'
        );
    }
  }
  var Dh = function (t, e) {
            ...
            t.push({
              range: [
                { x: 0, y: e[i][0] },
                {
                  ...
                  y: Math.min(e[i].at(-1), this._rows.coordList.length - 1),
                },
              ],
              type: 'row',
            });
  ...
  function $h(t) {
    if (t.length != this._rows.coordList.length) {
      var e = Sh.call(this, 'rows', t);
      Zh.call(this, t, !0, function () {
        for (var t = [], i = 0; i < e.length; i++)
          t.push({
            range: [
              { x: 0, y: this.getRowCoordById(e[i]) },
              { x: this._cols.coordList.length - 1, y: this.getRowCoordById(e[i]) },
            ],
            type: 'row',
          });
        Il.call(this, t);
  ...
  function ta() {
    if (this._searchCellsFound.length) {
      var t = this._searchCellsFound[this._searchCellIndex],
        e = { x: this.getColCoordById(t[1]), y: this.getRowCoordById(t[0]) },
        i = cl.call(this, e);
      Il.call(this, i, e, 0);
    }
    this.search('');
  ...
  function ea(t) {
    if ((Ol.call(this, t), this._searchCellsFound.length)) {
      var e = this._searchCellsFound[this._searchCellIndex];
      Ll.call(this, { x: this.getColCoordById(e[1]), y: this.getRowCoordById(e[0]) });
    }
  ...
  function oa() {
    if (this._searchCellsFound.length) {
      this._searchCellIndex == this._searchCellsFound.length - 1
        ? (this._searchCellIndex = 0)
        : this._searchCellIndex++;
      var t = this._searchCellsFound[this._searchCellIndex];
      (Ll.call(this, { x: this.getColCoordById(t[1]), y: this.getRowCoordById(t[0]) }),
        Dl.call(this, 'search'),
        this.redraw());
    }
  }
    ...
    for (e = this._rows.coordSections[0].length; e < this._rows.indexList.length; e++)
      if (this._rows.store[this._rows.indexList[e] - 1]._hide) s[e] = this._rows.indexList[e];
        ...
        for (var n = [], r = 0; r < t.length; r++)
          (null === (i = this._cellStore[this._rows.indexList[e] - 1][t[r][0] - 1].value) &&
            (i = ''),
            n.push(String(i)));
  ...
  function aa(t, e, i) {
    if (
      (void 0 === t && (t = null), void 0 === e && (e = null), void 0 === i && (i = !1), null != t)
    ) {
      var o = this._cols.coordList[t],
        s = 'asc';
      if (
        (null == e
          ? this._sortState.length &&
            this._sortState[0][0] == o &&
            (s = 'asc' == this._sortState[0][1] ? 'desc' : 'asc')
          : (s = e),
        i && !ca.call(this, o))
      )
  ...
  function da() {
    (this._isActive || this.events.dispatch('activate', {}),
      (this._isActive = !0),
      mi.call(this, 'document', 'mousedown'),
      this.keys.resume());
  }
  function ua() {
    (this._isActive && this.events.dispatch('deactivate'),
      (this._isActive = !1),
      this._domNodes.cellEditor._isOpen && this.closeCellEditorAndSave(),
  ...
  function Ha() {
    (mi.call(this, 'cellEditorInputField', 'copy'),
      ...
      P(this._domNodes.cellEditor, { opacity: 0, height: '1px', 'z-index': -1 }),
  ...
  function Aa(t) {
    ...
    if (
      (P(this._domNodes.cellEditorInputField, {
      ...
      'enter' == t
        ? to.call(this, 'inputModeEnter')
        : (to.call(this, 'inputModeEdit'),
          (this._domNodes.cellEditorInputField.value = this.getCellValue(
            this._cellCursorPosition
          ))),
  ...
  function Ba() {
    var t = this;
    'clipboard' in navigator && 'function' == typeof navigator.clipboard.readText
      ? navigator.clipboard
          .readText()
          .then(function (e) {
            '' != e && Zi.call(t, { text: e }, null);
          })
          .catch(function (t) {})
      : this.isIE
        ? document.execCommand('paste')
        : this.alertUser('Paste not available.');
  }
  function Oa() {
    ...
    In.call(
      this,
      { snapPointX: t + window.scrollX + i + s.left, snapPointY: e + window.scrollY + o + s.top },
      null
    );
  }
  function Da(t) {
  ...
  var Va = function (t) {
    var e = new Blob([t], { type: 'text/csv', name: 'datagridxl.csv' });
  ...
  function Xa(t) {
    void 0 === t && (t = {});
    var e = L({ useColTitles: !1, whitespace: 2, includeDataField: !1 }, t);
    if (e.includeDataField) var i = (o = { data: [] }).data;
    else {
      var o;
      i = o = [];
    }
  ...
  var Ya = function (t) {
    var e = new Blob([t], { type: 'application/json', name: 'datagridxl.json' });
    ...
    if (this.escapeQuotesOnCopy)
      ...
      for (var i = t[0].y; i <= t[1].y; i++) {
        for (var o = t[0].x; o <= t[1].x; o++)
          ((e +=
            this._cellStore[this._rows.coordList[i] - 1][this._cols.coordList[o] - 1].value || ''),
            o < t[1].x && (e += '\t'));
        i < t[1].y && (e += '\n');
      }
    }
    ...
    if ('objectCollection' == this._dataFormat)
      for (var i = 0; i < this._rows.coordList.length; i++) {
        for (var o = {}, s = 0; s < this._cols.coordList.length; s++) {
          o[(n = this.getColFromStore(this._cols.coordList[s])).field] =
            this._cellStore[this._rows.coordList[i] - 1][n.id - 1].value;
        }
        e.push(o);
      }
  ...
  var Ga = function () {
      ...
      this._domNodes.component.requestFullscreen
        ? this._domNodes.component.requestFullscreen()
        : this._domNodes.component.webkitRequestFullscreen
          ? this._domNodes.component.webkitRequestFullscreen()
          : this._domNodes.component.msRequestFullscreen &&
            this._domNodes.component.msRequestFullscreen();
    },
    Za = function () {
  ...
  function $a(t) {
    return (
      this.headerLabelSeries.letters.indexToLabel(this.getColIndexByCoord(t.x)) +
      this.headerLabelSeries.numbers.indexToLabel(this.getRowIndexByCoord(t.y))
    );
  }
  function Qa(t) {
  ...
  var tc = function (t) {
    var e = new Blob([t], { type: 'octet/stream', name: 'datagridxl.csv' });
  ...
  function ic() {
    ...
    (Xt.call(this),
      kl.call(this),
      this._isFullscreen && i == this._cd.componentWidth && e > this._cd.componentHeight + 200
        ? (o = !0)
        : this._isFullscreen &&
          i == this._cd.componentWidth &&
          this._cd.componentHeight > e + 200 &&
          (s = !0),
      s || o || tn.call(this, { x: this._panesXids.left.length, y: this._panesYids.top.length }),
      requestAnimationFrame(function () {
        Lr.call(t);
      }),
  ...
  function oc(t, e) {
    ...
    return (
      (i =
        t in this.locale && null !== this.locale[t]
          ? this.locale[t]
          : t in this._defaultLocale && null !== this._defaultLocale[t]
  ...
  function rc(t) {
    for (var e = [], i = 0; i < this._selection.length; i++)
      Io(t, this._selection[i].range) &&
        e.push({ range: this._selection[i].range, type: this._selection[i].type, index: i });
    return e;
  }
  function lc(t) {
    void 0 === t && (t = !1);
    ...
    var e = [
      {
        range: [
          { x: 0, y: 0 },
          { x: this._cols.coordList.length - 1, y: this._rows.coordList.length - 1 },
        ],
        type: 'all',
      },
    ];
  ...
  var cc = function (t) {
      if ('left' == t || 'right' == t) {
        var e,
          i = this._selection[this._activeRangeIndex].range,
          o = { x: this._cellCursorPosition.x, y: this._cellCursorPosition.y },
          s = i;
        'right' == t
          ? o.x == i[0].x
            ? ((s[0].x = i[0].x), (s[1].x = i[1].x + 1), (e = 1))
            : ((s[0].x = i[0].x + 1), (s[1].x = i[1].x), (e = 0))
          : 'left' == t &&
            (o.x == i[1].x
              ? ((s[0].x = i[0].x - 1), (s[1].x = i[1].x), (e = 0))
              : ((s[0].x = i[0].x), (s[1].x = i[1].x - 1), (e = 1)));
        ...
        var r = Rl.call(this, { x: s[e].x, y: s[e].y }, 'x');
        tn.call(this, { x: this._viewportPosition.x + r.x, y: this._viewportPosition.y + r.y });
      }
    },
    dc = function (t) {
      if ('up' == t || 'down' == t) {
        ...
        'down' == t
          ? o.y == i[0].y
            ? ((s[0].y = i[0].y), (s[1].y = i[1].y + 1), (e = 1))
            : ((s[0].y = i[0].y + 1), (s[1].y = i[1].y), (e = 0))
          : 'up' == t &&
            (o.y == i[1].y
              ? ((s[0].y = i[0].y - 1), (s[1].y = i[1].y), (e = 0))
              : ((s[0].y = i[0].y), (s[1].y = i[1].y - 1), (e = 1)));
        var n = this._selection;
        ((n[this._activeRangeIndex].range = s), Il.call(this, n, o, this._activeRangeIndex));
        var r = Rl.call(this, { x: s[e].x, y: s[e].y }, 'y');
        tn.call(this, { x: this._viewportPosition.x + r.x, y: this._viewportPosition.y + r.y });
      }
    },
    uc = function (t) {
      var e,
        i,
        o = this._selection[this._activeRangeIndex].range,
        s = { x: this._cellCursorPosition.x, y: this._cellCursorPosition.y },
        n = o;
      'right' == t
        ? ((e = 'x'),
          (n[0].y = o[0].y),
          (n[1].y = o[1].y),
          s.x == o[0].x
            ? ((n[0].x = o[0].x), (n[1].x = o[1].x + 1), (i = 1))
            : ((n[0].x = o[0].x + 1), (n[1].x = o[1].x), (i = 0)))
        : 'left' == t
          ? ((e = 'x'),
            (n[0].y = o[0].y),
            (n[1].y = o[1].y),
          ...
          : 'down' == t
            ? ((e = 'y'),
              ...
              (n[1].x = o[1].x),
              s.y == o[0].y
                ? ((n[0].y = o[0].y), (n[1].y = o[1].y + 1), (i = 1))
                : ((n[0].y = o[0].y + 1), (n[1].y = o[1].y), (i = 0)))
            : 'up' == t &&
              ((e = 'y'),
              (n[0].x = o[0].x),
              (n[1].x = o[1].x),
      ...
      var l = Rl.call(this, { x: n[i].x, y: n[i].y }, e);
      tn.call(this, { x: this._viewportPosition.x + l.x, y: this._viewportPosition.y + l.y });
    };
  function pc() {
    return null == this._cellCursorPosition
      ? null
      : { x: this._cellCursorPosition.x, y: this._cellCursorPosition.y };
  }
  function fc(t, e) {
  ...
  function gc(t) {
    ...
    var e = Is.call(
      this,
      { x: this._cellCursorPosition.x + t.x, y: this._cellCursorPosition.y + t.y },
      'document'
    );
    Il.call(this, [{ range: [e, e], type: 'cell' }]);
    var i = { x: this._viewportPosition.x, y: this._viewportPosition.y },
      o = Rl.call(this, e);
    ...
    if ((void 0 === t && (t = null), null != t)) {
      ...
      if (1 == this._selection.length && Di.call(this, e)) {
        var i = [
          {
            range: [
              (r = { x: this._cellCursorPosition.x + t.x, y: this._cellCursorPosition.y + t.y }),
              r,
            ],
            type: 'cell',
          },
        ...
        var o = this._cellCursorPosition.x + t.x,
          ...
          n = { top: !1, right: !1, bottom: !1, left: !1 };
        (o > e[1].x
          ? ((n.right = !0), (o = e[0].x), s < e[1].y ? s++ : ((s = e[0].y), (n.bottom = !0)))
          : o < e[0].x &&
            ((n.left = !0), (o = e[1].x), s > e[0].y ? s-- : ((s = e[1].y), (n.top = !0))),
          s > e[1].y
            ? ((n.bottom = !0), (s = e[0].y), o < e[1].x ? o++ : ((o = e[0].x), (n.right = !0)))
            : s < e[0].y &&
              ((n.top = !0), (s = e[1].y), o > e[0].x ? o-- : ((o = e[1].x), (n.left = !0))));
        var r = { x: o, y: s },
          l = this._activeRangeIndex;
        (n.right &&
          n.bottom &&
          (this._activeRangeIndex == this._selection.length - 1 ? (l = 0) : l++,
          (r = this._selection[l].range[0])),
          n.left &&
            n.top &&
            (0 == this._activeRangeIndex ? (l = this._selection.length - 1) : l--,
            (r = this._selection[l].range[1])),
          Il.call(this, this._selection, r, l));
      }
      var h = { x: this._viewportPosition.x, y: this._viewportPosition.y },
        a = Rl.call(this, r);
  ...
  function yc() {
    ...
    for (var e = 0, i = this._viewportPosition.y; e < this._cd.panesY.center.space && -1 != i; )
      ((e += this.getRowHeightById(this.getRowIdByCoord(i))), i--);
    var o = { x: this._cellCursorPosition.x, y: i + 1 + t };
    (Il.call(this, [{ range: [o, o], type: 'cell' }]),
      tn.call(this, { x: this._viewportPosition.x, y: i + 1 }),
      this.redraw());
  }
  function vc() {
    var t = this._cellCursorPosition.y - this._viewportPosition.y;
    t < 0 && (t = 0);
    var e = this._viewportPosition.y + (this._rowView.length - 1),
      i = { x: this._cellCursorPosition.x, y: e + t };
    (Il.call(this, [{ range: [i, i], type: 'cell' }]),
      tn.call(this, { x: this._viewportPosition.x, y: e }),
      this.redraw());
  }
  function mc() {
    var t = { x: this._cellCursorPosition.x, y: 0 };
    Il.call(this, [{ range: [t, t], type: 'cell' }]);
    var e = { x: this._viewportPosition.x, y: this._viewportPosition.y },
      i = Rl.call(this, t);
    (t.x >= this._panesXids.left.length && (e.x += i.x),
      t.y >= this._panesYids.top.length && (e.y += i.y),
  ...
  function xc() {
    var t = { x: this._cellCursorPosition.x, y: this._rows.coordList.length - 1 };
    Il.call(this, [{ range: [t, t], type: 'cell' }]);
    var e = { x: this._viewportPosition.x, y: this._viewportPosition.y },
      i = Rl.call(this, t);
    (t.x >= this._panesXids.left.length && (e.x += i.x),
  ...
  function wc() {
    var t = { x: 0, y: this._cellCursorPosition.y };
    Il.call(this, [{ range: [t, t], type: 'cell' }]);
    var e = { x: this._viewportPosition.x, y: this._viewportPosition.y },
      i = Rl.call(this, t);
    (t.x >= this._panesXids.left.length && (e.x += i.x),
  ...
  function Cc() {
    var t = { x: this._cols.coordList.length - 1, y: this._cellCursorPosition.y };
    Il.call(this, [{ range: [t, t], type: 'cell' }]);
    var e = { x: this._viewportPosition.x, y: this._viewportPosition.y },
      i = Rl.call(this, t);
    (t.x >= this._panesXids.left.length && (e.x += i.x),
  ...
  function bc() {
    var t = { x: this._panesXids.left.length, y: this._panesYids.top.length };
    Il.call(this, [{ range: [t, t], type: 'cell' }]);
    var e = Rl.call(this, t);
    (tn.call(this, { x: this._viewportPosition.x + e.x, y: this._viewportPosition.y + e.y }),
      this.redraw());
  }
  function Sc() {
    var t = { x: this._cols.coordList.length - 1, y: this._rows.coordList.length - 1 };
    Il.call(this, [{ range: [t, t], type: 'cell' }]);
    var e = Rl.call(this, t);
    (tn.call(this, { x: this._viewportPosition.x + e.x, y: this._viewportPosition.y + e.y }),
      this.redraw());
  ...
  function Rc(t) {
    void 0 === t && (t = !1);
    var e = We(this._selection, { type: 'cell' });
    if (t) return e;
    for (var i = [], o = 0; o < e.length; o++) i.push(e[o].range);
    return i;
  }
  function Lc(t, e) {
    void 0 === e && (e = !1);
    var i = this._cellCursorPosition || { x: 0, y: 0 };
    if (e) {
      var o = [{ range: (s = [i, Is.call(this, t)]), type: 'cell' }];
      Il.call(this, o, i, 0);
    } else {
  ...
  function Pc(t) {
    if ((void 0 === t && (t = null), null != t)) {
      ...
      e.push({ range: t, type: 'cell' });
      var i = e.length - 1,
        o = { x: e[i].range[0].x, y: e[i].range[1].y };
      (Il.call(this, e, o, i), this.redraw());
    }
  }
  function Nc(t) {
    for (var e = { x: t, y: 0 }, i = [], o = 0; o < this._selection.length; o++)
      Io(e, this._selection[o].range) &&
        'col' == this._selection[o].type &&
        i.push({ range: this._selection[o].range, type: this._selection[o].type, index: o });
    return i;
  }
  function kc(t) {
    void 0 === t && (t = !1);
    var e = We(this._selection, { type: 'col' });
    if (t) return e;
  ...
  function Hc(t) {
    if ((void 0 === t && (t = null), null != t)) {
      var e = Ul.call(this, t),
        i = { x: e[0].range[0].x, y: 0 };
      (Il.call(this, e, i), this.redraw());
    }
  }
  function zc(t) {
    var e = t,
      i = { left: 0, right: this._cols.coordList.length - 1 },
      o = e > i.right;
  ...
  function Ac(t, e) {
    ...
    if (e) {
      var o = [i.x, zc.call(this, t)],
        s = [{ range: (n = ir.call(this, o)), type: 'col' }];
      Il.call(this, s, i, 0);
    } else {
  ...
  function Tc(t) {
    if ((void 0 === t && (t = null), null != t)) {
      var e = this._selection;
      e.push({ range: ir.call(this, t), type: 'col' });
      var i = { x: e[e.length - 1].range[0].x, y: 0 },
        o = e.length - 1;
      (Il.call(this, e, i, o), this.redraw());
    }
  }
  function Fc(t) {
    for (var e = { x: 0, y: t }, i = [], o = 0; o < this._selection.length; o++)
      Io(e, this._selection[o].range) &&
        'row' == this._selection[o].type &&
        i.push({ range: this._selection[o].range, type: this._selection[o].type, index: o });
    return i;
  }
  function Ec(t) {
    void 0 === t && (t = !1);
    var e = We(this._selection, { type: 'row' });
    if (t) return e;
  ...
  function Mc(t) {
    if ((void 0 === t && (t = null), null != t)) {
      var e = Ph.call(this, t),
        i = { x: 0, y: e[0].range[0].y };
      (Il.call(this, e, i), this.redraw());
    }
  }
  function Bc(t) {
    var e = t,
      i = { top: 0, bottom: this._rows.coordList.length - 1 },
      o = e > i.bottom;
  ...
  function Oc(t, e) {
    ...
    if (e) {
      var o = [i.y, Bc.call(this, t)],
        s = [{ range: (n = or.call(this, o)), type: 'row' }];
      Il.call(this, s, i, 0);
    } else {
  ...
  function Dc(t) {
    if ((void 0 === t && (t = null), null != t)) {
      var e = this._selection;
      e.push({ range: or.call(this, t), type: 'row' });
      var i = { x: 0, y: e[e.length - 1].range[0].y },
        o = e.length - 1;
      (Il.call(this, e, i, o), this.redraw());
    }
  }
  ...
  function Uc() {
    return null == this._viewportPosition
      ? null
      : { x: this._viewportPosition.x, y: this._viewportPosition.y };
  }
  function qc(t) {
  ...
  function Gc() {
    ...
    for (var e in t) for (var i = 0; i < t[e].length; i++) xi.call(this, e, t[e][i]);
    (delete this._domNodes.container._resizeSensor,
      delete this._domNodes.lineHeightMeter._resizeSensor);
  }
  function Zc() {
    if (!('_isDestroyed' in this)) {
      for (var t in (Gc.call(this),
      this.keys.suspend(),
      (this._domNodes.container.innerHTML = ''),
      this._domNodes.lineHeightMeter.remove(),
      this._domNodes.textWidthMeter.remove(),
      this._domNodes))
        delete this._domNodes[t];
      for (var e in this.constructor._domNodes)
        (this.constructor._domNodes[e].remove(), delete this.constructor._domNodes[e]);
      this._isDestroyed = !0;
    }
  }
  var $c = function (t, e) {
    (void 0 === t && (t = null),
      ...
      (this._cellCursorPosition = { x: 0, y: 0 }),
      (this._activeRangeIndex = 0),
      (this._viewportPosition = null),
      (this._viewportOverflowPx = { x: 0, y: 0 }),
      (this._isViewportConnectedTo = { top: !0, left: !0 }),
      (this._sectionsPerPaneX = { left: [0], center: [1] }),
      (this._sectionsPerPaneY = { top: [0], center: [1] }),
      (this._isActive = !1),
      ...
      (this._sortState = []),
      (this._sortFunctions = { reset: new Function('a,b', 'return b[1] - a[1];') }),
      (this._rowOrderStore = []),
      Hr.call(this, t, e));
  };
  return (
    ($c.prototype.clearCellValues = function (t) {
    ...
    ($c._isMacOS = navigator.platform.indexOf('Mac') > -1),
    ($c._isIOS =
      (!!navigator.platform && /iPad|iPhone|iPod/.test(navigator.platform)) ||
      ('MacIntel' === navigator.platform && navigator.maxTouchPoints > 1)),
    ($c._isTouchDevice = window.matchMedia('(pointer: coarse)').matches),
    ($c.createEmptyData = function (t, e) {
      for (var i = [], o = 0; o < t; o++) {
        i.push([]);
