...
!(function () {
  ...
  const a = { series1: '#826af9', series2: '#d2b0ff', bg: '#f8d3ff' },
    i = { series1: '#fee802', series2: '#3fd0bd', series3: '#826bf8', series4: '#2b9bf4' },
  ...
  var c = document.querySelector('#lineAreaChart'),
    ...
    d = {
      ...
      plotOptions: {
        bar: {
          columnWidth: '15%',
          colors: { backgroundBarColors: [a.bg, a.bg, a.bg, a.bg, a.bg], backgroundBarRadius: 10 },
        },
      },
      dataLabels: { enabled: !1 },
      legend: {
    ...
    c =
      (null !== c && new ApexCharts(c, d).render(), document.querySelector('#horizontalBarChart')),
    d = {
      chart: { height: 400, type: 'bar', toolbar: { show: !1 } },
      plotOptions: {
        bar: { horizontal: !0, barHeight: '30%', startingShape: 'rounded', borderRadius: 8 },
      },
    ...
    d = {
      ...
      plotOptions: {
        radialBar: {
          ...
          dataLabels: {
            name: { fontSize: '2rem', fontFamily: 'Open Sans' },
            value: { fontSize: '1.2rem', color: t, fontFamily: 'Open Sans' },
            total: {
              show: !0,
              fontWeight: 400,
              fontSize: '1.3rem',
    ...
    d = {
      ...
      xaxis: {
        ...
        labels: {
          show: !0,
          style: { colors: [r, r, r, r, r, r, r, r], fontSize: '13px', fontFamily: 'Open Sans' },
        },
      },
      fill: { opacity: [1, 0.8] },
      ...
      responsive: [
        {
          ...
          options: {
            chart: { height: 380 },
            legend: { position: 'bottom', labels: { colors: t, useSeriesColors: !1 } },
          },
        },
        {
          breakpoint: 576,
