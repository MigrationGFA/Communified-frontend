            ...
            return (
              ...
              (!0 === l
                ...
                : '<span class="avatar-initial rounded-circle bg-label-' +
                  ...
                  '">' +
                  (l = (
                    ((l = (n = t.client_name).match(/\b\w/g) || []).shift() || '') + (l.pop() || '')
                  ).toUpperCase()) +
                  '</span>') +
              '</div></div><div class="d-flex flex-column"><a href="pages-profile-user.html" class="text-body text-truncate"><span class="fw-semibold">' +
              n +
