...
($(function () {
  ...
  s = (
    isDarkStyle
      ? ((t = config.colors_dark.borderColor), (a = config.colors_dark.bodyBg), config.colors_dark)
      : ((t = config.colors.borderColor), (a = config.colors.bodyBg), config.colors)
  ).headingColor;
  var e,
    n = $('.datatables-users'),
    i = $('.select2'),
        ...
        columnDefs: [
              ...
              return (
                ...
                (o
                  ...
                  : '<span class="avatar-initial rounded-circle bg-label-' +
                    ...
                    '">' +
                    (o = (
                      ((o = (n = a.full_name).match(/\b\w/g) || []).shift() || '') + (o.pop() || '')
                    ).toUpperCase()) +
                    '</span>') +
          ...
          },
          {
            ...
            render: function (e, t, a, s) {
              a = a.status;
              return (
                '<span class="badge ' + o[a].class + '" text-capitalized>' + o[a].title + '</span>'
              );
            },
          },
          {
