      ...
      columns: {
        identifier: function () {
          ...
          $td.each(function () {
            ...
            var span =
              '<span class="tabledit-span tabledit-identifier">' + $(this).text() + '</span>';
            var input =
        ...
        editable: function () {
          for (var i = 0; i < settings.columns.editable.length; i++) {
            var $td = $table.find(
              'tbody td:nth-child(' + (parseInt(settings.columns.editable[i][0]) + 1) + ')'
            );
        ...
        toolbar: function () {
          if (settings.editButton || settings.deleteButton) {
            ...
            $table
              .find('tr:gt(0)')
              .append('<td style="white-space: nowrap; width: 1%;">' + toolbar + '</td>');
          }
        },
      },
    };
