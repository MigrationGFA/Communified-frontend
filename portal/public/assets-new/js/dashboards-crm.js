...
!(function () {
  ...
  var e = document.querySelector('#salesLastYear'),
    r = {
      ...
      fill: {
        type: 'gradient',
        gradient: { shade: t, shadeIntensity: 0.8, opacityFrom: 0.6, opacityTo: 0.25 },
      },
    ...
    r = {
      chart: { type: 'bar', height: 78, parentHeightOffset: 0, stacked: !0, toolbar: { show: !1 } },
      series: [
    ...
    r = {
      ...
      xaxis: {
        ...
        axisBorder: { show: !1 },
        axisTicks: { show: !1 },
        labels: { style: { colors: i, fontSize: '13px', fontFamily: 'Public Sans' } },
      },
      yaxis: { labels: { show: !1 } },
  ...
  function s(t, e) {
    ...
    return {
      ...
      dataLabels: {
        ...
        offsetY: -25,
        style: { fontSize: '15px', colors: [n], fontWeight: '600', fontFamily: 'Public Sans' },
      },
      series: [{ data: t }],
      legend: { show: !1 },
      tooltip: { enabled: !1 },
  ...
  var e = $.ajax({
    ...
    r = {
      ...
      xaxis: {
        ...
        labels: {
          show: !0,
          style: { colors: [i, i, i, i, i, i], fontSize: '13px', fontFamily: 'Public Sans' },
        },
      },
  ...
  ((a = document.querySelectorAll('.chart-progress')),
    ...
    (e = document.querySelector('#projectStatusChart')),
    (r = {
