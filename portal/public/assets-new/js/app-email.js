    ...
    if (
      ...
      h &&
        h.addEventListener('keyup', (e) => {
          ...
          (t =
            'inbox' != a
              ? [].slice.call(document.querySelectorAll('.email-list-item[data-' + a + '="true"]'))
              : [].slice.call(document.querySelectorAll('.email-list-item'))).forEach((e) => {
            ...
            Helpers._hasClass('email-delete', e)
              ...
              : Helpers._hasClass('email-read', e)
                ? (e.parentNode.closest('li.email-list-item').classList.add('email-marked-read'),
                  ...
                  Helpers._toggleClass(e.querySelector('i'), 'ti-mail-opened', 'ti-mail'))
                : Helpers._hasClass('email-unread', e) &&
                  (e.parentNode.closest('li.email-list-item').classList.remove('email-marked-read'),
                  Helpers._toggleClass(e, 'email-read', 'email-unread'),
                  Helpers._toggleClass(e.querySelector('i'), 'ti-mail-opened', 'ti-mail'));
          });
        }));
