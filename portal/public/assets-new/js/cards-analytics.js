...
!(function () {
  ...
  var e = document.querySelector('#weeklyEarningReports'),
    r = {
      ...
      xaxis: {
        ...
        axisBorder: { show: !1 },
        axisTicks: { show: !1 },
        labels: { style: { colors: n, fontSize: '13px', fontFamily: 'Public Sans' } },
      },
      yaxis: { labels: { show: !1 } },
      tooltip: { enabled: !1 },
      responsive: [{ breakpoint: 1025, options: { chart: { height: 199 } } }],
    },
    e = (null !== e && new ApexCharts(e, r).render(), document.querySelector('#supportTracker')),
    r = {
      series: [85],
    ...
    e = (null !== e && new ApexCharts(e, r).render(), document.querySelector('#salesLastMonth')),
    r = {
      series: [
        { name: 'Sales', data: [32, 27, 27, 30, 25, 25] },
        { name: 'Visits', data: [25, 35, 20, 20, 20, 20] },
      ],
      chart: { height: 306, type: 'radar', toolbar: { show: !1 } },
      ...
      xaxis: {
        ...
        labels: {
          show: !0,
          style: { colors: [n, n, n, n, n, n], fontSize: '13px', fontFamily: 'Public Sans' },
        },
      },
      yaxis: { show: !1, min: 0, max: 40, tickAmount: 4 },
      responsive: [{ breakpoint: 769, options: { chart: { height: 400 } } }],
    },
    e = (null !== e && new ApexCharts(e, r).render(), document.querySelector('#totalRevenueChart')),
    r = {
      series: [
      ...
      xaxis: {
        ...
        labels: { style: { fontSize: '13px', colors: n, fontFamily: 'Public Sans' } },
        axisTicks: { show: !1 },
        axisBorder: { show: !1 },
      },
      yaxis: {
        labels: { offsetX: -16, style: { fontSize: '13px', colors: n, fontFamily: 'Public Sans' } },
        min: -200,
        max: 300,
        tickAmount: 5,
      },
    ...
    e = (null !== e && new ApexCharts(e, r).render(), document.querySelector('#budgetChart')),
    r = {
    ...
    e =
      (null !== e && new ApexCharts(e, r).render(), document.querySelector('#projectStatusChart')),
    r = {
      ...
      series: [
        {
          data: [
            2e3, 2e3, 4e3, 4e3, 3050, 3050, 2e3, 2e3, 3050, 3050, 4700, 4700, 2750, 2750, 5700,
            5700,
          ],
        },
      ],
  ...
  function a(t, e) {
    var r = config.colors_label.primary,
      ...
      i = [];
    for (let o = 0; o < t.length; o++) o === e ? i.push(a) : i.push(r);
    return {
      chart: { height: 258, parentHeightOffset: 0, type: 'bar', toolbar: { show: !1 } },
      plotOptions: {
        bar: {
          columnWidth: '32%',
          startingShape: 'rounded',
      ...
      dataLabels: {
        ...
        offsetY: -25,
        style: { fontSize: '15px', colors: [s], fontWeight: '600', fontFamily: 'Public Sans' },
      },
      series: [{ data: t }],
      legend: { show: !1 },
      tooltip: { enabled: !1 },
  ...
  var e = $.ajax({
    ...
    i = a(e.data[0].chart_data, e.data[0].active_option),
    r =
      (null !== r && new ApexCharts(r, i).render(),
      document.querySelector('#earningReportsTabsSales')),
    i = a(e.data[1].chart_data, e.data[1].active_option),
    r =
      (null !== r && new ApexCharts(r, i).render(),
      document.querySelector('#earningReportsTabsProfit')),
    i = a(e.data[2].chart_data, e.data[2].active_option),
    r =
      (null !== r && new ApexCharts(r, i).render(),
      document.querySelector('#earningReportsTabsIncome')),
    i = a(e.data[3].chart_data, e.data[3].active_option),
    e = (null !== r && new ApexCharts(r, i).render(), document.querySelector('#totalEarningChart')),
    r = {
      series: [
