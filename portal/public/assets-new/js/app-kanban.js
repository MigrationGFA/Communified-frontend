...
!(async function () {
  ...
  function u(e) {
    return e.id
      ? "<div class='badge " + $(e.element).data('color') + " rounded-pill'> " + e.text + '</div>'
      : e.text;
  }
  function b() {
  ...
  const v = new jKanban({
      ...
      click: function (e) {
        var t = e,
          ...
          n = n
            ? n + ', ' + i
            : d.getDate() + ' ' + d.toLocaleString('en', { month: 'long' }) + ', ' + i,
      ...
      buttonClick: function (e, a) {
        ...
        (n.setAttribute('class', 'new-item-form'),
          ...
          n.addEventListener('submit', function (e) {
            e.preventDefault();
            var t = [].slice.call(
              document.querySelectorAll('.kanban-board[data-id=' + a + '] .kanban-item')
            );
            v.addElement(a, {
            ...
            [].slice
              .call(document.querySelectorAll('.kanban-board[data-id=' + a + '] .kanban-text'))
              .forEach(function (e) {
            ...
            (e &&
              ...
              [].slice
                .call(document.querySelectorAll('.kanban-board[data-id=' + a + '] .delete-task'))
                .forEach(function (e) {
