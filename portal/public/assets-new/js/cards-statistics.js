...
!(function () {
  ...
  var i = {
    ...
    l = {
      ...
      plotOptions: {
        bar: {
          ...
          endingShape: 'rounded',
          borderRadius: 4,
          colors: { backgroundBarColors: [s, s, s, s, s, s, s], backgroundBarRadius: 4 },
        },
      },
      ...
      responsive: [
        ...
        { breakpoint: 1368, options: { plotOptions: { bar: { columnWidth: '48%' } } } },
        {
          ...
          options: {
            plotOptions: {
              bar: { borderRadius: 6, columnWidth: '30%', colors: { backgroundBarRadius: 6 } },
            },
          },
        },
        {
        ...
        { breakpoint: 768, options: { plotOptions: { bar: { columnWidth: '25%' } } } },
        {
          breakpoint: 576,
          options: {
            plotOptions: { bar: { borderRadius: 9 }, colors: { backgroundBarRadius: 9 } },
          },
        },
        {
          breakpoint: 479,
    ...
    l = {
      ...
      fill: {
        type: 'gradient',
        gradient: { shade: e, shadeIntensity: 0.8, opacityFrom: 0.6, opacityTo: 0.25 },
      },
      dataLabels: { enabled: !1 },
    ...
    l = {
      ...
      plotOptions: {
        radialBar: {
          ...
          dataLabels: {
            name: { show: !1 },
            value: { fontSize: '22px', color: r, fontWeight: 600, offsetY: -5 },
          },
        },
      },
      ...
      responsive: [
        ...
        },
        {
          ...
          options: {
            chart: { height: 142 },
            plotOptions: {
              radialBar: { hollow: { size: '70%' }, dataLabels: { value: { fontSize: '22px' } } },
            },
          },
        },
        {
          ...
          options: {
            chart: { height: 105 },
            plotOptions: {
              radialBar: { hollow: { size: '60%' }, dataLabels: { value: { fontSize: '18px' } } },
            },
          },
        },
      ],
    ...
    n =
      (null !== n && new ApexCharts(n, l).render(), document.querySelector('#impressionThisWeek')),
    l = {
      chart: {
        height: 90,
        parentHeightOffset: 0,
    ...
    l = {
      ...
      fill: {
        type: 'gradient',
        gradient: { shade: e, shadeIntensity: 0.8, opacityFrom: 0.6, opacityTo: 0.1 },
      },
      dataLabels: { enabled: !1 },
      stroke: { width: 2, curve: 'smooth' },
    ...
    n =
      (null !== n && new ApexCharts(n, l).render(), document.querySelector('#averageDailyTraffic')),
    l = {
      ...
      xaxis: {
        ...
        axisBorder: { show: !1 },
        axisTicks: { show: !1 },
        labels: { style: { colors: t, fontSize: '13px', fontFamily: 'Public Sans' }, show: !0 },
      },
      yaxis: { labels: { show: !1 } },
      responsive: [
        ...
        {
          breakpoint: 576,
          options: { plotOptions: { bar: { columnWidth: '25%', borderRadius: 10 } } },
        },
        {
          breakpoint: 500,
    ...
    l = {
      ...
      xaxis: {
        ...
        axisBorder: { show: !1 },
        axisTicks: { show: !1 },
        labels: { style: { colors: t, fontSize: '13px', fontFamily: 'Public Sans' } },
      },
      yaxis: { labels: { show: !1 } },
    ...
    n =
      (null !== n && new ApexCharts(n, l).render(), document.querySelector('#generatedLeadsChart')),
    l = {
