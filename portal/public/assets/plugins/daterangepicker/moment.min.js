...
!(function (a, b) {
  ...
  function t(a) {
    for (var b, c, d, e, f = 0; f < a.length; ) {
      for (
        e = s(a[f]).split('-'), b = e.length, c = s(a[f + 1]), c = c ? c.split('-') : null;
        b > 0;
  ...
  function Na(a) {
    return (
      this._isUTC && (this.utcOffset(0, a), (this._isUTC = !1), a && this.subtract(Ja(this), 'm')),
      this
    );
  }
  function Oa() {
  ...
  function Ya(a, b) {
    ...
    return (
      ...
      a.isBefore(b)
        ? (c = Xa(a, b))
        : ((c = Xa(b, a)), (c.milliseconds = -c.milliseconds), (c.months = -c.months)),
      c
    );
  }
  function Za(a, b) {
