    ...
    (e.MultiTooltip = e.Element.extend({
      ...
      getLineHeight: function (t) {
        ...
        return 0 === t
          ...
          : i + (1.5 * this.fontSize * e + this.fontSize / 2) + this.titleHeight;
      },
      draw: function () {
    ...
    (e.Scale = e.Element.extend({
      ...
      buildYLabels: function () {
        ...
        for (var t = v(this.stepValue), i = 0; i <= this.steps; i++)
          this.yLabels.push(
            y(this.templateString, { value: (this.min + i * this.stepValue).toFixed(t) })
          );
        this.yLabelWidth =
          this.display && this.showLabels ? z(this.ctx, this.font, this.yLabels) + 10 : 0;
      },
      ...
      fit: function () {
        ...
        for (
          this.calculateYRange(e), this.buildYLabels(), this.calculateXLabelRotation();
          e > this.endPoint - this.startPoint;
          ...
          ((e = this.endPoint - this.startPoint),
            ...
            this.buildYLabels(),
            t < this.yLabelWidth && ((this.endPoint = i), this.calculateXLabelRotation()));
      },
          ...
          n(
            ...
            function (i, e) {
              var s = this.calculateX(e) + C(this.lineWidth),
                n = this.calculateX(e - (this.offsetGridLines ? 0.5 : 0)) + C(this.lineWidth),
      ...
      setScaleSize: function () {
        ...
        for (
          ...
          ((t = this.getPointPosition(i, d)),
            (e = this.ctx.measureText(y(this.templateString, { value: this.labels[i] })).width + 5),
                  ...
                  function (e, s) {
                    n.bars.push(
                      new this.BarClass({
                        ...
                        strokeColor:
                          'object' == typeof i.strokeColor ? i.strokeColor[s] : i.strokeColor,
