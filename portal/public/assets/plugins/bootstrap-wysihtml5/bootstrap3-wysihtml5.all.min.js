                  ...
                  try {
                    (this.docSelection.empty(),
                      'None' != this.docSelection.type &&
                        ...
                        a &&
                          ((c = M(a).createTextRange()), c.select(), this.docSelection.empty())));
                  } catch (d) {}
                  j(this);
                }),
      ...
      addRowCell: function (a, b, d) {
        ...
        a.isReal
          ...
          : 'above' != d && a.isRowspan && a.lastRow
            ? b.appendChild(this.createCells('td', 1, e))
            : c.isRowspan &&
              a.el.attr('rowspan', parseInt(g.getAttribute(a.el, 'rowspan'), 10) + 1);
      },
      add: function (a) {
        this.rectify() &&
      ...
      (b.observe(k, 'DOMNodeRemoved', function () {
        ...
        b.observe(l, 'keydown', function (a) {
          ...
          ((a.ctrlKey || a.metaKey) && !a.altKey && c && (i.commands.exec(c), a.preventDefault()),
            8 === b
              ? f(a, i.selection, l, i)
              : i.config.handleTabKey && 9 === b && (a.preventDefault(), g(i, l)));
        }),
