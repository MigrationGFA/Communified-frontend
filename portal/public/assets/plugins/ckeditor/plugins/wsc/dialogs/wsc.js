...
(function () {
  ...
  var J = function (b) {
      ...
      for (d in b)
        ((c = (c = a.dialog.getContentElement(a.dialog._.currentTabId, d))
          ? c.getElement()
          : b[d].instance.getElement().getFirst() || b[d].instance.getElement()),
        ...
        'undefined' == c &&
          (a.userDictionaryName
            ? ((c = a.userDictionaryName),
              ...
              g.postMessage.send({ message: e, target: a.targetFromFrame[void 0] }))
            : (c = ''));
            ...
            b.plugins.scayt &&
              (b.wsc.isSsrvSame = (function () {
                ...
                window.SCAYT &&
                  ...
                  (g = f.split('//')[1].split('/')[0]),
                  (p =
                    f.split(g + '/')[1].replace('/lf/scayt3/ckscayt/', '') + '/script/ssrv.cgi'));
                !d ||
                  f ||
  ...
  CKEDITOR.dialog.add('options', function (b) {
    ...
    b = function (a) {
      ...
      'delete' != h &&
        ((a = ''), '' !== r.getValue() && (a = r.getValue()), g.cookie.set('udn', a));
