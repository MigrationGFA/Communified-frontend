...
(function () {
    ...
    CKEDITOR.tools = {
      ...
      extend: function (a) {
        ...
        'boolean' == typeof (b = arguments[f - 1])
          ? f--
          : 'boolean' == typeof (b = arguments[f - 2]) && ((c = arguments[f - 1]), (f -= 2));
        for (var k = 1; k < f; k++) {
          var d = arguments[k],
            q;
        ...
        for (var f, b = [], c = 0; c < a.length; c++)
          if ((f = a[c]))
            /@import|[{}]/.test(f)
              ...
              : b.push('\x3clink type\x3d"text/css" rel\x3dstylesheet href\x3d"' + f + '"\x3e');
        return b.join('');
      },
      ...
      transformPlainTextToHtml: function (a, f) {
        ...
        c = c.replace(/\n/g, '\x3cbr\x3e');
        b ||
          (c = c.replace(new RegExp('\x3cbr\x3e(?\x3d\x3c/' + k + '\x3e)'), function (a) {
    ...
    CKEDITOR.tools.extend(CKEDITOR.dom.element.prototype, {
      ...
      getDocumentPosition: function (a) {
        ...
        if (document.documentElement.getBoundingClientRect) {
          ...
          l &&
            (CKEDITOR.env.webkit || (CKEDITOR.env.ie && 12 <= CKEDITOR.env.version)
              ? ((b = d.$.scrollLeft || g.scrollLeft), (c = d.$.scrollTop || g.scrollTop))
        ...
        a &&
          ...
          !u.equals(q) &&
            u.$.frameElement &&
            ((a = new CKEDITOR.dom.element(u.$.frameElement).getDocumentPosition(a)),
            (b += a.x),
            (c += a.y)));
      ...
      scrollIntoParent: function (a, b, c) {
        ...
        function q(a, b) {
          ...
          f = a.getWindow();
          f.equals(b) ||
            ((f = q(CKEDITOR.dom.element.get(f.$.frameElement), b)), (c.x += f.x), (c.y += f.y));
          return c;
        }
        function y(a, b) {
      ...
      getEditor: function () {
        ...
        for (b in a)
          if (
            ((c = a[b]), c.element.equals(this) && c.elementMode != CKEDITOR.ELEMENT_MODE_APPENDTO)
          )
            return c;
        return null;
      },
      ...
      this.current
        ...
        : (a
            ...
            : ((f = d),
              f.type == CKEDITOR.NODE_ELEMENT &&
                ((f = f.getChild(e)) ||
                  (f = !1 === z(d, !0) ? null : d.getNextSourceNode(!0, p, z)))),
          f && !1 === z(f) && (f = null));
      for (; f && !this._.end; ) {
        this.current = f;
        ...
        return c(e) || b(e)
          ...
          : d(e) && !a
            ...
            : (e.type == CKEDITOR.NODE_TEXT &&
                  (e.hasAscendant('pre') || CKEDITOR.tools.trim(e.getText()).length)) ||
    ...
    CKEDITOR.dom.range.prototype = {
        ...
        switch (a) {
          ...
          case CKEDITOR.ENLARGE_ELEMENT:
            ...
            r.type == CKEDITOR.NODE_TEXT
              ? (H && ((r = !CKEDITOR.tools.trim(r.substring(0, H)).length && r), (C = !!r)),
              ...
              for (; p; )
                if (((r = !1), p.type == CKEDITOR.NODE_COMMENT)) p = p.getPrevious();
                  ...
                  if (p.type == CKEDITOR.NODE_TEXT)
                    ((G = p.getText()), d.test(G) && (p = null), (r = /[\s\ufeff]$/.test(G)));
                  else if (
                    (p.$.offsetWidth > (CKEDITOR.env.webkit ? 1 : 0) || (b && p.is('br'))) &&
                    !p.data('cke-bookmark')
                  )
            ...
            for (; h || p; ) {
              ...
              for (; p; ) {
                r = !1;
                if (p.type == CKEDITOR.NODE_TEXT)
                  ((G = p.getText()), q(p, 0) || (p = null), (r = /^[\s\ufeff]/.test(G)));
          ...
          case CKEDITOR.ENLARGE_LIST_ITEM_CONTENTS:
            ...
            this.setStartAt(
              M,
              !M.is('br') && ((!h && this.checkStartOfBlock()) || (h && M.contains(h)))
      ...
      shrink: function (a, b, c) {
        if (!this.collapsed) {
          ...
          k &&
            ...
            this.setStartAt(e, b ? CKEDITOR.POSITION_AFTER_START : CKEDITOR.POSITION_BEFORE_START);
          z &&
            (d.reset(),
      ...
      splitBlock: function (a, b) {
        ...
        'br' != a &&
          (e ||
            ((e = this.fixBlock(!0, a)),
            (q = new CKEDITOR.dom.elementPath(this.endContainer, this.root).block)),
          ...
          (d
            ...
            : c
              ? ((g = new CKEDITOR.dom.elementPath(this.startContainer, this.root)),
                ...
                (e = null))
              : ((q = this.splitElement(e, b || !1)), e.is('ul', 'ol') || e.appendBogus()));
        return {
          previousBlock: e,
          nextBlock: q,
          wasStartOfBlock: c,
      ...
      checkStartOfBlock: function () {
        ...
        CKEDITOR.env.ie &&
          ...
          ((a = CKEDITOR.tools.ltrim(a.substring(0, c))), k.test(a) && this.trim(0, 1));
        this.trim();
      ...
      checkEndOfBlock: function () {
        ...
        CKEDITOR.env.ie &&
          a.type == CKEDITOR.NODE_TEXT &&
          ((a = CKEDITOR.tools.rtrim(a.substring(c))), k.test(a) && this.trim(1, 0));
        this.trim();
    ...
    a.prototype = {
      getNextParagraph: function (a) {
          ...
          q.collapsed ||
            ...
            this._.lastNode &&
              ...
              y.checkEndOfBlock() &&
                ...
                (this._.lastNode = (y.block || y.blockLimit).getNextSourceNode(!0)))),
        ...
        for (this._.nextNode = null; y; ) {
          ...
          if (z) y.type == CKEDITOR.NODE_TEXT && e.test(y.getText()) && (z = 0);
            ...
            if (CKEDITOR.dtd.$block[p] && 'false' == y.getAttribute('contenteditable')) {
              ...
              l &&
                (l.setEndAt(y, CKEDITOR.POSITION_BEFORE_START), 'br' != p && (this._.nextNode = y));
              F = 1;
            } else {
              if (y.getFirst()) {
        ...
        u &&
          ...
          ('br' == u.getName()
            ? u.remove()
            : u.getLast() && 'br' == u.getLast().$.nodeName.toLowerCase() && u.getLast().remove());
        B &&
          (u = d.getLast()) &&
          u.type == CKEDITOR.NODE_ELEMENT &&
          'br' == u.getName() &&
          ...
          u.remove();
        this._.nextNode ||
          (this._.nextNode = A || d.equals(q) || !q ? null : this._getNextSourceNode(d, 1, q));
        return d;
      },
  ...
  (function () {
    ...
    function l(a, b) {
      ...
      if (!0 === a) return a;
      if ('string' == typeof a)
        return ((a = R(a)), '*' == a ? !0 : CKEDITOR.tools.convertArrayToObject(a.split(b)));
    ...
    function f(a) {
      ...
      for (a = R(a); (b = a.match(D)); )
        ((c = b[2])
          ...
          : (d = h = c = null),
          (p['$' + e++] = { elements: b[1], classes: c, styles: d, attributes: h }),
      ...
      if (e.doFilter) {
        ...
        if (!a.allAttributes)
          for (D in g)
            l[D] ||
              (n.test(D)
                ? D == (H = D.replace(/^data-cke-saved-/, '')) || l[H] || (delete g[D], (v = !0))
                : (delete g[D], (v = !0)));
      ...
      if (H.$empty[d] || !a.children.length)
        ...
        if ('br' == b)
          ...
          if (h) ((a.name = b), (a.attributes = {}), c.push({ check: 'parent-down', el: a }));
            ...
            h = a.parent;
            for (
              var p = h.type == CKEDITOR.NODE_DOCUMENT_FRAGMENT || 'body' == h.name,
                r,
                g,
                e = d.length;
              0 < e;
      ...
      if (a instanceof CKEDITOR.editor) {
        ...
        !0 === b
          ...
          : (b || (this.customConfig = !1),
            ...
            this.allow(M[a.enterMode] + ' ' + M[a.shiftEnterMode], 'default', 1),
        ...
        if (!this.disabled && a) {
          ...
          for (h = 0; h < a.length; ++h) {
            ...
            for (e = 0; e < b.length; ++e)
              ((m = b[e]),
                'string' == typeof m
                  ? ((m = m.split(/\s*:\s*/)), (g = m[0]), (q = null), (f = m[1]))
      ...
      J = (CKEDITOR.filter.transformationsTools = {
        ...
        transform: function (a, b) {
          if ('string' == typeof b) a.name = b;
            ...
            for (p in h)
              if ('class' == p)
                for (c = a.classes.join('|'), e = h[p].split(/\s+/); (r = e.pop()); )
          ...
          a.call(
            ...
            function (a) {
              ...
              for (f in a) {
                ...
                if (A)
                  for (A.split && (A = A.split(',')), k = 0; k < A.length; k++)
                    g[A[k]] || b.push(A[k]);
              }
              if (b.length) l.call(this, b);
                ...
                for (f in g)
                  ((k = g[f]),
                    k.onLoad &&
                      !k.onLoad._called &&
                      (!1 === k.onLoad() && delete g[f], (k.onLoad._called = 1)));
                c && c.call(e || window, g);
              }
            },
            this
      ...
      parse: function (b) {
        for (var c, e, g = 0, l; (c = this._.htmlPartsRegex.exec(b)); ) {
          ...
          if ((e = c[1]))
            if (
              ((e = e.toLowerCase()),
              l && CKEDITOR.dtd.$cdata[e] && (this.onCDATA(l.join('')), (l = null)),
              !l)
            ) {
              this.onTagClose(e);
              continue;
    ...
    CKEDITOR.htmlParser.fragment.fromHtml = function (g, l, k) {
      ...
      B.onTagClose = function (a) {
        ...
        for (var c = [], d = [], h = t; h != q && h.name != a; )
          (h._.isBlockLike || d.unshift(h), c.push(h), (h = h.returnPoint || h.parent));
        if (h != q) {
            ...
            if (p)
              for (f(p, 1) && e.push(p); p; )
                (g(p) &&
                  (r = c(p)) &&
                  f(r) &&
                  ((v = c(r)) && !g(v) ? e.push(r) : (m(z).insertAfter(r), r.remove())),
                  (p = p.previous));
            for (p = 0; p < e.length; p++) e[p].remove();
            if ((e = !a || !1 !== ('function' == typeof d ? d(h) : d)))
              z || CKEDITOR.env.needsBrFiller || h.type != CKEDITOR.NODE_DOCUMENT_FRAGMENT
                ? z ||
                  CKEDITOR.env.needsBrFiller ||
                  !(
                  ...
                  ? ((e = b(h)), (e = !e || ('form' == h.name && 'input' == e.name)))
                  : (e = !1)
                : (e = !1);
            e && h.add(m(a));
          }
    ...
    function f(a, b) {
      return a.replace(b, function (a, b, c) {
        0 === a.indexOf('\x3ctextarea') &&
          (a = b + u(c).replace(/</g, '\x26lt;').replace(/>/g, '\x26gt;') + '\x3c/textarea\x3e');
        ...
        elements: {
          ...
          table: function (a) {
            a.children.slice(0).sort(function (a, b) {
              ...
              a.type == CKEDITOR.NODE_ELEMENT &&
                b.type == a.type &&
                ((c = CKEDITOR.tools.indexOf(z, a.name)), (d = CKEDITOR.tools.indexOf(z, b.name)));
              (-1 < c && -1 < d && c != d) ||
    ...
    CKEDITOR.editable = CKEDITOR.tools.createClass({
      ...
      proto: {
        ...
        on: function (a, b) {
          ...
          CKEDITOR.env.ie &&
            /^focus|blur$/.exec(a) &&
            ((a = 'focus' == a ? 'focusin' : 'focusout'), (b = e(b, this)), (c[0] = a), (c[1] = b));
        ...
        insertElementIntoRange: function (a, b) {
          ...
          if (f)
            for (
              ;
              (g = b.getCommonAncestor(0, 1)) && (l = CKEDITOR.dtd[g.getName()]) && (!l || !l[e]);
            ...
            this.attachListener(a, 'key', function (b) {
              ...
              if (c in l) {
                ...
                var h,
                  ...
                  k,
                  c = 8 == c;
                (CKEDITOR.env.ie && 11 > CKEDITOR.env.version && (h = b.getSelectedElement())) ||
                (h = g(b))
                  ? (a.fire('saveSnapshot'),
                  ...
                  : e.collapsed &&
                    ...
                    e[c ? 'checkStartOfBlock' : 'checkEndOfBlock']()
                      ? (a.fire('saveSnapshot'),
                        e[c ? 'checkEndOfBlock' : 'checkStartOfBlock']() && p.remove(),
                      ...
                      : m.blockLimit &&
                          ...
                          e.checkBoundaryOfElement(v, c ? CKEDITOR.START : CKEDITOR.END) &&
                          (k = v[c ? 'getPrevious' : 'getNext'](f))
                        ? (a.fire('saveSnapshot'),
                          e['moveToElementEdit' + (c ? 'End' : 'Start')](k),
                          e.checkStartOfBlock() && e.checkEndOfBlock() ? k.remove() : e.select(),
                          a.fire('saveSnapshot'),
                          (d = 1))
                      ...
                      ((c = d),
                        ...
                        m && d && !m.equals(d)
                          ? (a.fire('saveSnapshot'),
                            ...
                            c.deleteContents(),
                            d.getParent() &&
                              (d.moveChildren(m, !1), b.lastElement.mergeSiblings(), w(m, d, !0)),
    ...
    var f = CKEDITOR.dom.walker.whitespaces(!0),
      ...
      q = (function () {
                  ...
                  K && f in CKEDITOR.dtd.$list
                    ...
                    : ((p = !!l[f]),
                      'br' != f ||
                        !e.data('cke-eol') ||
                        (r && r != C - 1) ||
                        ((w = (m = r ? g[r - 1].node : k.getItem(r + 1)) && (!a(m) || !m.is('br'))),
        ...
        function d(b, c) {
          ...
          for (r && e.push(' '); g < m; g++)
            ((f = h.getItem(g)), a(f) && !f.is(l) ? (e = e.concat(d(f, c))) : e.push(f));
          r && e.push(' ');
          return e;
        }
        function e(b) {
        ...
        return function (n, v, D, I) {
          ...
          if (!I.checkReadOnly()) {
            ...
            if ((E = K.contains(f, !1, 1)))
              (v.splitElement(E), (n.inlineStylesRoot = E), (n.inlineStylesPeak = K.lastElement));
            K = v.createBookmark();
            ...
            if (K) {
              ...
              for (G(v, x); I < v.length; I++) {
                ...
                if ((t = J.isLineBreak)) {
                  ...
                  J.hasBlockSibling
                    ? (t = 1)
                    : (S = t.startContainer.getAscendant(q.$block, 1)) && S.is({ div: 1, p: 1 })
                      ? ((aa = S.getPosition(F)),
                        aa == CKEDITOR.POSITION_IDENTICAL || aa == CKEDITOR.POSITION_CONTAINS
                          ? (t = 0)
                          : ((F = t.splitElement(S)),
                ...
                if (t) D = 0 < I;
                  ...
                  if (E && J.isElement) {
                    ...
                    if (t) F && ((W = x.splitElement(F)), n.zombies.push(W), n.zombies.push(F));
                      ...
                      F = d(J.node, F);
                      for (
                        var S = [], aa = F.length, ca = 0, ea = void 0, Y = 0, U = -1;
                        ca < aa;
                        ca++
                      )
                        ((ea = F[ca]),
                          ' ' == ea
                            ? (Y ||
                                (X && !ca) ||
                                (S.push(new CKEDITOR.dom.text(' ')), (U = S.length)),
                              (Y = 1))
                            : (S.push(ea), (Y = 0)));
                      t && U == S.length && S.pop();
                      X = S;
                  ...
                  J.lastNotAllowed &&
                    I < v.length - 1 &&
                    ((W = y ? L : W) && x.setEndAt(W, CKEDITOR.POSITION_AFTER_START), (E = 0));
                  x.collapse();
                }
              }
              1 != v.length
                ? (B = !1)
                : ((B = v[0]),
                  (B = B.isElement && 'false' == B.node.getAttribute('contenteditable')));
              B &&
                ((D = !0),
                (t = v[0].node),
            ...
            for (X = B.createBookmark(); (N = n.zombies.pop()); )
              N.getParent() &&
                ((T = B.clone()), T.moveToElementEditStart(N), T.removeEmptyBlocksAtEnd());
            if (W)
              for (; (N = W.pop()); )
                CKEDITOR.env.needsBrFiller ? N.appendBogus() : N.append(B.document.createText(' '));
          ...
          table: (function () {
            function a(c) {
              ...
              f.guard = function (a, f) {
                ...
                if (f && g && a.equals(g))
                  ((h = c.clone()), h.setEndAt(g, CKEDITOR.POSITION_BEFORE_END), e.push(h));
                else if (!f && m && a.equals(m))
                  ((h = c.clone()), h.setStartAt(m, CKEDITOR.POSITION_AFTER_START), e.push(h));
                else {
                  if ((l = !f))
                    l =
                      a.type == CKEDITOR.NODE_ELEMENT &&
  ...
  (function () {
    function a() {
      ...
      b.compare(this._.selectionPreviousPath) ||
        (CKEDITOR.env.webkit && (this._.previousActive = this.document.getActive()),
    ...
    function e(a) {
      ...
      return b(e) ||
        b(f, 1) ||
        !(e || f || (d.type == CKEDITOR.NODE_ELEMENT && d.isBlockBoundary() && d.getBogus()))
        ? !0
        : !1;
    }
    function g(a) {
      ...
      B = (function () {
        ...
        function b(a) {
          return function (b) {
            ...
            b.selected.remove();
            e ||
              (d.moveToElementEditablePosition(c.editable()), c.getSelection().selectRanges([d]));
            c.fire('saveSnapshot');
            return !1;
          };
        }
      ...
      e.on('contentDom', function () {
        ...
        g.attachListener(
          ...
          function () {
            v &&
              CKEDITOR.env.webkit &&
              (v = e._.previousActive && e._.previousActive.equals(f.getActive()));
            e.unlockSelection(v);
            v = 0;
          },
          null,
        ...
        if (CKEDITOR.env.ie && !n) {
          ...
          g.attachListener(g, 'mousedown', function (a) {
            2 == a.data.$.button &&
              (((a = e.document.getSelection()) && a.getType() != CKEDITOR.SELECTION_NONE) ||
              ...
              k.on('mousedown', function (a) {
                function b(a) {
                  ...
                  if (d) {
                    ...
                    d.setEndPoint(
                      0 > f.compareEndPoints('StartToStart', c) ? 'EndToEnd' : 'StartToStart',
                      c
                    );
                    d.select();
                  }
          ...
          if (this.isLocked) {
            ...
            a: {
              ...
              if (
                ...
                (n = w.getEnclosedNode()) && n.type == CKEDITOR.NODE_ELEMENT && (k = n),
            ...
            if (k) this.fake(k);
              ...
              if (q) {
                ...
                if (
                  ...
                  (k.endContainer.type == CKEDITOR.NODE_ELEMENT && k.endContainer.getName() in b)
                )
                ...
                f
                  ...
                  : ((u = b.getNext(w)),
                    ...
                    (u =
                      ...
                      (t || !b.hasPrevious() || (b.getPrevious().is && b.getPrevious().is('br')))),
                ...
                a
                  ? (u
                      ? (x.moveStart('character', -1), x.select(), k.document.$.selection.clear())
                      : x.select(),
                ...
                for (x = 0; x < a.length; x++) {
                  ...
                  k.collapsed &&
                    ...
                    u.type == CKEDITOR.NODE_ELEMENT &&
                    'br' == u.getName()
                      ? (l(this.root), k.moveToPosition(u, CKEDITOR.POSITION_BEFORE_START))
  ...
  (function () {
    ...
    function b(c) {
      var f = c.document;
      if (c.collapsed)
        ((f = F(this, f)), c.insertNode(f), c.moveToPosition(f, CKEDITOR.POSITION_BEFORE_END));
      else {
        var g = this.element,
          h = this._.definition,
          l,
          ...
          if (r.equals(w)) ((r = null), (k = !0));
            ...
            if (z)
              if (
                ...
                if (
                  (u ||
                    (t && CKEDITOR.dtd.$removeEmpty[t] && (r.getPosition(w) | M) != M) ||
                  ...
                  for (
                    var t = r, Y;
                    (k = !t.getNext(K)) && ((Y = t.getParent()), n[Y.getName()]) && d(Y, q, h, Q);
          ...
          if (k && u && !u.collapsed) {
            for (
              ...
              if (y.getName() == g) {
                ...
                for (P in h.styles)
                  !C[P] && (da = y.getStyle(P)) && (k.getStyle(P) == da ? (t[P] = 1) : (C[P] = 1));
              }
              y = y.getParent();
            }
    ...
    function c(a) {
      ...
      if (a.collapsed) {
        for (
          var e = new CKEDITOR.dom.elementPath(d.getParent(), a.root), f, g = 0, k;
          g < e.elements.length && (k = e.elements[g]) && k != e.block && k != e.blockLimit;
          g++
        )
          if (this.checkElementRemovable(k)) {
            ...
            (a.checkBoundaryOfElement(k, CKEDITOR.END) ||
              ...
              : (k.mergeSiblings(),
                k.is(this.element) ? u.call(this, k) : q(k, h(this)[k.getName()]));
          }
        if (f) {
          k = d;
          for (g = 0; ; g++) {
        ...
        for (e = d; !e.equals(m); )
          ((f = e.getNextSourceNode()),
            e.type == CKEDITOR.NODE_ELEMENT &&
              ...
              (e.getName() == this.element ? u.call(this, e) : q(e, h(this)[e.getName()]),
              f.type == CKEDITOR.NODE_ELEMENT && f.contains(d) && (b(), (f = d.getNext()))),
            (e = f));
      }
      a.moveToBookmark(c);
    ...
    CKEDITOR.style = function (a, b) {
      ...
      this.type =
        a.type ||
        (C[c] ? CKEDITOR.STYLE_BLOCK : r[c] ? CKEDITOR.STYLE_OBJECT : CKEDITOR.STYLE_INLINE);
      ...
      do
        if (n.type == CKEDITOR.NODE_ELEMENT) {
          ...
          if (
            !this.lastElement &&
            ((this.lastElement = n),
            n.is(CKEDITOR.dtd.$object) || 'false' == n.getAttribute('contenteditable'))
          )
            continue;
          if (n.equals(e)) break;
          if (
            !l &&
            ((w = n.getName()),
            'true' == n.getAttribute('contenteditable') ? (l = n) : !g && d[w] && (g = n),
            a[w])
          ) {
            if ((w = !g && 'div' == w)) {
              a: {
          ...
          getNextRange: function (l) {
            ...
            if (k && 1 < a.length) {
              ...
              if (l)
                for (var w = 0; a[g + w + 1]; ) {
                  ...
                  for (f = f.getById(d[w + 1].startNode); ; ) {
                    ...
                    if (f.equals(n)) l = 1;
                    else if (c(n) || (n.type == CKEDITOR.NODE_ELEMENT && n.isBlockBoundary()))
                      continue;
                    break;
                  }
                  if (!l) break;
              ...
              for (k.moveToBookmark(d.shift()); w--; )
                ((n = a[++g]), n.moveToBookmark(d.shift()), k.setEnd(n.endContainer, n.endOffset));
            }
            return k;
          },
        };
...
*/
      ...
      if (e != CKEDITOR.DIALOG_RESIZE_NONE) {
        var f = a.getParentEditor(),
          ...
          n = CKEDITOR.tools.addFunction(function (e) {
            ...
            CKEDITOR.env.ie6Compat &&
              ((d = u.getChild(0).getFrameDocument()), d.on('mousemove', b), d.on('mouseup', c));
        ...
        a.on('load', function () {
          ...
          e == CKEDITOR.DIALOG_RESIZE_WIDTH
            ...
            : e == CKEDITOR.DIALOG_RESIZE_HEIGHT && (b = ' cke_resizer_vertical');
          b = CKEDITOR.dom.element.createFromHtml(
      ...
      CKEDITOR.ui.dialog = {
        uiElement: function (a, b, c, d, e, f, g) {
          if (!(4 > arguments.length)) {
            ...
            for (
              var l = k['class'] && k['class'].split ? k['class'].split(' ') : [], n = 0;
              n < l.length;
              n++
            )
              l[n] && (r[l[n]] = 1);
            ...
            CKEDITOR.ui.dialog.uiElement.call(
              ...
              function () {
                ...
                for (var d = 0; d < c.length; d++) {
                  ...
                  h
                    ? k.push('height:' + v(h[d]))
                    : e && e.expand && k.push('height:' + Math.floor(100 / c.length) + '%');
    ...
    function y(b) {
        ...
        return {
          ...
          exec: function (b, a) {
            var d = function (a, d) {
              ...
              c = this;
            'string' == typeof a
              ? d({ dataValue: a, method: 'paste', dataTransfer: n.initPasteDataTransfer() }, 1)
      ...
      function l(a, d) {
        ...
        if (!c.getById('cke_pastebin')) {
          ...
          (k = m.getParent().isReadOnly())
            ...
            : m.setStyle('ltr' == b.config.contentsLangDirection ? 'left' : 'right', '-1000px');
      ...
      (function () {
        function a(d, c, e, f, q) {
          ...
          b.addMenuItems &&
            b.addMenuItem(c, { label: g, command: c, group: 'clipboard', order: q });
        }
          ...
          return 'plain-text' == c
            ...
            : 'semantic-content' == c
              ? ((c = a.semanticContent) ||
                  ...
                  c.allow({ $1: { elements: b(), attributes: !0, styles: !1, classes: !1 } }),
    ...
    CKEDITOR.plugins.clipboard = {
      ...
      isDropRangeAffectedByDragRange: function (b, a) {
        ...
        return (b.endContainer.equals(c) && b.endOffset <= d) ||
          (b.startContainer.getParent().equals(c) && b.startContainer.getIndex() < d) ||
          (b.endContainer.getParent().equals(c) && b.endContainer.getIndex() < d)
          ? !0
          : !1;
      },
          ...
          CKEDITOR.tools.setTimeout(
            function () {
              var a = CKEDITOR.tools.bind(function () {
                ...
                c = a.top;
                b.height - a.top < e &&
                  (n = c > e ? n - e : b.height > e ? n - a.bottom + b.height : n - a.top);
                CKEDITOR.env.ie &&
              ...
              function (a) {
                ...
                if (!e || !c) {
                  ...
                  if (CKEDITOR.env.mac && CKEDITOR.env.webkit) {
                    var c = this.editor,
                      b = new CKEDITOR.dom.elementPath(a.getTarget(), c.editable()).contains(
                        function (a) {
  ...
  CKEDITOR.plugins.add('resize', {
    init: function (b) {
      ...
      function k() {
        ...
        b.document &&
          (b.document.removeListener('mousemove', f), b.document.removeListener('mouseup', k));
      }
      var a = b.config,
  ...
  (function () {
    function B(a) {
      function d() {
        for (
          var b = g(), e = CKEDITOR.tools.clone(a.config.toolbarGroups) || q(a), f = 0;
          f < e.length;
          f++
        ) {
          var l = e[f];
        ...
        if ((a = a || v(b))) {
          ...
          if (k && m) {
            if (c && (c.is('li') || c.getParent().is('li'))) {
              ...
              if (e.is('li'))
                h || p
                  ? (h && p && a.remove(), c[p ? 'insertAfter' : 'insertBefore'](e))
                  : c.breakParent(e);
              else {
                if (b)
                  if (
      ...
      if ('function' != typeof c || !1 !== c.call(this._.filebrowserSe))
        if (!e || !1 !== e.call(this._.filebrowserSe, a, c))
          if (
            ...
            a &&
              ((b = this._.filebrowserSe), (d = b.getDialog()), (b = b.filebrowser.target || null)))
          )
    ...
    function m(a) {
      function f(a) {
        ...
        g.attachListener(g, 'keyup', function () {
          ...
          b &&
            (1 != d.count() || d.getItem(0).getCustomData('retain') || d.getItem(0).remove(1),
            (b = !1));
        });
      }
      var b = this.editor,
    ...
    function w(c) {
      ...
      for (
        ...
        b &&
          ...
          ((h = new CKEDITOR.dom.walker(d)), (h.evaluator = t), (d.startContainer = h.next()));
        b &&
          d.endContainer.type == CKEDITOR.NODE_ELEMENT &&
          d.endContainer.getName() in p &&
          ((h = new CKEDITOR.dom.walker(d)), (h.evaluator = t), (d.endContainer = h.previous()));
        if (b) return f(b);
      }
      return 0;
    }
        ...
        if (b) {
          if ((a = b.getAttribute('target')))
            ...
            for (g.target = { type: 'popup', name: a[1] }; (e = D.exec(a[2])); )
              ('yes' != e[2] && '1' != e[2]) || e[1] in { height: 1, width: 1, top: 1, left: 1 }
    ...
    CKEDITOR.removeAnchorCommand.prototype = {
      exec: function (c) {
        ...
        if (
          ...
          (f.getChildCount() ? f.is('a') : CKEDITOR.plugins.link.tryRestoreFakeAnchor(c, f))
        )
          f.remove(1);
  ...
  (function () {
    ...
    function C(b, m, e) {
      ...
      for (; e.checkStartOfBlock() && e.checkEndOfBlock(); ) {
        ...
        if (!c) break;
        c.is('li') &&
          ((g = c.getParent()), c.equals(g.getLast(u)) && c.equals(g.getFirst(u)) && (c = g));
            ...
            for (g = 0; g < B; g++)
              if (((w = r.contents[g]), H(w) && 1 < B))
                ...
                C &&
                  n.setAttribute(
                    'style',
                    C.replace(/([^;])$/, '$1;') + (n.getAttribute('style') || '')
                  );
                D && w.addClass(D);
                n = null;
                x && (l.append(x), (x = null));
                  ...
                  ((d = h.shift()),
                    ...
                    'false' == r.getAttribute('contenteditable')
                      ...
                      : (d.copyAttributes(t),
                        a &&
                          d.getDirection() &&
                          (t.removeStyle('direction'), t.removeAttribute('dir')),
                        d.moveChildren(t),
                        d.remove()),
                    t.appendTo(n));
                ...
                if (k) {
                  ...
                  if (
                    ...
                    2 == g &&
                      (e.moveToPosition(e.endPath().block, CKEDITOR.POSITION_BEFORE_END),
                      f.endPath().block &&
                        f.moveToPosition(f.endPath().block, CKEDITOR.POSITION_AFTER_START));
                    C(b, e, f);
                    m.cancel();
                  }
                } else
      ...
      v(d, {
        ...
        mouseNear: function () {
          ...
          var b = a.holdDistance,
            c = this.size;
          return c && q(a.mouse.y, c.top - b, c.bottom + b) && q(a.mouse.x, c.left - b, c.right + b)
            ? !0
            : !1;
        },
        place: function () {
          ...
          a.inInlineMode &&
            (m.top--, (m.top += b.editable.scroll.top), (m.left += b.editable.scroll.left));
          ...
          return function (b) {
            ...
            if (!aa(a, b) && b && !b.equals(a.editable) && !b.contains(a.editable)) {
              ...
              (!w(a, e, !c) || ((f = w(a, e, !c)) && n(f) && f.is(a.triggers)))
                ...
                : ((f = O(a, b)),
                  n(f) &&
                    (w(a, f, !c) ? (b = w(a, f, !c)) && n(b) && b.is(a.triggers) && d(f) : d(f)));
            }
          };
        })(),
      };
      ...
      a.on('beforeCommandExec', function (b) {
        ...
        b.data.name in c.options.disablingCommandExec && 'wysiwyg' == a.mode
          ...
          : ('bold' !== b.data.name &&
            ...
            'language' === b.data.name &&
              ((e = (e = a.plugins.language.getCurrentLangElement(a)) && e.$), (f = !0)),
        ...
        setTimeout(
          function () {
            ...
            c &&
              c.ltr &&
              c.rtl &&
              (a.document.fire('keydown', new CKEDITOR.dom.event({ keyCode: 37 })),
      ...
      this.loadScaytLibrary(a, function (a) {
        ...
        e
          ? ((e = {
            ...
            'boolean' === typeof a.config.scayt_ignoreWordsWithMixedCases &&
              (e['ignore-words-with-mixed-cases'] = a.config.scayt_ignoreWordsWithMixedCases),
            'boolean' === typeof a.config.scayt_ignoreWordsWithNumbers &&
              (e['ignore-words-with-numbers'] = a.config.scayt_ignoreWordsWithNumbers),
            (e = new SCAYT.CKSCAYT(
              e,
              function () {},
              function () {}
          ...
          if ((b = b.data.styles)) {
            for (var a, h, d, e = 0, n = b.length; e < n; e++)
              ...
              (c.blockless && a.element in CKEDITOR.dtd.$block) ||
                ...
                (a._.weight =
                  e + 1e3 * (d == CKEDITOR.STYLE_OBJECT ? 1 : d == CKEDITOR.STYLE_BLOCK ? 2 : 3)),
                (f[h] = a),
                k.push(a),
                m.push(a));
            k.sort(function (a, b) {
  ...
  CKEDITOR.plugins.add('table', {
    ...
    init: function (a) {
      function e(a) {
        return CKEDITOR.tools.extend(a || {}, {
          ...
          refresh: function (a, f) {
            this.setState(
              f.contains('table', 1) ? CKEDITOR.TRISTATE_OFF : CKEDITOR.TRISTATE_DISABLED
            );
          },
        });
      }
      if (!a.blockless) {
        ...
        a.ui.addButton &&
          a.ui.addButton('Table', { label: c.toolbar, command: 'table', toolbar: 'insert,30' });
  ...
  (function () {
    ...
    function u(e) {
      if (e instanceof CKEDITOR.dom.selection) {
        ...
        for (
          var d = d[d.length - 1], a = d.getParent().$.rowIndex + d.$.rowSpan - 1, d = [], f = e;
          f <= a;
          f++
        ) {
    ...
    function A(e, d) {
      ...
      if (1 < k) {
        ...
        for (
          k = l = 1, a = c.clone(), a.insertAfter(c), a.append((c = b.clone())), n = z(f, g), h = 0;
          h < n.length;
          h++
        )
          n[h].rowSpan++;
        ...
        b(
          ...
          d({
            ...
            exec: function (a) {
              ...
              for (
                var d = CKEDITOR.tools.buildTableMap(a), e, l, n = [], r = 0, p = d.length;
                r < p;
                r++
              )
  ...
  CKEDITOR.tools.buildTableMap = function (t) {
    ...
    for (var p = -1, u = [], v = 0; v < t.length; v++) {
      ...
      for (var m = -1, y = 0; y < t[v].cells.length; y++) {
        ...
        for (m++; u[p][m]; ) m++;
        for (
          var q = isNaN(x.colSpan) ? 1 : x.colSpan, x = isNaN(x.rowSpan) ? 1 : x.rowSpan, z = 0;
          z < x;
          z++
        ) {
          u[p + z] || (u[p + z] = []);
