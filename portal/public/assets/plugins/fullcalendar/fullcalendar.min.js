...
(function (t) {
  ...
  function me(n, r) {
    ...
    function q(t, e) {
      return void 0 === e
        ? te[t]
        : (('height' == t || 'contentHeight' == t || 'aspectRatio' == t) && ((te[t] = e), v(!0)),
          void 0);
    }
    function K(t, e) {
    ...
    ((Q.defaultAllDayEventDuration = e.duration(te.defaultAllDayEventDuration)),
      ...
      (Q.getDefaultEventEnd = function (t, e) {
        var n = e.clone();
        return (
          t ? n.stripTime().add(Q.defaultAllDayEventDuration) : n.add(Q.defaultTimedEventDuration),
  ...
  var $e = Xe.extend({
    ...
    updateCellDates: function () {
      for (
        ...
        (t.isHiddenDay(e) ? r.push(i + 0.5) : (i++, r.push(i), n.push(e.clone())),
          e.add(1, 'days'));
