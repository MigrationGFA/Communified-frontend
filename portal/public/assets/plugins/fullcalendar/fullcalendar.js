...
----------------------------------------------------------------------------------------------------------------------*/
  ...
  setLocalValues = allowValueOptimization
    ? function (mom, a) {
        // simlate what moment's accessors do
        mom._d.setTime(
          +new Date(a[0] || 0, a[1] || 0, a[2] || 0, a[3] || 0, a[4] || 0, a[5] || 0, a[6] || 0) // FYI, there is now way to apply an array of args to a constructor
        );
        moment.updateOffset(mom, false); // keepTime=false
      }
    : setMomentValues;
...
----------------------------------------------------------------------------------------------------------------------*/
  ...
  var DayGrid = Grid.extend({
    ...
    renderFillRow: function (type, seg) {
      ...
      skeletonEl = $(
        '<div class="fc-' + type.toLowerCase() + '-skeleton">' + '<table><tr/></table>' + '</div>'
      );
