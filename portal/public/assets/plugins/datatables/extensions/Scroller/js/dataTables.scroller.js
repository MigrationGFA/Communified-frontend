    ...
    Scroller.prototype = /** @lends Scroller.prototype */ {
      ...
      _fnConstruct: function () {
        ...
        if (this.s.loadingIndicator) {
          this.dom.loader = $(
            '<div class="DTS_Loading">' + this.s.dt.oLanguage.sLoadingRecords + '</div>'
          ).css('display', 'none');
      ...
      _fnScroll: function () {
        ...
        if (iScrollTop < this.s.redrawTop || iScrollTop > this.s.redrawBottom) {
          ...
          if (Math.abs(iScrollTop - this.s.lastScrollTop) > heights.viewport || this.s.ani) {
            iTopRow =
              parseInt(this._domain('physicalToVirtual', iScrollTop) / heights.row, 10) - preRows;
      ...
      _fnInfo: function () {
        ...
        var dt = this.s.dt,
          ...
          iPossibleEnd = Math.ceil(
            this.fnPixelsToRow(iScrollTop + this.s.heights.viewport, false, this.s.ani)
          ),
