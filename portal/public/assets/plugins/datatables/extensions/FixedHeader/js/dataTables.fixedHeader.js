  ...
  var factory = function ($, DataTable) {
    ...
    FixedHeader.prototype = {
      ...
      fnInit: function (oDtSettings, oInit) {
        ...
        if (s.oSides.top) {
          s.aoCache.push(
            that._fnCloneTable('fixedHeader', 'FixedHeader_Header', that._fnCloneThead)
          );
        }
        if (s.oSides.bottom) {
          s.aoCache.push(
            that._fnCloneTable('fixedFooter', 'FixedHeader_Footer', that._fnCloneTfoot)
          );
        }
        if (s.oSides.left) {
          s.aoCache.push(
            that._fnCloneTable('fixedLeft', 'FixedHeader_Left', that._fnCloneTLeft, s.oSides.left)
          );
        }
        if (s.oSides.right) {
          s.aoCache.push(
