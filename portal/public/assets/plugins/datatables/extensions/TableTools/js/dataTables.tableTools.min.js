  ...
  var p = function (m, p) {
    ...
    TableTools.prototype = {
      ...
      fnGetTitle: function (a) {
        ...
        'undefined' != typeof a.sTitle && '' !== a.sTitle
          ? (b = a.sTitle)
          : ((a = k.getElementsByTagName('title')), 0 < a.length && (b = a[0].innerHTML));
      ...
      fnCalcColRatios: function (a) {
        var b = this.s.dt.aoColumns,
          ...
          i;
        e = 0;
        for (i = a.length; e < i; e++) a[e] && ((d = b[e].nTh.offsetWidth), (f += d), c.push(d));
        e = 0;
      ...
      _fnButtonBase: function (a, b) {
        var c, d, f;
        b
          ? ((c = a.sTag && 'default' !== a.sTag ? a.sTag : this.s.tags.collection.button),
            (d =
              a.sLinerTag && 'default' !== a.sLinerTag ? a.sLiner : this.s.tags.collection.liner),
      ...
      _fnColumnTargets: function (a) {
        ...
        } else if ('visible' == a) for (c = 0; c < d; c++) b.push(f[c].bVisible ? !0 : !1);
        else if ('hidden' == a) for (c = 0; c < d; c++) b.push(f[c].bVisible ? !1 : !0);
        else if ('sortable' == a) for (c = 0; c < d; c++) b.push(f[c].bSortable ? !0 : !1);
      ...
      _fnGetDataTablesData: function (a) {
        ...
        for (f = m.length; d < f; d++) {
          ...
          a.bOpenRows &&
            ...
            1 === b.length &&
              ((h = this._fnBoundData(e('td', b[0].nTr).html(), a.sFieldBoundary, l)), i.push(h)));
        }
        if (a.bFooter && null !== g.nTFoot) {
          ...
          for (c = g.aoColumns.length; b < c; b++)
            n[b] &&
              ...
              ((h = g.aoColumns[b].nTf.innerHTML.replace(/\n/g, ' ').replace(/<.*?>/g, '')),
              (h = this._fnHtmlDecode(h)),
              j.push(this._fnBoundData(h, a.sFieldBoundary, l)));
          i.push(j.join(a.sFieldSeperator));
        }
      ...
      _fnPrintStart: function (a) {
        ...
        a.sMessage &&
          e('<div/>').addClass(this.classes.print.message).html(a.sMessage).prependTo('body');
      ...
      _fnPrintScrollStart: function () {
        ...
        '' !== a.oScroll.sY &&
          ((b.style.height = e(a.nTable).outerHeight() + 'px'), (b.style.overflow = 'visible'));
      },
      _fnPrintScrollEnd: function () {
        var a = this.s.dt,
          b = a.nTable.parentNode;
        '' !== a.oScroll.sX &&
          ((b.style.width = a.oApi._fnStringToCss(a.oScroll.sX)), (b.style.overflow = 'auto'));
        '' !== a.oScroll.sY &&
          ((b.style.height = a.oApi._fnStringToCss(a.oScroll.sY)), (b.style.overflow = 'auto'));
      },
      ...
      _fnPrintHideNodes: function (a) {
        for (
          var b = this.dom.print.hidden, c = a.parentNode, d = c.childNodes, f = 0, g = d.length;
          f < g;
          f++
        )
    ...
    e.fn.dataTableExt.fnVersionCheck('1.9.0')
      ? e.fn.dataTableExt.aoFeatures.push({
          fnInit: function (a) {
            var b = a.oInit;
            return new TableTools(a.oInstance, b ? b.tableTools || b.oTableTools || {} : {}).dom
              .container;
          },
          cFeature: 'T',
          sFeature: 'TableTools',
