...
(function (r, s, t) {
    ...
    j.prototype = {
      ...
      _fnGridSetup: function () {
        ...
        if (
          ...
          0 < this.s.iLeftColumns && (this.dom.grid.left.foot = g.childNodes[2]),
          0 < this.s.iRightColumns)
        )
      ...
      _fnEqualiseHeights: function (a, b, c) {
        if (!('none' == this.s.sHeightMatch && 'thead' !== a && 'tfoot' !== a)) {
          ...
          a.height();
          for (
            var e = this._fnGetTrNodes(e), b = this._fnGetTrNodes(c), h = [], c = 0, a = b.length;
            c < a;
            c++
          )
            ((g = e[c].offsetHeight),
  ...
  'function' === typeof define && define.amd
    ...
    : 'object' === typeof exports
      ...
      : jQuery && !jQuery.fn.dataTable.FixedColumns && p(jQuery, jQuery.fn.dataTable);
})(window, document);
