...
(function (o, r, s) {
          ...
          for (g = a.aoData.length; c < g; c++)
            ((i = a.aoData[c]),
              h
                ...
                : (d.isArray(i._aData) && l(i._aData, b, e), l(i._anHidden, b, e)));
          c = 0;
    ...
    var f = function (a, b) {
      ...
      d.fn.dataTable.Api
        ...
        : a.fnSettings
          ? (e = a.fnSettings())
          : 'string' === typeof a
            ? d.fn.dataTable.fnIsDataTable(d(a)[0]) && (e = d(a).eq(0).dataTable().fnSettings())
            : a.nodeName && 'table' === a.nodeName.toLowerCase()
              ? d.fn.dataTable.fnIsDataTable(a.nodeName) &&
                (e = d(a.nodeName).dataTable().fnSettings())
              : a instanceof jQuery
                ? d.fn.dataTable.fnIsDataTable(a[0]) && (e = a.eq(0).dataTable().fnSettings())
                : (e = a);
  ...
  'function' === typeof define && define.amd
    ...
    : 'object' === typeof exports
      ...
      : jQuery && !jQuery.fn.dataTable.ColReorder && o(jQuery, jQuery.fn.dataTable);
})(window, document);
