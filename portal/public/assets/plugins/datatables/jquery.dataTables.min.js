  ...
  var P = function (h) {
        ...
        a = function (a) {
          if (c === k || c === j)
            ((g = o[j]),
              ...
              g && g._bAttrSrc
                ? (S(g.mData._)(e, i), q(g.mData.sort, a), q(g.mData.type, a), q(g.mData.filter, a))
                : l
      ...
      for (c = l.length; b < c; b++)
        ((f = l[b]),
          ...
          a.oFeatures.bSort &&
            ...
            !1 !== f.bSortable &&
              (e.attr('tabindex', a.iTabIndex).attr('aria-controls', a.sTableId), Oa(a, f.nTh, b))),
        ...
        if (0 !== i.length) {
          ...
          for (j = j ? 0 : g; j < f; j++) {
            ...
            if (0 !== d) {
              var n = e[c % d];
              q._sRowStripe != n &&
                (h(l).removeClass(q._sRowStripe).addClass(n), (q._sRowStripe = n));
            }
      ...
      for (var f = a.sDom.split(''), g, j, i, o, l, q, n = 0; n < f.length; n++) {
        ...
        if ('<' == j) {
          ...
          if ("'" == o || '"' == o) {
            ...
            -1 != l.indexOf('.')
              ? ((o = l.split('.')), (i.id = o[0].substr(1, o[0].length - 1)), (i.className = o[1]))
              : '#' == l.charAt(0)
    ...
    function nb(a) {
      for (
        var b = a.oClasses,
          ...
          f = d ? e[0] : e,
          e = d ? e[1] : e,
          d = h('<select/>', { name: c + '_length', 'aria-controls': c, class: b.sLengthSelect }),
          g = 0,
          j = f.length;
        g < j;
        g++
    ...
    function Y(a) {
      ...
      if ('' === c) {
        if (
          ((O.width = '100%'),
          w && (r.find('tbody').height() > i.offsetHeight || 'scroll' == q.css('overflow-y')))
        )
      ...
      G(function (a, b) {
        a.innerHTML =
          '<div class="dataTables_sizing" style="height:0;overflow:hidden;">' + C[b] + '</div>';
        a.style.width = A[b];
      }, y);
      L &&
        G(function (a, b) {
    ...
    function Ga(a) {
      ...
      if (!k && !f && !d && j == aa(a) && j == i.length)
        ...
        f && g
          ? j.width(g)
          : f
            ? (j.css('width', 'auto'), j.width() < l.offsetWidth && j.width(l.offsetWidth))
            : d
    ...
    function Jb(a) {
      for (
        var b, c, e = a.aoColumns, d = U(a), a = a.oLanguage.oAria, f = 0, g = e.length;
        f < g;
        f++
      ) {
        c = e[f];
        ...
        c.bSortable &&
          (0 < d.length && d[0].col == f
            ? (i.setAttribute('aria-sort', 'asc' == d[0].dir ? 'ascending' : 'descending'),
              (c = j[d[0].index + 1] || j[0]))
            : (c = j[0]),
    ...
    function I(a, b, c, e) {
      ...
      if (b) Ea.console && console.log && console.log(c);
        ...
        ((b = m.ext), (b = b.sErrMode || b.errMode), w(a, null, 'error', [a, e, c]), 'alert' == b)
      )
        alert(c);
      else {
      ...
      for (d in b)
        b.hasOwnProperty(d) &&
          ...
          h.isPlainObject(e)
            ...
            : (a[d] = c && 'data' !== d && 'aaData' !== d && h.isArray(e) ? e.slice() : e));
      return a;
    }
    function Va(a, b, c) {
      h(a)
    ...
    function Wa(a, b) {
      ...
      b <= c
        ...
        : a <= e
          ...
          : (a >= b - 1 - e
              ? (c = V(b - (c - 2), b))
              : ((c = V(a - e + 2, a + e - 1)), c.push('ellipsis'), c.push(b - 1)),
        ...
        if ('table' != this.nodeName.toLowerCase())
          ...
          d.bJQueryUI
            ? (h.extend(i, m.ext.oJUIClasses, d.oClasses),
              d.sDom === l.sDom && 'lfrtip' === l.sDom && (p.sDom = '<"H"lfr>t<"F"ip>'),
              p.renderer)
          ...
          p.iInitDisplayStart === k &&
            ((p.iInitDisplayStart = d.iDisplayStart), (p._iDisplayStart = d.iDisplayStart));
        ...
        if ('current' == d) {
          ...
          for (e = a.aoData.length; c < e; c++)
            'none' == j
              ? f.push(c)
              : ((d = h.inArray(c, g)),
                ((-1 === d && 'removed' == j) || (0 <= d && 'applied' == j)) && f.push(c));
        }
        return f;
      };
    r('rows()', function (a, b) {
    ...
    var cb = function (a, b) {
        ...
        c.length &&
          ...
          c._details && (c._details.remove(), (c._detailsShow = k), (c._details = k)));
      },
      Vb = function (a, b) {
        var c = a.context;
          ...
          h(a.nTable).on('order.dt.DT', function (d, f, g, h) {
            if (a === f) {
              ...
              b.removeClass(c.sSortingClass + ' ' + e.sSortAsc + ' ' + e.sSortDesc).addClass(
                h[d] == 'asc' ? e.sSortAsc : h[d] == 'desc' ? e.sSortDesc : c.sSortingClass
              );
            }
          });
        },
