...
(function ($, AdminLTE) {
  ...
  //Dark sidebar skins
  var skin_blue = $('<li />', { style: 'float:left; width: 33.33333%; padding: 5px;' }).append(
  ...
  var skin_black = $('<li />', { style: 'float:left; width: 33.33333%; padding: 5px;' }).append(
  ...
  var skin_purple = $('<li />', { style: 'float:left; width: 33.33333%; padding: 5px;' }).append(
  ...
  var skin_green = $('<li />', { style: 'float:left; width: 33.33333%; padding: 5px;' }).append(
  ...
  var skin_red = $('<li />', { style: 'float:left; width: 33.33333%; padding: 5px;' }).append(
  ...
  var skin_yellow = $('<li />', { style: 'float:left; width: 33.33333%; padding: 5px;' }).append(
  ...
  var skin_red_light = $('<li />', { style: 'float:left; width: 33.33333%; padding: 5px;' }).append(
