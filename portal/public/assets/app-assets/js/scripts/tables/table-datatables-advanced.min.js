  ...
  rangePickr.flatpickr({
    ...
    onClose: function (t, a, e) {
      var l = '',
        n = new Date();
      (null != t[0] &&
        ((l = t[0].getMonth() + 1 + '/' + t[0].getDate() + '/' + t[0].getFullYear()),
        $('.start_date').val(l)),
        null != t[1] &&
          ((n = t[1].getMonth() + 1 + '/' + t[1].getDate() + '/' + t[1].getFullYear()),
          $('.end_date').val(n)),
...
$(function () {
  ...
  var t = $('.datatables-ajax'),
    ...
    n = '../../../app-assets/';
  if (
    ('laravel' === $('body').attr('data-framework') && (n = $('body').attr('data-asset-path')),
    t.length)
  )
    t.dataTable({
      processing: !0,
      ...
      columnDefs: [
        { className: 'control', orderable: !1, targets: 0 },
        {
          ...
          render: function (t, a, e, l) {
            ...
            return void 0 === o[n]
              ? t
              : '<span class="badge rounded-pill ' + o[n].class + '">' + o[n].title + '</span>';
          },
        },
      ],
      dom: '<"d-flex justify-content-between align-items-center mx-0 row"<"col-sm-12 col-md-6"l><"col-sm-12 col-md-6"f>>t<"d-flex justify-content-between mx-0 row"<"col-sm-12 col-md-6"i><"col-sm-12 col-md-6"p>>',
