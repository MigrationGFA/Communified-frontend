$(function () {
  ...
  (r.length &&
    ...
    d.length &&
      d.flatpickr({ defaultDate: new Date(i.getFullYear(), i.getMonth(), i.getDate() + 5) }),
    u.length && u.select2({ placeholder: 'Select country', dropdownParent: u.parent() }),
    ...
    $(document).on('change', '.item-details', function () {
      ...
      e.next('textarea').length
        ...
        : e.after('<textarea class="form-control mt-2" rows="2">' + t + '</textarea>');
    }),
    m.length &&
      m.on('click', function () {
