$(function () {
  ...
  ('laravel' === $('body').attr('data-framework') &&
    ((o = $('body').attr('data-asset-path')), (r = o + 'app/user/view/account')),
    s.each(function () {
      var e = $(this);
      (e.wrap('<div class="position-relative"></div>'),
        e.select2({ dropdownAutoWidth: !0, width: '100%', dropdownParent: e.parent() }));
    }),
    e.length &&
      e.DataTable({
        ...
        initComplete: function () {
          (this.api()
            ...
            .every(function () {
              var e = this,
                t =
                  ($('<label class="form-label" for="UserRole">Role</label>').appendTo(
                    '.user_role'
                  ),
                  $(
            ...
            this.api()
              ...
              .every(function () {
                var e = this,
                  t =
                    ($('<label class="form-label" for="UserPlan">Plan</label>').appendTo(
                      '.user_plan'
                    ),
                    $(
                ...
                e.data()
                  ...
                  .each(function (e, a) {
                    t.append(
                      '<option value="' + e + '" class="text-capitalize">' + e + '</option>'
                    );
                  });
              }),
            this.api()
              ...
              .every(function () {
                var e = this,
                  t =
                    ($('<label class="form-label" for="FilterTransaction">Status</label>').appendTo(
                      '.user_status'
                    ),
                    $(
