  ...
  $.ajax({
    ...
    success: function (result) {
      ...
      for (var i = 0; i < total_users; i++) {
        ...
        var set_option = option.appendChild(document.createElement('option'));
...
const redeem_estore_credit = () => {
  ...
  for (let i = 0; i < 10; i++) {
    coupon_code += characters.charAt(Math.floor(Math.random() * charactersLength));
  }
    ...
    success: function (output) {
      ...
      $.ajax({
        ...
        success: function (result) {
          ...
          $.ajax({
            url:
              'https://estore.getfundedafrica.com/wp-json/wc/v3/coupons/' +
              coupon_id +
              '?consumer_key=ck_c8f213701a6deda717f336a7685048ccfe07e4ba&consumer_secret=cs_63ec4d100f3c089022615326120d06e1d49498b0',
            method: 'POST',
            data: JSON.stringify({}),
            processData: false,
            dataType: 'json',
