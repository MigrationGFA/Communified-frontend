  ...
  ((w.fn = w.prototype =
    ...
    w.extend({
      ...
      makeArray: function (e, t) {
        var n = t || [];
        return (
          null != e && (_(Object(e)) ? w.merge(n, 'string' == typeof e ? [e] : e) : s.call(n, e)),
          n
        );
      },
      ...
      return (
        ...
        ce(function (r, s, a, l) {
          ...
          if (r) {
            ...
            ((y = _e(y === s ? y.splice(d, y.length) : y)), o ? o(null, s, y, l) : N.apply(s, y));
        })
      );
    }
    function Ee(e) {
    ...
    w.each(w.expr.match.bool.source.match(/\w+/g), function (e, t) {
      ...
      pt[t] = function (e, t, i) {
        var o,
          ...
          s = t.toLowerCase();
        return (
          i || ((r = pt[s]), (pt[s] = o), (o = null != n(e, t, i) ? s : null), (pt[s] = r)),
          o
        );
      };
    }));
    ...
    w.each(['get', 'post'], function (e, t) {
      w[t] = function (e, n, i, o) {
        return (
          ...
          w.ajax(
            w.extend({ url: e, type: t, dataType: o, data: n, success: i }, w.isPlainObject(e) && e)
          )
        );
      };
    }),
      ...
      return (
        ...
        c
          ...
          : Object.assign(
              {},
              i,
              (((t = {})[m] = s ? h + 'px' : ''), (t[g] = f ? e + 'px' : ''), (t.transform = ''), t)
            )
      );
    }
    function D(e) {
    ...
    class J extends H {
      ...
      _slide(e, t) {
        ...
        if (this._element.classList.contains('slide')) {
          ...
          (i.classList.remove('active'), r.classList.add('active'), (this._isSliding = !1), f());
        a && this.cycle();
      }
      _directionToOrder(e) {
