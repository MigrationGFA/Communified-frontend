  ...
  function E(p, v) {
            ...
            if (
              ...
              ((w.daysContainer.style.width = t + 'px'),
                (w.calendarContainer.style.width =
                  t + (void 0 !== w.weekWrapper ? w.weekWrapper.offsetWidth : 0) + 'px'),
    ...
    function S() {
      if (void 0 !== w.hourElement && void 0 !== w.minuteElement) {
        ...
        void 0 !== w.amPM &&
          ((e = n), (t = w.amPM.textContent), (n = (e % 12) + 12 * r(t === w.l10n.amPM[1])));
        var o =
    ...
    function W(e) {
      for (
        var t = e > 0 ? 0 : w.config.showMonths - 1, n = e > 0 ? w.config.showMonths : -1, a = t;
        a != n;
        a += e
      )
        for (
    ...
    function V(e) {
      return (
        !(!w.config.appendTo || !w.config.appendTo.contains(e)) || w.calendarContainer.contains(e)
      );
    }
    function Z(e) {
        ...
        switch (e.keyCode) {
          ...
          case 39:
            if (r || n) w.hourElement && w.hourElement.focus();
              ...
              (e.preventDefault(),
              void 0 !== w.daysContainer &&
                (!1 === a || (document.activeElement && ee(document.activeElement))))
            ) {
          ...
          case 40:
            ...
            (w.daysContainer && void 0 !== t.$i) || t === w.input || t === w.altInput
              ...
              : t === w.currentYearElement
                ? Q(w.currentYear - c)
                : w.config.enableTime &&
                  (!r && w.hourElement && w.hourElement.focus(), I(e), w._debouncedChange());
            break;
          case 9:
            if (r) {
      ...
      (function () {
        ((w.element = w.input = p),
          ...
          (function () {
            ...
            i.altInputClass ||
              (w.config.altInputClass = re().className + ' ' + w.config.altInputClass);
            pe('onParseConfig');
          })(),
          le(),
          (function () {
          ...
          (w.selectedDates.length || w.config.noCalendar) &&
            (w.config.enableTime && _(w.config.noCalendar ? w.latestSelectedDateObj : void 0),
            be(!1)),
          k());
