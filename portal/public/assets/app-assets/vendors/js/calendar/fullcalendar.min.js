...
var FullCalendar = (function (e) {
  ...
  function At(e, t, n) {
    ...
    return (
      ...
      r.length > 10 &&
        (null == t ? (r = r.replace('Z', '')) : 0 !== t && (r = r.replace('Z', Wt(t, !0)))),
      r
    );
  }
  function Ut(e) {
  ...
  function dr(e, t, n) {
    n.emitter.trigger(
      'select',
      r(r({}, pr(e, n)), { jsEvent: t ? t.origEvent : null, view: n.viewApi || n.calendarApi.view })
    );
  }
  function pr(e, t) {
    ...
    return (
      r(i, ((n = e), (o = t.dateEnv), r(r({}, ur(n.range, o, n.allDay)), { allDay: n.allDay }))),
      i
    );
  }
  function fr(e, t, n) {
          ...
          if (e instanceof Cr) {
            ...
            return (
              this.getCurrentData().eventStore.defs[n.defId] ||
                (this.dispatch({ type: 'ADD_EVENTS', eventStore: vn({ def: n, instance: r }) }),
      ...
      return (
        (e.prototype.setProp = function (e, t) {
          ...
          if (e in Tn)
            ...
            ((t = _n[e](t)), this.mutate({ standardProps: ((n = {}), (n[e] = t), n) }));
          else if (e in Dn) {
            var o = Dn[e](t);
            ('color' === e
  ...
  function Hr(e) {
    for (
      var t = e.length > 0 ? e[0].code : 'en', n = Pr.concat(e), r = { en: Nr }, o = 0, i = n;
      o < i.length;
      o++
    ) {
      var a = i[o];
      ...
      return (
        (e.prototype.addSegs = function (e) {
          for (var t = [], n = 0, r = e; n < r.length; n++) {
            var o = r[n];
            this.insertEntry(
              { segInput: o, spanStart: o.spanStart, spanEnd: o.spanEnd, thickness: o.thickness },
              t
            );
          }
          return t;
        ...
        (e.prototype.splitEntry = function (e, t, n) {
          ...
          return (
            ...
            t.spanEnd < e.spanEnd &&
              (i += this.insertEntry(r(r({}, e), { spanStart: t.spanEnd, spanEnd: e.spanEnd }), a)),
            i
              ? (n.push.apply(
                  n,
                  o(
        ...
        (t.prototype.renderWidgetGroup = function (e) {
          for (
            ...
            var u = l[s],
              ...
              f = u.buttonIcon;
            if ('title' === c)
              ((a = !1), i.push(mo('h2', { className: 'fc-toolbar-title' }, t.title)));
            else {
    ...
    ya = (function () {
      ...
      return (
        ...
        (e.prototype._sliceBusinessHours = function (e, t, n, r) {
          for (var i = [], a = 4; a < arguments.length; a++) i[a - 4] = arguments[a];
          return e
            ? this._sliceEventStore.apply(this, o([wt(e, Ea(t, Boolean(n)), r), {}, t, n], i)).bg
            : [];
        }),
        ...
        (e.prototype._sliceDateSpan = function (e, t, n) {
          ...
          if (!e) return [];
          for (
            var a = cr(e, t, n), s = this.sliceRange.apply(this, o([e.range], r)), l = 0, u = s;
            l < u.length;
            l++
          ) {
            var c = u[l];
          ...
          return mo(
            ...
            function (t, o, i, a, s) {
              return mo(
                ...
                s.isStartResizable &&
                  mo('div', { className: 'fc-event-resizer fc-event-resizer-start' }),
                s.isEndResizable &&
                  mo('div', { className: 'fc-event-resizer fc-event-resizer-end' })
              );
            }
          );
        }),
      ...
      return (
        ...
        (o.handleRenderRequest = function () {
          if (o.isRendering) {
            ...
            o.isRendered && ((o.isRendered = !1), wo(o.el), o.setClassNames([]), o.setHeight(''));
          Co();
        }),
        (o.el = t),
      ...
      function t(t) {
        ...
        ((n.dragSelection = null),
          ...
          (n.handlePointerUp = function (e) {
            n.dragSelection &&
              (dr(n.dragSelection, e, n.component.context), (n.dragSelection = null));
          }));
      ...
      ((n.draggingSegEl = null),
        ...
        (n.handleHitUpdate = function (e, t, r) {
          ...
          (l &&
            ...
            c ? He() : Oe(),
            t ||
              (l && Ts(a, e) && (l = null), (n.validMutation = l), (n.mutatedRelevantEvents = u)));
        }),
        (n.handleDragEnd = function (e) {
          var t = n.component.context,
            o = n.eventRange.def,
  ...
  function nl(e, t, n, r, o, i, a) {
    ...
    for (var l = [], u = [], c = 0; c < e.length; c += 1) {
      ...
      null != d
        ? l.push({ index: c, spanStart: R.firstCol, spanEnd: R.lastCol + 1, thickness: d })
        : u.push(R);
    }
    for (
      var p = s.addSegs(l),
          ...
          (t.renderHeadAxis = function (e, n) {
            ...
            return o.weekNumbers && 'day' === e
              ...
              : mo(
                  ...
                  mo('div', { className: 'fc-timegrid-axis-frame', style: { height: n } })
                );
          }),
              ...
              return mo(
                'div',
                {
                  className:
                    ...
                    (s.stackForward > 0 ? ' fc-timegrid-event-harness-inset' : ''),
                  key: c,
  ...
  function Gl(e, t, n, r, o) {
    for (
      ...
      var c = o.add(i, a),
        d = null !== Ht(s, l);
      (u.push({ date: c, time: a, key: c.toISOString(), isoTimeStr: Lt(c), isLabeled: d }),
        (a = Mt(a, r)),
        (s = Mt(s, r)));
    }
    return u;
    ...
    return (
      ...
      (t.prototype._eventStoreToSegs = function (e, t, n) {
        return this.eventRangesToSegs(
          jn(e, t, this.props.dateProfile.activeRange, this.context.options.nextDayThreshold).fg,
          n
        );
      }),
