  ...
  (function (a, e, t) {
    ...
    if (
      ...
      t(a).on('load', function () {
        var r = !1;
        ((n.hasClass('menu-collapsed') || 'true' === localStorage.getItem('menuCollapsed')) &&
          (r = !0),
        ...
        (t('a[data-action="collapse"]').on('click', function (a) {
          ...
          t('.dropdown-notification .dropdown-menu, .dropdown-cart .dropdown-menu').on(
            'click',
            function (a) {
              a.stopPropagation();
            }
          ...
          t('.card .heading-elements a[data-action="collapse"]').on('click', function () {
            ...
            parseInt(e[0].style.height, 10) > 0
              ...
              : e.data('height') &&
                ((a = e.data('height')), e.css('height', a).attr('data-height', ''));
          }),
        ...
        ('horizontal-menu' != l &&
          !1 === r &&
          t('.main-menu-content').find('li.active').parents('li').addClass('open'),
          'horizontal-menu' == l &&
            (t('.main-menu-content')
              .find('li.active')
        ...
        var i = t('.chartjs'),
          ...
          d = t('.main-menu');
        if (
          (i.css('height', c), n.hasClass('boxed-layout') && n.hasClass('vertical-overlay-menu'))
        ) {
          var h = d.width(),
        ...
        (t('.char-textarea').on('keyup', function (e) {
          ...
          t('.content-overlay').on('click', function () {
            ...
            (a.hasClass('open') &&
              (a.removeClass('open'), w.val(''), w.blur(), y.removeClass('show')),
    ...
    (t('.search-list-main').mouseenter(function () {
        ...
        if (
          ...
          if (
            ...
            (x.addClass('show-overlay'),
              b.focus() ? S.addClass('show') : (y.addClass('show'), S.removeClass('show')),
              ...
              for (m = 0; m < a.listItems.length; m++) {
                if (!0 === n) {
                  ...
                  for (p = t('ul.nav.navbar-nav.bookmark-icons li'), v = 0; v < p.length; v++)
                    s =
                      a.listItems[m].name === p[v].firstChild.dataset.bsOriginalTitle
                        ? ' text-warning'
                        : '';
                  h = feather.icons.star.toSvg({ class: 'bookmark-icon float-end' + s });
                }
      ...
      t('html').on('click', function (a) {
        t(a.target).hasClass('bookmark-icon') ||
          ...
          b.hasClass('show') && (b.removeClass('show'), x.removeClass('show-overlay')));
      }),
      ...
      t(e).on('click', '.bookmark-input .search-list .bookmark-icon', function (a) {
        if ((a.stopPropagation(), t(this).hasClass('text-warning'))) {
          ...
          for (var e = t('ul.nav.navbar-nav.bookmark-icons li'), s = 0; s < e.length; s++)
            e[s].firstChild.dataset.bsOriginalTitle == t(this).parent()[0].innerText &&
              e[s].remove();
          a.preventDefault();
        } else {
      ...
      t(a).on('keydown', function (e) {
        ...
        if (
          (40 === e.keyCode
            ...
            : 38 === e.keyCode &&
              ((n = o.prev()), o.removeClass('current_item'), (o = n.addClass('current_item'))),
      ...
      t('.form-password-toggle .input-group-text').on('click', function (a) {
        ...
        'text' === o.attr('type')
          ? (o.attr('type', 'password'),
            feather &&
              n.find('svg').replaceWith(feather.icons.eye.toSvg({ class: 'font-small-4' })))
          : 'password' === o.attr('type') &&
            (o.attr('type', 'text'),
            feather &&
              n.find('svg').replaceWith(feather.icons['eye-off'].toSvg({ class: 'font-small-4' })));
      }),
        ...
        n.hasClass('navbar-static')) &&
          (t(a).scrollTop() > 65
            ? (t('html:not(.dark-layout) .horizontal-menu .header-navbar.navbar-fixed').css({
              ...
              t('.dark-layout .horizontal-menu .horizontal-menu-wrapper.header-navbar').css(
                'background',
                '#161d31'
              ))
            : (t('html:not(.dark-layout) .horizontal-menu .header-navbar.navbar-fixed').css({
