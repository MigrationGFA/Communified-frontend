!function () {
  ...
  function o(l, n) {
    switch (
      ((this.b = l), (this.g = !!n.v), (this.a = n.c), (this.i = n.type), (this.h = !1), this.a)
    ) {
      case O:
      case H:
      case q:
...
*/
    ...
    for (var n = l.f.length, u = 0; u < n; ++u) {
      ...
      if (-1 != d.indexOf('|')) i = !1;
        ...
        (s.length < o.a.b.length
          ? (o = '')
          : ((o = s.replace(new RegExp(d, 'g'), a)), (o = o.replace(RegExp('9', 'g'), ' '))),
  ...
  function j(l, n) {
    for (var u = [], t = n.length - 3, e = l.f.length, r = 0; r < e; ++r) {
      ...
      0 == g(i, 3)
        ? u.push(l.f[r])
        : ((i = c(i, 3, Math.min(t, g(i, 3) - 1))), 0 == n.search(i) && u.push(l.f[r]));
    }
    l.f = u;
  }
  function I(l, n) {
        ...
        return l.A
          ...
          : 0 < l.f.length
            ? ((u = K(l, n)),
              ...
              0 < e.length
                ? e
                : (j(l, l.a.toString()), G(l) ? T(l) : l.l ? R(l, u) : l.i.toString()))
            : E(l);
    }
  }
  function V(l) {
  ...
  function $(l) {
    for (var n = l.a.toString(), u = l.f.length, t = 0; t < u; ++t) {
      ...
      if (new RegExp('^(?:' + r + ')$').test(n))
        return ((l.B = sl.test(c(e, 4))), (n = n.replace(new RegExp(r, 'g'), c(e, 2))), R(l, n));
    }
    return '';
  }
  function R(l, n) {
  ...
  function E(l) {
    ...
    if (3 <= n.length) {
      for (
        var u = l.o && 0 == l.h.length && 0 < g(l.g, 20) ? p(l.g, 20) || [] : p(l.g, 19) || [],
          t = u.length,
          e = 0;
        e < t;
        ++e
