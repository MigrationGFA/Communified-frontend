        ...
        (t.prototype.handleStepPoint = function (t, e) {
          if (e)
            if (this.xVal[t] !== this.xVal[t + 1]) {
              this.xSteps[t] =
                p([this.xVal[t], this.xVal[t + 1]], e, 0) / c(this.xPct[t], this.xPct[t + 1]);
  ...
  function j(t, b, o) {
    ...
    function B(t, e) {
      (e.handle && (ht(e.handle, b.cssClasses.active), (m -= 1)),
        ...
        0 === m &&
          ...
          Q(),
          t.cursor && ((E.style.cursor = ''), E.removeEventListener('selectstart', ut))),
    ...
    function q(t, e) {
      if (!e.handleNumbers.some(U)) {
        ...
        if (1 === e.handleNumbers.length)
          ((r = u[e.handleNumbers[0]].children[0]), (m += 1), dt(r, b.cssClasses.active));
        t.stopPropagation();
        var n = [],
          i = H(p.move, w, _, {
            target: t.target,
    ...
    function I(t) {
      ...
      Object.keys(g).forEach(function (t) {
        ...
        (i && i !== r) ||
          (o && o !== n) ||
          ((((e = n) !== gt.aria && e !== gt.tooltips) || o === n) && delete g[t]);
      });
    }
    function W(r, n, i) {
      Object.keys(g).forEach(function (t) {
    ...
    function $(t, e, r, n, i, o) {
      ...
      return (
        1 < u.length &&
          ...
          (n &&
            0 < e &&
            ((s = y.getAbsoluteDistance(t[e - 1], b.margin, !1)), (r = Math.max(r, s))),
          i &&
            e < u.length - 1 &&
            ((s = y.getAbsoluteDistance(t[e + 1], b.margin, !0)), (r = Math.min(r, s)))),
        1 < u.length &&
          b.limit &&
          (n && 0 < e && ((s = y.getAbsoluteDistance(t[e - 1], b.limit, !1)), (r = Math.min(r, s))),
          i &&
            e < u.length - 1 &&
            ((s = y.getAbsoluteDistance(t[e + 1], b.limit, !0)), (r = Math.max(r, s)))),
        b.padding &&
          (0 === e && ((s = y.getAbsoluteDistance(0, b.padding[0], !1)), (r = Math.max(r, s))),
          e === u.length - 1 &&
            ((s = y.getAbsoluteDistance(100, b.padding[1], !0)), (r = Math.min(r, s)))),
