    ...
    if ('viewport' === b) {
      ...
      y(b)
        ...
        : ((f = L(a)),
          ...
          (c = E(a.scrollWidth, a.clientWidth, b ? b.scrollWidth : 0, b ? b.clientWidth : 0)),
          (e = E(a.scrollHeight, a.clientHeight, b ? b.scrollHeight : 0, b ? b.clientHeight : 0)),
          (f = -d.scrollLeft + wa(f)),
          (d = -d.scrollTop),
          'rtl' === H(b || a).direction && (f += E(a.clientWidth, b ? b.clientWidth : 0) - c),
          (a = ya({ width: c, height: e, x: f, y: d })));
    return a;
  }
  function Bb(a) {
    var b = ha(la(a)),
