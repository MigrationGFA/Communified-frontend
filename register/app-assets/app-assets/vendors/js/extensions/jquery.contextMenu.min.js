    ...
    b = {
      ...
      click: function (e) {
        (e.preventDefault(),
          ...
          m(this).trigger(
            m.Event('contextmenu', { data: e.data, pageX: e.pageX, pageY: e.pageY })
          ));
      },
        ...
        n.is('.context-menu-list') ||
          ...
          (s.timer = setTimeout(function () {
            ((s.timer = null),
              ...
              (c = t).trigger(
                m.Event('contextmenu', { data: s.data, pageX: s.pageX, pageY: s.pageY })
              ));
          }, e.data.delay)));
      },
          ...
          setTimeout(function () {
            if (d)
              ...
              if (document.elementFromPoint && c.$layer) {
                if (
                  (c.$layer.hide(),
                  null !== (s = document.elementFromPoint(r - p.scrollLeft(), u - p.scrollTop())) &&
                    s.isContentEditable)
                ) {
              ...
              if (c.hideOnSecondTrigger && t && null !== c.$menu && void 0 !== c.$menu)
                c.$menu.trigger('contextmenu:hide');
              else {
                if (c.reposition && t)
                  if (document.elementFromPoint) {
                    ...
                    i.top <= a.pageY &&
                      ...
                      i.left <= a.pageX &&
                        ...
                        i.bottom >= a.pageY &&
                          ((i.right = i.left + c.$trigger.outerWidth()), i.right >= a.pageX))))
                  )
          ...
          switch (e.keyCode) {
            ...
            case 38:
              if ((b.keyStop(e, t), t.isInput)) {
                ...
                if (
                  38 === e.keyCode &&
                  'checkbox' === t.$selected.find('input, textarea, select').prop('type')
                )
            ...
            case 36:
              return t.$selected && t.$selected.find('input, textarea, select').length
                ...
                : (((t.$selected && t.$selected.parent()) || t.$menu)
                    .children(
                      ':not(.' + t.classNames.disabled + ', .' + t.classNames.notSelectable + ')'
                    )
      ...
      prevItem: function (e) {
        ...
        for (
          var a = t.$menu.children(),
            s = t.$selected && t.$selected.prev().length ? t.$selected.prev() : a.last(),
            i = s;
      ...
      nextItem: function (e) {
        ...
        for (
          var a = t.$menu.children(),
            s = t.$selected && t.$selected.next().length ? t.$selected.next() : a.first(),
            i = s;
          s.hasClass(n.classNames.disabled) ||
          s.hasClass(n.classNames.notSelectable) ||
          s.is(':hidden');
                  ...
                  (m.isFunction(o.icon)
                    ...
                    : 'string' != typeof o.icon ||
                      ...
                      ? 'string' == typeof o.icon && 'fa-' === o.icon.substring(0, 3)
                        ? (o._icon =
                            u.classNames.icon + ' ' + u.classNames.icon + '--fa fa ' + o.icon)
                        : (o._icon = u.classNames.icon + ' ' + u.classNames.icon + '-' + o.icon)
                      : (e.addClass(u.classNames.icon + ' ' + u.classNames.icon + '--fa5'),
  ...
  ((m.fn.contextMenu = function (e) {
    ...
    if (0 < this.length)
      if (void 0 === e) this.first().trigger('contextmenu');
        ...
        this.first().trigger(
          m.Event('contextmenu', { pageX: e.x, pageY: e.y, mouseButton: e.button })
        );
      else if ('hide' === e) {
