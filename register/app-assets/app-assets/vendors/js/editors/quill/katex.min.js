  ...
  return (function (t) {
    ...
    function (t, e, r) {
          ...
          return (
            ...
            (e.toMarkup = function () {
              var t = !1,
                e = '<span';
              this.classes.length &&
                ((t = !0), (e += ' class="'), (e += c.escape(T(this.classes))), (e += '"'));
              var r = '';
      ...
      var St = kt,
        ...
        Tt = function (t, e) {
          ...
          if (t.unit in Mt) r = Mt[t.unit] / e.fontMetrics().ptPerEm / e.sizeMultiplier;
            ...
            var a;
            if (((a = e.style.isTight() ? e.havingStyle(e.style.text()) : e), 'ex' === t.unit))
        ...
        Ct = function (t, e, r, a, n) {
          ...
          if (((t = o.value), s)) {
            ...
            ('undefined' != typeof console &&
              console.warn(
                "No character metrics for '" + t + "' in style '" + e + "' and mode '" + r + "'"
              ),
          ...
          makeOrd: function (t, e, r) {
            ...
            if (l) {
              ...
              if ('boldsymbol' === l) {
                ...
                s
                  ? ((u = Lt[l].fontName), (p = [l]))
                  : ((u = Et(l, e.fontWeight, e.fontShape)), (p = [l, e.fontWeight, e.fontShape]));
      ...
      var $t = function (t) {
        ...
        ae = function (t) {
          return t instanceof A || t instanceof I || (t instanceof N && t.hasClass('enclosing'))
            ? t
            : null;
        },
        ne = function (t, e) {
        ...
        for (var a, n = ee(t, e, 'root'), i = [], o = [], s = 0; s < n.length; s++)
          if (
            ...
            n[s].hasClass('newline') &&
              (o.pop(), o.length > 0 && (i.push(se(o, e)), (o = [])), i.push(n[s]));
      ...
      function be(t, e, r, a, n) {
        var i,
          o = ge(t, r);
        i =
          1 === o.length && o[0] instanceof me && c.contains(['mrow', 'mtable'], o[0].type)
            ? o[0]
      ...
      var ye = function (t) {
        ...
        Ae = function (t, e, r, a) {
          ...
          if (/fbox|color/.test(e)) {
            ...
            (/^[bx]cancel$/.test(e) &&
              s.push(
                new D({ x1: '0', y1: '0', x2: '100%', y2: '100%', 'stroke-width': '0.046em' })
              ),
              /^x?cancel$/.test(e) &&
                s.push(
                  new D({ x1: '0', y1: '100%', x2: '100%', y2: '0', 'stroke-width': '0.046em' })
                ));
      ...
      var Ie = function (t, e) {
          ...
          if (a.isStretchy)
            ...
            ('\\vec' === a.label
              ...
              : (((m = H((m = Dt.makeOrd({ mode: a.mode, text: a.label }, e, 'textord')))).italic =
                  0),
                (u = m.width)),
      ...
      (_t({
        ...
        _t({
          ...
          htmlBuilder: function (t, e) {
            ...
            return (
              t.newLine &&
                (r.classes.push('newline'), t.size && (r.style.marginTop = Tt(t.size, e) + 'em')),
              r
            );
          },
          mathmlBuilder: function (t, e) {
      ...
      var De = {
        ...
        Fe = function (t, e, r, a) {
          ...
          (null == n &&
            ((r.noexpand = !0),
            (n = { tokens: [r], numArgs: 0, unexpandable: !t.gullet.isExpandable(r.text) })),
      ...
      (_t({
        ...
        handler: function (t) {
          ...
          if (De[a.text])
            return (
              ('\\global' !== r && '\\\\globallong' !== r) || (a.text = De[a.text]),
        ...
        ar = function (t, e, r, a) {
          for (var n = Math.min(2, 3 - a.style.size); n < r.length && 'stack' !== r[n].type; n++) {
            var i = Ve(t, rr(r[n]), 'math'),
              o = i.height + i.depth;
            if (
              ('small' === r[n].type && (o *= a.havingBaseStyle(r[n].style).sizeMultiplier), o > e)
            )
              return r[n];
          }
          return r[r.length - 1];
      ...
      (_t({
        ...
        _t({
          ...
          htmlBuilder: function (t, e) {
            ur(t);
            for (
              var r, a, n = ee(t.body, e, !0, ['mopen', 'mclose']), i = 0, o = 0, s = !1, l = 0;
              l < n.length;
              l++
            )
              n[l].isMiddle
      ...
      var pr = function (t, e) {
          ...
          if ('sout' === i)
            ...
            (/box/.test(i)
              ...
              /fbox|boxed|fcolorbox/.test(i) &&
                ((r.style.borderStyle = 'solid'), (r.style.borderWidth = m + 'em')),
              (s = n.depth + h),
              t.backgroundColor &&
        ...
        dr = function (t, e) {
          var r = 0,
            a = new ue.MathNode(t.label.indexOf('colorbox') > -1 ? 'mpadded' : 'menclose', [
              ve(t.body, e),
            ]);
          switch (t.label) {
            case '\\cancel':
        ...
        kr = function (t, e) {
          ...
          if (t.cols && t.cols.length > 0) {
            ...
            ('separator' === o[0].type && ((n += 'top '), (h = 1)),
              'separator' === o[o.length - 1].type && ((n += 'bottom '), (m -= 1)));
            for (var c = h; c < m; c++)
              'align' === o[c].type
                ? ((i += wr[o[c].align]), l && (s += 'none '), (l = !0))
                : 'separator' === o[c].type &&
                  l &&
                  ((s += '|' === o[c].separator ? 'solid ' : 'dashed '), (l = !1));
          ...
          return (
            ...
            t.arraystretch &&
              t.arraystretch < 1 &&
              (r = new ue.MathNode('mstyle', [r])).setAttribute('scriptlevel', '1'),
            r
          );
        },
        Sr = function (t, e) {
      ...
      var Ir = function (t, e) {
        ...
        Or = function (t, e) {
          ...
          if (
            (t.hasBarLine
              ? (t.barSize
                  ? ((m = Tt(t.barSize, e)), (h = Dt.makeLineSpan('frac-line', e, m)))
      ...
      var Fr = function (t, e, r, a, n, i, o) {
          ...
          if (l && s) {
            var u =
              a.fontMetrics().bigOpSpacing5 + s.elem.height + s.elem.depth + s.kern + t.depth + o;
            h = Dt.makeVList(
              {
                positionType: 'bottom',
                positionData: u,
        ...
        Ur = function (t, e) {
          ...
          var o,
            ...
            l = !1;
          if (
            (s.size === w.DISPLAY.size && n.symbol && !c.contains(Vr, n.name) && (l = !0), n.symbol)
          ) {
            var h = l ? 'Size2-Regular' : 'Size1-Regular',
              m = '';
            if (
              (('\\oiint' !== n.name && '\\oiiint' !== n.name) ||
                ((m = n.name.substr(1)), (n.name = 'oiint' === m ? '\\iint' : '\\iiint')),
          ...
          return (
            ...
            i
              ? Fr(o, r, a, e, s, v, x)
              : (x && ((o.style.position = 'relative'), (o.style.top = x + 'em')), o)
          );
        },
        Gr = function (t, e) {
          var r;
      ...
      (_t({
        ...
        handler: function (t, e) {
          ...
          return (
            1 === a.length && (a = Yr[a]),
            { type: 'op', mode: r.mode, limits: !0, parentIsSupSub: !1, symbol: !0, name: a }
          );
        },
        htmlBuilder: Ur,
        mathmlBuilder: Gr,
      ...
      (_t({
        ...
        _t({
          ...
          handler: function (t) {
            ...
            return (
              1 === r.length && (r = Wr[r]),
              { type: 'op', mode: e.mode, limits: !1, parentIsSupSub: !1, symbol: !0, name: r }
            );
          },
          htmlBuilder: Ur,
          mathmlBuilder: Gr,
      ...
      var Xr = function (t, e) {
        ...
        if (
          ('supsub' === t.type
            ? ((r = t.sup), (a = t.sub), (n = Ce(t.base, 'operatorname')), (o = !0))
            : (n = Ce(t, 'operatorname')),
          n.body.length > 0)
        ) {
          for (
      ...
      (jt({
        ...
        htmlBuilder: function (t, e) {
          ...
          if (s) {
            ...
            ((a = oe(s, f, e)),
              d ||
                (u = h.height - (f.fontMetrics().supDrop * f.sizeMultiplier) / e.sizeMultiplier));
          }
          if (l) {
        ...
        ya = (function () {
          ...
          return (
            ...
            (e.expandOnce = function (t) {
              ...
              if (a.numArgs)
                for (
                  var i = this.consumeArgs(a.numArgs), s = (n = n.slice()).length - 1;
                  s >= 0;
                  --s
                ) {
                  var l = n[s];
            ...
            (e.isExpandable = function (t) {
              var e = this.macros.get(t);
              return null != e
                ? 'string' == typeof e || 'function' == typeof e || !e.unexpandable
                : ia.hasOwnProperty(t);
            }),
            t
          );
          ...
          return (
            ...
            (e.parseGroup = function (e, r, n, i, s, l) {
              ...
              if (r ? '[' === u : '{' === u || '\\begingroup' === u) {
                ...
                null == (m = this.parseFunction(i, e, n) || this.parseSymbol()) &&
                '\\' === u[0] &&
                !ba.hasOwnProperty(u)
              ) {
