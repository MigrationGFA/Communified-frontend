      ...
      if (t)
        switch (t.name) {
          case 'xl':
            ...
            break;
          case 'lg':
            'vertical-overlay-menu' === s || 'vertical-menu-modern' === s || 'horizontal-menu' === s
              ? this.hide()
              : this.collapse();
            break;
          case 'md':
      ...
      bind_events: function () {
        ...
        (a('.navigation-main')
            ...
            if (i.hasClass('menu-collapsed') && 'vertical-menu-modern' != i.data('menu')) {
              ...
              (e.hasClass('has-sub') ||
                ...
                'vertical-compact-menu' !== i.data('menu') &&
                  o.appendTo('.main-menu-content').css({ position: 'fixed', top: s }));
            }
          })
          ...
          .on('click.app.menu', 'li', function (e) {
            var n = a(this);
            (n.is('.disabled') ||
            (i.hasClass('menu-collapsed') && 'vertical-menu-modern' != i.data('menu'))
              ? e.preventDefault()
              : n.has('ul').length
                ? n.is('.open')
            ...
            .on('mouseenter', function () {
              if (
                ...
                0 === a('.main-menu li.open').length &&
                  a('.main-menu-content').find('li.active').parents('li').addClass('open');
