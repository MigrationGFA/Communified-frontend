...
(function (f) {
    ...
    _popover: function (a, b, c) {
      var d = this.c,
        ...
        m = function () {
          ...
          f(b.buttons('[aria-haspopup="true"][aria-expanded="true"]').nodes()).attr(
            'aria-expanded',
            'false'
          );
      ...
      e.collectionTitle &&
        c.prepend('<div class="dt-button-collection-title">' + e.collectionTitle + '</div>');
      ...
      if (
        ...
        c.hasClass(e.rightAlignClassName)
          ? ((w = B - x),
            l > g + w && ((g = l - (g + w)), (d -= x + w), (w = g > d ? w + d : w + g)))
          : ((w = l - g),
            d < x + w && ((g = l - (g + w)), (d -= x + w), (w = g > d ? w + d : w + g)));
      ...
      f('body')
        .on('click.dtb-collection', function (C) {
          ...
          ((!f(C.target).parents()[I]().filter(a).length && !f(J).hasClass('dt-buttons')) ||
      ...
      var c = [],
        ...
        e = function (g, l) {
          ...
          if (Array.isArray(g) || g instanceof f) for (p = 0, k = g.length; p < k; p++) e(g[p], l);
            ...
            'object' === typeof g &&
              g.nodeName &&
              ((n = f.inArray(g, p)), -1 !== n && c.push({ inst: l, node: p[n] }));
        },
        h = 0,
        m = a.length;
      h < m;
  ...
  q.Api.register('button().add()', function (a, b) {
    var c = this.context;
    c.length &&
      ((c = u.instanceSelector(this._groupSelector, c[0]._buttons)), c.length && c[0].add(b, a));
  ...
  q.Api.register('buttons.exportInfo()', function (a) {
    ...
    var b = a;
    var c =
      '*' === b.filename && '*' !== b.title && b.title !== t && null !== b.title && '' !== b.title
        ? b.title
        : b.filename;
