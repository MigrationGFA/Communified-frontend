                ...
                ? t.addEventListener(
                    ...
                    function (t) {
                      (t.preventDefault(),
                        ...
                        'function' == typeof this.contextfn && this.contextfn(this, t));
                    },
                    !1
                  )
                : t.attachEvent('oncontextmenu', function () {
                    (e.options.context(this),
                      'function' == typeof this.contextfn && this.contextfn(this),
            ...
            function l(t) {
              ...
              if (e.options.itemHandleOptions.enabled) {
                if (void 0 !== (e.options.itemHandleOptions.customHandler || void 0))
                  return (n =
                    '<div> ' +
                    e.options.itemHandleOptions.customHandler.replace(/%([^%]+)%/g, (e, n) =>
                      void 0 !== t[n] ? t[n] : ''
                    ) +
                    ' </div>');
            ...
            (arguments[0] &&
              ...
              (this.addBoards = function (t, n) {
                ...
                for (var p in t) {
                  ...
                  if (
                    (y.classList.add('kanban-drag'), '' !== v.bodyClass && void 0 !== v.bodyClass)
                  )
                  ...
                  if (0 !== s(e)) {
                    if (
                      ...
                      var u,
                        f = {
                          left:
                            (u = E.getBoundingClientRect()).left + l('scrollLeft', 'pageXOffset'),
