    ...
    const Ue = {
      ...
      updateVolume() {
        this.supported.ui &&
          (H(this.elements.inputs.volume) &&
            Ue.setRange.call(this, this.elements.inputs.volume, this.muted ? 0 : this.volume),
      ...
      timeUpdate(e) {
        ...
        (Ue.updateTimeDisplay.call(
          ...
          (e && 'timeupdate' === e.type && this.media.seeking) || Ue.updateProgress.call(this, e));
      },
      durationUpdate() {
        ...
        (!e &&
          ...
          this.paused &&
          Ue.updateTimeDisplay.call(this, this.elements.display.currentTime, this.duration),
      ...
      constructor(t) {
        (e(this, 'onChange', () => {
          ...
          e(this, 'update', () => {
            if (this.enabled) {
              let e;
              ((e = this.forceFallback ? 'Fallback (forced)' : it.native ? 'Native' : 'Fallback'),
            ...
            if (
              ...
              this.bind(
                ...
                (t) => {
                  ...
                  [13, 32].includes(i) &&
                    (13 !== i
                      ? (t.preventDefault(), t.stopPropagation(), Ue.toggleMenu.call(e, t))
            ...
            (this.bind(
              ...
              e.config.toggleInvert &&
                ...
                this.bind(t.display.currentTime, 'click', () => {
                  0 !== e.currentTime &&
                    ((e.config.invertTime = !e.config.invertTime), Ue.timeUpdate.call(e));
                }),
              this.bind(
                t.inputs.volume,
                i,
              ...
              this.bind(t.controls, 'focusin', () => {
                ...
                (clearTimeout(s.controls),
                  (s.controls = setTimeout(() => nt.toggleControls.call(e, !1), n)));
              }),
              this.bind(
                t.inputs.volume,
                'wheel',
