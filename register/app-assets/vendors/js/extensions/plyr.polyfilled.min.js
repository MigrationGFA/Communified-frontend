  ...
  (function (e, t) {
    ...
    var Z = {
      ...
      ee = t(function (e) {
        ...
        (e.exports = function (e, t, r, a) {
          ...
          ('function' == typeof r &&
            ...
            (o = i(r)).source || (o.source = s.join('string' == typeof t ? t : ''))),
            e !== n
              ? (l ? !u && e[t] && (c = !0) : delete e[t], c ? (e[t] = r) : L(e, t, r))
              : c
                ? (e[t] = r)
                : I(t, r));
      ...
      he = function (e) {
        return function (t, i, n) {
          ...
          } else for (; a > o; o++) if ((e || o in r) && r[o] === i) return e || o || 0;
          return !e && -1;
        };
      },
      ...
      if (!a || !o || ('replace' === e && (!it || !nt || rt)) || ('split' === e && !at)) {
        var l = /./[r],
          c = i(
            ...
            { REPLACE_KEEPS_$0: nt, REGEXP_REPLACE_SUBSTITUTES_UNDEFINED_CAPTURE: rt }
          ),
          u = c[0],
          h = c[1];
      ...
      return [
        ...
        function (e, n) {
          ...
          for (var f, g = '', y = 0, b = 0; b < p.length; b++) {
            m = p[b];
            for (
              var v = String(m[0]), w = bt(vt(ae(m.index), c.length), 0), k = [], T = 1;
              T < m.length;
              T++
            )
    ...
    var Ut =
        ...
        function (e, t) {
          ...
          return (
            null !== e
              ? ((Rt.prototype = C(e)), (i = new Rt()), (Rt.prototype = null), (i[Mt] = e))
              : (i = $t()),
            void 0 === t ? i : Ot(i, t)
          );
        },
      ...
      Ft = et('toStringTag'),
      Dt = function (e, t, i) {
        e && !v((e = i ? e : e.prototype), Ft) && qt(e, Ft, { configurable: !0, value: t });
      },
      Ht = {},
      ...
      zt = function (e, t, i) {
        var n = t + ' Iterator';
        return ((e.prototype = Ut(Bt, { next: c(1, i) })), Dt(e, n, !1), (Ht[n] = Vt), e);
      },
      Wt =
      ...
      ei = function (e, t, i, n, s, r, a) {
        ...
        if (
          (g &&
            ...
            Kt !== Object.prototype &&
              o.next &&
              (Ct(o) !== Kt && (Wt ? Wt(o, Kt) : 'function' != typeof o[Gt] && L(o, Gt, Zt)),
              Dt(o, h, !0))),
          s == Qt &&
            m &&
            m.name !== Qt &&
    ...
    var bi = '[object z]' === String(yi),
      ...
      Ei = function (e) {
        var t,
          ...
          p = 0;
        if (
          (h && (u = hi(u, c > 2 ? arguments[2] : void 0, 2)), null == d || (l == Array && fi(d)))
        )
          for (i = new l((t = le(o.length))); t > p; p++)
            ((a = h ? u(o[p], p) : o[p]), gi(i, p, a));
        else
          for (r = (s = d.call(o)).next, i = new l(); !(n = r.call(s)).done; p++)
    ...
    var Fi = function (e) {
      ...
      rn = function (e, t) {
        if (t)
          for (var i, n, s = t.split('&'), r = 0; r < s.length; )
            (i = s[r++]).length &&
              ((n = i.split('=')), e.push({ key: Zi(n.shift()), value: Zi(n.join('=')) }));
      },
      an = function (e) {
      ...
      ln = zt(
        ...
        function () {
          ...
          return (
            i.done ||
              (i.value = 'keys' === t ? n.key : 'values' === t ? n.value : [n.key, n.value]),
            i
          );
        }
      ),
      cn = function () {
        ...
        var e,
          ...
          h = [];
        if (
          (Wi(u, { type: Vi, entries: h, updateURL: function () {}, updateSearchParams: an }),
          void 0 !== c)
        )
          if (g(c))
    ...
    (!(function (e, t, i) {
      ...
      un,
      {
        ...
        delete: function (e) {
          ...
          for (var t = Ki(this), i = t.entries, n = e + '', s = 0; s < i.length; )
        ...
        getAll: function (e) {
          on(arguments.length, 1);
          for (var t = Ki(this).entries, i = e + '', n = [], s = 0; s < t.length; s++)
        ...
        set: function (e, t) {
          on(arguments.length, 1);
          for (
            var i, n = Ki(this), s = n.entries, r = !1, a = e + '', o = t + '', l = 0;
            l < s.length;
            l++
          )
            (i = s[l]).key === a && (r ? s.splice(l--, 1) : ((r = !0), (i.value = o)));
              ...
              return (
                arguments.length > 1 &&
                  (g((t = arguments[1])) &&
                    ((i = t.body),
                    ki(i) === Vi &&
                      ((n = t.headers ? new Hi(t.headers) : new Hi()).has('content-type') ||
                        n.set('content-type', 'application/x-www-form-urlencoded;charset=UTF-8'),
                      (t = Ut(t, { body: c(0, String(i)), headers: c(0, n) })))),
                  s.push(t)),
                Di.apply(this, s)
              );
            },
    ...
    var hn,
      ...
      Yn = function (e, t) {
        var i;
        return (
          2 == e.length && En.test(e.charAt(0)) && (':' == (i = e.charAt(1)) || (!t && '|' == i))
        );
      },
      Gn = function (e) {
        var t;
          ...
          switch (((r = s[u]), c)) {
            ...
            case Zn:
              if (r && (An.test(r) || '+' == r || '-' == r || '.' == r)) h += r.toLowerCase();
                ...
                if (
                  ...
                  return;
                if (((e.scheme = h), i))
                  return void (zn(e) && Vn[e.scheme] == e.port && (e.port = null));
                ((h = ''),
                  'file' == e.scheme
                    ? (c = hs)
            ...
            case hs:
              if (((e.scheme = 'file'), '/' == r || '\\' == r)) c = ds;
                ...
                if (r == hn) ((e.host = n.host), (e.path = n.path.slice()), (e.query = n.query));
                  ...
                  ((e.host = n.host), (e.path = n.path.slice()), (e.query = ''), (c = ys));
                else {
                  if ('#' != r) {
                    (Gn(s.slice(u).join('')) ||
            ...
            case ds:
              ...
              (n &&
                'file' == n.scheme &&
                !Gn(s.slice(u).join('')) &&
                (Yn(n.path[0], !0) ? e.path.push(n.path[0]) : (e.host = n.host)),
                (c = fs));
              continue;
            case ps:
              if (r == hn || '/' == r || '\\' == r || '?' == r || '#' == r) {
      ...
      (r &&
        Ot(ks, {
          ...
          search: Ms(_s, function (e) {
            ...
            ('' == (e = String(e))
              ? (t.query = null)
              : ('?' == e.charAt(0) && (e = e.slice(1)), (t.query = ''), vs(t, e, ys)),
              gn(t.searchParams).updateSearchParams(t.query));
          }),
          searchParams: Ms(Os),
          hash: Ms(Ns, function (e) {
            var t = bn(this);
            '' != (e = String(e))
              ? ('#' == e.charAt(0) && (e = e.slice(1)), (t.fragment = ''), vs(t, e, bs))
              : (t.fragment = null);
          }),
        }),
      ee(
            ...
            Object.defineProperty(r, '_fromString', {
              ...
              value: function (e) {
                ...
                for (i = 0; i < r.length; i++)
                  ((n = r[i].split('=')), this.append(s(n[0]), n.length > 1 ? s(n[1]) : ''));
              },
            }));
      })(
        void 0 !== e
              ...
              var t = e.URL,
                i = function (t, i) {
                  ...
                  if (i && (void 0 === e.location || i !== e.location.href)) {
                    ((i = i.toLowerCase()),
                      ((n = (s = document.implementation.createHTMLDocument('')).createElement(
                        'base'
                      )).href = i),
    ...
    var Vs = function (e) {
      ...
      ir = function (e) {
        return (
          Ws(e) || ((Ys(e) || Gs(e) || Xs(e)) && !e.length) || (Ks(e) && !Object.keys(e).length)
        );
      };
    function nr(e, t) {
      if (1 > t) {
    ...
    var sr = (function () {
      function e(t, i) {
        ((function (e, t) {
          ...
          er(t) ? (this.element = t) : Qs(t) && (this.element = document.querySelector(t)),
          er(this.element) &&
          ...
          [
            ...
            },
            {
              ...
              value: function (t) {
                ...
                return (
                  0 > (i = (100 / l.width) * (s.clientX - l.left)) ? (i = 0) : 100 < i && (i = 100),
          ...
          [
            {
              ...
              value: function (t) {
                ...
                if (
                  (ir(t) || Qs(t)
                    ? (n = Array.from(document.querySelectorAll(Qs(t) ? t : 'input[type="range"]')))
                    : er(t)
                      ? (n = [t])
                      : Zs(t)
                        ? (n = Array.from(t))
    ...
    const rr = (e) => (null != e ? e.constructor : null),
      ...
      dr = (e) => ar(e, NodeList),
      pr = (e) =>
        or(e) || ((cr(e) || hr(e) || dr(e)) && !e.length) || (lr(e) && !Object.keys(e).length);
    var mr = or,
      fr = lr,
    ...
    function Nr(e = {}, ...t) {
      ...
      return fr(i)
        ? (Object.keys(i).forEach((t) => {
            fr(i[t])
              ? (Object.keys(e).includes(t) || Object.assign(e, { [t]: {} }), Nr(e[t], i[t]))
    ...
    function Yr(e = null, t = !1) {
      Tr(e) && (e.focus({ preventScroll: !0 }), t && Br(e, this.config.classNames.tabFocus));
    }
    const Gr = {
        'audio/ogg': 'vorbis',
        'audio/wav': '1',
      ...
      Xr = {
        ...
        check(e, t, i) {
          const n = _r.isIPhone && i && Xr.playsinline,
            s = Xr[e] || 'html5' !== t;
          return { api: s, ui: s && Xr.rangeInput && ('video' !== e || !_r.isIPhone || n) };
        },
        pip: !(
          _r.isIPhone ||
          (!vr(jr('video').webkitSetPresentationMode) &&
            (!document.pictureInPictureEnabled || jr('video').disablePictureInPicture))
        ),
    ...
    function sa() {
      return new Promise((e) =>
        this.ready ? setTimeout(e, 0) : Zr.call(this, this.elements.container, 'ready', e)
      ).then(() => {});
    }
    function ra(e) {
      Cr(e) && e.then(null, () => {});
    ...
    function ha(e) {
      ...
      if (
        ...
        null === i && !xr(this.embed) && wr(this.embed.ratio) && ({ ratio: i } = this.embed),
        null === i && this.isHTML5)
      ) {
      ...
      setup() {
        ...
        ((e.options.speed = e.config.speed.options),
          ...
          Object.defineProperty(e.media, 'quality', {
            get() {
              const t = ma.getSources.call(e).find((t) => t.getAttribute('src') === e.source);
            ...
            set(t) {
              if (e.quality !== t) {
                if (e.config.quality.forced && vr(e.config.quality.onChange))
                  ...
                  const i = ma.getSources.call(e).find((e) => Number(e.getAttribute('size')) === t);
                  if (!i) return;
                  const {
                    currentTime: n,
                    paused: s,
    ...
    const ga = (e = '', t = '', i = '') =>
      ...
      ya = (e = '') =>
        e
          .toString()
          .replace(/\w\S*/g, (e) => e.charAt(0).toUpperCase() + e.substr(1).toLowerCase());
    function ba(e = '') {
      let t = e.toString();
      return (
        (t = (function (e = '') {
          let t = e.toString();
          return ((t = ga(t, '-', ' ')), (t = ga(t, '_', ' ')), (t = ya(t)), ga(t, ' ', ''));
        })(t)),
    ...
    function Ea(e, t) {
      ...
      if (!i || !s()) {
        ...
        Sa(e)
          .then((e) => {
            xr(e) ||
              (s && window.localStorage.setItem(`cache-${t}`, JSON.stringify({ content: e })),
              r(a, e));
          })
          .catch(() => {});
      }
    ...
    const Pa = {
      ...
      findElements() {
        try {
          return (
            (this.elements.controls = Kr.call(this, this.config.selectors.controls.wrapper)),
            ...
            (this.elements.progress = Kr.call(this, this.config.selectors.progress)),
      ...
      createBadge(e) {
        ...
        return (t.appendChild(jr('span', { class: this.config.classNames.menu.badge }, e)), t);
      },
      createButton(e, t) {
        const i = Nr({}, t);
        let n = ba(e);
        ...
        return (
          s.toggle
            ? (r.appendChild(Pa.createIcon.call(this, s.iconPressed, { class: 'icon--pressed' })),
              r.appendChild(Pa.createIcon.call(this, s.icon, { class: 'icon--not-pressed' })),
              r.appendChild(Pa.createLabel.call(this, s.labelPressed, { class: 'label--pressed' })),
              r.appendChild(Pa.createLabel.call(this, s.label, { class: 'label--not-pressed' })))
      ...
      createRange(e, t) {
        ...
        return ((this.elements.inputs[e] = i), Pa.updateRangeFill.call(this, i), sr.setup(i), i);
      },
      createProgress(e, t) {
        const i = jr(
          'progress',
      ...
      bindMenuItemShortcuts(e, t) {
        (Zr.call(
          ...
          (i) => {
            ...
            if (!n && [32, 39].includes(i.which)) Pa.showMenuPanel.call(this, t, !0);
            else {
              let t;
              32 !== i.which &&
                (40 === i.which || (n && 39 === i.which)
                  ? ((t = e.nextElementSibling), Tr(t) || (t = e.parentNode.firstElementChild))
                  : ((t = e.previousElementSibling), Tr(t) || (t = e.parentNode.lastElementChild)),
                Yr.call(this, t, !0));
            }
          },
          !1
      ...
      updateVolume() {
        this.supported.ui &&
          (Tr(this.elements.inputs.volume) &&
            Pa.setRange.call(this, this.elements.inputs.volume, this.muted ? 0 : this.volume),
          ...
          switch (e.type) {
            ...
            case 'seeked':
              ((t = (function (e, t) {
                ...
                'timeupdate' === e.type && Pa.setRange.call(this, this.elements.inputs.seek, t));
              break;
            case 'playing':
            case 'progress':
      ...
      updateSeekTooltip(e) {
        ...
        (n < 0 ? (n = 0) : n > 100 && (n = 100),
          ...
          Sr(e) && ['mouseenter', 'mouseleave'].includes(e.type) && i('mouseenter' === e.type));
      },
      timeUpdate(e) {
        ...
        (Pa.updateTimeDisplay.call(
          ...
          (e && 'timeupdate' === e.type && this.media.seeking) || Pa.updateProgress.call(this, e));
      },
      durationUpdate() {
        if (!this.supported.ui || (!this.config.invertTime && this.currentTime)) return;
        if (this.duration >= 2 ** 32)
          return (Hr(this.elements.display.currentTime, !0), void Hr(this.elements.progress, !0));
        Tr(this.elements.inputs.seek) &&
        ...
        (!e &&
          ...
          this.paused &&
          Pa.updateTimeDisplay.call(this, this.elements.display.currentTime, this.duration),
          e && Pa.updateTimeDisplay.call(this, this.elements.display.duration, this.duration),
      ...
      setQualityMenu(e) {
        ...
        wr(e) &&
          (this.options.quality = aa(e).filter((e) => this.config.quality.options.includes(e)));
        const n = !xr(this.options.quality) && this.options.quality.length > 1;
        if ((Pa.toggleMenuButton.call(this, t, n), qr(i), Pa.checkMenu.call(this), !n)) return;
        const s = (e) => {
      ...
      setCaptionsMenu() {
        ...
        const e = 'captions',
          ...
          n = Boolean(i.length);
        if ((Pa.toggleMenuButton.call(this, e, n), qr(t), Pa.checkMenu.call(this), !n)) return;
        const s = i.map((e, i) => ({
          value: i,
          checked: this.captions.toggled && this.currentTrack === i,
          title: Ia.getLabel.call(this, e),
          badge: e.language && Pa.createBadge.call(this, e.language.toUpperCase()),
          list: t,
          type: 'language',
        }));
        (s.unshift({
          ...
          const e = Pa.getMenuSize.call(this, i),
            t = (e) => {
              e.target === n &&
                ...
                ((n.style.width = ''), (n.style.height = ''), ea.call(this, n, Lr, t));
            };
          (Zr.call(this, n, Lr, t),
      ...
      create(e) {
        ...
        return (
          aa(wr(this.config.controls) ? this.config.controls : []).forEach((a) => {
            if (
              ...
              const t = jr('div', { class: `${u.class} plyr__progress__container` }),
                i = jr('div', Dr(this.config.selectors.progress));
              if (
                (i.appendChild(s.call(this, 'seek', { id: `plyr-seek-${e.id}` })),
                i.appendChild(n.call(this, 'buffer')),
                this.config.tooltips.seek)
              ) {
                const e = jr('span', { class: this.config.classNames.tooltip }, '00:00');
            ...
            if (
              ...
              if (
                ((Tr(t) && c.contains(t)) ||
                  ((t = jr('div', Nr({}, u, { class: `${u.class} plyr__volume`.trim() }))),
                ...
                t.appendChild(s.call(this, 'volume', Nr(i, { id: `plyr-volume-${e.id}` })));
              }
            }
            if (
              ...
              const n = jr('div', Nr({}, u, { class: `${u.class} plyr__menu`.trim(), hidden: '' }));
              n.appendChild(
              ...
              (a.appendChild(o),
                ...
                this.config.settings.forEach((i) => {
                  ...
                  const s = jr('span', null, ka.get(i, this.config)),
                    a = jr('span', { class: this.config.classNames.menu.value });
                  ((a.innerHTML = e[i]), s.appendChild(a), n.appendChild(s), o.appendChild(n));
                  const c = jr('div', { id: `plyr-settings-${e.id}-${i}`, hidden: '' }),
                    u = jr('button', {
                      type: 'button',
                      class: `${this.config.classNames.control} ${this.config.classNames.control}--back`,
                    });
                  (u.appendChild(jr('span', { 'aria-hidden': !0 }, ka.get(i, this.config))),
                    u.appendChild(
                      jr(
                        'span',
            ...
            if (
              ...
              'airplay' === a && Xr.airplay && c.appendChild(i.call(this, 'airplay', u)),
              'download' === a)
            ) {
              const e = Nr({}, u, { element: 'a', href: this.download, target: '_blank' });
              this.isHTML5 && (e.download = '');
              const { download: t } = this.config.urls;
              (!Pr(t) &&
                this.isEmbed &&
                Nr(e, { icon: `logo-${this.provider}`, label: this.provider }),
      ...
      inject() {
        ...
        let i = !0;
        (vr(this.config.controls) && (this.config.controls = this.config.controls.call(this, t)),
        ...
        if (
          (n[Tr(e) ? 'insertAdjacentElement' : 'insertAdjacentHTML']('afterbegin', e),
    ...
    const Ia = {
        setup() {
          ...
          if (!this.isVideo || this.isYouTube || (this.isHTML5 && !Xr.textTracks))
            return void (
              wr(this.config.controls) &&
          ...
          if (
            (Tr(this.elements.captions) ||
              ((this.elements.captions = jr('div', Dr(this.config.selectors.captions))),
          ...
          if (
            ...
            Object.assign(this.captions, { toggled: !1, active: s, language: n, languages: i }),
            this.isHTML5)
          ) {
        ...
        update() {
          ...
          (this.isHTML5 &&
            ...
            Br(this.elements.container, this.config.classNames.captions.enabled, !xr(e)),
            wr(this.config.controls) &&
              this.config.controls.includes('settings') &&
              this.config.settings.includes('captions') &&
              Pa.setCaptionsMenu.call(this));
        ...
        toggle(e, t = !0) {
          ...
          if (s !== i) {
            if (
              ...
              return ((this.captions.language = t.language), void Ia.set.call(this, e.indexOf(t)));
            }
            (this.elements.buttons.captions && (this.elements.buttons.captions.pressed = s),
              ...
              ia.call(this, this.media, s ? 'captionsenabled' : 'captionsdisabled'));
          }
          setTimeout(() => {
        ...
        getLabel(e) {
          let t = e;
          return (
            !Ar(t) && Xr.textTracks && this.captions.toggled && (t = Ia.getCurrentTrack.call(this)),
            Ar(t)
              ? xr(t.label)
                ? xr(t.language)
    ...
    class Ua {
      ...
      get log() {
        return this.enabled ? Function.prototype.bind.call(console.log, console) : $a;
      }
      get warn() {
        return this.enabled ? Function.prototype.bind.call(console.warn, console) : $a;
      }
      get error() {
        return this.enabled ? Function.prototype.bind.call(console.error, console) : $a;
      }
    }
    class qa {
      constructor(e) {
        ($s(this, 'onChange', () => {
          ...
          $s(this, 'toggleFallback', (e = !1) => {
            if (
              ...
              Br(this.target, this.player.config.classNames.fullscreen.fallback, e),
              _r.isIos)
            ) {
          ...
          $s(this, 'update', () => {
            if (this.enabled) {
              let e;
              ((e = this.forceFallback ? 'Fallback (forced)' : qa.native ? 'Native' : 'Fallback'),
            ...
            this.enabled &&
              (_r.isIos && this.player.config.fullscreen.iosNative
                ...
                : !qa.native || this.forceFallback
                  ...
                  : this.prefix
                    ? xr(this.prefix) || this.target[`${this.prefix}Request${this.property}`]()
          ...
          Zr.call(this, this.player.elements.container, 'keydown', (e) => this.trapFocus(e)),
          this.update());
      }
      static get native() {
        return !!(
      ...
      static get prefix() {
        ...
        return (
          ['webkit', 'moz', 'ms'].some(
            (t) =>
              !(!vr(document[`${t}ExitFullscreen`]) && !vr(document[`${t}CancelFullScreen`])) &&
              ((e = t), !0)
          ),
          e
        );
      ...
      get active() {
        ...
        if (!qa.native || this.forceFallback)
          return Vr(this.target, this.player.config.classNames.fullscreen.fallback);
        const e = this.prefix
    ...
    const Da = {
      addStyleHook() {
        (Br(this.elements.container, this.config.selectors.container.replace('.', ''), !0),
          Br(this.elements.container, this.config.classNames.uiSupported, this.supported.ui));
      },
      ...
      build() {
        ...
        (Tr(this.elements.controls) || (Pa.inject.call(this), this.listeners.controls()),
          ...
          Br(this.elements.container, this.config.classNames.isTouch, this.touch),
          (this.ready = !0),
          setTimeout(() => {
            ia.call(this, this.media, 'ready');
          }, 0),
          Da.setTitle.call(this),
          this.poster && Da.setPoster.call(this, this.poster, !1).catch(() => {}),
          this.config.duration && Pa.durationUpdate.call(this));
      },
      setTitle() {
        let e = ka.get('play', this.config);
        if (
          (yr(this.config.title) && !xr(this.config.title) && (e += `, ${this.config.title}`),
      ...
      checkPlaying(e) {
        (Br(this.elements.container, this.config.classNames.playing, this.playing),
          Br(this.elements.container, this.config.classNames.paused, this.paused),
          Br(this.elements.container, this.config.classNames.stopped, this.stopped),
          Array.from(this.elements.buttons.play || []).forEach((e) => {
            (Object.assign(e, { pressed: this.playing }),
              e.setAttribute('aria-label', ka.get(this.playing ? 'pause' : 'play', this.config)));
          }),
      ...
      checkLoading(e) {
        ((this.loading = ['stalled', 'waiting'].includes(e.type)),
          ...
          (this.timers.loading = setTimeout(
            () => {
              (Br(this.elements.container, this.config.classNames.loading, this.loading),
    ...
    class Ha {
      constructor(e) {
        ($s(this, 'firstTouch', () => {
          ...
          $s(this, 'global', (e = !0) => {
            const { player: t } = this;
            (t.config.keyboard.global && Jr.call(t, window, 'keydown keyup', this.handleKey, e, !1),
          ...
          $s(this, 'container', () => {
              ...
              Zr.call(
                ...
                (t) => {
                  ...
                  (['touchstart', 'touchmove', 'mousemove'].includes(t.type) &&
                    ...
                    (n.controls = setTimeout(() => Da.toggleControls.call(e, !1), r)));
                }
              ));
            const s = (t) => {
            ...
            Zr.call(e, i.container, 'enterfullscreen exitfullscreen', (t) => {
              ...
              (((t, i, n) => {
                ...
                a || (o ? Zr.call(e, window, 'resize', r) : ea.call(e, window, 'resize', r)));
            });
          }),
          $s(this, 'media', () => {
            const { player: e } = this,
              { elements: t } = e;
            if (
              (Zr.call(e, e.media, 'timeupdate seeking seeked', (t) => Pa.timeUpdate.call(e, t)),
              Zr.call(e, e.media, 'durationchange loadeddata loadedmetadata', (t) =>
                Pa.durationUpdate.call(e, t)
              ),
              ...
              Zr.call(e, e.media, 'volumechange', (t) => Pa.updateVolume.call(e, t)),
              Zr.call(e, e.media, 'playing play pause ended emptied timeupdate', (t) =>
                Da.checkPlaying.call(e, t)
              ),
            ...
            (e.supported.ui &&
              ...
              Zr.call(e, e.media, 'ratechange', () => {
                (Pa.updateSetting.call(e, 'speed'), e.storage.set({ speed: e.speed }));
              }),
          ...
          $s(this, 'controls', () => {
            ...
            if (
              ...
              this.bind(
                ...
                'click',
                (t) => {
                  (t.stopPropagation(), t.preventDefault(), Pa.toggleMenu.call(e, t));
                },
                null,
                !1
              ),
              this.bind(
                ...
                (t) => {
                  ...
                  [13, 32].includes(i) &&
                    (13 !== i
                      ? (t.preventDefault(), t.stopPropagation(), Pa.toggleMenu.call(e, t))
            ...
            (this.bind(
              ...
              _r.isWebkit &&
                Array.from(Wr.call(e, 'input[type="range"]')).forEach((t) => {
                  this.bind(t, 'input', (t) => Pa.updateRangeFill.call(e, t.target));
                }),
              e.config.toggleInvert &&
                !Tr(t.display.duration) &&
                this.bind(t.display.currentTime, 'click', () => {
                  0 !== e.currentTime &&
                    ((e.config.invertTime = !e.config.invertTime), Pa.timeUpdate.call(e));
                }),
              this.bind(
                t.inputs.volume,
                i,
              ...
              this.bind(t.controls, 'focusin', () => {
                ...
                (clearTimeout(n.controls),
                  (n.controls = setTimeout(() => Da.toggleControls.call(e, !1), s)));
              }),
              this.bind(
                t.inputs.volume,
                'wheel',
    ...
    function za(e) {
      (e && !this.embed.hasPlayed && (this.embed.hasPlayed = !0),
        this.media.paused === e &&
          ((this.media.paused = !e), ia.call(this, this.media, e ? 'play' : 'pause')));
    }
    const Wa = {
      setup() {
        const e = this;
      ...
      ready() {
        ...
        (t.customControls ||
          Sa(fa(e.config.urls.vimeo.api, u)).then((t) => {
            !xr(t) && t.thumbnail_url && Da.setPoster.call(e, t.thumbnail_url).catch(() => {});
          }),
        ...
        (Object.defineProperty(e.media, 'loop', {
          ...
          e.embed.on('progress', (t) => {
            ((e.media.buffered = t.percent),
              ...
              1 === parseInt(t.percent, 10) && ia.call(e, e.media, 'canplaythrough'),
              e.embed.getDuration().then((t) => {
                t !== e.media.duration &&
                  ((e.media.duration = t), ia.call(e, e.media, 'durationchange'));
              }));
    ...
    const Ga = {
          ...
          Sa(fa(this.config.urls.youtube.api, e))
            .then((e) => {
              if (fr(e)) {
                ...
                ((this.config.title = t), Da.setTitle.call(this), (this.embed.ratio = pa(n, i)));
              }
              da.call(this);
            })
            .catch(() => {
        ...
        ready() {
          ...
          const s = xr((r = n))
            ? null
            : r.match(/^.*(youtu.be\/|v\/|u\/\w\/|embed\/|watch\?v=|&v=)([^#&?]*).*/)
              ? RegExp.$2
              : r;
          var r;
          const a = jr('div', {
            ...
            events: {
              onError(t) {
                if (!e.media.error) {
                  ...
                  ((e.media.error = { code: i, message: n }), ia.call(e, e.media, 'error'));
                }
              },
              ...
              onReady(i) {
                ...
                (Object.defineProperty(e.media, 'muted', {
                  ...
                  Object.defineProperty(e.media, 'currentSrc', { get: () => n.getVideoUrl() }),
                ...
                ((e.options.speed = o.filter((t) => e.config.speed.options.includes(t))),
                  ...
                  (e.timers.buffering = setInterval(() => {
                    ((e.media.buffered = n.getVideoLoadedFraction()),
                      ...
                      1 === e.media.buffered &&
                        (clearInterval(e.timers.buffering), ia.call(e, e.media, 'canplaythrough')));
                  }, 200)),
              ...
              onStateChange(i) {
                ...
                switch (
                  ...
                  case 0:
                    (Ka.call(e, !1),
                      e.media.loop ? (n.stopVideo(), n.playVideo()) : ia.call(e, e.media, 'ended'));
                    break;
                  case 1:
                ...
                ia.call(e, e.elements.container, 'statechange', !1, { code: i.data });
              },
            },
          });
        },
        ...
        setup() {
          this.media
            ? (Br(
              ...
              this.isVideo &&
                ((this.elements.wrapper = jr('div', { class: this.config.classNames.video })),
                Mr(this.media, this.elements.wrapper),
                (this.elements.poster = jr('div', { class: this.config.classNames.poster })),
    ...
    class Qa {
      constructor(e) {
        ($s(this, 'load', () => {
          ...
          $s(this, 'setupIMA', () => {
            ((this.elements.container = jr('div', { class: this.player.config.classNames.ads })),
                ...
                if (0 !== e && -1 !== e && e < this.player.duration) {
                  ...
                  if (Tr(t)) {
                    const i = (100 / this.player.duration) * e,
                      n = jr('span', { class: this.player.config.classNames.cues });
          ...
          $s(this, 'onAdEvent', (e) => {
            ...
            switch (
              ...
              case google.ima.AdEvent.Type.LOG:
                n.adError &&
                  this.player.debug.warn(`Non-fatal ad error: ${n.adError.getMessage()}`);
            }
          }),
          $s(this, 'onAdError', (e) => {
          ...
          $s(
            this,
            'on',
            (e, t) => (wr(this.events[e]) || (this.events[e] = []), this.events[e].push(t), this)
          ),
      ...
      get tagUrl() {
        ...
        return `https://go.aniview.com/api/adserver6/vast/?${La({ AV_PUBLISHERID: '58c25bb0073ef448b1087ad6', AV_CHANNELID: '5a0458dc28a06145e4519d21', AV_URL: window.location.hostname, cb: Date.now(), AV_WIDTH: 640, AV_HEIGHT: 480, AV_CDIM2: e.publisherId })}`;
      }
    }
    const Ja = (e) => {
        const t = [];
            ...
            this.destroy.call(
              ...
              () => {
                ((this.options.quality = []),
                  Ur(this.media),
                  (this.media = null),
                  Tr(this.elements.container) && this.elements.container.removeAttribute('class'));
                ...
                (Object.assign(this, {
                  ...
                  (this.isHTML5 || (this.isEmbed && !this.supported.ui)) && Da.build.call(this),
    ...
    class io {
      constructor(e, t) {
        if (
          ...
          $s(this, 'togglePlay', (e) => ((br(e) ? e : !this.playing) ? this.play() : this.pause())),
          $s(this, 'stop', () => {
            this.isHTML5
              ...
              this.isHTML5
                ...
                : this.isYouTube
                  ? (clearInterval(this.timers.buffering),
                    ...
                    null !== this.embed && vr(this.embed.destroy) && this.embed.destroy(),
                    i())
                  : this.isVimeo &&
          ...
          (this.touch = Xr.touch),
          (this.media = e),
          yr(this.media) && (this.media = document.querySelectorAll(this.media)),
          ((window.jQuery && this.media instanceof jQuery) || kr(this.media) || wr(this.media)) &&
        ...
        ((this.supported = Xr.check(this.type, this.provider, this.config.playsinline)),
          this.supported.api
            ? ((this.eventListeners = []),
              ...
              Xa.setup.call(this),
              this.config.debug &&
                Zr.call(this, this.elements.container, this.config.events.join(' '), (e) => {
              ...
              this.isHTML5 && this.config.autoplay && this.once('canplay', () => ra(this.play())),
              (this.lastSeekTime = 0),
              this.config.previewThumbnails.enabled && (this.previewThumbnails = new eo(this)))
