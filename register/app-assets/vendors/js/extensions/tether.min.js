          ...
          },
          {
            ...
            value: function (t) {
              if ('undefined' != typeof this.bindings && this.bindings[t]) {
                for (
                  var e = 0, o = arguments.length, n = Array(o > 1 ? o - 1 : 0), i = 1;
                  o > i;
                  i++
                )
                  n[i - 1] = arguments[i];
      ...
      n = function i() {
        return 'undefined' != typeof e && e > 16
          ...
          : void (
              ...
              (null != o && (clearTimeout(o), (o = null)), (t = b()), D(), (e = b() - t))
            );
      };
          ...
          },
          {
            ...
            value: function () {
              ...
              if ('scroll-handle' === this.targetModifier) {
                ...
                i && (r = 15);
                var s =
                    t.height - parseFloat(n.borderTopWidth) - parseFloat(n.borderBottomWidth) - r,
                  e = {
                    width: 15,
          ...
          },
          {
            ...
            value: function () {
              ...
              if (this.enabled) {
                ...
                ((d = w(d, c)), (p = w(p, g)));
                for (
                  var m = h.left + p.left - d.left, v = h.top + p.top - d.top, y = 0;
                  y < x.modules.length;
                  ++y
                ) {
                  var b = x.modules[y],
      ...
      return (
        this.options.constraints.forEach(function (t) {
          ...
          (o < b[1] && (l.indexOf('top') >= 0 ? ((o = b[1]), w.push('top')) : C.push('top')),
            ...
            n + f > b[2] &&
              (l.indexOf('right') >= 0 ? ((n = b[2] - f), w.push('right')) : C.push('right')),
            w.length &&
              !(function () {
                var t = void 0;
                ((t =
