...
const gfa_subscribe = (classname) => {
  ...
  $.ajax({
    ...
    error: function () {
      $('.' + classname + '-subscribeBtn').html('Error saving data');
    },
    beforeSend: function () {
      $('.' + classname + '-subscribeBtn').val('Submiting Form...');
    },
    success: function (data) {
      $('.' + classname + '-subscribeBtn').html(
        'Succès! Veuillez vérifier votre e-mail pour continuer'
      );
      $('.' + classname + '-subscribeBtn').prop('disabled', true);
    },
  });
};
...
const gfa_reg_news = (classname) => {
  ...
  $.ajax({
    ...
    beforeSend: function () {
      $('.' + classname + '-subscribeBtn').html('Submiting Form...');
    },
    success: function (data) {
      $('.' + classname + '-subscribeBtn').html(
        'Succès! Veuillez vérifier votre e-mail pour continuer'
...
const checkEmail = (classname, id) => {
  ...
  $.ajax({
    ...
    error: function () {
      $('.' + classname + '-showData').html('Error showing data');
    },
    beforeSend: function () {
      $('.' + classname + '-showData').html('Checking Previous Data...');
    },
    success: function (data) {
...
const checkEmail_acc = () => {
  ...
  $.ajax({
    ...
    error: function () {
      $('.showDataAcc').html('Error saving data');
    },
    beforeSend: function () {
      $('.showDataAcc').html('Checking Previous Data...');
    },
    success: function (data) {
      if (data == 1) {
        $('.showDataAcc').html(
...
const accelerator_form = () => {
  ...
  $.ajax({
    ...
    success: function (data) {
      $('.accBtn').html('Succès ✔ veuillez consulter votre messagerie email pour continuer');
      $('.accBtn').prop('disabled', true);
...
const checkEmail_org = () => {
  ...
  $.ajax({
    ...
    error: function () {
      $('.showDataOrg').html('Error checking data');
    },
    beforeSend: function () {
      $('.showDataOrg').html('Checking Previous Data...');
    },
    success: function (data) {
      if (data == 1) {
        $('.showDataOrg').html(
...
const financial = () => {
  ...
  $.ajax({
    ...
    success: function (data) {
      $('.orgBtn').html('Succès ✔ veuillez consulter votre messagerie email pour continuer');
      $('.orgBtn').prop('disabled', true);
      // Clear all form fields (inputs, selects, and textareas)
      form.reset();
...
const checkEmailInv = () => {
  ...
  $.ajax({
    ...
    error: function () {
      $('.showDataInv').html('Error showing data');
    },
    beforeSend: function () {
      $('.showDataInv').html('Checking Previous Data...');
    },
    success: function (data) {
      if (data == 1) {
        $('.showDataInv').html(
        ...
        $('.investorBtn').prop('disabled', true);
      } else {
        $('.showDataInv').html('');
        $('.investorBtn').prop('disabled', false);
      }
    },
  });
};
...
const investorForm = () => {
  ...
  $.ajax({
    ...
    error: function () {
      $('.investorBtn').html('Error saving data');
    },
    beforeSend: function () {
      $('.investorBtn').html('Submiting Form...');
    },
    success: function (data) {
      $('.investorBtn').html('Succès ✔ veuillez consulter votre messagerie email pour continuer');
      $('.investorBtn').prop('disabled', true);
